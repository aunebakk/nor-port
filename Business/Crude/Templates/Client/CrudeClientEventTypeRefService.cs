...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeClientEventTypeRefService {
        ...
        [OperationContract()]
        List<CrudeClientEventTypeRefContract> FetchWithFilter(string clientEventTypeRcd, string clientEventTypeName, System.Guid userId, System.DateTime dateTime);
    ...
    public partial class CrudeClientEventTypeRefService : ICrudeClientEventTypeRefService {
        ...
        public List<CrudeClientEventTypeRefContract> FetchWithFilter(string clientEventTypeRcd, string clientEventTypeName, System.Guid userId, System.DateTime dateTime) {
            var list = new List<CrudeClientEventTypeRefContract>();
