/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:02:47 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeClientService {
        ...
        [OperationContract()]
        List<CrudeClientContract> FetchByAddressId(System.Guid addressId);
        
        [OperationContract()]
        List<CrudeClientContract> FetchByDefaultUserId(System.Guid defaultUserId);
        
        [OperationContract()]
        List<CrudeClientContract> FetchByUserId(System.Guid userId);
        
        [OperationContract()]
        List<CrudeClientContract> FetchByPassengerTypeRcd(string passengerTypeRcd);
        
        [OperationContract()]
        List<CrudeClientContract> FetchByNationalityRcd(string nationalityRcd);
        
        [OperationContract()]
        List<CrudeClientContract> FetchByGenderRcd(string genderRcd);
        
        [OperationContract()]
        List<CrudeClientContract> FetchByTitleRcd(string titleRcd);
    ...
    public partial class CrudeClientService : ICrudeClientService {
        ...
        public List<CrudeClientContract> FetchByAddressId(System.Guid addressId) {
            return DataListToContractList(CrudeClientData.FetchByAddressId(addressId));
        }
        
        // fetch by Foreign key into new List of class instances
        // links:
        //  docLink: http://sql2x.org/documentationLink/a7599485-4f00-4ebf-974d-53f69c43654e
        public List<CrudeClientContract> FetchByDefaultUserId(System.Guid defaultUserId) {
            return DataListToContractList(CrudeClientData.FetchByDefaultUserId(defaultUserId));
        }
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/a7599485-4f00-4ebf-974d-53f69c43654e
        public List<CrudeClientContract> FetchByPassengerTypeRcd(string passengerTypeRcd) {
            return DataListToContractList(CrudeClientData.FetchByPassengerTypeRcd(passengerTypeRcd));
        }
        
        // fetch by Foreign key into new List of class instances
        // links:
        //  docLink: http://sql2x.org/documentationLink/a7599485-4f00-4ebf-974d-53f69c43654e
        public List<CrudeClientContract> FetchByNationalityRcd(string nationalityRcd) {
            return DataListToContractList(CrudeClientData.FetchByNationalityRcd(nationalityRcd));
        }
        
        // fetch by Foreign key into new List of class instances
        // links:
        //  docLink: http://sql2x.org/documentationLink/a7599485-4f00-4ebf-974d-53f69c43654e
        public List<CrudeClientContract> FetchByGenderRcd(string genderRcd) {
            return DataListToContractList(CrudeClientData.FetchByGenderRcd(genderRcd));
        }
        
        // fetch by Foreign key into new List of class instances
        // links:
        //  docLink: http://sql2x.org/documentationLink/a7599485-4f00-4ebf-974d-53f69c43654e
        public List<CrudeClientContract> FetchByTitleRcd(string titleRcd) {
            return DataListToContractList(CrudeClientData.FetchByTitleRcd(titleRcd));
        }
