...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeFlightSegmentService {
        ...
        [OperationContract()]
        CrudeFlightSegmentContract FetchByFlightSegmentId(System.Guid flightSegmentId);
        
        [OperationContract()]
        List<CrudeFlightSegmentContract> FetchByFlightId(System.Guid flightId);
        
        [OperationContract()]
        List<CrudeFlightSegmentContract> FetchByDepartureAirportId(System.Guid departureAirportId);
        
        [OperationContract()]
        List<CrudeFlightSegmentContract> FetchByArrivalAirportId(System.Guid arrivalAirportId);
        
        [OperationContract()]
        List<CrudeFlightSegmentContract> FetchByUserId(System.Guid userId);
        
        [OperationContract()]
        List<CrudeFlightSegmentContract> FetchWithFilter(System.Guid flightSegmentId, System.Guid flightId, System.Guid departureAirportId, System.Guid arrivalAirportId, int logicalSegmentNumber, int physicalSegmentNumber, System.DateTime fromDateTime, System.DateTime untilDateTime, string departureGate, string arrivalGate, System.Guid userId, System.DateTime dateTime);
        
        [OperationContract()]
        List<CrudeFlightSegmentContract> FetchAll();
        
        [OperationContract()]
        List<CrudeFlightSegmentContract> FetchAllWithLimit(int limit);
        
        [OperationContract()]
        List<CrudeFlightSegmentContract> FetchAllWithLimitAndOffset(int limit, int offset);
        
        [OperationContract()]
        int FetchAllCount();
        
        [OperationContract()]
        void Insert(CrudeFlightSegmentContract contract);
        
        [OperationContract()]
        void Update(CrudeFlightSegmentContract contract);
    ...
    // this contract is an identical representation of flight_segment's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/bccca991-4801-4ad4-80f0-0357a1249606
    public partial class CrudeFlightSegmentService : ICrudeFlightSegmentService {
        ...
        public List<CrudeFlightSegmentContract> FetchByFlightId(System.Guid flightId) {
            return DataListToContractList(CrudeFlightSegmentData.FetchByFlightId(flightId));
        }
        
        // fetch by Foreign key into new List of class instances
        // links:
        //  docLink: http://sql2x.org/documentationLink/a7599485-4f00-4ebf-974d-53f69c43654e
        public List<CrudeFlightSegmentContract> FetchByDepartureAirportId(System.Guid departureAirportId) {
            return DataListToContractList(CrudeFlightSegmentData.FetchByDepartureAirportId(departureAirportId));
        }
        ...
        public static List<CrudeFlightSegmentContract> DataListToContractList(List<CrudeFlightSegmentData> dataList) {
            var contractList = new List<CrudeFlightSegmentContract>();
        ...
        public List<CrudeFlightSegmentContract> FetchAllWithLimit(int limit) {
            var list = new List<CrudeFlightSegmentContract>();
            List<CrudeFlightSegmentData> dataList = CrudeFlightSegmentData.FetchAllWithLimit(limit);
        ...
        public void Insert(CrudeFlightSegmentContract contract, SqlConnection connection, SqlTransaction transaction) {
            var data = new CrudeFlightSegmentData();
            ContractToData(contract, data);
