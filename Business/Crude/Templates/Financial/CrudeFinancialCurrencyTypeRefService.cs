...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeFinancialCurrencyTypeRefService {
        ...
        [OperationContract()]
        List<CrudeFinancialCurrencyTypeRefContract> FetchWithFilter(string financialCurrencyTypeRcd, string financialCurrencyTypeCode, string financialCurrencyTypeName, int decimalCount, System.Guid userId, System.DateTime dateTime);
    ...
    // this contract is an identical representation of financial_currency_type_ref's columns
    ...
    public partial class CrudeFinancialCurrencyTypeRefService : ICrudeFinancialCurrencyTypeRefService {
        ...
        // copy all rows from a List of serialized data objects in CrudeFinancialCurrencyTypeRefData to a List of SOAP Contracts
        // links:
        ...
        public List<CrudeFinancialCurrencyTypeRefContract> FetchWithFilter(string financialCurrencyTypeRcd, string financialCurrencyTypeCode, string financialCurrencyTypeName, int decimalCount, System.Guid userId, System.DateTime dateTime) {
            var list = new List<CrudeFinancialCurrencyTypeRefContract>();
