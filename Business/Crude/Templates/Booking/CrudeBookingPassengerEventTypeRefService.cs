...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeBookingPassengerEventTypeRefService {
        ...
        [OperationContract()]
        CrudeBookingPassengerEventTypeRefContract FetchByBookingPassengerEventTypeRcd(string bookingPassengerEventTypeRcd);
        
        [OperationContract()]
        List<CrudeBookingPassengerEventTypeRefContract> FetchByUserId(System.Guid userId);
        
        [OperationContract()]
        CrudeBookingPassengerEventTypeRefContract FetchByBookingPassengerEventTypeName(string bookingPassengerEventTypeName);
        
        [OperationContract()]
        List<CrudeBookingPassengerEventTypeRefContract> FetchWithFilter(string bookingPassengerEventTypeRcd, string bookingPassengerEventTypeName, System.Guid userId, System.DateTime dateTime);
        
        [OperationContract()]
        List<CrudeBookingPassengerEventTypeRefContract> FetchAll();
        
        [OperationContract()]
        List<CrudeBookingPassengerEventTypeRefContract> FetchAllWithLimit(int limit);
        
        [OperationContract()]
        List<CrudeBookingPassengerEventTypeRefContract> FetchAllWithLimitAndOffset(int limit, int offset);
        
        [OperationContract()]
        int FetchAllCount();
        
        [OperationContract()]
        void Insert(CrudeBookingPassengerEventTypeRefContract contract);
        
        [OperationContract()]
        void Update(CrudeBookingPassengerEventTypeRefContract contract);
    ...
    // this contract is an identical representation of booking_passenger_event_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  SOAP ( Simple Object Access Protocol ): https://en.wikipedia.org/wiki/SOAP
    //  WCF ( Windows Communication Foundation ): https://en.wikipedia.org/wiki/Windows_Communication_Foundation
    //  docLink: http://sql2x.org/documentationLink/bccca991-4801-4ad4-80f0-0357a1249606
    public partial class CrudeBookingPassengerEventTypeRefService : ICrudeBookingPassengerEventTypeRefService {
        ...
        public CrudeBookingPassengerEventTypeRefContract FetchByBookingPassengerEventTypeRcd(string bookingPassengerEventTypeRcd) {
            ...
            dataAccessLayer.FetchByBookingPassengerEventTypeRcd(bookingPassengerEventTypeRcd);
            DataToContract(dataAccessLayer, contract);

            return contract;
        }
        
        public CrudeBookingPassengerEventTypeRefContract FetchByBookingPassengerEventTypeName(string bookingPassengerEventTypeName) {
            var dataAccessLayer = new CrudeBookingPassengerEventTypeRefData();
            var contract = new CrudeBookingPassengerEventTypeRefContract();

            dataAccessLayer.FetchByBookingPassengerEventTypeName(bookingPassengerEventTypeName);
            DataToContract(dataAccessLayer, contract);
        ...
        public List<CrudeBookingPassengerEventTypeRefContract> FetchByUserId(System.Guid userId) {
            return DataListToContractList(CrudeBookingPassengerEventTypeRefData.FetchByUserId(userId));
        }
        
        // copy all rows from a List of serialized data objects to a List of SOAP Contracts
        // links:
        //  docLink: http://sql2x.org/documentationLink/7467f97d-14e5-4ccf-9282-ef8df4f63088
        public static List<CrudeBookingPassengerEventTypeRefContract> DataListToContractList(List<CrudeBookingPassengerEventTypeRefData> dataList) {
            var contractList = new List<CrudeBookingPassengerEventTypeRefContract>();
        ...
        public List<CrudeBookingPassengerEventTypeRefContract> FetchAllWithLimit(int limit) {
            var list = new List<CrudeBookingPassengerEventTypeRefContract>();
            List<CrudeBookingPassengerEventTypeRefData> dataList = CrudeBookingPassengerEventTypeRefData.FetchAllWithLimit(limit);
        ...
        public int FetchAllCount() {
            return CrudeBookingPassengerEventTypeRefData.FetchAllCount();
        }
        ...
        public List<CrudeBookingPassengerEventTypeRefContract> FetchWithFilter(string bookingPassengerEventTypeRcd, string bookingPassengerEventTypeName, System.Guid userId, System.DateTime dateTime) {
            ...
            foreach (CrudeBookingPassengerEventTypeRefData data in dataList) {
                ...
                list.Add(crudeBookingPassengerEventTypeRefContract);
            }
        ...
        public void Insert(CrudeBookingPassengerEventTypeRefContract contract) {
            var data = new CrudeBookingPassengerEventTypeRefData();
        ...
        public void Insert(CrudeBookingPassengerEventTypeRefContract contract, SqlConnection connection, SqlTransaction transaction) {
            var data = new CrudeBookingPassengerEventTypeRefData();
            ContractToData(contract, data);
        ...
        public void Delete(string bookingPassengerEventTypeRcd) {
            CrudeBookingPassengerEventTypeRefData.Delete(bookingPassengerEventTypeRcd);
        }
