...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeAddressService {
        ...
        [OperationContract()]
        CrudeAddressContract FetchByAddressId(System.Guid addressId);
        
        [OperationContract()]
        List<CrudeAddressContract> FetchByUserId(System.Guid userId);
        
        [OperationContract()]
        List<CrudeAddressContract> FetchByAddressTypeRcd(string addressTypeRcd);
        
        [OperationContract()]
        List<CrudeAddressContract> FetchWithFilter(System.Guid addressId, string addressTypeRcd, string addressOne, string addressTwo, string addressThree, string city, string street, string state, string district, string province, string zipCode, string poBox, string comment, System.Guid userId, System.DateTime dateTime);
        
        [OperationContract()]
        List<CrudeAddressContract> FetchAll();
        
        [OperationContract()]
        List<CrudeAddressContract> FetchAllWithLimit(int limit);
        
        [OperationContract()]
        List<CrudeAddressContract> FetchAllWithLimitAndOffset(int limit, int offset);
        
        [OperationContract()]
        int FetchAllCount();
        
        [OperationContract()]
        void Insert(CrudeAddressContract contract);
        
        [OperationContract()]
        void Update(CrudeAddressContract contract);
    ...
    // this contract is an identical representation of address's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  SOAP ( Simple Object Access Protocol ): https://en.wikipedia.org/wiki/SOAP
    //  WCF ( Windows Communication Foundation ): https://en.wikipedia.org/wiki/Windows_Communication_Foundation
    //  docLink: http://sql2x.org/documentationLink/bccca991-4801-4ad4-80f0-0357a1249606
    public partial class CrudeAddressService : ICrudeAddressService {
        ...
        public List<CrudeAddressContract> FetchByUserId(System.Guid userId) {
            return DataListToContractList(CrudeAddressData.FetchByUserId(userId));
        }
        
        // fetch by Foreign key into new List of class instances
        // links:
        //  docLink: http://sql2x.org/documentationLink/a7599485-4f00-4ebf-974d-53f69c43654e
        public List<CrudeAddressContract> FetchByAddressTypeRcd(string addressTypeRcd) {
            return DataListToContractList(CrudeAddressData.FetchByAddressTypeRcd(addressTypeRcd));
        }
        ...
        public static void ContractListToDataList(List<CrudeAddressContract> contractList, List<CrudeAddressData> dataList) {
            foreach (CrudeAddressContract contract in contractList) {
                var data = new CrudeAddressData();
                CrudeAddressService.ContractToData(contract, data);
                dataList.Add(data);
            }
        }
        ...
        public List<CrudeAddressContract> FetchAllWithLimit(int limit) {
            var list = new List<CrudeAddressContract>();
            List<CrudeAddressData> dataList = CrudeAddressData.FetchAllWithLimit(limit);
        ...
        public void Insert(CrudeAddressContract contract, SqlConnection connection, SqlTransaction transaction) {
            var data = new CrudeAddressData();
            ContractToData(contract, data);
