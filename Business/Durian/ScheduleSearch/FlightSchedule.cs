/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:47:24 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this contract is an identical representation of FlightSchedule's columns
    ...
    public class FlightSchedule {
        ...
        public List<FlightScheduleContract> FlightScheduleFromDal(List<FlightScheduleData> dataList) {
           var list = new List<FlightScheduleContract>();

           foreach (FlightScheduleData data in dataList) {
               var contract = new FlightScheduleContract();
