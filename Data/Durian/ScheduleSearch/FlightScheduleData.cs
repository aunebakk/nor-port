/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:47:23 PM
...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of a ansi sql select statement in FlightScheduleData's columns
    ...
    public partial class FlightScheduleData {
        ...
        public void Populate(IDataReader reader, FlightScheduleDataOrdinals ordinals) {
    ...
    //  this class start with an identical representation of the method in FlightScheduleData's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )  with a number indicating the columns position in the original ansi sql select statement
    // links:
    //  docLink: http://sql2x.org/documentationLink/0d935f44-0309-4dca-a8f2-a4e8eafd2201
    public partial class FlightScheduleDataOrdinals {
        ...
        // parameters:
        //  reader: IDataReader from SQLClient
        public FlightScheduleDataOrdinals(IDataReader reader) {
