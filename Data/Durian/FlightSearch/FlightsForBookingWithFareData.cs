/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:45:03 AM
...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of a ansi sql select statement in FlightsForBookingWithFareData's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/d360d55c-efab-4b5b-99be-9425d91ebd59
    [Serializable()]
    public partial class FlightsForBookingWithFareData {
        ...
        public bool BookingOpenFlag { get; set; }
        ...
        public void Populate(IDataReader reader, FlightsForBookingWithFareDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.BookingOpenFlag)) BookingOpenFlag = reader.GetBoolean(ordinals.BookingOpenFlag);
    ...
    //  this class start with an identical representation of the method in FlightsForBookingWithFareData's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )  with a number indicating the columns position in the original ansi sql select statement
    // links:
    //  docLink: http://sql2x.org/documentationLink/0d935f44-0309-4dca-a8f2-a4e8eafd2201
    public partial class FlightsForBookingWithFareDataOrdinals {
        ...
        // parameters:
        //  reader: IDataReader from SQLClient
        public FlightsForBookingWithFareDataOrdinals(IDataReader reader) {
            ...
            BookingOpenFlag = reader.GetOrdinal("booking_open_flag");
