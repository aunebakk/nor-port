/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 11:03:38 AM
...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of a ansi sql select statement in FlightsWithCheckinInformationData's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/d360d55c-efab-4b5b-99be-9425d91ebd59
    [Serializable()]
    public partial class FlightsWithCheckinInformationData {
        ...
        public void Populate(IDataReader reader, FlightsWithCheckinInformationDataOrdinals ordinals) {
    ...
    // this class start with an identical representation of the method in FlightsWithCheckinInformationData's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )  with a number indicating the columns position in the original ansi sql select statement
    // links:
    //  docLink: http://sql2x.org/documentationLink/0d935f44-0309-4dca-a8f2-a4e8eafd2201
    public partial class FlightsWithCheckinInformationDataOrdinals {
        ...
        // parameters:
        //  reader: IDataReader from SQLClient
        public FlightsWithCheckinInformationDataOrdinals(IDataReader reader) {
