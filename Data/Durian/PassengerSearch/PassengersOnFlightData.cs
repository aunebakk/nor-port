/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:47:03 PM
...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of a ansi sql select statement in PassengersOnFlightData's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/d360d55c-efab-4b5b-99be-9425d91ebd59
    [Serializable()]
    public partial class PassengersOnFlightData {
        ...
        public void Populate(IDataReader reader, PassengersOnFlightDataOrdinals ordinals) {
            ...
            if (!reader.IsDBNull(ordinals.CheckedinFlag)) CheckedinFlag = reader.GetBoolean(ordinals.CheckedinFlag);
    ...
    //  this class start with an identical representation of the method in PassengersOnFlightData's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )  with a number indicating the columns position in the original ansi sql select statement
    // links:
    //  docLink: http://sql2x.org/documentationLink/0d935f44-0309-4dca-a8f2-a4e8eafd2201
    public partial class PassengersOnFlightDataOrdinals {
        ...
        // parameters:
        //  reader: IDataReader from SQLClient
        public PassengersOnFlightDataOrdinals(IDataReader reader) {
            ...
            CheckedinFlag = reader.GetOrdinal("checkedin_flag");
