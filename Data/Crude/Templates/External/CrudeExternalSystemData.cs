...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of external_system's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeExternalSystemData {
        ...
        public void FetchByExternalSystemId(System.Guid externalSystemId) {
            // create query against external_system
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 external_system_id, external_system_code, external_system_name, user_id, date_time
                            from [external_system]
                            where external_system_id = @external_system_id
                            order by external_system_name";
        ...
        // parameters:
        //  externalSystemId: primary key of table external_system
        public static CrudeExternalSystemData GetByExternalSystemId(System.Guid externalSystemId) {
            // create query against external_system
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeExternalSystemData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against external_system
        ...
        public static List<CrudeExternalSystemData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeExternalSystemData>();
            ...
            string sql = @" select external_system_id, external_system_code, external_system_name, user_id, date_time
                            from [external_system]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of external_system
        ...
        public void FetchByExternalSystemCode(string externalSystemCode) {
            // create query against external_system
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 external_system_id, external_system_code, external_system_name, user_id, date_time
                            from [external_system]
                            where external_system_code like '%' + @externalSystemCode + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@externalSystemCode",SqlDbType.NVarChar).Value = externalSystemCode;
        ...
        public static List<CrudeExternalSystemData> FetchAll() {
            var dataList = new List<CrudeExternalSystemData>();
        ...
        public static List<CrudeExternalSystemData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeExternalSystemData>();
            ...
            string sql = @" select top " + limit.ToString() + @" external_system_id, external_system_code, external_system_name, user_id, date_time
                            from [external_system]
                            order by external_system_name";
        ...
        public static List<CrudeExternalSystemData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeExternalSystemData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [external_system]";
        ...
        public static List<CrudeExternalSystemData> FetchWithFilter(System.Guid externalSystemId, string externalSystemCode, string externalSystemName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeExternalSystemData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(externalSystemCode)) {
                        sql += "  and external_system_code like '%' + @external_system_code + '%'";
                        command.Parameters.Add("@external_system_code", SqlDbType.NVarChar).Value = externalSystemCode.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(externalSystemName)) {
                        sql += "  and external_system_name like '%' + @external_system_name + '%'";
                        command.Parameters.Add("@external_system_name", SqlDbType.NVarChar).Value = externalSystemName.Replace("'","''");
                    }
                    ...
                    sql += " order by external_system_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["external_system_code"] != System.DBNull.Value) ExternalSystemCode = (System.String) reader["external_system_code"];
            if (reader["external_system_name"] != System.DBNull.Value) ExternalSystemName = (System.String) reader["external_system_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [external_system] (external_system_id, external_system_code, external_system_name, user_id, date_time)";
            sql += "            values (@external_system_id, @external_system_code, @external_system_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@external_system_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ExternalSystemId;
                    command.Parameters.Add("@external_system_code",SqlDbType.NVarChar).Value = (System.String)ExternalSystemCode;
                    command.Parameters.Add("@external_system_name",SqlDbType.NVarChar).Value = (System.String)ExternalSystemName;
        ...
        public void Update() {
            ...
            string sql = @" update [external_system] set
        ...
        public static void Delete(System.Guid externalSystemId) {
            // create query against external_system
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [external_system] 
                where external_system_id = @external_system_id";
