...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of flight_segment_event's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFlightSegmentEventData {
        ...
        public void FetchByFlightSegmentEventId(System.Guid flightSegmentEventId) {
            // create query against flight_segment_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_segment_event_id, flight_segment_id, flight_segment_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time
                            from [flight_segment_event]
                            where flight_segment_event_id = @flight_segment_event_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@flight_segment_event_id",SqlDbType.UniqueIdentifier).Value = flightSegmentEventId;
        ...
        // parameters:
        //  flightSegmentEventId: primary key of table flight_segment_event
        public static CrudeFlightSegmentEventData GetByFlightSegmentEventId(System.Guid flightSegmentEventId) {
            // create query against flight_segment_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightSegmentEventData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_segment_event
        ...
        public static List<CrudeFlightSegmentEventData> FetchByFlightSegmentId(System.Guid flightSegmentId) {
            var dataList = new List<CrudeFlightSegmentEventData>();
            ...
            string sql = @" select flight_segment_event_id, flight_segment_id, flight_segment_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time
                            from [flight_segment_event]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of flight_segment_event
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightSegmentEventData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightSegmentEventData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightSegmentEventData> FetchByDateTimeTypeRcd(string dateTimeTypeRcd) {
            var dataList = new List<CrudeFlightSegmentEventData>();
            ...
            string sql = @" select flight_segment_event_id, flight_segment_id, flight_segment_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time
                            from [flight_segment_event]
                            where date_time_type_rcd = @date_time_type_rcd
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@date_time_type_rcd", SqlDbType.NVarChar).Value = dateTimeTypeRcd.Replace("'","''");
        ...
        public static List<CrudeFlightSegmentEventData> FetchAll() {
            var dataList = new List<CrudeFlightSegmentEventData>();
        ...
        public static List<CrudeFlightSegmentEventData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightSegmentEventData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_segment_event_id, flight_segment_id, flight_segment_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time
                            from [flight_segment_event]";
        ...
        public static List<CrudeFlightSegmentEventData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightSegmentEventData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_segment_event]";
        ...
        public static List<CrudeFlightSegmentEventData> FetchWithFilter(System.Guid flightSegmentEventId, System.Guid flightSegmentId, int flightSegmentEventNumber, string dateTimeTypeRcd, System.DateTime newDateTime, string remarks, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightSegmentEventData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (flightSegmentEventId != Guid.Empty) {
                        sql += "  and flight_segment_event_id = @flight_segment_event_id";
                        command.Parameters.Add("@flight_segment_event_id", SqlDbType.UniqueIdentifier).Value = flightSegmentEventId;
                    }
                    ...
                    if (flightSegmentEventNumber != 0) {
                        sql += "  and flight_segment_event_number = @flight_segment_event_number";
                        command.Parameters.Add("@flight_segment_event_number", SqlDbType.Int).Value = flightSegmentEventNumber;
                    }
                    if (!string.IsNullOrEmpty(dateTimeTypeRcd)) {
                        sql += "  and date_time_type_rcd like '%' + @date_time_type_rcd + '%'";
                        command.Parameters.Add("@date_time_type_rcd", SqlDbType.NVarChar).Value = dateTimeTypeRcd.Replace("'","''");
                    }
                    if (newDateTime != DateTime.MinValue) {
                        sql += "  and new_date_time = @new_date_time";
                        command.Parameters.Add("@new_date_time", SqlDbType.DateTime).Value = newDateTime;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["flight_segment_event_id"] != System.DBNull.Value) FlightSegmentEventId = (System.Guid) reader["flight_segment_event_id"];
            if (reader["flight_segment_id"] != System.DBNull.Value) FlightSegmentId = (System.Guid) reader["flight_segment_id"];
            if (reader["flight_segment_event_number"] != System.DBNull.Value) FlightSegmentEventNumber = (System.Int32) reader["flight_segment_event_number"];
            if (reader["date_time_type_rcd"] != System.DBNull.Value) DateTimeTypeRcd = (System.String) reader["date_time_type_rcd"];
            if (reader["new_date_time"] != System.DBNull.Value) NewDateTime = (System.DateTime) reader["new_date_time"];
        ...
        public void Insert() {
            ...
            if (FlightSegmentEventId == Guid.Empty)
                FlightSegmentEventId = Guid.NewGuid();
            ...
            string sql = "insert into [flight_segment_event] (flight_segment_event_id, flight_segment_id, flight_segment_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time)";
            sql += "            values (@flight_segment_event_id, @flight_segment_id, @flight_segment_event_number, @date_time_type_rcd, @new_date_time, @remarks, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_segment_event_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightSegmentEventId;
                    command.Parameters.Add("@flight_segment_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightSegmentId;
                    command.Parameters.Add("@flight_segment_event_number",SqlDbType.Int).Value = (System.Int32)FlightSegmentEventNumber;
                    command.Parameters.Add("@date_time_type_rcd",SqlDbType.NVarChar).Value = (System.String)DateTimeTypeRcd;
                    command.Parameters.Add("@new_date_time",SqlDbType.DateTime).Value = (System.DateTime)NewDateTime;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_segment_event] set
                 flight_segment_event_id = @flight_segment_event_id
                ,flight_segment_id = @flight_segment_id
                ,flight_segment_event_number = @flight_segment_event_number
                ,date_time_type_rcd = @date_time_type_rcd
        ...
        public static void Delete(System.Guid flightSegmentEventId) {
            // create query against flight_segment_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_segment_event] 
                where flight_segment_event_id = @flight_segment_event_id";
