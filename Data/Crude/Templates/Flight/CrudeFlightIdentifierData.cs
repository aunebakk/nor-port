...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of flight_identifier's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeFlightIdentifierData {
        
        public System.Guid FlightIdentifierId { get; set; }
        ...
        public void FetchByFlightIdentifierId(System.Guid flightIdentifierId) {
            // create query against flight_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_identifier_id, flight_id, flight_identifier_code, flight_identifier_type_rcd, user_id, date_time
                            from [flight_identifier]
                            where flight_identifier_id = @flight_identifier_id
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@flight_identifier_id",SqlDbType.UniqueIdentifier).Value = flightIdentifierId;
        ...
        // parameters:
        //  flightIdentifierId: primary key of table flight_identifier
        public static CrudeFlightIdentifierData GetByFlightIdentifierId(System.Guid flightIdentifierId) {
            // create query against flight_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightIdentifierData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_identifier
        ...
        public static List<CrudeFlightIdentifierData> FetchByFlightId(System.Guid flightId) {
            var dataList = new List<CrudeFlightIdentifierData>();
            ...
            string sql = @" select flight_identifier_id, flight_id, flight_identifier_code, flight_identifier_type_rcd, user_id, date_time
                            from [flight_identifier]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of flight_identifier
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightIdentifierData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightIdentifierData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightIdentifierData> FetchByFlightIdentifierTypeRcd(string flightIdentifierTypeRcd) {
            var dataList = new List<CrudeFlightIdentifierData>();
            ...
            string sql = @" select flight_identifier_id, flight_id, flight_identifier_code, flight_identifier_type_rcd, user_id, date_time
                            from [flight_identifier]
                            where flight_identifier_type_rcd = @flight_identifier_type_rcd
        ...
        public static List<CrudeFlightIdentifierData> FetchAll() {
            var dataList = new List<CrudeFlightIdentifierData>();
        ...
        public static List<CrudeFlightIdentifierData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightIdentifierData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_identifier_id, flight_id, flight_identifier_code, flight_identifier_type_rcd, user_id, date_time
                            from [flight_identifier]
                            order by flight_identifier_code";
        ...
        public static List<CrudeFlightIdentifierData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightIdentifierData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_identifier]";
        ...
        public static List<CrudeFlightIdentifierData> FetchWithFilter(System.Guid flightIdentifierId, System.Guid flightId, string flightIdentifierCode, string flightIdentifierTypeRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightIdentifierData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (flightIdentifierId != Guid.Empty) {
                        sql += "  and flight_identifier_id = @flight_identifier_id";
                        command.Parameters.Add("@flight_identifier_id", SqlDbType.UniqueIdentifier).Value = flightIdentifierId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["flight_identifier_id"] != System.DBNull.Value) FlightIdentifierId = (System.Guid) reader["flight_identifier_id"];
            if (reader["flight_id"] != System.DBNull.Value) FlightId = (System.Guid) reader["flight_id"];
            if (reader["flight_identifier_code"] != System.DBNull.Value) FlightIdentifierCode = (System.String) reader["flight_identifier_code"];
            if (reader["flight_identifier_type_rcd"] != System.DBNull.Value) FlightIdentifierTypeRcd = (System.String) reader["flight_identifier_type_rcd"];
        ...
        public void Insert() {
            ...
            if (FlightIdentifierId == Guid.Empty)
                FlightIdentifierId = Guid.NewGuid();
            ...
            string sql = "insert into [flight_identifier] (flight_identifier_id, flight_id, flight_identifier_code, flight_identifier_type_rcd, user_id, date_time)";
            sql += "            values (@flight_identifier_id, @flight_id, @flight_identifier_code, @flight_identifier_type_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_identifier_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightIdentifierId;
                    command.Parameters.Add("@flight_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightId;
                    command.Parameters.Add("@flight_identifier_code",SqlDbType.NVarChar).Value = (System.String)FlightIdentifierCode;
                    command.Parameters.Add("@flight_identifier_type_rcd",SqlDbType.NVarChar).Value = (System.String)FlightIdentifierTypeRcd;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_identifier] set
                 flight_identifier_id = @flight_identifier_id
                ,flight_id = @flight_id
                ,flight_identifier_code = @flight_identifier_code
                ,flight_identifier_type_rcd = @flight_identifier_type_rcd
                ,user_id = @user_id
                ,date_time = @date_time
            where flight_identifier_id = @flight_identifier_id";
        ...
        public static void Delete(System.Guid flightIdentifierId) {
            // create query against flight_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_identifier] 
                where flight_identifier_id = @flight_identifier_id";
