...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of flight_schedule_segment's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFlightScheduleSegmentData {
        ...
        public void FetchByFlightScheduleSegmentId(System.Guid flightScheduleSegmentId) {
            // create query against flight_schedule_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_schedule_segment_id, flight_schedule_id, departure_airport_id, arrival_airport_id, physical_segment_number, logical_segment_number, departure_time, arrival_time, departure_gate, arrival_gate, user_id, date_time
                            from [flight_schedule_segment]
                            where flight_schedule_segment_id = @flight_schedule_segment_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@flight_schedule_segment_id",SqlDbType.UniqueIdentifier).Value = flightScheduleSegmentId;
        ...
        // parameters:
        //  flightScheduleSegmentId: primary key of table flight_schedule_segment
        public static CrudeFlightScheduleSegmentData GetByFlightScheduleSegmentId(System.Guid flightScheduleSegmentId) {
            // create query against flight_schedule_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightScheduleSegmentData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_schedule_segment
        ...
        public static List<CrudeFlightScheduleSegmentData> FetchByFlightScheduleId(System.Guid flightScheduleId) {
            var dataList = new List<CrudeFlightScheduleSegmentData>();
            ...
            string sql = @" select flight_schedule_segment_id, flight_schedule_id, departure_airport_id, arrival_airport_id, physical_segment_number, logical_segment_number, departure_time, arrival_time, departure_gate, arrival_gate, user_id, date_time
                            from [flight_schedule_segment]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of flight_schedule_segment
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleSegmentData> FetchByDepartureAirportId(System.Guid departureAirportId) {
            var dataList = new List<CrudeFlightScheduleSegmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleSegmentData> FetchByArrivalAirportId(System.Guid arrivalAirportId) {
            var dataList = new List<CrudeFlightScheduleSegmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleSegmentData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightScheduleSegmentData>();
        ...
        public static List<CrudeFlightScheduleSegmentData> FetchAll() {
            var dataList = new List<CrudeFlightScheduleSegmentData>();
        ...
        public static List<CrudeFlightScheduleSegmentData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightScheduleSegmentData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_schedule_segment_id, flight_schedule_id, departure_airport_id, arrival_airport_id, physical_segment_number, logical_segment_number, departure_time, arrival_time, departure_gate, arrival_gate, user_id, date_time
                            from [flight_schedule_segment]";
        ...
        public static List<CrudeFlightScheduleSegmentData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightScheduleSegmentData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_schedule_segment]";
        ...
        public static List<CrudeFlightScheduleSegmentData> FetchWithFilter(System.Guid flightScheduleSegmentId, System.Guid flightScheduleId, System.Guid departureAirportId, System.Guid arrivalAirportId, int physicalSegmentNumber, int logicalSegmentNumber, System.TimeSpan departureTime, System.TimeSpan arrivalTime, string departureGate, string arrivalGate, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightScheduleSegmentData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (flightScheduleSegmentId != Guid.Empty) {
                        sql += "  and flight_schedule_segment_id = @flight_schedule_segment_id";
                        command.Parameters.Add("@flight_schedule_segment_id", SqlDbType.UniqueIdentifier).Value = flightScheduleSegmentId;
                    }
                    ...
                    if (physicalSegmentNumber != 0) {
                        sql += "  and physical_segment_number = @physical_segment_number";
                        command.Parameters.Add("@physical_segment_number", SqlDbType.Int).Value = physicalSegmentNumber;
                    }
                    if (logicalSegmentNumber != 0) {
                        sql += "  and logical_segment_number = @logical_segment_number";
                        command.Parameters.Add("@logical_segment_number", SqlDbType.Int).Value = logicalSegmentNumber;
                    }
                    if (departureTime != TimeSpan.MinValue) {
                        sql += "  and departure_time = @departure_time";
                        command.Parameters.Add("@departure_time", SqlDbType.Time).Value = departureTime;
                    }
                    if (arrivalTime != TimeSpan.MinValue) {
                        sql += "  and arrival_time = @arrival_time";
                        command.Parameters.Add("@arrival_time", SqlDbType.Time).Value = arrivalTime;
                    }
                    if (!string.IsNullOrEmpty(departureGate)) {
                        sql += "  and departure_gate like '%' + @departure_gate + '%'";
                        command.Parameters.Add("@departure_gate", SqlDbType.NVarChar).Value = departureGate.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(arrivalGate)) {
                        sql += "  and arrival_gate like '%' + @arrival_gate + '%'";
                        command.Parameters.Add("@arrival_gate", SqlDbType.NVarChar).Value = arrivalGate.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["flight_schedule_segment_id"] != System.DBNull.Value) FlightScheduleSegmentId = (System.Guid) reader["flight_schedule_segment_id"];
            if (reader["flight_schedule_id"] != System.DBNull.Value) FlightScheduleId = (System.Guid) reader["flight_schedule_id"];
            if (reader["departure_airport_id"] != System.DBNull.Value) DepartureAirportId = (System.Guid) reader["departure_airport_id"];
            if (reader["arrival_airport_id"] != System.DBNull.Value) ArrivalAirportId = (System.Guid) reader["arrival_airport_id"];
            if (reader["physical_segment_number"] != System.DBNull.Value) PhysicalSegmentNumber = (System.Int32) reader["physical_segment_number"];
            if (reader["logical_segment_number"] != System.DBNull.Value) LogicalSegmentNumber = (System.Int32) reader["logical_segment_number"];
            if (reader["departure_time"] != System.DBNull.Value) DepartureTime = (System.TimeSpan) reader["departure_time"];
            if (reader["arrival_time"] != System.DBNull.Value) ArrivalTime = (System.TimeSpan) reader["arrival_time"];
            if (reader["departure_gate"] != System.DBNull.Value) DepartureGate = (System.String) reader["departure_gate"];
            if (reader["arrival_gate"] != System.DBNull.Value) ArrivalGate = (System.String) reader["arrival_gate"];
        ...
        public void Insert() {
            ...
            if (FlightScheduleSegmentId == Guid.Empty)
                FlightScheduleSegmentId = Guid.NewGuid();
            ...
            string sql = "insert into [flight_schedule_segment] (flight_schedule_segment_id, flight_schedule_id, departure_airport_id, arrival_airport_id, physical_segment_number, logical_segment_number, departure_time, arrival_time, departure_gate, arrival_gate, user_id, date_time)";
            sql += "            values (@flight_schedule_segment_id, @flight_schedule_id, @departure_airport_id, @arrival_airport_id, @physical_segment_number, @logical_segment_number, @departure_time, @arrival_time, @departure_gate, @arrival_gate, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_schedule_segment_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightScheduleSegmentId;
                    command.Parameters.Add("@flight_schedule_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightScheduleId;
                    command.Parameters.Add("@departure_airport_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)DepartureAirportId;
                    command.Parameters.Add("@arrival_airport_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ArrivalAirportId;
                    command.Parameters.Add("@physical_segment_number",SqlDbType.Int).Value = (PhysicalSegmentNumber == 0 ? (object)DBNull.Value : (System.Int32)PhysicalSegmentNumber);
                    command.Parameters.Add("@logical_segment_number",SqlDbType.Int).Value = (System.Int32)LogicalSegmentNumber;
                    command.Parameters.Add("@departure_time",SqlDbType.Time).Value = (System.TimeSpan)DepartureTime;
                    command.Parameters.Add("@arrival_time",SqlDbType.Time).Value = (System.TimeSpan)ArrivalTime;
                    command.Parameters.Add("@departure_gate",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(DepartureGate)) ? (object)DBNull.Value : (System.String)DepartureGate;
                    command.Parameters.Add("@arrival_gate",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(ArrivalGate)) ? (object)DBNull.Value : (System.String)ArrivalGate;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_schedule_segment] set
                 flight_schedule_segment_id = @flight_schedule_segment_id
                ,flight_schedule_id = @flight_schedule_id
                ,departure_airport_id = @departure_airport_id
                ,arrival_airport_id = @arrival_airport_id
                ,physical_segment_number = @physical_segment_number
                ,logical_segment_number = @logical_segment_number
        ...
        public static void Delete(System.Guid flightScheduleSegmentId) {
            // create query against flight_schedule_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_schedule_segment] 
                where flight_schedule_segment_id = @flight_schedule_segment_id";
