...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of flight_schedule_segment_rule_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFlightScheduleSegmentRuleRefData {
        
        public string FlightScheduleSegmentRuleRcd { get; set; }
        
        public string FlightScheduleSegmentRuleName { get; set; }
        ...
        public void FetchByFlightScheduleSegmentRuleRcd(string flightScheduleSegmentRuleRcd) {
            // create query against flight_schedule_segment_rule_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_schedule_segment_rule_rcd, flight_schedule_segment_rule_name, user_id, date_time
                            from [flight_schedule_segment_rule_ref]
                            where flight_schedule_segment_rule_rcd = @flight_schedule_segment_rule_rcd
                            order by flight_schedule_segment_rule_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@flight_schedule_segment_rule_rcd",SqlDbType.NVarChar).Value = flightScheduleSegmentRuleRcd;
        ...
        // parameters:
        //  flightScheduleSegmentRuleRcd: primary key of table flight_schedule_segment_rule_ref
        public static CrudeFlightScheduleSegmentRuleRefData GetByFlightScheduleSegmentRuleRcd(string flightScheduleSegmentRuleRcd) {
            // create query against flight_schedule_segment_rule_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightScheduleSegmentRuleRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_schedule_segment_rule_ref
        ...
        public static List<CrudeFlightScheduleSegmentRuleRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleRefData>();
            ...
            string sql = @" select flight_schedule_segment_rule_rcd, flight_schedule_segment_rule_name, user_id, date_time
                            from [flight_schedule_segment_rule_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of flight_schedule_segment_rule_ref
        ...
        public void FetchByFlightScheduleSegmentRuleName(string flightScheduleSegmentRuleName) {
            // create query against flight_schedule_segment_rule_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 flight_schedule_segment_rule_rcd, flight_schedule_segment_rule_name, user_id, date_time
                            from [flight_schedule_segment_rule_ref]
                            where flight_schedule_segment_rule_name like '%' + @flightScheduleSegmentRuleName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@flightScheduleSegmentRuleName",SqlDbType.NVarChar).Value = flightScheduleSegmentRuleName;
        ...
        public static List<CrudeFlightScheduleSegmentRuleRefData> FetchAll() {
            var dataList = new List<CrudeFlightScheduleSegmentRuleRefData>();
        ...
        public static List<CrudeFlightScheduleSegmentRuleRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_schedule_segment_rule_rcd, flight_schedule_segment_rule_name, user_id, date_time
                            from [flight_schedule_segment_rule_ref]
                            order by flight_schedule_segment_rule_name";
        ...
        public static List<CrudeFlightScheduleSegmentRuleRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_schedule_segment_rule_ref]";
        ...
        public static List<CrudeFlightScheduleSegmentRuleRefData> FetchWithFilter(string flightScheduleSegmentRuleRcd, string flightScheduleSegmentRuleName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(flightScheduleSegmentRuleName)) {
                        sql += "  and flight_schedule_segment_rule_name like '%' + @flight_schedule_segment_rule_name + '%'";
                        command.Parameters.Add("@flight_schedule_segment_rule_name", SqlDbType.NVarChar).Value = flightScheduleSegmentRuleName.Replace("'","''");
                    }
                    ...
                    sql += " order by flight_schedule_segment_rule_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["flight_schedule_segment_rule_name"] != System.DBNull.Value) FlightScheduleSegmentRuleName = (System.String) reader["flight_schedule_segment_rule_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [flight_schedule_segment_rule_ref] (flight_schedule_segment_rule_rcd, flight_schedule_segment_rule_name, user_id, date_time)";
            sql += "            values (@flight_schedule_segment_rule_rcd, @flight_schedule_segment_rule_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_schedule_segment_rule_name",SqlDbType.NVarChar).Value = (System.String)FlightScheduleSegmentRuleName;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_schedule_segment_rule_ref] set
                 flight_schedule_segment_rule_rcd = @flight_schedule_segment_rule_rcd
                ,flight_schedule_segment_rule_name = @flight_schedule_segment_rule_name
                ,user_id = @user_id
                ,date_time = @date_time
            where flight_schedule_segment_rule_rcd = @flight_schedule_segment_rule_rcd";
        ...
        public static void Delete(string flightScheduleSegmentRuleRcd) {
            // create query against flight_schedule_segment_rule_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_schedule_segment_rule_ref] 
                where flight_schedule_segment_rule_rcd = @flight_schedule_segment_rule_rcd";
