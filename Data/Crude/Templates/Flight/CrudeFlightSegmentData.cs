...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of flight_segment's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFlightSegmentData {
        ...
        public void FetchByFlightSegmentId(System.Guid flightSegmentId) {
            // create query against flight_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_segment_id, flight_id, departure_airport_id, arrival_airport_id, logical_segment_number, physical_segment_number, from_date_time, until_date_time, departure_gate, arrival_gate, user_id, date_time
                            from [flight_segment]
                            where flight_segment_id = @flight_segment_id";
        ...
        // parameters:
        //  flightSegmentId: primary key of table flight_segment
        public static CrudeFlightSegmentData GetByFlightSegmentId(System.Guid flightSegmentId) {
            // create query against flight_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightSegmentData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_segment
        ...
        public static List<CrudeFlightSegmentData> FetchByFlightId(System.Guid flightId) {
            ...
            string sql = @" select flight_segment_id, flight_id, departure_airport_id, arrival_airport_id, logical_segment_number, physical_segment_number, from_date_time, until_date_time, departure_gate, arrival_gate, user_id, date_time
                            from [flight_segment]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of flight_segment
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightSegmentData> FetchByDepartureAirportId(System.Guid departureAirportId) {
            var dataList = new List<CrudeFlightSegmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightSegmentData> FetchByArrivalAirportId(System.Guid arrivalAirportId) {
            var dataList = new List<CrudeFlightSegmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightSegmentData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightSegmentData>();
        ...
        public static List<CrudeFlightSegmentData> FetchAll() {
            var dataList = new List<CrudeFlightSegmentData>();
        ...
        public static List<CrudeFlightSegmentData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightSegmentData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_segment_id, flight_id, departure_airport_id, arrival_airport_id, logical_segment_number, physical_segment_number, from_date_time, until_date_time, departure_gate, arrival_gate, user_id, date_time
                            from [flight_segment]";
        ...
        public static List<CrudeFlightSegmentData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightSegmentData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_segment]";
        ...
        public static List<CrudeFlightSegmentData> FetchWithFilter(System.Guid flightSegmentId, System.Guid flightId, System.Guid departureAirportId, System.Guid arrivalAirportId, int logicalSegmentNumber, int physicalSegmentNumber, System.DateTime fromDateTime, System.DateTime untilDateTime, string departureGate, string arrivalGate, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightSegmentData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (flightSegmentId != Guid.Empty) {
                        sql += "  and flight_segment_id = @flight_segment_id";
                        command.Parameters.Add("@flight_segment_id", SqlDbType.UniqueIdentifier).Value = flightSegmentId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["flight_segment_id"] != System.DBNull.Value) FlightSegmentId = (System.Guid) reader["flight_segment_id"];
            if (reader["flight_id"] != System.DBNull.Value) FlightId = (System.Guid) reader["flight_id"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [flight_segment] (flight_segment_id, flight_id, departure_airport_id, arrival_airport_id, logical_segment_number, physical_segment_number, from_date_time, until_date_time, departure_gate, arrival_gate, user_id, date_time)";
            sql += "            values (@flight_segment_id, @flight_id, @departure_airport_id, @arrival_airport_id, @logical_segment_number, @physical_segment_number, @from_date_time, @until_date_time, @departure_gate, @arrival_gate, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_segment_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightSegmentId;
                    command.Parameters.Add("@flight_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightId;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_segment] set
                 flight_segment_id = @flight_segment_id
                ,flight_id = @flight_id
        ...
        public static void Delete(System.Guid flightSegmentId) {
            // create query against flight_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_segment] 
                where flight_segment_id = @flight_segment_id";
