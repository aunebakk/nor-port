...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of flight_schedule_identifier's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFlightScheduleIdentifierData {
        ...
        public void FetchByFlightScheduleIdentifierId(System.Guid flightScheduleIdentifierId) {
        ...
        public static List<CrudeFlightScheduleIdentifierData> FetchByFlightScheduleId(System.Guid flightScheduleId) {
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleIdentifierData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightScheduleIdentifierData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleIdentifierData> FetchByFlightIdentifierTypeRcd(string flightIdentifierTypeRcd) {
            var dataList = new List<CrudeFlightScheduleIdentifierData>();
        ...
        public static List<CrudeFlightScheduleIdentifierData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightScheduleIdentifierData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_schedule_identifier]";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Populate(IDataReader reader) {
            if (reader["flight_schedule_identifier_id"] != System.DBNull.Value) FlightScheduleIdentifierId = (System.Guid) reader["flight_schedule_identifier_id"];
        ...
        public void Insert() {
            ...
            if (FlightScheduleIdentifierId == Guid.Empty)
                FlightScheduleIdentifierId = Guid.NewGuid();
            ...
            string sql = "insert into [flight_schedule_identifier] (flight_schedule_identifier_id, flight_schedule_id, flight_identifier_type_rcd, flight_identifier_code, user_id, date_time)";
            sql += "            values (@flight_schedule_identifier_id, @flight_schedule_id, @flight_identifier_type_rcd, @flight_identifier_code, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_schedule_identifier_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightScheduleIdentifierId;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_schedule_identifier] set
                 flight_schedule_identifier_id = @flight_schedule_identifier_id
        ...
        public static void Delete(System.Guid flightScheduleIdentifierId) {
            // create query against flight_schedule_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_schedule_identifier] 
                where flight_schedule_identifier_id = @flight_schedule_identifier_id";
