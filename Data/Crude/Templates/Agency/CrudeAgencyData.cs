...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    public partial class CrudeAgencyData {
        ...
        public void FetchByAgencyId(System.Guid agencyId) {
            // create query against agency
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 agency_id, agency_code, agency_name, user_id, date_time
                            from [agency]
        ...
        // parameters:
        //  agencyId: primary key of table agency
        public static CrudeAgencyData GetByAgencyId(System.Guid agencyId) {
            // create query against agency
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeAgencyData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAgencyData>();
            ...
            string sql = @" select agency_id, agency_code, agency_name, user_id, date_time
                            from [agency]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of agency
        ...
        public void FetchByAgencyCode(string agencyCode) {
            // create query against agency
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 agency_id, agency_code, agency_name, user_id, date_time
                            from [agency]
                            where agency_code like '%' + @agencyCode + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@agencyCode",SqlDbType.NVarChar).Value = agencyCode;
        ...
        public static List<CrudeAgencyData> FetchAll() {
            var dataList = new List<CrudeAgencyData>();
        ...
        public static List<CrudeAgencyData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAgencyData>();
            ...
            string sql = @" select top " + limit.ToString() + @" agency_id, agency_code, agency_name, user_id, date_time
                            from [agency]
                            order by agency_name";
        ...
        public static List<CrudeAgencyData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAgencyData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [agency]";
        ...
        public static List<CrudeAgencyData> FetchWithFilter(System.Guid agencyId, string agencyCode, string agencyName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAgencyData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(agencyCode)) {
                        sql += "  and agency_code like '%' + @agency_code + '%'";
                        command.Parameters.Add("@agency_code", SqlDbType.NVarChar).Value = agencyCode.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(agencyName)) {
                        sql += "  and agency_name like '%' + @agency_name + '%'";
                        command.Parameters.Add("@agency_name", SqlDbType.NVarChar).Value = agencyName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["agency_code"] != System.DBNull.Value) AgencyCode = (System.String) reader["agency_code"];
            if (reader["agency_name"] != System.DBNull.Value) AgencyName = (System.String) reader["agency_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [agency] (agency_id, agency_code, agency_name, user_id, date_time)";
            sql += "            values (@agency_id, @agency_code, @agency_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@agency_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AgencyId;
                    command.Parameters.Add("@agency_code",SqlDbType.NVarChar).Value = (System.String)AgencyCode;
                    command.Parameters.Add("@agency_name",SqlDbType.NVarChar).Value = (System.String)AgencyName;
        ...
        public static void Delete(System.Guid agencyId) {
            // create query against agency
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
