...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of address's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAddressData {
        ...
        public void FetchByAddressId(System.Guid addressId) {
            // create query against address
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 address_id, address_type_rcd, address_one, address_two, address_three, city, street, state, district, province, zip_code, po_box, comment, user_id, date_time
                            from [address]
        ...
        // parameters:
        //  addressId: primary key of table address
        public static CrudeAddressData GetByAddressId(System.Guid addressId) {
            // create query against address
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeAddressData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAddressData>();
            ...
            string sql = @" select address_id, address_type_rcd, address_one, address_two, address_three, city, street, state, district, province, zip_code, po_box, comment, user_id, date_time
                            from [address]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of address
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAddressData> FetchByAddressTypeRcd(string addressTypeRcd) {
            var dataList = new List<CrudeAddressData>();
            ...
            string sql = @" select address_id, address_type_rcd, address_one, address_two, address_three, city, street, state, district, province, zip_code, po_box, comment, user_id, date_time
                            from [address]
                            where address_type_rcd = @address_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@address_type_rcd", SqlDbType.NVarChar).Value = addressTypeRcd.Replace("'","''");
        ...
        public static List<CrudeAddressData> FetchAll() {
            var dataList = new List<CrudeAddressData>();
        ...
        public static List<CrudeAddressData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAddressData>();
            ...
            string sql = @" select top " + limit.ToString() + @" address_id, address_type_rcd, address_one, address_two, address_three, city, street, state, district, province, zip_code, po_box, comment, user_id, date_time
                            from [address]
                            order by zip_code";
        ...
        public static List<CrudeAddressData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAddressData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(addressTypeRcd)) {
                        sql += "  and address_type_rcd like '%' + @address_type_rcd + '%'";
                        command.Parameters.Add("@address_type_rcd", SqlDbType.NVarChar).Value = addressTypeRcd.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["address_type_rcd"] != System.DBNull.Value) AddressTypeRcd = (System.String) reader["address_type_rcd"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [address] (address_id, address_type_rcd, address_one, address_two, address_three, city, street, state, district, province, zip_code, po_box, comment, user_id, date_time)";
            sql += "            values (@address_id, @address_type_rcd, @address_one, @address_two, @address_three, @city, @street, @state, @district, @province, @zip_code, @po_box, @comment, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@address_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AddressId;
                    command.Parameters.Add("@address_type_rcd",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(AddressTypeRcd)) ? (object)DBNull.Value : (System.String)AddressTypeRcd;
        ...
        public void Update() {
            ...
            string sql = @" update [address] set
                ...
                ,address_type_rcd = @address_type_rcd
        ...
        public static void Delete(System.Guid addressId) {
            // create query against address
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
