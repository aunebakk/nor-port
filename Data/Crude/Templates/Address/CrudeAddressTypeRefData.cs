...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of address_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAddressTypeRefData {
        ...
        public void FetchByAddressTypeRcd(string addressTypeRcd) {
            // create query against address_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 address_type_rcd, address_type_name, user_id, date_time
                            from [address_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@address_type_rcd",SqlDbType.NVarChar).Value = addressTypeRcd;
        ...
        // parameters:
        //  addressTypeRcd: primary key of table address_type_ref
        public static CrudeAddressTypeRefData GetByAddressTypeRcd(string addressTypeRcd) {
            // create query against address_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAddressTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against address_type_ref
        ...
        public static List<CrudeAddressTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAddressTypeRefData>();
            ...
            string sql = @" select address_type_rcd, address_type_name, user_id, date_time
                            from [address_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of address_type_ref
        ...
        public void FetchByAddressTypeName(string addressTypeName) {
            // create query against address_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 address_type_rcd, address_type_name, user_id, date_time
                            from [address_type_ref]
                            where address_type_name like '%' + @addressTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@addressTypeName",SqlDbType.NVarChar).Value = addressTypeName;
        ...
        public static List<CrudeAddressTypeRefData> FetchAll() {
            var dataList = new List<CrudeAddressTypeRefData>();
        ...
        public static List<CrudeAddressTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAddressTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" address_type_rcd, address_type_name, user_id, date_time
                            from [address_type_ref]
                            order by address_type_name";
        ...
        public static List<CrudeAddressTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAddressTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [address_type_ref]";
        ...
        public static List<CrudeAddressTypeRefData> FetchWithFilter(string addressTypeRcd, string addressTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAddressTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(addressTypeName)) {
                        sql += "  and address_type_name like '%' + @address_type_name + '%'";
                        command.Parameters.Add("@address_type_name", SqlDbType.NVarChar).Value = addressTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by address_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["address_type_name"] != System.DBNull.Value) AddressTypeName = (System.String) reader["address_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [address_type_ref] (address_type_rcd, address_type_name, user_id, date_time)";
            sql += "            values (@address_type_rcd, @address_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@address_type_rcd",SqlDbType.NVarChar).Value = (System.String)AddressTypeRcd;
                    command.Parameters.Add("@address_type_name",SqlDbType.NVarChar).Value = (System.String)AddressTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [address_type_ref] set
        ...
        public static void Delete(string addressTypeRcd) {
            // create query against address_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [address_type_ref] 
                where address_type_rcd = @address_type_rcd";
