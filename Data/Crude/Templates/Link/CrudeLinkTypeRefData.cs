...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of link_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeLinkTypeRefData {
        ...
        public void FetchByLinkTypeRcd(string linkTypeRcd) {
            // create query against link_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 link_type_rcd, link_type_name, user_id, date_time
                            from [link_type_ref]
                            where link_type_rcd = @link_type_rcd
                            order by link_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@link_type_rcd",SqlDbType.NVarChar).Value = linkTypeRcd;
        ...
        // parameters:
        //  linkTypeRcd: primary key of table link_type_ref
        public static CrudeLinkTypeRefData GetByLinkTypeRcd(string linkTypeRcd) {
            // create query against link_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeLinkTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against link_type_ref
        ...
        public static List<CrudeLinkTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeLinkTypeRefData>();
            ...
            string sql = @" select link_type_rcd, link_type_name, user_id, date_time
                            from [link_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of link_type_ref
        ...
        public void FetchByLinkTypeName(string linkTypeName) {
            // create query against link_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 link_type_rcd, link_type_name, user_id, date_time
                            from [link_type_ref]
                            where link_type_name like '%' + @linkTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@linkTypeName",SqlDbType.NVarChar).Value = linkTypeName;
        ...
        public static List<CrudeLinkTypeRefData> FetchAll() {
            var dataList = new List<CrudeLinkTypeRefData>();
        ...
        public static List<CrudeLinkTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeLinkTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" link_type_rcd, link_type_name, user_id, date_time
                            from [link_type_ref]
                            order by link_type_name";
        ...
        public static List<CrudeLinkTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeLinkTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [link_type_ref]";
        ...
        public static List<CrudeLinkTypeRefData> FetchWithFilter(string linkTypeRcd, string linkTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeLinkTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(linkTypeName)) {
                        sql += "  and link_type_name like '%' + @link_type_name + '%'";
                        command.Parameters.Add("@link_type_name", SqlDbType.NVarChar).Value = linkTypeName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["link_type_name"] != System.DBNull.Value) LinkTypeName = (System.String) reader["link_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [link_type_ref] (link_type_rcd, link_type_name, user_id, date_time)";
            sql += "            values (@link_type_rcd, @link_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@link_type_name",SqlDbType.NVarChar).Value = (System.String)LinkTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [link_type_ref] set
        ...
        public static void Delete(string linkTypeRcd) {
            // create query against link_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [link_type_ref] 
                where link_type_rcd = @link_type_rcd";
