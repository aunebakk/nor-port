...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airline_identifier's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirlineIdentifierData {
        ...
        public void FetchByAirlineIdentifierId(System.Guid airlineIdentifierId) {
            // create query against airline_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airline_identifier_id, airline_id, airline_identifier_type_rcd, airline_identifier_code, user_id, date_time
                            from [airline_identifier]
                            where airline_identifier_id = @airline_identifier_id
                            order by airline_identifier_code";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airline_identifier_id",SqlDbType.UniqueIdentifier).Value = airlineIdentifierId;
        ...
        // parameters:
        //  airlineIdentifierId: primary key of table airline_identifier
        public static CrudeAirlineIdentifierData GetByAirlineIdentifierId(System.Guid airlineIdentifierId) {
            // create query against airline_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirlineIdentifierData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airline_identifier
        ...
        public static List<CrudeAirlineIdentifierData> FetchByAirlineId(System.Guid airlineId) {
            var dataList = new List<CrudeAirlineIdentifierData>();
            ...
            string sql = @" select airline_identifier_id, airline_id, airline_identifier_type_rcd, airline_identifier_code, user_id, date_time
                            from [airline_identifier]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airline_identifier
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineIdentifierData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirlineIdentifierData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineIdentifierData> FetchByAirlineIdentifierTypeRcd(string airlineIdentifierTypeRcd) {
            var dataList = new List<CrudeAirlineIdentifierData>();
            ...
            string sql = @" select airline_identifier_id, airline_id, airline_identifier_type_rcd, airline_identifier_code, user_id, date_time
                            from [airline_identifier]
                            where airline_identifier_type_rcd = @airline_identifier_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@airline_identifier_type_rcd", SqlDbType.NVarChar).Value = airlineIdentifierTypeRcd.Replace("'","''");
        ...
        public static List<CrudeAirlineIdentifierData> FetchAll() {
            var dataList = new List<CrudeAirlineIdentifierData>();
        ...
        public static List<CrudeAirlineIdentifierData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirlineIdentifierData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airline_identifier_id, airline_id, airline_identifier_type_rcd, airline_identifier_code, user_id, date_time
                            from [airline_identifier]
                            order by airline_identifier_code";
        ...
        public static List<CrudeAirlineIdentifierData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirlineIdentifierData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airline_identifier]";
        ...
        public static List<CrudeAirlineIdentifierData> FetchWithFilter(System.Guid airlineIdentifierId, System.Guid airlineId, string airlineIdentifierTypeRcd, string airlineIdentifierCode, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirlineIdentifierData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airlineIdentifierId != Guid.Empty) {
                        sql += "  and airline_identifier_id = @airline_identifier_id";
                        command.Parameters.Add("@airline_identifier_id", SqlDbType.UniqueIdentifier).Value = airlineIdentifierId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(airlineIdentifierTypeRcd)) {
                        sql += "  and airline_identifier_type_rcd like '%' + @airline_identifier_type_rcd + '%'";
                        command.Parameters.Add("@airline_identifier_type_rcd", SqlDbType.NVarChar).Value = airlineIdentifierTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(airlineIdentifierCode)) {
                        sql += "  and airline_identifier_code like '%' + @airline_identifier_code + '%'";
                        command.Parameters.Add("@airline_identifier_code", SqlDbType.NVarChar).Value = airlineIdentifierCode.Replace("'","''");
                    }
                    ...
                    sql += " order by airline_identifier_code";
        ...
        public void Populate(IDataReader reader) {
            if (reader["airline_identifier_id"] != System.DBNull.Value) AirlineIdentifierId = (System.Guid) reader["airline_identifier_id"];
            if (reader["airline_id"] != System.DBNull.Value) AirlineId = (System.Guid) reader["airline_id"];
            if (reader["airline_identifier_type_rcd"] != System.DBNull.Value) AirlineIdentifierTypeRcd = (System.String) reader["airline_identifier_type_rcd"];
            if (reader["airline_identifier_code"] != System.DBNull.Value) AirlineIdentifierCode = (System.String) reader["airline_identifier_code"];
        ...
        public void Insert() {
            ...
            if (AirlineIdentifierId == Guid.Empty)
                AirlineIdentifierId = Guid.NewGuid();
            ...
            string sql = "insert into [airline_identifier] (airline_identifier_id, airline_id, airline_identifier_type_rcd, airline_identifier_code, user_id, date_time)";
            sql += "            values (@airline_identifier_id, @airline_id, @airline_identifier_type_rcd, @airline_identifier_code, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airline_identifier_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineIdentifierId;
                    command.Parameters.Add("@airline_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineId;
                    command.Parameters.Add("@airline_identifier_type_rcd",SqlDbType.NVarChar).Value = (System.String)AirlineIdentifierTypeRcd;
                    command.Parameters.Add("@airline_identifier_code",SqlDbType.NVarChar).Value = (System.String)AirlineIdentifierCode;
        ...
        public void Update() {
            ...
            string sql = @" update [airline_identifier] set
                 airline_identifier_id = @airline_identifier_id
                ,airline_id = @airline_id
                ,airline_identifier_type_rcd = @airline_identifier_type_rcd
                ,airline_identifier_code = @airline_identifier_code
                ,user_id = @user_id
                ,date_time = @date_time
            where airline_identifier_id = @airline_identifier_id";
        ...
        public static void Delete(System.Guid airlineIdentifierId) {
            // create query against airline_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airline_identifier] 
                where airline_identifier_id = @airline_identifier_id";
