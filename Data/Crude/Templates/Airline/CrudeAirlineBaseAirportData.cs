...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airline_base_airport's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirlineBaseAirportData {
        ...
        public void FetchByAirlineBaseAirportId(System.Guid airlineBaseAirportId) {
            // create query against airline_base_airport
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airline_base_airport_id, airline_id, airport_id, user_id, date_time
                            from [airline_base_airport]
                            where airline_base_airport_id = @airline_base_airport_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airline_base_airport_id",SqlDbType.UniqueIdentifier).Value = airlineBaseAirportId;
        ...
        // parameters:
        //  airlineBaseAirportId: primary key of table airline_base_airport
        public static CrudeAirlineBaseAirportData GetByAirlineBaseAirportId(System.Guid airlineBaseAirportId) {
            // create query against airline_base_airport
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirlineBaseAirportData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airline_base_airport
        ...
        public static List<CrudeAirlineBaseAirportData> FetchByAirlineId(System.Guid airlineId) {
            var dataList = new List<CrudeAirlineBaseAirportData>();
            ...
            string sql = @" select airline_base_airport_id, airline_id, airport_id, user_id, date_time
                            from [airline_base_airport]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airline_base_airport
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineBaseAirportData> FetchByAirportId(System.Guid airportId) {
            var dataList = new List<CrudeAirlineBaseAirportData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineBaseAirportData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirlineBaseAirportData>();
        ...
        public static List<CrudeAirlineBaseAirportData> FetchAll() {
            var dataList = new List<CrudeAirlineBaseAirportData>();
        ...
        public static List<CrudeAirlineBaseAirportData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirlineBaseAirportData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airline_base_airport_id, airline_id, airport_id, user_id, date_time
                            from [airline_base_airport]";
        ...
        public static List<CrudeAirlineBaseAirportData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirlineBaseAirportData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airline_base_airport]";
        ...
        public static List<CrudeAirlineBaseAirportData> FetchWithFilter(System.Guid airlineBaseAirportId, System.Guid airlineId, System.Guid airportId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirlineBaseAirportData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airlineBaseAirportId != Guid.Empty) {
                        sql += "  and airline_base_airport_id = @airline_base_airport_id";
                        command.Parameters.Add("@airline_base_airport_id", SqlDbType.UniqueIdentifier).Value = airlineBaseAirportId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["airline_base_airport_id"] != System.DBNull.Value) AirlineBaseAirportId = (System.Guid) reader["airline_base_airport_id"];
        ...
        public void Insert() {
            ...
            if (AirlineBaseAirportId == Guid.Empty)
                AirlineBaseAirportId = Guid.NewGuid();
            ...
            string sql = "insert into [airline_base_airport] (airline_base_airport_id, airline_id, airport_id, user_id, date_time)";
            sql += "            values (@airline_base_airport_id, @airline_id, @airport_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airline_base_airport_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineBaseAirportId;
        ...
        public void Update() {
            ...
            string sql = @" update [airline_base_airport] set
                 airline_base_airport_id = @airline_base_airport_id
        ...
        public static void Delete(System.Guid airlineBaseAirportId) {
            // create query against airline_base_airport
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airline_base_airport] 
                where airline_base_airport_id = @airline_base_airport_id";
