...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airline_identifier_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirlineIdentifierTypeRefData {
        ...
        public void FetchByAirlineIdentifierTypeRcd(string airlineIdentifierTypeRcd) {
            // create query against airline_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airline_identifier_type_rcd, airline_identifier_type_name, user_id, date_time
                            from [airline_identifier_type_ref]
                            where airline_identifier_type_rcd = @airline_identifier_type_rcd
                            order by airline_identifier_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airline_identifier_type_rcd",SqlDbType.NVarChar).Value = airlineIdentifierTypeRcd;
        ...
        // parameters:
        //  airlineIdentifierTypeRcd: primary key of table airline_identifier_type_ref
        public static CrudeAirlineIdentifierTypeRefData GetByAirlineIdentifierTypeRcd(string airlineIdentifierTypeRcd) {
            // create query against airline_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirlineIdentifierTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airline_identifier_type_ref
        ...
        public static List<CrudeAirlineIdentifierTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirlineIdentifierTypeRefData>();
            ...
            string sql = @" select airline_identifier_type_rcd, airline_identifier_type_name, user_id, date_time
                            from [airline_identifier_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airline_identifier_type_ref
        ...
        public void FetchByAirlineIdentifierTypeName(string airlineIdentifierTypeName) {
            // create query against airline_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airline_identifier_type_rcd, airline_identifier_type_name, user_id, date_time
                            from [airline_identifier_type_ref]
                            where airline_identifier_type_name like '%' + @airlineIdentifierTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airlineIdentifierTypeName",SqlDbType.NVarChar).Value = airlineIdentifierTypeName;
        ...
        public static List<CrudeAirlineIdentifierTypeRefData> FetchAll() {
            var dataList = new List<CrudeAirlineIdentifierTypeRefData>();
        ...
        public static List<CrudeAirlineIdentifierTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirlineIdentifierTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airline_identifier_type_rcd, airline_identifier_type_name, user_id, date_time
                            from [airline_identifier_type_ref]
                            order by airline_identifier_type_name";
        ...
        public static List<CrudeAirlineIdentifierTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirlineIdentifierTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airline_identifier_type_ref]";
        ...
        public static List<CrudeAirlineIdentifierTypeRefData> FetchWithFilter(string airlineIdentifierTypeRcd, string airlineIdentifierTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirlineIdentifierTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(airlineIdentifierTypeName)) {
                        sql += "  and airline_identifier_type_name like '%' + @airline_identifier_type_name + '%'";
                        command.Parameters.Add("@airline_identifier_type_name", SqlDbType.NVarChar).Value = airlineIdentifierTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by airline_identifier_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["airline_identifier_type_name"] != System.DBNull.Value) AirlineIdentifierTypeName = (System.String) reader["airline_identifier_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airline_identifier_type_ref] (airline_identifier_type_rcd, airline_identifier_type_name, user_id, date_time)";
            sql += "            values (@airline_identifier_type_rcd, @airline_identifier_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airline_identifier_type_name",SqlDbType.NVarChar).Value = (System.String)AirlineIdentifierTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [airline_identifier_type_ref] set
                 airline_identifier_type_rcd = @airline_identifier_type_rcd
                ,airline_identifier_type_name = @airline_identifier_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where airline_identifier_type_rcd = @airline_identifier_type_rcd";
        ...
        public static void Delete(string airlineIdentifierTypeRcd) {
            // create query against airline_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airline_identifier_type_ref] 
                where airline_identifier_type_rcd = @airline_identifier_type_rcd";
