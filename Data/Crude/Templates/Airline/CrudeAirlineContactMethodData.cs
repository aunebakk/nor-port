...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airline_contact_method's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirlineContactMethodData {
        ...
        public void FetchByAirlineContactMethodId(System.Guid airlineContactMethodId) {
            // create query against airline_contact_method
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airline_contact_method_id, airline_id, contact_method_rcd, contact_method_way, comment, user_id, date_time
                            from [airline_contact_method]
                            where airline_contact_method_id = @airline_contact_method_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airline_contact_method_id",SqlDbType.UniqueIdentifier).Value = airlineContactMethodId;
        ...
        // parameters:
        //  airlineContactMethodId: primary key of table airline_contact_method
        public static CrudeAirlineContactMethodData GetByAirlineContactMethodId(System.Guid airlineContactMethodId) {
            // create query against airline_contact_method
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirlineContactMethodData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airline_contact_method
        ...
        public static List<CrudeAirlineContactMethodData> FetchByAirlineId(System.Guid airlineId) {
            var dataList = new List<CrudeAirlineContactMethodData>();
            ...
            string sql = @" select airline_contact_method_id, airline_id, contact_method_rcd, contact_method_way, comment, user_id, date_time
                            from [airline_contact_method]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airline_contact_method
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineContactMethodData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirlineContactMethodData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineContactMethodData> FetchByContactMethodRcd(string contactMethodRcd) {
            var dataList = new List<CrudeAirlineContactMethodData>();
        ...
        public static List<CrudeAirlineContactMethodData> FetchAll() {
            var dataList = new List<CrudeAirlineContactMethodData>();
        ...
        public static List<CrudeAirlineContactMethodData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirlineContactMethodData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airline_contact_method_id, airline_id, contact_method_rcd, contact_method_way, comment, user_id, date_time
                            from [airline_contact_method]";
        ...
        public static List<CrudeAirlineContactMethodData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirlineContactMethodData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airline_contact_method]";
        ...
        public static List<CrudeAirlineContactMethodData> FetchWithFilter(System.Guid airlineContactMethodId, System.Guid airlineId, string contactMethodRcd, string contactMethodWay, string comment, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirlineContactMethodData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airlineContactMethodId != Guid.Empty) {
                        sql += "  and airline_contact_method_id = @airline_contact_method_id";
                        command.Parameters.Add("@airline_contact_method_id", SqlDbType.UniqueIdentifier).Value = airlineContactMethodId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["airline_contact_method_id"] != System.DBNull.Value) AirlineContactMethodId = (System.Guid) reader["airline_contact_method_id"];
            if (reader["airline_id"] != System.DBNull.Value) AirlineId = (System.Guid) reader["airline_id"];
            if (reader["contact_method_rcd"] != System.DBNull.Value) ContactMethodRcd = (System.String) reader["contact_method_rcd"];
        ...
        public void Insert() {
            ...
            if (AirlineContactMethodId == Guid.Empty)
                AirlineContactMethodId = Guid.NewGuid();
            ...
            string sql = "insert into [airline_contact_method] (airline_contact_method_id, airline_id, contact_method_rcd, contact_method_way, comment, user_id, date_time)";
            sql += "            values (@airline_contact_method_id, @airline_id, @contact_method_rcd, @contact_method_way, @comment, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airline_contact_method_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineContactMethodId;
                    command.Parameters.Add("@airline_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineId;
                    command.Parameters.Add("@contact_method_rcd",SqlDbType.NVarChar).Value = (System.String)ContactMethodRcd;
        ...
        public void Update() {
            ...
            string sql = @" update [airline_contact_method] set
                 airline_contact_method_id = @airline_contact_method_id
                ,airline_id = @airline_id
                ,contact_method_rcd = @contact_method_rcd
        ...
        public static void Delete(System.Guid airlineContactMethodId) {
            // create query against airline_contact_method
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airline_contact_method] 
                where airline_contact_method_id = @airline_contact_method_id";
