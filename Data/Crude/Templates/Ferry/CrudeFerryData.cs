...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    public partial class CrudeFerryData {
        ...
        public void FetchByFerryId(System.Guid ferryId) {
            // create query against ferry
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 ferry_id, ferry_name, ferry_type_rcd, product_id, first_float_date_time, operational_date_time, engine_type, passenger_capacity, user_id, date_time
                            from [ferry]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@ferry_id",SqlDbType.UniqueIdentifier).Value = ferryId;
        ...
        // parameters:
        //  ferryId: primary key of table ferry
        public static CrudeFerryData GetByFerryId(System.Guid ferryId) {
            // create query against ferry
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeFerryData> FetchByProductId(System.Guid productId) {
            var dataList = new List<CrudeFerryData>();
            ...
            string sql = @" select ferry_id, ferry_name, ferry_type_rcd, product_id, first_float_date_time, operational_date_time, engine_type, passenger_capacity, user_id, date_time
                            from [ferry]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of ferry
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFerryData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFerryData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFerryData> FetchByFerryTypeRcd(string ferryTypeRcd) {
            var dataList = new List<CrudeFerryData>();
            ...
            string sql = @" select ferry_id, ferry_name, ferry_type_rcd, product_id, first_float_date_time, operational_date_time, engine_type, passenger_capacity, user_id, date_time
                            from [ferry]
                            where ferry_type_rcd = @ferry_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@ferry_type_rcd", SqlDbType.NVarChar).Value = ferryTypeRcd.Replace("'","''");
        ...
        public void FetchByFerryName(string ferryName) {
            // create query against ferry
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 ferry_id, ferry_name, ferry_type_rcd, product_id, first_float_date_time, operational_date_time, engine_type, passenger_capacity, user_id, date_time
                            from [ferry]
                            where ferry_name like '%' + @ferryName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@ferryName",SqlDbType.NVarChar).Value = ferryName;
        ...
        public static List<CrudeFerryData> FetchAll() {
            var dataList = new List<CrudeFerryData>();
        ...
        public static List<CrudeFerryData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFerryData>();
            ...
            string sql = @" select top " + limit.ToString() + @" ferry_id, ferry_name, ferry_type_rcd, product_id, first_float_date_time, operational_date_time, engine_type, passenger_capacity, user_id, date_time
                            from [ferry]
                            order by ferry_name";
        ...
        public static List<CrudeFerryData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFerryData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [ferry]";
        ...
        public static List<CrudeFerryData> FetchWithFilter(System.Guid ferryId, string ferryName, string ferryTypeRcd, System.Guid productId, System.DateTime firstFloatDateTime, System.DateTime operationalDateTime, string engineType, int passengerCapacity, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFerryData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (ferryId != Guid.Empty) {
                        sql += "  and ferry_id = @ferry_id";
                        command.Parameters.Add("@ferry_id", SqlDbType.UniqueIdentifier).Value = ferryId;
                    }
                    if (!string.IsNullOrEmpty(ferryName)) {
                        sql += "  and ferry_name like '%' + @ferry_name + '%'";
                        command.Parameters.Add("@ferry_name", SqlDbType.NVarChar).Value = ferryName.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(ferryTypeRcd)) {
                        sql += "  and ferry_type_rcd like '%' + @ferry_type_rcd + '%'";
                        command.Parameters.Add("@ferry_type_rcd", SqlDbType.NVarChar).Value = ferryTypeRcd.Replace("'","''");
                    }
                    ...
                    if (firstFloatDateTime != DateTime.MinValue) {
                        sql += "  and first_float_date_time = @first_float_date_time";
                        command.Parameters.Add("@first_float_date_time", SqlDbType.DateTime).Value = firstFloatDateTime;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["ferry_id"] != System.DBNull.Value) FerryId = (System.Guid) reader["ferry_id"];
            if (reader["ferry_name"] != System.DBNull.Value) FerryName = (System.String) reader["ferry_name"];
            if (reader["ferry_type_rcd"] != System.DBNull.Value) FerryTypeRcd = (System.String) reader["ferry_type_rcd"];
            if (reader["product_id"] != System.DBNull.Value) ProductId = (System.Guid) reader["product_id"];
            if (reader["first_float_date_time"] != System.DBNull.Value) FirstFloatDateTime = (System.DateTime) reader["first_float_date_time"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [ferry] (ferry_id, ferry_name, ferry_type_rcd, product_id, first_float_date_time, operational_date_time, engine_type, passenger_capacity, user_id, date_time)";
            sql += "            values (@ferry_id, @ferry_name, @ferry_type_rcd, @product_id, @first_float_date_time, @operational_date_time, @engine_type, @passenger_capacity, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@ferry_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FerryId;
                    command.Parameters.Add("@ferry_name",SqlDbType.NVarChar).Value = (System.String)FerryName;
                    command.Parameters.Add("@ferry_type_rcd",SqlDbType.NVarChar).Value = (System.String)FerryTypeRcd;
                    ...
                    command.Parameters.Add("@first_float_date_time",SqlDbType.DateTime).Value = (FirstFloatDateTime == DateTime.MinValue ? (object)DBNull.Value : (System.DateTime)FirstFloatDateTime);
        ...
        public void Update() {
            ...
            string sql = @" update [ferry] set
                 ferry_id = @ferry_id
                ,ferry_name = @ferry_name
                ,ferry_type_rcd = @ferry_type_rcd
                ,product_id = @product_id
                ,first_float_date_time = @first_float_date_time
        ...
        public static void Delete(System.Guid ferryId) {
            // create query against ferry
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
