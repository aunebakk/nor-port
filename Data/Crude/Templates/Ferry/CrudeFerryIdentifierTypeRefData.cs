...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of ferry_identifier_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFerryIdentifierTypeRefData {
        
        public string FerryIdentifierTypeRcd { get; set; }
        
        public string FerryIdentifierTypeName { get; set; }
        ...
        public void FetchByFerryIdentifierTypeRcd(string ferryIdentifierTypeRcd) {
            // create query against ferry_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 ferry_identifier_type_rcd, ferry_identifier_type_name, state_rcd, user_id, date_time
                            from [ferry_identifier_type_ref]
                            where ferry_identifier_type_rcd = @ferry_identifier_type_rcd
                            order by ferry_identifier_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@ferry_identifier_type_rcd",SqlDbType.NVarChar).Value = ferryIdentifierTypeRcd;
        ...
        // parameters:
        //  ferryIdentifierTypeRcd: primary key of table ferry_identifier_type_ref
        public static CrudeFerryIdentifierTypeRefData GetByFerryIdentifierTypeRcd(string ferryIdentifierTypeRcd) {
            // create query against ferry_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFerryIdentifierTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against ferry_identifier_type_ref
        ...
        public static List<CrudeFerryIdentifierTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFerryIdentifierTypeRefData>();
            ...
            string sql = @" select ferry_identifier_type_rcd, ferry_identifier_type_name, state_rcd, user_id, date_time
                            from [ferry_identifier_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of ferry_identifier_type_ref
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFerryIdentifierTypeRefData> FetchByStateRcd(string stateRcd) {
            var dataList = new List<CrudeFerryIdentifierTypeRefData>();
        ...
        public void FetchByFerryIdentifierTypeName(string ferryIdentifierTypeName) {
            // create query against ferry_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 ferry_identifier_type_rcd, ferry_identifier_type_name, state_rcd, user_id, date_time
                            from [ferry_identifier_type_ref]
                            where ferry_identifier_type_name like '%' + @ferryIdentifierTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@ferryIdentifierTypeName",SqlDbType.NVarChar).Value = ferryIdentifierTypeName;
        ...
        public static List<CrudeFerryIdentifierTypeRefData> FetchAll() {
            var dataList = new List<CrudeFerryIdentifierTypeRefData>();
        ...
        public static List<CrudeFerryIdentifierTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFerryIdentifierTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" ferry_identifier_type_rcd, ferry_identifier_type_name, state_rcd, user_id, date_time
                            from [ferry_identifier_type_ref]
                            order by ferry_identifier_type_name";
        ...
        public static List<CrudeFerryIdentifierTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFerryIdentifierTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [ferry_identifier_type_ref]";
        ...
        public static List<CrudeFerryIdentifierTypeRefData> FetchWithFilter(string ferryIdentifierTypeRcd, string ferryIdentifierTypeName, string stateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFerryIdentifierTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(ferryIdentifierTypeName)) {
                        sql += "  and ferry_identifier_type_name like '%' + @ferry_identifier_type_name + '%'";
                        command.Parameters.Add("@ferry_identifier_type_name", SqlDbType.NVarChar).Value = ferryIdentifierTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by ferry_identifier_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["ferry_identifier_type_name"] != System.DBNull.Value) FerryIdentifierTypeName = (System.String) reader["ferry_identifier_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [ferry_identifier_type_ref] (ferry_identifier_type_rcd, ferry_identifier_type_name, state_rcd, user_id, date_time)";
            sql += "            values (@ferry_identifier_type_rcd, @ferry_identifier_type_name, @state_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@ferry_identifier_type_name",SqlDbType.NVarChar).Value = (System.String)FerryIdentifierTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [ferry_identifier_type_ref] set
                 ferry_identifier_type_rcd = @ferry_identifier_type_rcd
                ,ferry_identifier_type_name = @ferry_identifier_type_name
                ,state_rcd = @state_rcd
                ,user_id = @user_id
                ,date_time = @date_time
            where ferry_identifier_type_rcd = @ferry_identifier_type_rcd";
        ...
        public static void Delete(string ferryIdentifierTypeRcd) {
            // create query against ferry_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [ferry_identifier_type_ref] 
                where ferry_identifier_type_rcd = @ferry_identifier_type_rcd";
