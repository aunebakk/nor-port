...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airport_supplier's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirportSupplierData {
        ...
        public void FetchByAirportSupplierId(System.Guid airportSupplierId) {
            // create query against airport_supplier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_supplier_id, aiport_supplier_name, airport_supplier_code, user_id, date_time
                            from [airport_supplier]
                            where airport_supplier_id = @airport_supplier_id
                            order by aiport_supplier_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_supplier_id",SqlDbType.UniqueIdentifier).Value = airportSupplierId;
        ...
        // parameters:
        //  airportSupplierId: primary key of table airport_supplier
        public static CrudeAirportSupplierData GetByAirportSupplierId(System.Guid airportSupplierId) {
            // create query against airport_supplier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportSupplierData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_supplier
        ...
        public static List<CrudeAirportSupplierData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportSupplierData>();
            ...
            string sql = @" select airport_supplier_id, aiport_supplier_name, airport_supplier_code, user_id, date_time
                            from [airport_supplier]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_supplier
        ...
        public void FetchByAiportSupplierName(string aiportSupplierName) {
            // create query against airport_supplier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airport_supplier_id, aiport_supplier_name, airport_supplier_code, user_id, date_time
                            from [airport_supplier]
                            where aiport_supplier_name like '%' + @aiportSupplierName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@aiportSupplierName",SqlDbType.NVarChar).Value = aiportSupplierName;
        ...
        public static List<CrudeAirportSupplierData> FetchAll() {
            var dataList = new List<CrudeAirportSupplierData>();
        ...
        public static List<CrudeAirportSupplierData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportSupplierData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_supplier_id, aiport_supplier_name, airport_supplier_code, user_id, date_time
                            from [airport_supplier]
                            order by aiport_supplier_name";
        ...
        public static List<CrudeAirportSupplierData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportSupplierData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_supplier]";
        ...
        public static List<CrudeAirportSupplierData> FetchWithFilter(System.Guid airportSupplierId, string aiportSupplierName, string airportSupplierCode, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportSupplierData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airportSupplierId != Guid.Empty) {
                        sql += "  and airport_supplier_id = @airport_supplier_id";
                        command.Parameters.Add("@airport_supplier_id", SqlDbType.UniqueIdentifier).Value = airportSupplierId;
                    }
                    if (!string.IsNullOrEmpty(aiportSupplierName)) {
                        sql += "  and aiport_supplier_name like '%' + @aiport_supplier_name + '%'";
                        command.Parameters.Add("@aiport_supplier_name", SqlDbType.NVarChar).Value = aiportSupplierName.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(airportSupplierCode)) {
                        sql += "  and airport_supplier_code like '%' + @airport_supplier_code + '%'";
                        command.Parameters.Add("@airport_supplier_code", SqlDbType.NVarChar).Value = airportSupplierCode.Replace("'","''");
                    }
                    ...
                    sql += " order by aiport_supplier_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_supplier_id"] != System.DBNull.Value) AirportSupplierId = (System.Guid) reader["airport_supplier_id"];
            if (reader["aiport_supplier_name"] != System.DBNull.Value) AiportSupplierName = (System.String) reader["aiport_supplier_name"];
            if (reader["airport_supplier_code"] != System.DBNull.Value) AirportSupplierCode = (System.String) reader["airport_supplier_code"];
        ...
        public void Insert() {
            ...
            if (AirportSupplierId == Guid.Empty)
                AirportSupplierId = Guid.NewGuid();
            ...
            string sql = "insert into [airport_supplier] (airport_supplier_id, aiport_supplier_name, airport_supplier_code, user_id, date_time)";
            sql += "            values (@airport_supplier_id, @aiport_supplier_name, @airport_supplier_code, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_supplier_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportSupplierId;
                    command.Parameters.Add("@aiport_supplier_name",SqlDbType.NVarChar).Value = (System.String)AiportSupplierName;
                    command.Parameters.Add("@airport_supplier_code",SqlDbType.NVarChar).Value = (System.String)AirportSupplierCode;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_supplier] set
                 airport_supplier_id = @airport_supplier_id
                ,aiport_supplier_name = @aiport_supplier_name
                ,airport_supplier_code = @airport_supplier_code
                ,user_id = @user_id
                ,date_time = @date_time
            where airport_supplier_id = @airport_supplier_id";
        ...
        public static void Delete(System.Guid airportSupplierId) {
            // create query against airport_supplier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_supplier] 
                where airport_supplier_id = @airport_supplier_id";
