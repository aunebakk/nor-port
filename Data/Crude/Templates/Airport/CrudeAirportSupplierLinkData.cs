...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airport_supplier_link's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirportSupplierLinkData {
        
        public System.Guid AirportSupplierLinkId { get; set; }
        ...
        public void FetchByAirportSupplierLinkId(System.Guid airportSupplierLinkId) {
            // create query against airport_supplier_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_supplier_link_id, airport_id, airport_supplier_id, user_id, date_time
                            from [airport_supplier_link]
                            where airport_supplier_link_id = @airport_supplier_link_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_supplier_link_id",SqlDbType.UniqueIdentifier).Value = airportSupplierLinkId;
        ...
        // parameters:
        //  airportSupplierLinkId: primary key of table airport_supplier_link
        public static CrudeAirportSupplierLinkData GetByAirportSupplierLinkId(System.Guid airportSupplierLinkId) {
            // create query against airport_supplier_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportSupplierLinkData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_supplier_link
        ...
        public static List<CrudeAirportSupplierLinkData> FetchByAirportId(System.Guid airportId) {
            var dataList = new List<CrudeAirportSupplierLinkData>();
            ...
            string sql = @" select airport_supplier_link_id, airport_id, airport_supplier_id, user_id, date_time
                            from [airport_supplier_link]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_supplier_link
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportSupplierLinkData> FetchByAirportSupplierId(System.Guid airportSupplierId) {
            var dataList = new List<CrudeAirportSupplierLinkData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportSupplierLinkData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportSupplierLinkData>();
        ...
        public static List<CrudeAirportSupplierLinkData> FetchAll() {
            var dataList = new List<CrudeAirportSupplierLinkData>();
        ...
        public static List<CrudeAirportSupplierLinkData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportSupplierLinkData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_supplier_link_id, airport_id, airport_supplier_id, user_id, date_time
                            from [airport_supplier_link]";
        ...
        public static List<CrudeAirportSupplierLinkData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportSupplierLinkData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_supplier_link]";
        ...
        public static List<CrudeAirportSupplierLinkData> FetchWithFilter(System.Guid airportSupplierLinkId, System.Guid airportId, System.Guid airportSupplierId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportSupplierLinkData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airportSupplierLinkId != Guid.Empty) {
                        sql += "  and airport_supplier_link_id = @airport_supplier_link_id";
                        command.Parameters.Add("@airport_supplier_link_id", SqlDbType.UniqueIdentifier).Value = airportSupplierLinkId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_supplier_link_id"] != System.DBNull.Value) AirportSupplierLinkId = (System.Guid) reader["airport_supplier_link_id"];
        ...
        public void Insert() {
            ...
            if (AirportSupplierLinkId == Guid.Empty)
                AirportSupplierLinkId = Guid.NewGuid();
            ...
            string sql = "insert into [airport_supplier_link] (airport_supplier_link_id, airport_id, airport_supplier_id, user_id, date_time)";
            sql += "            values (@airport_supplier_link_id, @airport_id, @airport_supplier_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_supplier_link_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportSupplierLinkId;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_supplier_link] set
                 airport_supplier_link_id = @airport_supplier_link_id
        ...
        public static void Delete(System.Guid airportSupplierLinkId) {
            // create query against airport_supplier_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_supplier_link] 
                where airport_supplier_link_id = @airport_supplier_link_id";
