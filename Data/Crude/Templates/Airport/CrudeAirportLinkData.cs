...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airport_link's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirportLinkData {
        
        public System.Guid AirportLinkId { get; set; }
        ...
        public void FetchByAirportLinkId(System.Guid airportLinkId) {
            // create query against airport_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_link_id, airport_id, link_type_rcd, user_id, date_time
                            from [airport_link]
                            where airport_link_id = @airport_link_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_link_id",SqlDbType.UniqueIdentifier).Value = airportLinkId;
        ...
        // parameters:
        //  airportLinkId: primary key of table airport_link
        public static CrudeAirportLinkData GetByAirportLinkId(System.Guid airportLinkId) {
            // create query against airport_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportLinkData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_link
        ...
        public static List<CrudeAirportLinkData> FetchByAirportId(System.Guid airportId) {
            var dataList = new List<CrudeAirportLinkData>();
            ...
            string sql = @" select airport_link_id, airport_id, link_type_rcd, user_id, date_time
                            from [airport_link]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_link
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportLinkData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportLinkData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportLinkData> FetchByLinkTypeRcd(string linkTypeRcd) {
            var dataList = new List<CrudeAirportLinkData>();
        ...
        public static List<CrudeAirportLinkData> FetchAll() {
            var dataList = new List<CrudeAirportLinkData>();
        ...
        public static List<CrudeAirportLinkData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportLinkData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_link_id, airport_id, link_type_rcd, user_id, date_time
                            from [airport_link]";
        ...
        public static List<CrudeAirportLinkData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportLinkData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_link]";
        ...
        public static List<CrudeAirportLinkData> FetchWithFilter(System.Guid airportLinkId, System.Guid airportId, string linkTypeRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportLinkData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airportLinkId != Guid.Empty) {
                        sql += "  and airport_link_id = @airport_link_id";
                        command.Parameters.Add("@airport_link_id", SqlDbType.UniqueIdentifier).Value = airportLinkId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_link_id"] != System.DBNull.Value) AirportLinkId = (System.Guid) reader["airport_link_id"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airport_link] (airport_link_id, airport_id, link_type_rcd, user_id, date_time)";
            sql += "            values (@airport_link_id, @airport_id, @link_type_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_link_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportLinkId;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_link] set
        ...
        public static void Delete(System.Guid airportLinkId) {
            // create query against airport_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_link] 
                where airport_link_id = @airport_link_id";
