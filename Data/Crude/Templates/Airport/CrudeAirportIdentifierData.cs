...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airport_identifier's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAirportIdentifierData {
        ...
        public void FetchByAirportIdentifierId(System.Guid airportIdentifierId) {
            ...
            string sql = @" select top 1 airport_identifier_id, airport_id, airport_identifier_type_rcd, airport_identifier_code, user_id, date_time
                            from [airport_identifier]
                            where airport_identifier_id = @airport_identifier_id
        ...
        // parameters:
        //  airportIdentifierId: primary key of table airport_identifier
        public static CrudeAirportIdentifierData GetByAirportIdentifierId(System.Guid airportIdentifierId) {
            // create query against airport_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportIdentifierData();
        ...
        public static List<CrudeAirportIdentifierData> FetchByAirportId(System.Guid airportId) {
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportIdentifierData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportIdentifierData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportIdentifierData> FetchByAirportIdentifierTypeRcd(string airportIdentifierTypeRcd) {
            var dataList = new List<CrudeAirportIdentifierData>();
        ...
        public static List<CrudeAirportIdentifierData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportIdentifierData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_identifier_id, airport_id, airport_identifier_type_rcd, airport_identifier_code, user_id, date_time
                            from [airport_identifier]
                            order by airport_identifier_code";
        ...
        public static List<CrudeAirportIdentifierData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportIdentifierData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_identifier]";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_identifier_id"] != System.DBNull.Value) AirportIdentifierId = (System.Guid) reader["airport_identifier_id"];
            ...
            if (reader["airport_identifier_code"] != System.DBNull.Value) AirportIdentifierCode = (System.String) reader["airport_identifier_code"];
        ...
        public void Insert() {
            ...
            if (AirportIdentifierId == Guid.Empty)
                AirportIdentifierId = Guid.NewGuid();
            ...
            string sql = "insert into [airport_identifier] (airport_identifier_id, airport_id, airport_identifier_type_rcd, airport_identifier_code, user_id, date_time)";
            sql += "            values (@airport_identifier_id, @airport_id, @airport_identifier_type_rcd, @airport_identifier_code, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_identifier_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportIdentifierId;
                    ...
                    command.Parameters.Add("@airport_identifier_code",SqlDbType.NVarChar).Value = (System.String)AirportIdentifierCode;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_identifier] set
                 airport_identifier_id = @airport_identifier_id
                ,airport_id = @airport_id
                ,airport_identifier_type_rcd = @airport_identifier_type_rcd
                ,airport_identifier_code = @airport_identifier_code
                ,user_id = @user_id
                ,date_time = @date_time
            where airport_identifier_id = @airport_identifier_id";
        ...
        public static void Delete(System.Guid airportIdentifierId) {
            // create query against airport_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_identifier] 
                where airport_identifier_id = @airport_identifier_id";
