...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airport_identifier_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirportIdentifierTypeRefData {
        ...
        public void FetchByAirportIdentifierTypeRcd(string airportIdentifierTypeRcd) {
            // create query against airport_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_identifier_type_rcd, airport_identifier_type_name, user_id, date_time
                            from [airport_identifier_type_ref]
                            where airport_identifier_type_rcd = @airport_identifier_type_rcd
                            order by airport_identifier_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_identifier_type_rcd",SqlDbType.NVarChar).Value = airportIdentifierTypeRcd;
        ...
        // parameters:
        //  airportIdentifierTypeRcd: primary key of table airport_identifier_type_ref
        public static CrudeAirportIdentifierTypeRefData GetByAirportIdentifierTypeRcd(string airportIdentifierTypeRcd) {
            // create query against airport_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportIdentifierTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_identifier_type_ref
        ...
        public static List<CrudeAirportIdentifierTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportIdentifierTypeRefData>();
            ...
            string sql = @" select airport_identifier_type_rcd, airport_identifier_type_name, user_id, date_time
                            from [airport_identifier_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_identifier_type_ref
        ...
        public void FetchByAirportIdentifierTypeName(string airportIdentifierTypeName) {
            // create query against airport_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airport_identifier_type_rcd, airport_identifier_type_name, user_id, date_time
                            from [airport_identifier_type_ref]
                            where airport_identifier_type_name like '%' + @airportIdentifierTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airportIdentifierTypeName",SqlDbType.NVarChar).Value = airportIdentifierTypeName;
        ...
        public static List<CrudeAirportIdentifierTypeRefData> FetchAll() {
            var dataList = new List<CrudeAirportIdentifierTypeRefData>();
        ...
        public static List<CrudeAirportIdentifierTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportIdentifierTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_identifier_type_rcd, airport_identifier_type_name, user_id, date_time
                            from [airport_identifier_type_ref]
                            order by airport_identifier_type_name";
        ...
        public static List<CrudeAirportIdentifierTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportIdentifierTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_identifier_type_ref]";
        ...
        public static List<CrudeAirportIdentifierTypeRefData> FetchWithFilter(string airportIdentifierTypeRcd, string airportIdentifierTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportIdentifierTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(airportIdentifierTypeName)) {
                        sql += "  and airport_identifier_type_name like '%' + @airport_identifier_type_name + '%'";
                        command.Parameters.Add("@airport_identifier_type_name", SqlDbType.NVarChar).Value = airportIdentifierTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by airport_identifier_type_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_identifier_type_rcd"] != System.DBNull.Value) AirportIdentifierTypeRcd = (System.String) reader["airport_identifier_type_rcd"];
            if (reader["airport_identifier_type_name"] != System.DBNull.Value) AirportIdentifierTypeName = (System.String) reader["airport_identifier_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airport_identifier_type_ref] (airport_identifier_type_rcd, airport_identifier_type_name, user_id, date_time)";
            sql += "            values (@airport_identifier_type_rcd, @airport_identifier_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_identifier_type_rcd",SqlDbType.NVarChar).Value = (System.String)AirportIdentifierTypeRcd;
                    command.Parameters.Add("@airport_identifier_type_name",SqlDbType.NVarChar).Value = (System.String)AirportIdentifierTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_identifier_type_ref] set
                 airport_identifier_type_rcd = @airport_identifier_type_rcd
                ,airport_identifier_type_name = @airport_identifier_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where airport_identifier_type_rcd = @airport_identifier_type_rcd";
        ...
        public static void Delete(string airportIdentifierTypeRcd) {
            // create query against airport_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_identifier_type_ref] 
                where airport_identifier_type_rcd = @airport_identifier_type_rcd";
