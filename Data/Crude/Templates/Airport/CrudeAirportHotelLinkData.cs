...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airport_hotel_link's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirportHotelLinkData {
        
        public System.Guid AirportHotelLinkId { get; set; }
        ...
        public void FetchByAirportHotelLinkId(System.Guid airportHotelLinkId) {
            // create query against airport_hotel_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_hotel_link_id, airport_id, service_hotel_id, user_id, date_time
                            from [airport_hotel_link]
                            where airport_hotel_link_id = @airport_hotel_link_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_hotel_link_id",SqlDbType.UniqueIdentifier).Value = airportHotelLinkId;
        ...
        // parameters:
        //  airportHotelLinkId: primary key of table airport_hotel_link
        public static CrudeAirportHotelLinkData GetByAirportHotelLinkId(System.Guid airportHotelLinkId) {
            // create query against airport_hotel_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportHotelLinkData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_hotel_link
        ...
        public static List<CrudeAirportHotelLinkData> FetchByAirportId(System.Guid airportId) {
            var dataList = new List<CrudeAirportHotelLinkData>();
            ...
            string sql = @" select airport_hotel_link_id, airport_id, service_hotel_id, user_id, date_time
                            from [airport_hotel_link]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_hotel_link
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportHotelLinkData> FetchByServiceHotelId(System.Guid serviceHotelId) {
            var dataList = new List<CrudeAirportHotelLinkData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportHotelLinkData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportHotelLinkData>();
        ...
        public static List<CrudeAirportHotelLinkData> FetchAll() {
            var dataList = new List<CrudeAirportHotelLinkData>();
        ...
        public static List<CrudeAirportHotelLinkData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportHotelLinkData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_hotel_link_id, airport_id, service_hotel_id, user_id, date_time
                            from [airport_hotel_link]";
        ...
        public static List<CrudeAirportHotelLinkData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportHotelLinkData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_hotel_link]";
        ...
        public static List<CrudeAirportHotelLinkData> FetchWithFilter(System.Guid airportHotelLinkId, System.Guid airportId, System.Guid serviceHotelId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportHotelLinkData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airportHotelLinkId != Guid.Empty) {
                        sql += "  and airport_hotel_link_id = @airport_hotel_link_id";
                        command.Parameters.Add("@airport_hotel_link_id", SqlDbType.UniqueIdentifier).Value = airportHotelLinkId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_hotel_link_id"] != System.DBNull.Value) AirportHotelLinkId = (System.Guid) reader["airport_hotel_link_id"];
        ...
        public void Insert() {
            ...
            if (AirportHotelLinkId == Guid.Empty)
                AirportHotelLinkId = Guid.NewGuid();
            ...
            string sql = "insert into [airport_hotel_link] (airport_hotel_link_id, airport_id, service_hotel_id, user_id, date_time)";
            sql += "            values (@airport_hotel_link_id, @airport_id, @service_hotel_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_hotel_link_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportHotelLinkId;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_hotel_link] set
                 airport_hotel_link_id = @airport_hotel_link_id
        ...
        public static void Delete(System.Guid airportHotelLinkId) {
            // create query against airport_hotel_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_hotel_link] 
                where airport_hotel_link_id = @airport_hotel_link_id";
