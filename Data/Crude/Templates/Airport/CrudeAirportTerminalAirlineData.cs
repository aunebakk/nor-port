...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airport_terminal_airline's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirportTerminalAirlineData {
        
        public System.Guid AirportTerminalAirlineId { get; set; }
        ...
        public void FetchByAirportTerminalAirlineId(System.Guid airportTerminalAirlineId) {
            // create query against airport_terminal_airline
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_terminal_airline_id, airport_terminal_id, airline_id, user_id, date_time
                            from [airport_terminal_airline]
                            where airport_terminal_airline_id = @airport_terminal_airline_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_terminal_airline_id",SqlDbType.UniqueIdentifier).Value = airportTerminalAirlineId;
        ...
        // parameters:
        //  airportTerminalAirlineId: primary key of table airport_terminal_airline
        public static CrudeAirportTerminalAirlineData GetByAirportTerminalAirlineId(System.Guid airportTerminalAirlineId) {
            // create query against airport_terminal_airline
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportTerminalAirlineData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_terminal_airline
        ...
        public static List<CrudeAirportTerminalAirlineData> FetchByAirportTerminalId(System.Guid airportTerminalId) {
            var dataList = new List<CrudeAirportTerminalAirlineData>();
            ...
            string sql = @" select airport_terminal_airline_id, airport_terminal_id, airline_id, user_id, date_time
                            from [airport_terminal_airline]
                            where airport_terminal_id = @airport_terminal_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_terminal_id", SqlDbType.UniqueIdentifier).Value = airportTerminalId;
                    ...
                    // read all rows returned from the query of airport_terminal_airline
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportTerminalAirlineData> FetchByAirlineId(System.Guid airlineId) {
            var dataList = new List<CrudeAirportTerminalAirlineData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportTerminalAirlineData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportTerminalAirlineData>();
        ...
        public static List<CrudeAirportTerminalAirlineData> FetchAll() {
            var dataList = new List<CrudeAirportTerminalAirlineData>();
        ...
        public static List<CrudeAirportTerminalAirlineData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportTerminalAirlineData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_terminal_airline_id, airport_terminal_id, airline_id, user_id, date_time
                            from [airport_terminal_airline]";
        ...
        public static List<CrudeAirportTerminalAirlineData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportTerminalAirlineData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_terminal_airline]";
        ...
        public static List<CrudeAirportTerminalAirlineData> FetchWithFilter(System.Guid airportTerminalAirlineId, System.Guid airportTerminalId, System.Guid airlineId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportTerminalAirlineData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airportTerminalAirlineId != Guid.Empty) {
                        sql += "  and airport_terminal_airline_id = @airport_terminal_airline_id";
                        command.Parameters.Add("@airport_terminal_airline_id", SqlDbType.UniqueIdentifier).Value = airportTerminalAirlineId;
                    }
                    if (airportTerminalId != Guid.Empty) {
                        sql += "  and airport_terminal_id = @airport_terminal_id";
                        command.Parameters.Add("@airport_terminal_id", SqlDbType.UniqueIdentifier).Value = airportTerminalId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_terminal_airline_id"] != System.DBNull.Value) AirportTerminalAirlineId = (System.Guid) reader["airport_terminal_airline_id"];
            if (reader["airport_terminal_id"] != System.DBNull.Value) AirportTerminalId = (System.Guid) reader["airport_terminal_id"];
        ...
        public void Insert() {
            ...
            if (AirportTerminalAirlineId == Guid.Empty)
                AirportTerminalAirlineId = Guid.NewGuid();
            ...
            string sql = "insert into [airport_terminal_airline] (airport_terminal_airline_id, airport_terminal_id, airline_id, user_id, date_time)";
            sql += "            values (@airport_terminal_airline_id, @airport_terminal_id, @airline_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_terminal_airline_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportTerminalAirlineId;
                    command.Parameters.Add("@airport_terminal_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportTerminalId;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_terminal_airline] set
                 airport_terminal_airline_id = @airport_terminal_airline_id
                ,airport_terminal_id = @airport_terminal_id
        ...
        public static void Delete(System.Guid airportTerminalAirlineId) {
            // create query against airport_terminal_airline
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_terminal_airline] 
                where airport_terminal_airline_id = @airport_terminal_airline_id";
