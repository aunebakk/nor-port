...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of airport_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeAirportTypeRefData {
        ...
        public void FetchByAirportTypeRcd(string airportTypeRcd) {
            // create query against airport_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_type_rcd, airport_type_name, user_id, date_time
                            from [airport_type_ref]
                            where airport_type_rcd = @airport_type_rcd
                            order by airport_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_type_rcd",SqlDbType.NVarChar).Value = airportTypeRcd;
        ...
        // parameters:
        //  airportTypeRcd: primary key of table airport_type_ref
        public static CrudeAirportTypeRefData GetByAirportTypeRcd(string airportTypeRcd) {
            // create query against airport_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_type_ref
        ...
        public static List<CrudeAirportTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportTypeRefData>();
            ...
            string sql = @" select airport_type_rcd, airport_type_name, user_id, date_time
                            from [airport_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_type_ref
        ...
        public void FetchByAirportTypeName(string airportTypeName) {
            // create query against airport_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airport_type_rcd, airport_type_name, user_id, date_time
                            from [airport_type_ref]
                            where airport_type_name like '%' + @airportTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airportTypeName",SqlDbType.NVarChar).Value = airportTypeName;
        ...
        public static List<CrudeAirportTypeRefData> FetchAll() {
            var dataList = new List<CrudeAirportTypeRefData>();
        ...
        public static List<CrudeAirportTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_type_rcd, airport_type_name, user_id, date_time
                            from [airport_type_ref]
                            order by airport_type_name";
        ...
        public static List<CrudeAirportTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_type_ref]";
        ...
        public static List<CrudeAirportTypeRefData> FetchWithFilter(string airportTypeRcd, string airportTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(airportTypeName)) {
                        sql += "  and airport_type_name like '%' + @airport_type_name + '%'";
                        command.Parameters.Add("@airport_type_name", SqlDbType.NVarChar).Value = airportTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by airport_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["airport_type_name"] != System.DBNull.Value) AirportTypeName = (System.String) reader["airport_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airport_type_ref] (airport_type_rcd, airport_type_name, user_id, date_time)";
            sql += "            values (@airport_type_rcd, @airport_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_type_rcd",SqlDbType.NVarChar).Value = (System.String)AirportTypeRcd;
                    command.Parameters.Add("@airport_type_name",SqlDbType.NVarChar).Value = (System.String)AirportTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_type_ref] set
                 airport_type_rcd = @airport_type_rcd
                ,airport_type_name = @airport_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where airport_type_rcd = @airport_type_rcd";
        ...
        public static void Delete(string airportTypeRcd) {
            // create query against airport_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_type_ref] 
                where airport_type_rcd = @airport_type_rcd";
