...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of cart_user's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeCartUserData {
        ...
        public void FetchByCartUserId(System.Guid cartUserId) {
            // create query against cart_user
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 cart_user_id
                            from [cart_user]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@cart_user_id",SqlDbType.UniqueIdentifier).Value = cartUserId;
        ...
        // parameters:
        //  cartUserId: primary key of table cart_user
        public static CrudeCartUserData GetByCartUserId(System.Guid cartUserId) {
            // create query against cart_user
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against cart_user
        ...
        public static List<CrudeCartUserData> FetchAll() {
            var dataList = new List<CrudeCartUserData>();
            ...
            string sql = @" select cart_user_id
                            from [cart_user]";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of cart_user
        ...
        public static List<CrudeCartUserData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeCartUserData>();
            ...
            string sql = @" select top " + limit.ToString() + @" cart_user_id
                            from [cart_user]";
        ...
        public static List<CrudeCartUserData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeCartUserData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [cart_user]";
        ...
        public static List<CrudeCartUserData> FetchWithFilter(System.Guid cartUserId) {
            var dataList = new List<CrudeCartUserData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (cartUserId != Guid.Empty) {
                        sql += "  and cart_user_id = @cart_user_id";
                        command.Parameters.Add("@cart_user_id", SqlDbType.UniqueIdentifier).Value = cartUserId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["cart_user_id"] != System.DBNull.Value) CartUserId = (System.Guid) reader["cart_user_id"];
        }
        ...
        public void Insert() {
            ...
            string sql = "insert into [cart_user] (cart_user_id)";
            sql += "            values (@cart_user_id)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@cart_user_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)CartUserId;
                    // execute query against cart_user
        ...
        public void Update() {
            ...
            string sql = @" update [cart_user] set
        ...
        public static void Delete(System.Guid cartUserId) {
            // create query against cart_user
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
