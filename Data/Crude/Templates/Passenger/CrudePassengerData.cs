...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of passenger's columns
    ...
    public partial class CrudePassengerData {
        ...
        public void FetchByPassengerId(System.Guid passengerId) {
            // create query against passenger
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 passenger_id, became_passenger_id, binding_passenger_id, passenger_type_rcd, passenger_name, default_state_rcd, user_id, date_time
                            from [passenger]
        ...
        // parameters:
        //  passengerId: primary key of table passenger
        public static CrudePassengerData GetByPassengerId(System.Guid passengerId) {
            // create query against passenger
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudePassengerData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against passenger
        ...
        public static List<CrudePassengerData> FetchByBecamePassengerId(System.Guid becamePassengerId) {
            ...
            string sql = @" select passenger_id, became_passenger_id, binding_passenger_id, passenger_type_rcd, passenger_name, default_state_rcd, user_id, date_time
                            from [passenger]
                            where became_passenger_id = @became_passenger_id
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@became_passenger_id", SqlDbType.UniqueIdentifier).Value = becamePassengerId;
                    ...
                    // read all rows returned from the query of passenger
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudePassengerData> FetchByBindingPassengerId(System.Guid bindingPassengerId) {
            var dataList = new List<CrudePassengerData>();
            ...
            string sql = @" select passenger_id, became_passenger_id, binding_passenger_id, passenger_type_rcd, passenger_name, default_state_rcd, user_id, date_time
                            from [passenger]
                            where binding_passenger_id = @binding_passenger_id
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@binding_passenger_id", SqlDbType.UniqueIdentifier).Value = bindingPassengerId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudePassengerData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudePassengerData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudePassengerData> FetchByPassengerTypeRcd(string passengerTypeRcd) {
            var dataList = new List<CrudePassengerData>();
            ...
            string sql = @" select passenger_id, became_passenger_id, binding_passenger_id, passenger_type_rcd, passenger_name, default_state_rcd, user_id, date_time
                            from [passenger]
                            where passenger_type_rcd = @passenger_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@passenger_type_rcd", SqlDbType.NVarChar).Value = passengerTypeRcd.Replace("'","''");
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudePassengerData> FetchByDefaultStateRcd(string defaultStateRcd) {
            var dataList = new List<CrudePassengerData>();
        ...
        public void FetchByPassengerName(string passengerName) {
            // create query against passenger
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@passengerName",SqlDbType.NVarChar).Value = passengerName;
        ...
        public static List<CrudePassengerData> FetchAll() {
            var dataList = new List<CrudePassengerData>();
        ...
        public static List<CrudePassengerData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudePassengerData>();
            ...
            string sql = @" select top " + limit.ToString() + @" passenger_id, became_passenger_id, binding_passenger_id, passenger_type_rcd, passenger_name, default_state_rcd, user_id, date_time
                            from [passenger]
                            order by passenger_name";
        ...
        public static List<CrudePassengerData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudePassengerData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [passenger]";
        ...
        public static List<CrudePassengerData> FetchWithFilter(System.Guid passengerId, System.Guid becamePassengerId, System.Guid bindingPassengerId, string passengerTypeRcd, string passengerName, string defaultStateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudePassengerData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (becamePassengerId != Guid.Empty) {
                        sql += "  and became_passenger_id = @became_passenger_id";
                        command.Parameters.Add("@became_passenger_id", SqlDbType.UniqueIdentifier).Value = becamePassengerId;
                    }
                    if (bindingPassengerId != Guid.Empty) {
                        sql += "  and binding_passenger_id = @binding_passenger_id";
                        command.Parameters.Add("@binding_passenger_id", SqlDbType.UniqueIdentifier).Value = bindingPassengerId;
                    }
                    if (!string.IsNullOrEmpty(passengerTypeRcd)) {
                        sql += "  and passenger_type_rcd like '%' + @passenger_type_rcd + '%'";
                        command.Parameters.Add("@passenger_type_rcd", SqlDbType.NVarChar).Value = passengerTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(passengerName)) {
                        sql += "  and passenger_name like '%' + @passenger_name + '%'";
                        command.Parameters.Add("@passenger_name", SqlDbType.NVarChar).Value = passengerName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["became_passenger_id"] != System.DBNull.Value) BecamePassengerId = (System.Guid) reader["became_passenger_id"];
            if (reader["binding_passenger_id"] != System.DBNull.Value) BindingPassengerId = (System.Guid) reader["binding_passenger_id"];
            if (reader["passenger_type_rcd"] != System.DBNull.Value) PassengerTypeRcd = (System.String) reader["passenger_type_rcd"];
            if (reader["passenger_name"] != System.DBNull.Value) PassengerName = (System.String) reader["passenger_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [passenger] (passenger_id, became_passenger_id, binding_passenger_id, passenger_type_rcd, passenger_name, default_state_rcd, user_id, date_time)";
            sql += "            values (@passenger_id, @became_passenger_id, @binding_passenger_id, @passenger_type_rcd, @passenger_name, @default_state_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@became_passenger_id",SqlDbType.UniqueIdentifier).Value = (BecamePassengerId == Guid.Empty ? (object)DBNull.Value : (System.Guid)BecamePassengerId);
                    command.Parameters.Add("@binding_passenger_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BindingPassengerId;
                    command.Parameters.Add("@passenger_type_rcd",SqlDbType.NVarChar).Value = (System.String)PassengerTypeRcd;
                    command.Parameters.Add("@passenger_name",SqlDbType.NVarChar).Value = (System.String)PassengerName;
        ...
        public void Update() {
            ...
            string sql = @" update [passenger] set
                ...
                ,became_passenger_id = @became_passenger_id
                ,binding_passenger_id = @binding_passenger_id
                ,passenger_type_rcd = @passenger_type_rcd
        ...
        public static void Delete(System.Guid passengerId) {
            // create query against passenger
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
