...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of passenger_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudePassengerTypeRefData {
        ...
        public void FetchByPassengerTypeRcd(string passengerTypeRcd) {
            // create query against passenger_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 passenger_type_rcd, passenger_type_name, user_id, date_time
                            from [passenger_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@passenger_type_rcd",SqlDbType.NVarChar).Value = passengerTypeRcd;
        ...
        // parameters:
        //  passengerTypeRcd: primary key of table passenger_type_ref
        public static CrudePassengerTypeRefData GetByPassengerTypeRcd(string passengerTypeRcd) {
            // create query against passenger_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudePassengerTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against passenger_type_ref
        ...
        public static List<CrudePassengerTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudePassengerTypeRefData>();
            ...
            string sql = @" select passenger_type_rcd, passenger_type_name, user_id, date_time
                            from [passenger_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of passenger_type_ref
        ...
        public void FetchByPassengerTypeName(string passengerTypeName) {
            // create query against passenger_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 passenger_type_rcd, passenger_type_name, user_id, date_time
                            from [passenger_type_ref]
                            where passenger_type_name like '%' + @passengerTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@passengerTypeName",SqlDbType.NVarChar).Value = passengerTypeName;
        ...
        public static List<CrudePassengerTypeRefData> FetchAll() {
            var dataList = new List<CrudePassengerTypeRefData>();
        ...
        public static List<CrudePassengerTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudePassengerTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" passenger_type_rcd, passenger_type_name, user_id, date_time
                            from [passenger_type_ref]
                            order by passenger_type_name";
        ...
        public static List<CrudePassengerTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudePassengerTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [passenger_type_ref]";
        ...
        public static List<CrudePassengerTypeRefData> FetchWithFilter(string passengerTypeRcd, string passengerTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudePassengerTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(passengerTypeName)) {
                        sql += "  and passenger_type_name like '%' + @passenger_type_name + '%'";
                        command.Parameters.Add("@passenger_type_name", SqlDbType.NVarChar).Value = passengerTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by passenger_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["passenger_type_name"] != System.DBNull.Value) PassengerTypeName = (System.String) reader["passenger_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [passenger_type_ref] (passenger_type_rcd, passenger_type_name, user_id, date_time)";
            sql += "            values (@passenger_type_rcd, @passenger_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@passenger_type_name",SqlDbType.NVarChar).Value = (System.String)PassengerTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [passenger_type_ref] set
        ...
        public static void Delete(string passengerTypeRcd) {
            // create query against passenger_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [passenger_type_ref] 
                where passenger_type_rcd = @passenger_type_rcd";
