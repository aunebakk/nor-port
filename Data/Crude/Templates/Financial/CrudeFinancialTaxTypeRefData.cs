...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_tax_type_ref's columns
    ...
    public partial class CrudeFinancialTaxTypeRefData {
        ...
        // parameters:
        //  financialTaxTypeRcd: primary key of table financial_tax_type_ref
        public void FetchByFinancialTaxTypeRcd(string financialTaxTypeRcd) {
            // create query against financial_tax_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_tax_type_rcd, financial_tax_type_name, user_id, date_time
        ...
        public static CrudeFinancialTaxTypeRefData GetByFinancialTaxTypeRcd(string financialTaxTypeRcd) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_tax_type_ref
        ...
        public static List<CrudeFinancialTaxTypeRefData> FetchByUserId(System.Guid userId) {
            ...
            string sql = @" select financial_tax_type_rcd, financial_tax_type_name, user_id, date_time
                            from [financial_tax_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_tax_type_ref
        ...
        public static List<CrudeFinancialTaxTypeRefData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_tax_type_rcd, financial_tax_type_name, user_id, date_time
                            from [financial_tax_type_ref]
                            order by financial_tax_type_name";
        ...
        public static List<CrudeFinancialTaxTypeRefData> FetchWithFilter(string financialTaxTypeRcd, string financialTaxTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialTaxTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_tax_type_ref] (financial_tax_type_rcd, financial_tax_type_name, user_id, date_time)";
            sql += "            values (@financial_tax_type_rcd, @financial_tax_type_name, @user_id, @date_time)";
