...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_payment_accounting's columns
    ...
    public partial class CrudeFinancialPaymentAccountingData {
        ...
        public void FetchByFinancialPaymentAccountingId(System.Guid financialPaymentAccountingId) {
            // create query against financial_payment_accounting
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_payment_accounting_id, amount, financial_currency_id, user_id, date_time
        ...
        public static CrudeFinancialPaymentAccountingData GetByFinancialPaymentAccountingId(System.Guid financialPaymentAccountingId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_payment_accounting
        ...
        public static List<CrudeFinancialPaymentAccountingData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_payment_accounting_id, amount, financial_currency_id, user_id, date_time
                            from [financial_payment_accounting]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_payment_accounting
        ...
        public static List<CrudeFinancialPaymentAccountingData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_payment_accounting_id, amount, financial_currency_id, user_id, date_time
                            from [financial_payment_accounting]";
        ...
        public static List<CrudeFinancialPaymentAccountingData> FetchWithFilter(System.Guid financialPaymentAccountingId, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialPaymentAccountingData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_payment_accounting] (financial_payment_accounting_id, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_payment_accounting_id, @amount, @financial_currency_id, @user_id, @date_time)";
