...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_payment's columns
    ...
    public partial class CrudeFinancialPaymentData {
        ...
        public void FetchByFinancialPaymentId(System.Guid financialPaymentId) {
            // create query against financial_payment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_payment_id, financial_payment_type_rcd, financial_payment_card_id, financial_payment_cash_id, financial_payment_voucher_id, financial_payment_coupon_id, financial_payment_bank_id, financial_payment_accounting_id, user_id, date_time
        ...
        public static CrudeFinancialPaymentData GetByFinancialPaymentId(System.Guid financialPaymentId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_payment
        ...
        public static List<CrudeFinancialPaymentData> FetchByFinancialPaymentCardId(System.Guid financialPaymentCardId) {
            ...
            string sql = @" select financial_payment_id, financial_payment_type_rcd, financial_payment_card_id, financial_payment_cash_id, financial_payment_voucher_id, financial_payment_coupon_id, financial_payment_bank_id, financial_payment_accounting_id, user_id, date_time
                            from [financial_payment]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_payment
        ...
        public static List<CrudeFinancialPaymentData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_payment_id, financial_payment_type_rcd, financial_payment_card_id, financial_payment_cash_id, financial_payment_voucher_id, financial_payment_coupon_id, financial_payment_bank_id, financial_payment_accounting_id, user_id, date_time
                            from [financial_payment]";
        ...
        public static List<CrudeFinancialPaymentData> FetchWithFilter(System.Guid financialPaymentId, string financialPaymentTypeRcd, System.Guid financialPaymentCardId, System.Guid financialPaymentCashId, System.Guid financialPaymentVoucherId, System.Guid financialPaymentCouponId, System.Guid financialPaymentBankId, System.Guid financialPaymentAccountingId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialPaymentData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_payment] (financial_payment_id, financial_payment_type_rcd, financial_payment_card_id, financial_payment_cash_id, financial_payment_voucher_id, financial_payment_coupon_id, financial_payment_bank_id, financial_payment_accounting_id, user_id, date_time)";
            sql += "            values (@financial_payment_id, @financial_payment_type_rcd, @financial_payment_card_id, @financial_payment_cash_id, @financial_payment_voucher_id, @financial_payment_coupon_id, @financial_payment_bank_id, @financial_payment_accounting_id, @user_id, @date_time)";
