...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_fee's columns
    ...
    public partial class CrudeFinancialFeeData {
        ...
        public void FetchByFinancialFeeId(System.Guid financialFeeId) {
            // create query against financial_fee
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_fee_id, financial_fee_type_rcd, amount, financial_currency_id, user_id, date_time
                            from [financial_fee]
        ...
        public static CrudeFinancialFeeData GetByFinancialFeeId(System.Guid financialFeeId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_fee
        ...
        public static List<CrudeFinancialFeeData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_fee_id, financial_fee_type_rcd, amount, financial_currency_id, user_id, date_time
                            from [financial_fee]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_fee
        ...
        public static List<CrudeFinancialFeeData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_fee_id, financial_fee_type_rcd, amount, financial_currency_id, user_id, date_time
                            from [financial_fee]";
        ...
        public static List<CrudeFinancialFeeData> FetchWithFilter(System.Guid financialFeeId, string financialFeeTypeRcd, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialFeeData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_fee] (financial_fee_id, financial_fee_type_rcd, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_fee_id, @financial_fee_type_rcd, @amount, @financial_currency_id, @user_id, @date_time)";
