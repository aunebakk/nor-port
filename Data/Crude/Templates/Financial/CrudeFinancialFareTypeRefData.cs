...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_fare_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFinancialFareTypeRefData {
        
        public string FinancialFareTypeRcd { get; set; }
        
        public string FinancialFareTypeName { get; set; }
        ...
        public void FetchByFinancialFareTypeRcd(string financialFareTypeRcd) {
            // create query against financial_fare_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_fare_type_rcd, financial_fare_type_name, user_id, date_time
                            from [financial_fare_type_ref]
                            where financial_fare_type_rcd = @financial_fare_type_rcd
                            order by financial_fare_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@financial_fare_type_rcd",SqlDbType.NVarChar).Value = financialFareTypeRcd;
        ...
        // parameters:
        //  financialFareTypeRcd: primary key of table financial_fare_type_ref
        public static CrudeFinancialFareTypeRefData GetByFinancialFareTypeRcd(string financialFareTypeRcd) {
            // create query against financial_fare_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFinancialFareTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_fare_type_ref
        ...
        public static List<CrudeFinancialFareTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFinancialFareTypeRefData>();
            ...
            string sql = @" select financial_fare_type_rcd, financial_fare_type_name, user_id, date_time
                            from [financial_fare_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_fare_type_ref
        ...
        public void FetchByFinancialFareTypeName(string financialFareTypeName) {
            // create query against financial_fare_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 financial_fare_type_rcd, financial_fare_type_name, user_id, date_time
                            from [financial_fare_type_ref]
                            where financial_fare_type_name like '%' + @financialFareTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@financialFareTypeName",SqlDbType.NVarChar).Value = financialFareTypeName;
        ...
        public static List<CrudeFinancialFareTypeRefData> FetchAll() {
            var dataList = new List<CrudeFinancialFareTypeRefData>();
        ...
        public static List<CrudeFinancialFareTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFinancialFareTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" financial_fare_type_rcd, financial_fare_type_name, user_id, date_time
                            from [financial_fare_type_ref]
                            order by financial_fare_type_name";
        ...
        public static List<CrudeFinancialFareTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFinancialFareTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [financial_fare_type_ref]";
        ...
        public static List<CrudeFinancialFareTypeRefData> FetchWithFilter(string financialFareTypeRcd, string financialFareTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialFareTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(financialFareTypeName)) {
                        sql += "  and financial_fare_type_name like '%' + @financial_fare_type_name + '%'";
                        command.Parameters.Add("@financial_fare_type_name", SqlDbType.NVarChar).Value = financialFareTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by financial_fare_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["financial_fare_type_name"] != System.DBNull.Value) FinancialFareTypeName = (System.String) reader["financial_fare_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_fare_type_ref] (financial_fare_type_rcd, financial_fare_type_name, user_id, date_time)";
            sql += "            values (@financial_fare_type_rcd, @financial_fare_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_fare_type_name",SqlDbType.NVarChar).Value = (System.String)FinancialFareTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [financial_fare_type_ref] set
                 financial_fare_type_rcd = @financial_fare_type_rcd
                ,financial_fare_type_name = @financial_fare_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where financial_fare_type_rcd = @financial_fare_type_rcd";
        ...
        public static void Delete(string financialFareTypeRcd) {
            // create query against financial_fare_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [financial_fare_type_ref] 
                where financial_fare_type_rcd = @financial_fare_type_rcd";
