...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_fare's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFinancialFareData {
        ...
        public void FetchByFinancialFareId(System.Guid financialFareId) {
            // create query against financial_fare
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_fare_id, financial_fare_type_rcd, departure_airport_id, arrival_airport_id, valid_from_flight_date_time, valid_until_flight_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_fare]
        ...
        // parameters:
        //  financialFareId: primary key of table financial_fare
        public static CrudeFinancialFareData GetByFinancialFareId(System.Guid financialFareId) {
            // create query against financial_fare
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFinancialFareData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_fare
        ...
        public static List<CrudeFinancialFareData> FetchByDepartureAirportId(System.Guid departureAirportId) {
            var dataList = new List<CrudeFinancialFareData>();
            ...
            string sql = @" select financial_fare_id, financial_fare_type_rcd, departure_airport_id, arrival_airport_id, valid_from_flight_date_time, valid_until_flight_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_fare]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_fare
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialFareData> FetchByArrivalAirportId(System.Guid arrivalAirportId) {
            var dataList = new List<CrudeFinancialFareData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialFareData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeFinancialFareData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialFareData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFinancialFareData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialFareData> FetchByFinancialFareTypeRcd(string financialFareTypeRcd) {
            var dataList = new List<CrudeFinancialFareData>();
            ...
            string sql = @" select financial_fare_id, financial_fare_type_rcd, departure_airport_id, arrival_airport_id, valid_from_flight_date_time, valid_until_flight_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_fare]
                            where financial_fare_type_rcd = @financial_fare_type_rcd
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@financial_fare_type_rcd", SqlDbType.NVarChar).Value = financialFareTypeRcd.Replace("'","''");
        ...
        public static List<CrudeFinancialFareData> FetchAll() {
            var dataList = new List<CrudeFinancialFareData>();
        ...
        public static List<CrudeFinancialFareData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFinancialFareData>();
            ...
            string sql = @" select top " + limit.ToString() + @" financial_fare_id, financial_fare_type_rcd, departure_airport_id, arrival_airport_id, valid_from_flight_date_time, valid_until_flight_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_fare]";
        ...
        public static List<CrudeFinancialFareData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFinancialFareData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [financial_fare]";
        ...
        public static List<CrudeFinancialFareData> FetchWithFilter(System.Guid financialFareId, string financialFareTypeRcd, System.Guid departureAirportId, System.Guid arrivalAirportId, System.DateTime validFromFlightDateTime, System.DateTime validUntilFlightDateTime, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialFareData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(financialFareTypeRcd)) {
                        sql += "  and financial_fare_type_rcd like '%' + @financial_fare_type_rcd + '%'";
                        command.Parameters.Add("@financial_fare_type_rcd", SqlDbType.NVarChar).Value = financialFareTypeRcd.Replace("'","''");
                    }
                    ...
                    if (validFromFlightDateTime != DateTime.MinValue) {
                        sql += "  and valid_from_flight_date_time = @valid_from_flight_date_time";
                        command.Parameters.Add("@valid_from_flight_date_time", SqlDbType.DateTime).Value = validFromFlightDateTime;
                    }
                    if (validUntilFlightDateTime != DateTime.MinValue) {
                        sql += "  and valid_until_flight_date_time = @valid_until_flight_date_time";
                        command.Parameters.Add("@valid_until_flight_date_time", SqlDbType.DateTime).Value = validUntilFlightDateTime;
                    }
                    if (amount != 0) {
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["financial_fare_type_rcd"] != System.DBNull.Value) FinancialFareTypeRcd = (System.String) reader["financial_fare_type_rcd"];
            ...
            if (reader["valid_from_flight_date_time"] != System.DBNull.Value) ValidFromFlightDateTime = (System.DateTime) reader["valid_from_flight_date_time"];
            if (reader["valid_until_flight_date_time"] != System.DBNull.Value) ValidUntilFlightDateTime = (System.DateTime) reader["valid_until_flight_date_time"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_fare] (financial_fare_id, financial_fare_type_rcd, departure_airport_id, arrival_airport_id, valid_from_flight_date_time, valid_until_flight_date_time, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_fare_id, @financial_fare_type_rcd, @departure_airport_id, @arrival_airport_id, @valid_from_flight_date_time, @valid_until_flight_date_time, @amount, @financial_currency_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_fare_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FinancialFareId;
                    command.Parameters.Add("@financial_fare_type_rcd",SqlDbType.NVarChar).Value = (System.String)FinancialFareTypeRcd;
                    ...
                    command.Parameters.Add("@valid_from_flight_date_time",SqlDbType.DateTime).Value = (System.DateTime)ValidFromFlightDateTime;
                    command.Parameters.Add("@valid_until_flight_date_time",SqlDbType.DateTime).Value = (System.DateTime)ValidUntilFlightDateTime;
        ...
        public void Update() {
            ...
            string sql = @" update [financial_fare] set
                 financial_fare_id = @financial_fare_id
                ,financial_fare_type_rcd = @financial_fare_type_rcd
                ,departure_airport_id = @departure_airport_id
                ,arrival_airport_id = @arrival_airport_id
                ,valid_from_flight_date_time = @valid_from_flight_date_time
                ,valid_until_flight_date_time = @valid_until_flight_date_time
                ,amount = @amount
        ...
        public static void Delete(System.Guid financialFareId) {
            // create query against financial_fare
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [financial_fare] 
                where financial_fare_id = @financial_fare_id";
