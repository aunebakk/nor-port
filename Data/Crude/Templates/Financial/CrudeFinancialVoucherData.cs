...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_voucher's columns
    ...
    public partial class CrudeFinancialVoucherData {
        ...
        public void FetchByFinancialVoucherId(System.Guid financialVoucherId) {
            // create query against financial_voucher
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_voucher_id, financial_voucher_type_rcd, voucher_number, voucher_description, value_amount, financial_currency_id, valid_from_date_time, valid_until_date_time, user_id, date_time
        ...
        public static CrudeFinancialVoucherData GetByFinancialVoucherId(System.Guid financialVoucherId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_voucher
        ...
        public static List<CrudeFinancialVoucherData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_voucher_id, financial_voucher_type_rcd, voucher_number, voucher_description, value_amount, financial_currency_id, valid_from_date_time, valid_until_date_time, user_id, date_time
                            from [financial_voucher]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_voucher
        ...
        public static List<CrudeFinancialVoucherData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_voucher_id, financial_voucher_type_rcd, voucher_number, voucher_description, value_amount, financial_currency_id, valid_from_date_time, valid_until_date_time, user_id, date_time
                            from [financial_voucher]";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_voucher] (financial_voucher_id, financial_voucher_type_rcd, voucher_number, voucher_description, value_amount, financial_currency_id, valid_from_date_time, valid_until_date_time, user_id, date_time)";
            sql += "            values (@financial_voucher_id, @financial_voucher_type_rcd, @voucher_number, @voucher_description, @value_amount, @financial_currency_id, @valid_from_date_time, @valid_until_date_time, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@value_amount",SqlDbType.Decimal).Value = (ValueAmount == 0 ? (object)DBNull.Value : (System.Decimal)ValueAmount);
