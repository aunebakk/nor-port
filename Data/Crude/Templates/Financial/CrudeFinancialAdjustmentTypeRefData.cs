...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_adjustment_type_ref's columns
    ...
    public partial class CrudeFinancialAdjustmentTypeRefData {
        ...
        // parameters:
        //  financialAdjustmentTypeRcd: primary key of table financial_adjustment_type_ref
        public void FetchByFinancialAdjustmentTypeRcd(string financialAdjustmentTypeRcd) {
            // create query against financial_adjustment_type_ref
        ...
        public static CrudeFinancialAdjustmentTypeRefData GetByFinancialAdjustmentTypeRcd(string financialAdjustmentTypeRcd) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_adjustment_type_ref
        ...
        public static List<CrudeFinancialAdjustmentTypeRefData> FetchByUserId(System.Guid userId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_adjustment_type_ref
