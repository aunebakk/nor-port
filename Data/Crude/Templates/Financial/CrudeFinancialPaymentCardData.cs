...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_payment_card's columns
    ...
    public partial class CrudeFinancialPaymentCardData {
        ...
        public void FetchByFinancialPaymentCardId(System.Guid financialPaymentCardId) {
            // create query against financial_payment_card
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_payment_card_id, financial_card_type_rcd, name_on_card, card_number, card_verification_value, address_verification_code, issued_year, issued_month, expiry_year, expiry_month, amount, financial_currency_id, user_id, date_time
        ...
        public static CrudeFinancialPaymentCardData GetByFinancialPaymentCardId(System.Guid financialPaymentCardId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_payment_card
        ...
        public static List<CrudeFinancialPaymentCardData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_payment_card_id, financial_card_type_rcd, name_on_card, card_number, card_verification_value, address_verification_code, issued_year, issued_month, expiry_year, expiry_month, amount, financial_currency_id, user_id, date_time
                            from [financial_payment_card]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_payment_card
        ...
        public static List<CrudeFinancialPaymentCardData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_payment_card_id, financial_card_type_rcd, name_on_card, card_number, card_verification_value, address_verification_code, issued_year, issued_month, expiry_year, expiry_month, amount, financial_currency_id, user_id, date_time
                            from [financial_payment_card]
                            order by address_verification_code";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_payment_card] (financial_payment_card_id, financial_card_type_rcd, name_on_card, card_number, card_verification_value, address_verification_code, issued_year, issued_month, expiry_year, expiry_month, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_payment_card_id, @financial_card_type_rcd, @name_on_card, @card_number, @card_verification_value, @address_verification_code, @issued_year, @issued_month, @expiry_year, @expiry_month, @amount, @financial_currency_id, @user_id, @date_time)";
