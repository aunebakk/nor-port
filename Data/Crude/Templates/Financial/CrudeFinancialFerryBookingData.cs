...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_ferry_booking's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeFinancialFerryBookingData {
        ...
        public void FetchByFinancialFerryBookingId(System.Guid financialFerryBookingId) {
            // create query against financial_ferry_booking
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_ferry_booking_id, service_ferry_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_ferry_booking]
        ...
        // parameters:
        //  financialFerryBookingId: primary key of table financial_ferry_booking
        public static CrudeFinancialFerryBookingData GetByFinancialFerryBookingId(System.Guid financialFerryBookingId) {
            // create query against financial_ferry_booking
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFinancialFerryBookingData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_ferry_booking
        ...
        public static List<CrudeFinancialFerryBookingData> FetchByServiceFerryId(System.Guid serviceFerryId) {
            var dataList = new List<CrudeFinancialFerryBookingData>();
            ...
            string sql = @" select financial_ferry_booking_id, service_ferry_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_ferry_booking]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_ferry_booking
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialFerryBookingData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeFinancialFerryBookingData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialFerryBookingData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFinancialFerryBookingData>();
        ...
        public static List<CrudeFinancialFerryBookingData> FetchAll() {
            var dataList = new List<CrudeFinancialFerryBookingData>();
        ...
        public static List<CrudeFinancialFerryBookingData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFinancialFerryBookingData>();
            ...
            string sql = @" select top " + limit.ToString() + @" financial_ferry_booking_id, service_ferry_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_ferry_booking]";
        ...
        public static List<CrudeFinancialFerryBookingData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFinancialFerryBookingData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [financial_ferry_booking]";
        ...
        public static List<CrudeFinancialFerryBookingData> FetchWithFilter(System.Guid financialFerryBookingId, System.Guid serviceFerryId, System.DateTime fromDateTime, System.DateTime untilDateTime, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialFerryBookingData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            if (FinancialFerryBookingId == Guid.Empty)
                FinancialFerryBookingId = Guid.NewGuid();
            ...
            string sql = "insert into [financial_ferry_booking] (financial_ferry_booking_id, service_ferry_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_ferry_booking_id, @service_ferry_id, @from_date_time, @until_date_time, @amount, @financial_currency_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_ferry_booking_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FinancialFerryBookingId;
                    command.Parameters.Add("@service_ferry_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServiceFerryId;
        ...
        public void Update() {
            ...
            string sql = @" update [financial_ferry_booking] set
        ...
        public static void Delete(System.Guid financialFerryBookingId) {
            // create query against financial_ferry_booking
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [financial_ferry_booking] 
                where financial_ferry_booking_id = @financial_ferry_booking_id";
