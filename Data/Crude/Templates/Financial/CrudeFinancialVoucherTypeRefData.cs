...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of financial_voucher_type_ref's columns
    ...
    public partial class CrudeFinancialVoucherTypeRefData {
        ...
        // parameters:
        //  financialVoucherTypeRcd: primary key of table financial_voucher_type_ref
        public void FetchByFinancialVoucherTypeRcd(string financialVoucherTypeRcd) {
            // create query against financial_voucher_type_ref
        ...
        public static CrudeFinancialVoucherTypeRefData GetByFinancialVoucherTypeRcd(string financialVoucherTypeRcd) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_voucher_type_ref
        ...
        public static List<CrudeFinancialVoucherTypeRefData> FetchByUserId(System.Guid userId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_voucher_type_ref
