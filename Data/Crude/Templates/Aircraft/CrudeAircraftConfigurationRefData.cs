...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of aircraft_configuration_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAircraftConfigurationRefData {
        ...
        public void FetchByAircraftConfigurationRcd(string aircraftConfigurationRcd) {
            // create query against aircraft_configuration_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_configuration_rcd, aircraft_configuration_name, description, active_flag, sort_order, user_id, date_time
                            from [aircraft_configuration_ref]
                            where aircraft_configuration_rcd = @aircraft_configuration_rcd
                            order by aircraft_configuration_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_configuration_rcd",SqlDbType.NVarChar).Value = aircraftConfigurationRcd;
        ...
        // parameters:
        //  aircraftConfigurationRcd: primary key of table aircraft_configuration_ref
        public static CrudeAircraftConfigurationRefData GetByAircraftConfigurationRcd(string aircraftConfigurationRcd) {
            // create query against aircraft_configuration_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftConfigurationRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_configuration_ref
        ...
        public static List<CrudeAircraftConfigurationRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftConfigurationRefData>();
            ...
            string sql = @" select aircraft_configuration_rcd, aircraft_configuration_name, description, active_flag, sort_order, user_id, date_time
                            from [aircraft_configuration_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_configuration_ref
        ...
        public void FetchByAircraftConfigurationName(string aircraftConfigurationName) {
            // create query against aircraft_configuration_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 aircraft_configuration_rcd, aircraft_configuration_name, description, active_flag, sort_order, user_id, date_time
                            from [aircraft_configuration_ref]
                            where aircraft_configuration_name like '%' + @aircraftConfigurationName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@aircraftConfigurationName",SqlDbType.NVarChar).Value = aircraftConfigurationName;
        ...
        public static List<CrudeAircraftConfigurationRefData> FetchAll() {
            var dataList = new List<CrudeAircraftConfigurationRefData>();
        ...
        public static List<CrudeAircraftConfigurationRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftConfigurationRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_configuration_rcd, aircraft_configuration_name, description, active_flag, sort_order, user_id, date_time
                            from [aircraft_configuration_ref]
                            order by aircraft_configuration_name";
        ...
        public static List<CrudeAircraftConfigurationRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftConfigurationRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_configuration_ref]";
        ...
        public static List<CrudeAircraftConfigurationRefData> FetchWithFilter(string aircraftConfigurationRcd, string aircraftConfigurationName, string description, bool activeFlag, int sortOrder, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftConfigurationRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(aircraftConfigurationName)) {
                        sql += "  and aircraft_configuration_name like '%' + @aircraft_configuration_name + '%'";
                        command.Parameters.Add("@aircraft_configuration_name", SqlDbType.NVarChar).Value = aircraftConfigurationName.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(description)) {
                        sql += "  and description like '%' + @description + '%'";
                        command.Parameters.Add("@description", SqlDbType.NVarChar).Value = description.Replace("'","''");
                    }
                    if (activeFlag != false) {
                    ...
                    sql += " order by aircraft_configuration_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["aircraft_configuration_name"] != System.DBNull.Value) AircraftConfigurationName = (System.String) reader["aircraft_configuration_name"];
            if (reader["description"] != System.DBNull.Value) Description = (System.String) reader["description"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [aircraft_configuration_ref] (aircraft_configuration_rcd, aircraft_configuration_name, description, active_flag, sort_order, user_id, date_time)";
            sql += "            values (@aircraft_configuration_rcd, @aircraft_configuration_name, @description, @active_flag, @sort_order, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_configuration_name",SqlDbType.NVarChar).Value = (System.String)AircraftConfigurationName;
                    command.Parameters.Add("@description",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(Description)) ? (object)DBNull.Value : (System.String)Description;
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_configuration_ref] set
                 aircraft_configuration_rcd = @aircraft_configuration_rcd
                ,aircraft_configuration_name = @aircraft_configuration_name
        ...
        public static void Delete(string aircraftConfigurationRcd) {
            // create query against aircraft_configuration_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_configuration_ref] 
                where aircraft_configuration_rcd = @aircraft_configuration_rcd";
