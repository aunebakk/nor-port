...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of aircraft_document_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAircraftDocumentTypeRefData {
        ...
        public void FetchByAircraftDocumentTypeRcd(string aircraftDocumentTypeRcd) {
            // create query against aircraft_document_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_document_type_rcd, aircraft_document_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_document_type_ref]
                            where aircraft_document_type_rcd = @aircraft_document_type_rcd
                            order by aircraft_document_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_document_type_rcd",SqlDbType.NVarChar).Value = aircraftDocumentTypeRcd;
        ...
        // parameters:
        //  aircraftDocumentTypeRcd: primary key of table aircraft_document_type_ref
        public static CrudeAircraftDocumentTypeRefData GetByAircraftDocumentTypeRcd(string aircraftDocumentTypeRcd) {
            // create query against aircraft_document_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftDocumentTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_document_type_ref
        ...
        public static List<CrudeAircraftDocumentTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftDocumentTypeRefData>();
            ...
            string sql = @" select aircraft_document_type_rcd, aircraft_document_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_document_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_document_type_ref
        ...
        public void FetchByAircraftDocumentTypeName(string aircraftDocumentTypeName) {
            // create query against aircraft_document_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 aircraft_document_type_rcd, aircraft_document_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_document_type_ref]
                            where aircraft_document_type_name like '%' + @aircraftDocumentTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@aircraftDocumentTypeName",SqlDbType.NVarChar).Value = aircraftDocumentTypeName;
        ...
        public static List<CrudeAircraftDocumentTypeRefData> FetchAll() {
            var dataList = new List<CrudeAircraftDocumentTypeRefData>();
        ...
        public static List<CrudeAircraftDocumentTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftDocumentTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_document_type_rcd, aircraft_document_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_document_type_ref]
                            order by aircraft_document_type_name";
        ...
        public static List<CrudeAircraftDocumentTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftDocumentTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_document_type_ref]";
        ...
        public static List<CrudeAircraftDocumentTypeRefData> FetchWithFilter(string aircraftDocumentTypeRcd, string aircraftDocumentTypeName, bool activeFlag, int sortOrder, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftDocumentTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(aircraftDocumentTypeRcd)) {
                        sql += "  and aircraft_document_type_rcd like '%' + @aircraft_document_type_rcd + '%'";
                        command.Parameters.Add("@aircraft_document_type_rcd", SqlDbType.NVarChar).Value = aircraftDocumentTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(aircraftDocumentTypeName)) {
                        sql += "  and aircraft_document_type_name like '%' + @aircraft_document_type_name + '%'";
                        command.Parameters.Add("@aircraft_document_type_name", SqlDbType.NVarChar).Value = aircraftDocumentTypeName.Replace("'","''");
                    }
                    if (activeFlag != false) {
                    ...
                    sql += " order by aircraft_document_type_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["aircraft_document_type_rcd"] != System.DBNull.Value) AircraftDocumentTypeRcd = (System.String) reader["aircraft_document_type_rcd"];
            if (reader["aircraft_document_type_name"] != System.DBNull.Value) AircraftDocumentTypeName = (System.String) reader["aircraft_document_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [aircraft_document_type_ref] (aircraft_document_type_rcd, aircraft_document_type_name, active_flag, sort_order, user_id, date_time)";
            sql += "            values (@aircraft_document_type_rcd, @aircraft_document_type_name, @active_flag, @sort_order, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_document_type_rcd",SqlDbType.NVarChar).Value = (System.String)AircraftDocumentTypeRcd;
                    command.Parameters.Add("@aircraft_document_type_name",SqlDbType.NVarChar).Value = (System.String)AircraftDocumentTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_document_type_ref] set
                 aircraft_document_type_rcd = @aircraft_document_type_rcd
                ,aircraft_document_type_name = @aircraft_document_type_name
        ...
        public static void Delete(string aircraftDocumentTypeRcd) {
            // create query against aircraft_document_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_document_type_ref] 
                where aircraft_document_type_rcd = @aircraft_document_type_rcd";
