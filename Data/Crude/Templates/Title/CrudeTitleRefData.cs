...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of title_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeTitleRefData {
        ...
        public void FetchByTitleRcd(string titleRcd) {
            // create query against title_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 title_rcd, title_name, user_id, date_time
                            from [title_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@title_rcd",SqlDbType.NVarChar).Value = titleRcd;
        ...
        // parameters:
        //  titleRcd: primary key of table title_ref
        public static CrudeTitleRefData GetByTitleRcd(string titleRcd) {
            // create query against title_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against title_ref
        ...
        public static List<CrudeTitleRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeTitleRefData>();
            ...
            string sql = @" select title_rcd, title_name, user_id, date_time
                            from [title_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of title_ref
        ...
        public void FetchByTitleName(string titleName) {
            // create query against title_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@titleName",SqlDbType.NVarChar).Value = titleName;
        ...
        public static List<CrudeTitleRefData> FetchAll() {
            var dataList = new List<CrudeTitleRefData>();
        ...
        public static List<CrudeTitleRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeTitleRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" title_rcd, title_name, user_id, date_time
                            from [title_ref]
                            order by title_name";
        ...
        public static List<CrudeTitleRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeTitleRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [title_ref]";
        ...
        public static List<CrudeTitleRefData> FetchWithFilter(string titleRcd, string titleName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeTitleRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(titleName)) {
                        sql += "  and title_name like '%' + @title_name + '%'";
                        command.Parameters.Add("@title_name", SqlDbType.NVarChar).Value = titleName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["title_name"] != System.DBNull.Value) TitleName = (System.String) reader["title_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [title_ref] (title_rcd, title_name, user_id, date_time)";
            sql += "            values (@title_rcd, @title_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@title_rcd",SqlDbType.NVarChar).Value = (System.String)TitleRcd;
                    command.Parameters.Add("@title_name",SqlDbType.NVarChar).Value = (System.String)TitleName;
        ...
        public void Update() {
            ...
            string sql = @" update [title_ref] set
                 title_rcd = @title_rcd
        ...
        public static void Delete(string titleRcd) {
            // create query against title_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
