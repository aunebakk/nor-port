...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of service_hotel_link's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeServiceHotelLinkData {
        ...
        public void FetchByServiceHotelLinkId(System.Guid serviceHotelLinkId) {
            // create query against service_hotel_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_hotel_link_id, service_hotel_id, link_type_rcd, link, user_id, date_time
                            from [service_hotel_link]
                            where service_hotel_link_id = @service_hotel_link_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@service_hotel_link_id",SqlDbType.UniqueIdentifier).Value = serviceHotelLinkId;
        ...
        // parameters:
        //  serviceHotelLinkId: primary key of table service_hotel_link
        public static CrudeServiceHotelLinkData GetByServiceHotelLinkId(System.Guid serviceHotelLinkId) {
            // create query against service_hotel_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceHotelLinkData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_hotel_link
        ...
        public static List<CrudeServiceHotelLinkData> FetchByServiceHotelId(System.Guid serviceHotelId) {
            var dataList = new List<CrudeServiceHotelLinkData>();
            ...
            string sql = @" select service_hotel_link_id, service_hotel_id, link_type_rcd, link, user_id, date_time
                            from [service_hotel_link]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_hotel_link
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceHotelLinkData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceHotelLinkData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceHotelLinkData> FetchByLinkTypeRcd(string linkTypeRcd) {
            var dataList = new List<CrudeServiceHotelLinkData>();
        ...
        public static List<CrudeServiceHotelLinkData> FetchAll() {
            var dataList = new List<CrudeServiceHotelLinkData>();
        ...
        public static List<CrudeServiceHotelLinkData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceHotelLinkData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_hotel_link_id, service_hotel_id, link_type_rcd, link, user_id, date_time
                            from [service_hotel_link]";
        ...
        public static List<CrudeServiceHotelLinkData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceHotelLinkData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_hotel_link]";
        ...
        public static List<CrudeServiceHotelLinkData> FetchWithFilter(System.Guid serviceHotelLinkId, System.Guid serviceHotelId, string linkTypeRcd, string link, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceHotelLinkData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (serviceHotelLinkId != Guid.Empty) {
                        sql += "  and service_hotel_link_id = @service_hotel_link_id";
                        command.Parameters.Add("@service_hotel_link_id", SqlDbType.UniqueIdentifier).Value = serviceHotelLinkId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["service_hotel_link_id"] != System.DBNull.Value) ServiceHotelLinkId = (System.Guid) reader["service_hotel_link_id"];
        ...
        public void Insert() {
            ...
            if (ServiceHotelLinkId == Guid.Empty)
                ServiceHotelLinkId = Guid.NewGuid();
            ...
            string sql = "insert into [service_hotel_link] (service_hotel_link_id, service_hotel_id, link_type_rcd, link, user_id, date_time)";
            sql += "            values (@service_hotel_link_id, @service_hotel_id, @link_type_rcd, @link, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_hotel_link_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServiceHotelLinkId;
        ...
        public void Update() {
            ...
            string sql = @" update [service_hotel_link] set
                 service_hotel_link_id = @service_hotel_link_id
        ...
        public static void Delete(System.Guid serviceHotelLinkId) {
            // create query against service_hotel_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_hotel_link] 
                where service_hotel_link_id = @service_hotel_link_id";
