...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of service_package's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeServicePackageData {
        ...
        public void FetchByServicePackageId(System.Guid servicePackageId) {
            // create query against service_package
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_package_id, service_package_name, service_hotel_id, service_special_service_request_id, service_car_rental_id, departure_airport_id, arrival_airport_id, stay_duration_days, user_id, date_time
                            from [service_package]
                            where service_package_id = @service_package_id
                            order by service_package_name";
        ...
        // parameters:
        //  servicePackageId: primary key of table service_package
        public static CrudeServicePackageData GetByServicePackageId(System.Guid servicePackageId) {
            // create query against service_package
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServicePackageData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_package
        ...
        public static List<CrudeServicePackageData> FetchByServiceHotelId(System.Guid serviceHotelId) {
            var dataList = new List<CrudeServicePackageData>();
            ...
            string sql = @" select service_package_id, service_package_name, service_hotel_id, service_special_service_request_id, service_car_rental_id, departure_airport_id, arrival_airport_id, stay_duration_days, user_id, date_time
                            from [service_package]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_package
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackageData> FetchByServiceSpecialServiceRequestId(System.Guid serviceSpecialServiceRequestId) {
            var dataList = new List<CrudeServicePackageData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackageData> FetchByServiceCarRentalId(System.Guid serviceCarRentalId) {
            var dataList = new List<CrudeServicePackageData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackageData> FetchByDepartureAirportId(System.Guid departureAirportId) {
            var dataList = new List<CrudeServicePackageData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackageData> FetchByArrivalAirportId(System.Guid arrivalAirportId) {
            var dataList = new List<CrudeServicePackageData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackageData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServicePackageData>();
        ...
        public void FetchByServicePackageName(string servicePackageName) {
            // create query against service_package
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 service_package_id, service_package_name, service_hotel_id, service_special_service_request_id, service_car_rental_id, departure_airport_id, arrival_airport_id, stay_duration_days, user_id, date_time
                            from [service_package]
                            where service_package_name like '%' + @servicePackageName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@servicePackageName",SqlDbType.NVarChar).Value = servicePackageName;
        ...
        public static List<CrudeServicePackageData> FetchAll() {
            var dataList = new List<CrudeServicePackageData>();
        ...
        public static List<CrudeServicePackageData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServicePackageData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_package_id, service_package_name, service_hotel_id, service_special_service_request_id, service_car_rental_id, departure_airport_id, arrival_airport_id, stay_duration_days, user_id, date_time
                            from [service_package]
                            order by service_package_name";
        ...
        public static List<CrudeServicePackageData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServicePackageData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_package]";
        ...
        public static List<CrudeServicePackageData> FetchWithFilter(System.Guid servicePackageId, string servicePackageName, System.Guid serviceHotelId, System.Guid serviceSpecialServiceRequestId, System.Guid serviceCarRentalId, System.Guid departureAirportId, System.Guid arrivalAirportId, int stayDurationDays, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServicePackageData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (servicePackageId != Guid.Empty) {
                        sql += "  and service_package_id = @service_package_id";
                        command.Parameters.Add("@service_package_id", SqlDbType.UniqueIdentifier).Value = servicePackageId;
                    }
                    if (!string.IsNullOrEmpty(servicePackageName)) {
                        sql += "  and service_package_name like '%' + @service_package_name + '%'";
                        command.Parameters.Add("@service_package_name", SqlDbType.NVarChar).Value = servicePackageName.Replace("'","''");
                    }
                    ...
                    if (stayDurationDays != 0) {
                        sql += "  and stay_duration_days = @stay_duration_days";
                        command.Parameters.Add("@stay_duration_days", SqlDbType.Int).Value = stayDurationDays;
                    }
                    ...
                    sql += " order by service_package_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["service_package_id"] != System.DBNull.Value) ServicePackageId = (System.Guid) reader["service_package_id"];
            if (reader["service_package_name"] != System.DBNull.Value) ServicePackageName = (System.String) reader["service_package_name"];
            ...
            if (reader["stay_duration_days"] != System.DBNull.Value) StayDurationDays = (System.Int32) reader["stay_duration_days"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [service_package] (service_package_id, service_package_name, service_hotel_id, service_special_service_request_id, service_car_rental_id, departure_airport_id, arrival_airport_id, stay_duration_days, user_id, date_time)";
            sql += "            values (@service_package_id, @service_package_name, @service_hotel_id, @service_special_service_request_id, @service_car_rental_id, @departure_airport_id, @arrival_airport_id, @stay_duration_days, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_package_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServicePackageId;
                    command.Parameters.Add("@service_package_name",SqlDbType.NVarChar).Value = (System.String)ServicePackageName;
                    ...
                    command.Parameters.Add("@stay_duration_days",SqlDbType.Int).Value = (StayDurationDays == 0 ? (object)DBNull.Value : (System.Int32)StayDurationDays);
        ...
        public void Update() {
            ...
            string sql = @" update [service_package] set
        ...
        public static void Delete(System.Guid servicePackageId) {
            // create query against service_package
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_package] 
                where service_package_id = @service_package_id";
