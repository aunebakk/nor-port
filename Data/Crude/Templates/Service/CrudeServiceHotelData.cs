...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of service_hotel's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeServiceHotelData {
        ...
        public void FetchByServiceHotelId(System.Guid serviceHotelId) {
            // create query against service_hotel
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_hotel_id, hotel_name, day_price_amount, financial_currency_id, address_id, product_id, user_id, date_time
                            from [service_hotel]
        ...
        // parameters:
        //  serviceHotelId: primary key of table service_hotel
        public static CrudeServiceHotelData GetByServiceHotelId(System.Guid serviceHotelId) {
            // create query against service_hotel
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceHotelData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_hotel
        ...
        public static List<CrudeServiceHotelData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeServiceHotelData>();
            ...
            string sql = @" select service_hotel_id, hotel_name, day_price_amount, financial_currency_id, address_id, product_id, user_id, date_time
                            from [service_hotel]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_hotel
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceHotelData> FetchByAddressId(System.Guid addressId) {
            var dataList = new List<CrudeServiceHotelData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceHotelData> FetchByProductId(System.Guid productId) {
            var dataList = new List<CrudeServiceHotelData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceHotelData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceHotelData>();
        ...
        public void FetchByHotelName(string hotelName) {
            // create query against service_hotel
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@hotelName",SqlDbType.NVarChar).Value = hotelName;
        ...
        public static List<CrudeServiceHotelData> FetchAll() {
            var dataList = new List<CrudeServiceHotelData>();
        ...
        public static List<CrudeServiceHotelData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceHotelData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_hotel_id, hotel_name, day_price_amount, financial_currency_id, address_id, product_id, user_id, date_time
                            from [service_hotel]
                            order by hotel_name";
        ...
        public static List<CrudeServiceHotelData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceHotelData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_hotel]";
        ...
        public static List<CrudeServiceHotelData> FetchWithFilter(System.Guid serviceHotelId, string hotelName, decimal dayPriceAmount, System.Guid financialCurrencyId, System.Guid addressId, System.Guid productId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceHotelData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(hotelName)) {
                        ...
                        command.Parameters.Add("@hotel_name", SqlDbType.NVarChar).Value = hotelName.Replace("'","''");
                    }
                    if (dayPriceAmount != 0) {
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["hotel_name"] != System.DBNull.Value) HotelName = (System.String) reader["hotel_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [service_hotel] (service_hotel_id, hotel_name, day_price_amount, financial_currency_id, address_id, product_id, user_id, date_time)";
            sql += "            values (@service_hotel_id, @hotel_name, @day_price_amount, @financial_currency_id, @address_id, @product_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@hotel_name",SqlDbType.NVarChar).Value = (System.String)HotelName;
        ...
        public void Update() {
            ...
            string sql = @" update [service_hotel] set
        ...
        public static void Delete(System.Guid serviceHotelId) {
            // create query against service_hotel
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_hotel] 
                where service_hotel_id = @service_hotel_id";
