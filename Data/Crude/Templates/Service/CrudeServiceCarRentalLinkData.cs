...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of service_car_rental_link's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeServiceCarRentalLinkData {
        ...
        public void FetchByServiceCarRentalLinkId(System.Guid serviceCarRentalLinkId) {
            // create query against service_car_rental_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_car_rental_link_id, service_car_rental_id, link_type_rcd, user_id, date_time
                            from [service_car_rental_link]
                            where service_car_rental_link_id = @service_car_rental_link_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@service_car_rental_link_id",SqlDbType.UniqueIdentifier).Value = serviceCarRentalLinkId;
        ...
        // parameters:
        //  serviceCarRentalLinkId: primary key of table service_car_rental_link
        public static CrudeServiceCarRentalLinkData GetByServiceCarRentalLinkId(System.Guid serviceCarRentalLinkId) {
            // create query against service_car_rental_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceCarRentalLinkData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_car_rental_link
        ...
        public static List<CrudeServiceCarRentalLinkData> FetchByServiceCarRentalId(System.Guid serviceCarRentalId) {
            var dataList = new List<CrudeServiceCarRentalLinkData>();
            ...
            string sql = @" select service_car_rental_link_id, service_car_rental_id, link_type_rcd, user_id, date_time
                            from [service_car_rental_link]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_car_rental_link
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceCarRentalLinkData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceCarRentalLinkData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceCarRentalLinkData> FetchByLinkTypeRcd(string linkTypeRcd) {
            var dataList = new List<CrudeServiceCarRentalLinkData>();
            ...
            string sql = @" select service_car_rental_link_id, service_car_rental_id, link_type_rcd, user_id, date_time
                            from [service_car_rental_link]
                            where link_type_rcd = @link_type_rcd
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@link_type_rcd", SqlDbType.NVarChar).Value = linkTypeRcd.Replace("'","''");
        ...
        public static List<CrudeServiceCarRentalLinkData> FetchAll() {
            var dataList = new List<CrudeServiceCarRentalLinkData>();
        ...
        public static List<CrudeServiceCarRentalLinkData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceCarRentalLinkData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_car_rental_link_id, service_car_rental_id, link_type_rcd, user_id, date_time
                            from [service_car_rental_link]";
        ...
        public static List<CrudeServiceCarRentalLinkData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceCarRentalLinkData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_car_rental_link]";
        ...
        public static List<CrudeServiceCarRentalLinkData> FetchWithFilter(System.Guid serviceCarRentalLinkId, System.Guid serviceCarRentalId, string linkTypeRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceCarRentalLinkData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (serviceCarRentalLinkId != Guid.Empty) {
                        sql += "  and service_car_rental_link_id = @service_car_rental_link_id";
                        command.Parameters.Add("@service_car_rental_link_id", SqlDbType.UniqueIdentifier).Value = serviceCarRentalLinkId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(linkTypeRcd)) {
                        sql += "  and link_type_rcd like '%' + @link_type_rcd + '%'";
                        command.Parameters.Add("@link_type_rcd", SqlDbType.NVarChar).Value = linkTypeRcd.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["service_car_rental_link_id"] != System.DBNull.Value) ServiceCarRentalLinkId = (System.Guid) reader["service_car_rental_link_id"];
            if (reader["service_car_rental_id"] != System.DBNull.Value) ServiceCarRentalId = (System.Guid) reader["service_car_rental_id"];
            if (reader["link_type_rcd"] != System.DBNull.Value) LinkTypeRcd = (System.String) reader["link_type_rcd"];
        ...
        public void Insert() {
            ...
            if (ServiceCarRentalLinkId == Guid.Empty)
                ServiceCarRentalLinkId = Guid.NewGuid();
            ...
            string sql = "insert into [service_car_rental_link] (service_car_rental_link_id, service_car_rental_id, link_type_rcd, user_id, date_time)";
            sql += "            values (@service_car_rental_link_id, @service_car_rental_id, @link_type_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_car_rental_link_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServiceCarRentalLinkId;
                    command.Parameters.Add("@service_car_rental_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServiceCarRentalId;
                    command.Parameters.Add("@link_type_rcd",SqlDbType.NVarChar).Value = (System.String)LinkTypeRcd;
        ...
        public void Update() {
            ...
            string sql = @" update [service_car_rental_link] set
                 service_car_rental_link_id = @service_car_rental_link_id
                ,service_car_rental_id = @service_car_rental_id
                ,link_type_rcd = @link_type_rcd
                ,user_id = @user_id
                ,date_time = @date_time
            where service_car_rental_link_id = @service_car_rental_link_id";
        ...
        public static void Delete(System.Guid serviceCarRentalLinkId) {
            // create query against service_car_rental_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_car_rental_link] 
                where service_car_rental_link_id = @service_car_rental_link_id";
