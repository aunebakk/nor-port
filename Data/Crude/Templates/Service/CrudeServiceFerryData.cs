...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of service_ferry's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeServiceFerryData {
        ...
        public void FetchByServiceFerryId(System.Guid serviceFerryId) {
            // create query against service_ferry
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_ferry_id, ferry_id, amount, financial_currency_id, user_id, date_time
                            from [service_ferry]
        ...
        // parameters:
        //  serviceFerryId: primary key of table service_ferry
        public static CrudeServiceFerryData GetByServiceFerryId(System.Guid serviceFerryId) {
            // create query against service_ferry
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceFerryData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_ferry
        ...
        public static List<CrudeServiceFerryData> FetchByFerryId(System.Guid ferryId) {
            var dataList = new List<CrudeServiceFerryData>();
            ...
            string sql = @" select service_ferry_id, ferry_id, amount, financial_currency_id, user_id, date_time
                            from [service_ferry]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_ferry
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceFerryData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeServiceFerryData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceFerryData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceFerryData>();
        ...
        public static List<CrudeServiceFerryData> FetchAll() {
            var dataList = new List<CrudeServiceFerryData>();
        ...
        public static List<CrudeServiceFerryData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceFerryData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_ferry_id, ferry_id, amount, financial_currency_id, user_id, date_time
                            from [service_ferry]";
        ...
        public static List<CrudeServiceFerryData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceFerryData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_ferry]";
        ...
        public static List<CrudeServiceFerryData> FetchWithFilter(System.Guid serviceFerryId, System.Guid ferryId, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceFerryData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [service_ferry] (service_ferry_id, ferry_id, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@service_ferry_id, @ferry_id, @amount, @financial_currency_id, @user_id, @date_time)";
        ...
        public void Update() {
            ...
            string sql = @" update [service_ferry] set
        ...
        public static void Delete(System.Guid serviceFerryId) {
            // create query against service_ferry
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_ferry] 
                where service_ferry_id = @service_ferry_id";
