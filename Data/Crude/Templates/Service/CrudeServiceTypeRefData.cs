...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of service_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeServiceTypeRefData {
        ...
        public void FetchByServiceTypeRcd(string serviceTypeRcd) {
            // create query against service_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_type_rcd, service_type_name, user_id, date_time
                            from [service_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@service_type_rcd",SqlDbType.NVarChar).Value = serviceTypeRcd;
        ...
        // parameters:
        //  serviceTypeRcd: primary key of table service_type_ref
        public static CrudeServiceTypeRefData GetByServiceTypeRcd(string serviceTypeRcd) {
            // create query against service_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_type_ref
        ...
        public static List<CrudeServiceTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceTypeRefData>();
            ...
            string sql = @" select service_type_rcd, service_type_name, user_id, date_time
                            from [service_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_type_ref
        ...
        public void FetchByServiceTypeName(string serviceTypeName) {
            // create query against service_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 service_type_rcd, service_type_name, user_id, date_time
                            from [service_type_ref]
                            where service_type_name like '%' + @serviceTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@serviceTypeName",SqlDbType.NVarChar).Value = serviceTypeName;
        ...
        public static List<CrudeServiceTypeRefData> FetchAll() {
            var dataList = new List<CrudeServiceTypeRefData>();
        ...
        public static List<CrudeServiceTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_type_rcd, service_type_name, user_id, date_time
                            from [service_type_ref]
                            order by service_type_name";
        ...
        public static List<CrudeServiceTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_type_ref]";
        ...
        public static List<CrudeServiceTypeRefData> FetchWithFilter(string serviceTypeRcd, string serviceTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(serviceTypeName)) {
                        sql += "  and service_type_name like '%' + @service_type_name + '%'";
                        command.Parameters.Add("@service_type_name", SqlDbType.NVarChar).Value = serviceTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by service_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["service_type_name"] != System.DBNull.Value) ServiceTypeName = (System.String) reader["service_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [service_type_ref] (service_type_rcd, service_type_name, user_id, date_time)";
            sql += "            values (@service_type_rcd, @service_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_type_name",SqlDbType.NVarChar).Value = (System.String)ServiceTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [service_type_ref] set
        ...
        public static void Delete(string serviceTypeRcd) {
            // create query against service_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_type_ref] 
                where service_type_rcd = @service_type_rcd";
