...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    public partial class CrudeServiceRequestStatusRefData {
        ...
        public void FetchByServiceRequestStatusRcd(string serviceRequestStatusRcd) {
            // create query against service_request_status_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_request_status_rcd, service_request_status_name, user_id, date_time, description
                            from [service_request_status_ref]
                            where service_request_status_rcd = @service_request_status_rcd
                            order by service_request_status_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@service_request_status_rcd",SqlDbType.NVarChar).Value = serviceRequestStatusRcd;
        ...
        // parameters:
        //  serviceRequestStatusRcd: primary key of table service_request_status_ref
        public static CrudeServiceRequestStatusRefData GetByServiceRequestStatusRcd(string serviceRequestStatusRcd) {
            // create query against service_request_status_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceRequestStatusRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_request_status_ref
        ...
        public static List<CrudeServiceRequestStatusRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceRequestStatusRefData>();
            ...
            string sql = @" select service_request_status_rcd, service_request_status_name, user_id, date_time, description
                            from [service_request_status_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_request_status_ref
        ...
        public void FetchByServiceRequestStatusName(string serviceRequestStatusName) {
            // create query against service_request_status_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 service_request_status_rcd, service_request_status_name, user_id, date_time, description
                            from [service_request_status_ref]
                            where service_request_status_name like '%' + @serviceRequestStatusName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@serviceRequestStatusName",SqlDbType.NVarChar).Value = serviceRequestStatusName;
        ...
        public static List<CrudeServiceRequestStatusRefData> FetchAll() {
            var dataList = new List<CrudeServiceRequestStatusRefData>();
        ...
        public static List<CrudeServiceRequestStatusRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceRequestStatusRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_request_status_rcd, service_request_status_name, user_id, date_time, description
                            from [service_request_status_ref]
                            order by service_request_status_name";
        ...
        public static List<CrudeServiceRequestStatusRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceRequestStatusRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_request_status_ref]";
        ...
        public static List<CrudeServiceRequestStatusRefData> FetchWithFilter(string serviceRequestStatusRcd, string serviceRequestStatusName, System.Guid userId, System.DateTime dateTime, string description) {
            var dataList = new List<CrudeServiceRequestStatusRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(serviceRequestStatusName)) {
                        sql += "  and service_request_status_name like '%' + @service_request_status_name + '%'";
                        command.Parameters.Add("@service_request_status_name", SqlDbType.NVarChar).Value = serviceRequestStatusName.Replace("'","''");
                    }
                    ...
                    sql += " order by service_request_status_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["service_request_status_name"] != System.DBNull.Value) ServiceRequestStatusName = (System.String) reader["service_request_status_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [service_request_status_ref] (service_request_status_rcd, service_request_status_name, user_id, date_time, description)";
            sql += "            values (@service_request_status_rcd, @service_request_status_name, @user_id, @date_time, @description)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_request_status_name",SqlDbType.NVarChar).Value = (System.String)ServiceRequestStatusName;
        ...
        public void Update() {
            ...
            string sql = @" update [service_request_status_ref] set
                 service_request_status_rcd = @service_request_status_rcd
                ,service_request_status_name = @service_request_status_name
                ,user_id = @user_id
                ,date_time = @date_time
        ...
        public static void Delete(string serviceRequestStatusRcd) {
            // create query against service_request_status_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_request_status_ref] 
                where service_request_status_rcd = @service_request_status_rcd";
