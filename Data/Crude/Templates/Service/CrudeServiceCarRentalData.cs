...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of service_car_rental's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeServiceCarRentalData {
        ...
        public void FetchByServiceCarRentalId(System.Guid serviceCarRentalId) {
            // create query against service_car_rental
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_car_rental_id, car_name, day_price_amount, financial_currency_id, address_id, product_id, user_id, date_time
                            from [service_car_rental]
        ...
        // parameters:
        //  serviceCarRentalId: primary key of table service_car_rental
        public static CrudeServiceCarRentalData GetByServiceCarRentalId(System.Guid serviceCarRentalId) {
            // create query against service_car_rental
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceCarRentalData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_car_rental
        ...
        public static List<CrudeServiceCarRentalData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeServiceCarRentalData>();
            ...
            string sql = @" select service_car_rental_id, car_name, day_price_amount, financial_currency_id, address_id, product_id, user_id, date_time
                            from [service_car_rental]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_car_rental
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceCarRentalData> FetchByAddressId(System.Guid addressId) {
            var dataList = new List<CrudeServiceCarRentalData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceCarRentalData> FetchByProductId(System.Guid productId) {
            var dataList = new List<CrudeServiceCarRentalData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceCarRentalData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceCarRentalData>();
        ...
        public void FetchByCarName(string carName) {
            // create query against service_car_rental
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@carName",SqlDbType.NVarChar).Value = carName;
        ...
        public static List<CrudeServiceCarRentalData> FetchAll() {
            var dataList = new List<CrudeServiceCarRentalData>();
        ...
        public static List<CrudeServiceCarRentalData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceCarRentalData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_car_rental_id, car_name, day_price_amount, financial_currency_id, address_id, product_id, user_id, date_time
                            from [service_car_rental]
                            order by car_name";
        ...
        public static List<CrudeServiceCarRentalData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceCarRentalData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_car_rental]";
        ...
        public static List<CrudeServiceCarRentalData> FetchWithFilter(System.Guid serviceCarRentalId, string carName, decimal dayPriceAmount, System.Guid financialCurrencyId, System.Guid addressId, System.Guid productId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceCarRentalData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(carName)) {
                        sql += "  and car_name like '%' + @car_name + '%'";
                        command.Parameters.Add("@car_name", SqlDbType.NVarChar).Value = carName.Replace("'","''");
                    }
                    if (dayPriceAmount != 0) {
                        sql += "  and day_price_amount = @day_price_amount";
                        command.Parameters.Add("@day_price_amount", SqlDbType.Decimal).Value = dayPriceAmount;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["car_name"] != System.DBNull.Value) CarName = (System.String) reader["car_name"];
            if (reader["day_price_amount"] != System.DBNull.Value) DayPriceAmount = (System.Decimal) reader["day_price_amount"];
        ...
        public void Insert() {
            ...
            if (ServiceCarRentalId == Guid.Empty)
                ServiceCarRentalId = Guid.NewGuid();
            ...
            string sql = "insert into [service_car_rental] (service_car_rental_id, car_name, day_price_amount, financial_currency_id, address_id, product_id, user_id, date_time)";
            sql += "            values (@service_car_rental_id, @car_name, @day_price_amount, @financial_currency_id, @address_id, @product_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@car_name",SqlDbType.NVarChar).Value = (System.String)CarName;
                    command.Parameters.Add("@day_price_amount",SqlDbType.Decimal).Value = (DayPriceAmount == 0 ? (object)DBNull.Value : (System.Decimal)DayPriceAmount);
        ...
        public void Update() {
            ...
            string sql = @" update [service_car_rental] set
                 service_car_rental_id = @service_car_rental_id
                ,car_name = @car_name
                ,day_price_amount = @day_price_amount
        ...
        public static void Delete(System.Guid serviceCarRentalId) {
            // create query against service_car_rental
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_car_rental] 
                where service_car_rental_id = @service_car_rental_id";
