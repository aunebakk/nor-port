...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of reporting_roundup's columns
    ...
    public partial class CrudeReportingRoundupData {
        ...
        public void FetchByReportingRoundupId(System.Guid reportingRoundupId) {
            // create query against reporting_roundup
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 reporting_roundup_id, date, reporting_roundup_type_rcd, reporting_reference_code, count_number, user_id, date_time
                            from [reporting_roundup]
                            where reporting_roundup_id = @reporting_roundup_id
                            order by reporting_reference_code";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@reporting_roundup_id",SqlDbType.UniqueIdentifier).Value = reportingRoundupId;
        ...
        // parameters:
        //  reportingRoundupId: primary key of table reporting_roundup
        public static CrudeReportingRoundupData GetByReportingRoundupId(System.Guid reportingRoundupId) {
            // create query against reporting_roundup
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeReportingRoundupData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against reporting_roundup
        ...
        public static List<CrudeReportingRoundupData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeReportingRoundupData>();
            ...
            string sql = @" select reporting_roundup_id, date, reporting_roundup_type_rcd, reporting_reference_code, count_number, user_id, date_time
                            from [reporting_roundup]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of reporting_roundup
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeReportingRoundupData> FetchByReportingRoundupTypeRcd(string reportingRoundupTypeRcd) {
            var dataList = new List<CrudeReportingRoundupData>();
            ...
            string sql = @" select reporting_roundup_id, date, reporting_roundup_type_rcd, reporting_reference_code, count_number, user_id, date_time
                            from [reporting_roundup]
                            where reporting_roundup_type_rcd = @reporting_roundup_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@reporting_roundup_type_rcd", SqlDbType.NVarChar).Value = reportingRoundupTypeRcd.Replace("'","''");
        ...
        public static List<CrudeReportingRoundupData> FetchAll() {
            var dataList = new List<CrudeReportingRoundupData>();
        ...
        public static List<CrudeReportingRoundupData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeReportingRoundupData>();
            ...
            string sql = @" select top " + limit.ToString() + @" reporting_roundup_id, date, reporting_roundup_type_rcd, reporting_reference_code, count_number, user_id, date_time
                            from [reporting_roundup]
                            order by reporting_reference_code";
        ...
        public static List<CrudeReportingRoundupData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeReportingRoundupData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [reporting_roundup]";
        ...
        public static List<CrudeReportingRoundupData> FetchWithFilter(System.Guid reportingRoundupId, System.DateTime date, string reportingRoundupTypeRcd, string reportingReferenceCode, int countNumber, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeReportingRoundupData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (reportingRoundupId != Guid.Empty) {
                        sql += "  and reporting_roundup_id = @reporting_roundup_id";
                        command.Parameters.Add("@reporting_roundup_id", SqlDbType.UniqueIdentifier).Value = reportingRoundupId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(reportingRoundupTypeRcd)) {
                        sql += "  and reporting_roundup_type_rcd like '%' + @reporting_roundup_type_rcd + '%'";
                        command.Parameters.Add("@reporting_roundup_type_rcd", SqlDbType.NVarChar).Value = reportingRoundupTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(reportingReferenceCode)) {
                        sql += "  and reporting_reference_code like '%' + @reporting_reference_code + '%'";
                        command.Parameters.Add("@reporting_reference_code", SqlDbType.NVarChar).Value = reportingReferenceCode.Replace("'","''");
                    }
                    if (countNumber != 0) {
                        sql += "  and count_number = @count_number";
                        command.Parameters.Add("@count_number", SqlDbType.Int).Value = countNumber;
                    }
                    ...
                    sql += " order by reporting_reference_code";
        ...
        public void Populate(IDataReader reader) {
            if (reader["reporting_roundup_id"] != System.DBNull.Value) ReportingRoundupId = (System.Guid) reader["reporting_roundup_id"];
            if (reader["date"] != System.DBNull.Value) Date = (System.DateTime) reader["date"];
            if (reader["reporting_roundup_type_rcd"] != System.DBNull.Value) ReportingRoundupTypeRcd = (System.String) reader["reporting_roundup_type_rcd"];
            if (reader["reporting_reference_code"] != System.DBNull.Value) ReportingReferenceCode = (System.String) reader["reporting_reference_code"];
            if (reader["count_number"] != System.DBNull.Value) CountNumber = (System.Int32) reader["count_number"];
        ...
        public void Insert() {
            ...
            if (ReportingRoundupId == Guid.Empty)
                ReportingRoundupId = Guid.NewGuid();
            ...
            string sql = "insert into [reporting_roundup] (reporting_roundup_id, date, reporting_roundup_type_rcd, reporting_reference_code, count_number, user_id, date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@reporting_roundup_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ReportingRoundupId;
                    command.Parameters.Add("@date",SqlDbType.DateTime).Value = (System.DateTime)Date;
                    ...
                    command.Parameters.Add("@count_number",SqlDbType.Int).Value = (System.Int32)CountNumber;
        ...
        public void Update() {
            ...
            string sql = @" update [reporting_roundup] set
                 reporting_roundup_id = @reporting_roundup_id
                ,date = @date
                ,reporting_roundup_type_rcd = @reporting_roundup_type_rcd
                ,reporting_reference_code = @reporting_reference_code
        ...
        public static void Delete(System.Guid reportingRoundupId) {
            // create query against reporting_roundup
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [reporting_roundup] 
                where reporting_roundup_id = @reporting_roundup_id";
