...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of client_type_ref's columns
    ...
    public partial class CrudeClientTypeRefData {
        ...
        public void FetchByClientTypeRcd(string clientTypeRcd) {
            // create query against client_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 client_type_rcd, client_type_name, user_id, date_time
        ...
        public static CrudeClientTypeRefData GetByClientTypeRcd(string clientTypeRcd) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against client_type_ref
        ...
        public static List<CrudeClientTypeRefData> FetchByUserId(System.Guid userId) {
            ...
            string sql = @" select client_type_rcd, client_type_name, user_id, date_time
                            from [client_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of client_type_ref
        ...
        public static List<CrudeClientTypeRefData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" client_type_rcd, client_type_name, user_id, date_time
                            from [client_type_ref]
                            order by client_type_name";
        ...
        public static List<CrudeClientTypeRefData> FetchWithFilter(string clientTypeRcd, string clientTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeClientTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [client_type_ref] (client_type_rcd, client_type_name, user_id, date_time)";
            sql += "            values (@client_type_rcd, @client_type_name, @user_id, @date_time)";
