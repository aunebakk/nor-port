...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of client_event_type_ref's columns
    ...
    public partial class CrudeClientEventTypeRefData {
        ...
        public void FetchByClientEventTypeRcd(string clientEventTypeRcd) {
            ...
            string sql = @" select top 1 client_event_type_rcd, client_event_type_name, user_id, date_time
        ...
        public static List<CrudeClientEventTypeRefData> FetchByUserId(System.Guid userId) {
            ...
            string sql = @" select client_event_type_rcd, client_event_type_name, user_id, date_time
                            from [client_event_type_ref]
        ...
        public static List<CrudeClientEventTypeRefData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" client_event_type_rcd, client_event_type_name, user_id, date_time
                            from [client_event_type_ref]
                            order by client_event_type_name";
        ...
        public static List<CrudeClientEventTypeRefData> FetchWithFilter(string clientEventTypeRcd, string clientEventTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeClientEventTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [client_event_type_ref] (client_event_type_rcd, client_event_type_name, user_id, date_time)";
            sql += "            values (@client_event_type_rcd, @client_event_type_name, @user_id, @date_time)";
