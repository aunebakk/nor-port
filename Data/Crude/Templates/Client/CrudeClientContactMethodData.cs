...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    public partial class CrudeClientContactMethodData {
        ...
        public static List<CrudeClientContactMethodData> FetchWithFilter(System.Guid clientContactMethodId, System.Guid clientId, string contactMethodRcd, string contactMethodWay, string comment, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeClientContactMethodData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [client_contact_method] (client_contact_method_id, client_id, contact_method_rcd, contact_method_way, comment, user_id, date_time)";
            sql += "            values (@client_contact_method_id, @client_id, @contact_method_rcd, @contact_method_way, @comment, @user_id, @date_time)";
