...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    public partial class CrudeClientLinkData {
        ...
        public void FetchByClientLinkId(System.Guid clientLinkId) {
            ...
            string sql = @" select top 1 client_link_id, client_id, link_type_rcd, link, user_id, date_time
                            from [client_link]
        ...
        public static List<CrudeClientLinkData> FetchByClientId(System.Guid clientId) {
            ...
            string sql = @" select client_link_id, client_id, link_type_rcd, link, user_id, date_time
                            from [client_link]
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeClientLinkData> FetchByLinkTypeRcd(string linkTypeRcd) {
            var dataList = new List<CrudeClientLinkData>();
        ...
        public static List<CrudeClientLinkData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" client_link_id, client_id, link_type_rcd, link, user_id, date_time
                            from [client_link]";
        ...
        public static List<CrudeClientLinkData> FetchWithFilter(System.Guid clientLinkId, System.Guid clientId, string linkTypeRcd, string link, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeClientLinkData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [client_link] (client_link_id, client_id, link_type_rcd, link, user_id, date_time)";
            sql += "            values (@client_link_id, @client_id, @link_type_rcd, @link, @user_id, @date_time)";
