...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of booking_contact_method's columns
    ...
    public partial class CrudeBookingContactMethodData {
        ...
        public void FetchByBookingContactMethodId(System.Guid bookingContactMethodId) {
            ...
            string sql = @" select top 1 booking_contact_method_id, booking_id, contact_method_rcd, contact_method_way, comment, user_id, date_time
                            from [booking_contact_method]
                            where booking_contact_method_id = @booking_contact_method_id";
        ...
        // parameters:
        //  bookingContactMethodId: primary key of table booking_contact_method
        public static CrudeBookingContactMethodData GetByBookingContactMethodId(System.Guid bookingContactMethodId) {
            // create query against booking_contact_method
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingContactMethodData();
        ...
        public static List<CrudeBookingContactMethodData> FetchByBookingId(System.Guid bookingId) {
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingContactMethodData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingContactMethodData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingContactMethodData> FetchByContactMethodRcd(string contactMethodRcd) {
            var dataList = new List<CrudeBookingContactMethodData>();
        ...
        public static List<CrudeBookingContactMethodData> FetchAll() {
            var dataList = new List<CrudeBookingContactMethodData>();
        ...
        public static List<CrudeBookingContactMethodData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingContactMethodData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_contact_method_id, booking_id, contact_method_rcd, contact_method_way, comment, user_id, date_time
                            from [booking_contact_method]";
        ...
        public static List<CrudeBookingContactMethodData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingContactMethodData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_contact_method]";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Populate(IDataReader reader) {
            if (reader["booking_contact_method_id"] != System.DBNull.Value) BookingContactMethodId = (System.Guid) reader["booking_contact_method_id"];
        ...
        public void Insert() {
            ...
            if (BookingContactMethodId == Guid.Empty)
                BookingContactMethodId = Guid.NewGuid();
            ...
            string sql = "insert into [booking_contact_method] (booking_contact_method_id, booking_id, contact_method_rcd, contact_method_way, comment, user_id, date_time)";
            sql += "            values (@booking_contact_method_id, @booking_id, @contact_method_rcd, @contact_method_way, @comment, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_contact_method_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingContactMethodId;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_contact_method] set
                 booking_contact_method_id = @booking_contact_method_id
        ...
        public static void Delete(System.Guid bookingContactMethodId) {
            // create query against booking_contact_method
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_contact_method] 
                where booking_contact_method_id = @booking_contact_method_id";
