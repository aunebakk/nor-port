...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of booking_flight_segment's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeBookingFlightSegmentData {
        ...
        public void FetchByBookingFlightSegmentId(System.Guid bookingFlightSegmentId) {
            // create query against booking_flight_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_flight_segment_id, became_booking_flight_segment_id, binding_booking_flight_segment_id, booking_id, flight_segment_id, default_state_rcd, user_id, date_time
                            from [booking_flight_segment]
        ...
        // parameters:
        //  bookingFlightSegmentId: primary key of table booking_flight_segment
        public static CrudeBookingFlightSegmentData GetByBookingFlightSegmentId(System.Guid bookingFlightSegmentId) {
            // create query against booking_flight_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingFlightSegmentData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_flight_segment
        ...
        public static List<CrudeBookingFlightSegmentData> FetchByBecameBookingFlightSegmentId(System.Guid becameBookingFlightSegmentId) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
            ...
            string sql = @" select booking_flight_segment_id, became_booking_flight_segment_id, binding_booking_flight_segment_id, booking_id, flight_segment_id, default_state_rcd, user_id, date_time
                            from [booking_flight_segment]
                            where became_booking_flight_segment_id = @became_booking_flight_segment_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@became_booking_flight_segment_id", SqlDbType.UniqueIdentifier).Value = becameBookingFlightSegmentId;
                    ...
                    // read all rows returned from the query of booking_flight_segment
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingFlightSegmentData> FetchByBindingBookingFlightSegmentId(System.Guid bindingBookingFlightSegmentId) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
            ...
            string sql = @" select booking_flight_segment_id, became_booking_flight_segment_id, binding_booking_flight_segment_id, booking_id, flight_segment_id, default_state_rcd, user_id, date_time
                            from [booking_flight_segment]
                            where binding_booking_flight_segment_id = @binding_booking_flight_segment_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@binding_booking_flight_segment_id", SqlDbType.UniqueIdentifier).Value = bindingBookingFlightSegmentId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingFlightSegmentData> FetchByBookingId(System.Guid bookingId) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingFlightSegmentData> FetchByFlightSegmentId(System.Guid flightSegmentId) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingFlightSegmentData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingFlightSegmentData> FetchByDefaultStateRcd(string defaultStateRcd) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
        ...
        public static List<CrudeBookingFlightSegmentData> FetchAll() {
            var dataList = new List<CrudeBookingFlightSegmentData>();
        ...
        public static List<CrudeBookingFlightSegmentData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_flight_segment_id, became_booking_flight_segment_id, binding_booking_flight_segment_id, booking_id, flight_segment_id, default_state_rcd, user_id, date_time
                            from [booking_flight_segment]";
        ...
        public static List<CrudeBookingFlightSegmentData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_flight_segment]";
        ...
        public static List<CrudeBookingFlightSegmentData> FetchWithFilter(System.Guid bookingFlightSegmentId, System.Guid becameBookingFlightSegmentId, System.Guid bindingBookingFlightSegmentId, System.Guid bookingId, System.Guid flightSegmentId, string defaultStateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingFlightSegmentData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (becameBookingFlightSegmentId != Guid.Empty) {
                        sql += "  and became_booking_flight_segment_id = @became_booking_flight_segment_id";
                        command.Parameters.Add("@became_booking_flight_segment_id", SqlDbType.UniqueIdentifier).Value = becameBookingFlightSegmentId;
                    }
                    if (bindingBookingFlightSegmentId != Guid.Empty) {
                        sql += "  and binding_booking_flight_segment_id = @binding_booking_flight_segment_id";
                        command.Parameters.Add("@binding_booking_flight_segment_id", SqlDbType.UniqueIdentifier).Value = bindingBookingFlightSegmentId;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["became_booking_flight_segment_id"] != System.DBNull.Value) BecameBookingFlightSegmentId = (System.Guid) reader["became_booking_flight_segment_id"];
            if (reader["binding_booking_flight_segment_id"] != System.DBNull.Value) BindingBookingFlightSegmentId = (System.Guid) reader["binding_booking_flight_segment_id"];
        ...
        public void Insert() {
            ...
            if (BookingFlightSegmentId == Guid.Empty)
                BookingFlightSegmentId = Guid.NewGuid();
            ...
            string sql = "insert into [booking_flight_segment] (booking_flight_segment_id, became_booking_flight_segment_id, binding_booking_flight_segment_id, booking_id, flight_segment_id, default_state_rcd, user_id, date_time)";
            sql += "            values (@booking_flight_segment_id, @became_booking_flight_segment_id, @binding_booking_flight_segment_id, @booking_id, @flight_segment_id, @default_state_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@became_booking_flight_segment_id",SqlDbType.UniqueIdentifier).Value = (BecameBookingFlightSegmentId == Guid.Empty ? (object)DBNull.Value : (System.Guid)BecameBookingFlightSegmentId);
                    command.Parameters.Add("@binding_booking_flight_segment_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BindingBookingFlightSegmentId;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_flight_segment] set
                 booking_flight_segment_id = @booking_flight_segment_id
                ,became_booking_flight_segment_id = @became_booking_flight_segment_id
                ,binding_booking_flight_segment_id = @binding_booking_flight_segment_id
        ...
        public static void Delete(System.Guid bookingFlightSegmentId) {
            // create query against booking_flight_segment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_flight_segment] 
                where booking_flight_segment_id = @booking_flight_segment_id";
