...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of booking_event_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeBookingEventTypeRefData {
        
        public string BookingEventTypeRcd { get; set; }
        
        public string BookingEventTypeName { get; set; }
        ...
        public void FetchByBookingEventTypeRcd(string bookingEventTypeRcd) {
            // create query against booking_event_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_event_type_rcd, booking_event_type_name, user_id, date_time
                            from [booking_event_type_ref]
                            where booking_event_type_rcd = @booking_event_type_rcd
                            order by booking_event_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@booking_event_type_rcd",SqlDbType.NVarChar).Value = bookingEventTypeRcd;
        ...
        // parameters:
        //  bookingEventTypeRcd: primary key of table booking_event_type_ref
        public static CrudeBookingEventTypeRefData GetByBookingEventTypeRcd(string bookingEventTypeRcd) {
            // create query against booking_event_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingEventTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_event_type_ref
        ...
        public static List<CrudeBookingEventTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingEventTypeRefData>();
            ...
            string sql = @" select booking_event_type_rcd, booking_event_type_name, user_id, date_time
                            from [booking_event_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_event_type_ref
        ...
        public void FetchByBookingEventTypeName(string bookingEventTypeName) {
            // create query against booking_event_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 booking_event_type_rcd, booking_event_type_name, user_id, date_time
                            from [booking_event_type_ref]
                            where booking_event_type_name like '%' + @bookingEventTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@bookingEventTypeName",SqlDbType.NVarChar).Value = bookingEventTypeName;
        ...
        public static List<CrudeBookingEventTypeRefData> FetchAll() {
            var dataList = new List<CrudeBookingEventTypeRefData>();
        ...
        public static List<CrudeBookingEventTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingEventTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_event_type_rcd, booking_event_type_name, user_id, date_time
                            from [booking_event_type_ref]
                            order by booking_event_type_name";
        ...
        public static List<CrudeBookingEventTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingEventTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_event_type_ref]";
        ...
        public static List<CrudeBookingEventTypeRefData> FetchWithFilter(string bookingEventTypeRcd, string bookingEventTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingEventTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(bookingEventTypeRcd)) {
                        sql += "  and booking_event_type_rcd like '%' + @booking_event_type_rcd + '%'";
                        command.Parameters.Add("@booking_event_type_rcd", SqlDbType.NVarChar).Value = bookingEventTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(bookingEventTypeName)) {
                        sql += "  and booking_event_type_name like '%' + @booking_event_type_name + '%'";
                        command.Parameters.Add("@booking_event_type_name", SqlDbType.NVarChar).Value = bookingEventTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by booking_event_type_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["booking_event_type_rcd"] != System.DBNull.Value) BookingEventTypeRcd = (System.String) reader["booking_event_type_rcd"];
            if (reader["booking_event_type_name"] != System.DBNull.Value) BookingEventTypeName = (System.String) reader["booking_event_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking_event_type_ref] (booking_event_type_rcd, booking_event_type_name, user_id, date_time)";
            sql += "            values (@booking_event_type_rcd, @booking_event_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_event_type_rcd",SqlDbType.NVarChar).Value = (System.String)BookingEventTypeRcd;
                    command.Parameters.Add("@booking_event_type_name",SqlDbType.NVarChar).Value = (System.String)BookingEventTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_event_type_ref] set
                 booking_event_type_rcd = @booking_event_type_rcd
                ,booking_event_type_name = @booking_event_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where booking_event_type_rcd = @booking_event_type_rcd";
        ...
        public static void Delete(string bookingEventTypeRcd) {
            // create query against booking_event_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_event_type_ref] 
                where booking_event_type_rcd = @booking_event_type_rcd";
