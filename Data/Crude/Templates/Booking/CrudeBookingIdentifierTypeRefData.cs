...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of booking_identifier_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeBookingIdentifierTypeRefData {
        
        public string BookingIdentifierTypeRcd { get; set; }
        
        public string BookingIdentifierTypeName { get; set; }
        ...
        public void FetchByBookingIdentifierTypeRcd(string bookingIdentifierTypeRcd) {
            // create query against booking_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_identifier_type_rcd, booking_identifier_type_name, user_id, date_time
                            from [booking_identifier_type_ref]
                            where booking_identifier_type_rcd = @booking_identifier_type_rcd
                            order by booking_identifier_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@booking_identifier_type_rcd",SqlDbType.NVarChar).Value = bookingIdentifierTypeRcd;
        ...
        // parameters:
        //  bookingIdentifierTypeRcd: primary key of table booking_identifier_type_ref
        public static CrudeBookingIdentifierTypeRefData GetByBookingIdentifierTypeRcd(string bookingIdentifierTypeRcd) {
            // create query against booking_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingIdentifierTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_identifier_type_ref
        ...
        public static List<CrudeBookingIdentifierTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingIdentifierTypeRefData>();
            ...
            string sql = @" select booking_identifier_type_rcd, booking_identifier_type_name, user_id, date_time
                            from [booking_identifier_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_identifier_type_ref
        ...
        public void FetchByBookingIdentifierTypeName(string bookingIdentifierTypeName) {
            // create query against booking_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 booking_identifier_type_rcd, booking_identifier_type_name, user_id, date_time
                            from [booking_identifier_type_ref]
                            where booking_identifier_type_name like '%' + @bookingIdentifierTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@bookingIdentifierTypeName",SqlDbType.NVarChar).Value = bookingIdentifierTypeName;
        ...
        public static List<CrudeBookingIdentifierTypeRefData> FetchAll() {
            var dataList = new List<CrudeBookingIdentifierTypeRefData>();
        ...
        public static List<CrudeBookingIdentifierTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingIdentifierTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_identifier_type_rcd, booking_identifier_type_name, user_id, date_time
                            from [booking_identifier_type_ref]
                            order by booking_identifier_type_name";
        ...
        public static List<CrudeBookingIdentifierTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingIdentifierTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_identifier_type_ref]";
        ...
        public static List<CrudeBookingIdentifierTypeRefData> FetchWithFilter(string bookingIdentifierTypeRcd, string bookingIdentifierTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingIdentifierTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(bookingIdentifierTypeRcd)) {
                        sql += "  and booking_identifier_type_rcd like '%' + @booking_identifier_type_rcd + '%'";
                        command.Parameters.Add("@booking_identifier_type_rcd", SqlDbType.NVarChar).Value = bookingIdentifierTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(bookingIdentifierTypeName)) {
                        sql += "  and booking_identifier_type_name like '%' + @booking_identifier_type_name + '%'";
                        command.Parameters.Add("@booking_identifier_type_name", SqlDbType.NVarChar).Value = bookingIdentifierTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by booking_identifier_type_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["booking_identifier_type_rcd"] != System.DBNull.Value) BookingIdentifierTypeRcd = (System.String) reader["booking_identifier_type_rcd"];
            if (reader["booking_identifier_type_name"] != System.DBNull.Value) BookingIdentifierTypeName = (System.String) reader["booking_identifier_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking_identifier_type_ref] (booking_identifier_type_rcd, booking_identifier_type_name, user_id, date_time)";
            sql += "            values (@booking_identifier_type_rcd, @booking_identifier_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_identifier_type_rcd",SqlDbType.NVarChar).Value = (System.String)BookingIdentifierTypeRcd;
                    command.Parameters.Add("@booking_identifier_type_name",SqlDbType.NVarChar).Value = (System.String)BookingIdentifierTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_identifier_type_ref] set
                 booking_identifier_type_rcd = @booking_identifier_type_rcd
                ,booking_identifier_type_name = @booking_identifier_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where booking_identifier_type_rcd = @booking_identifier_type_rcd";
        ...
        public static void Delete(string bookingIdentifierTypeRcd) {
            // create query against booking_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_identifier_type_ref] 
                where booking_identifier_type_rcd = @booking_identifier_type_rcd";
