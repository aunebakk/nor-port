...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of booking_document_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeBookingDocumentTypeRefData {
        
        public string BookingDocumentTypeRcd { get; set; }
        
        public string BookingDocumentTypeName { get; set; }
        ...
        public void FetchByBookingDocumentTypeRcd(string bookingDocumentTypeRcd) {
            // create query against booking_document_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_document_type_rcd, booking_document_type_name, user_id, date_time
                            from [booking_document_type_ref]
                            where booking_document_type_rcd = @booking_document_type_rcd
                            order by booking_document_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@booking_document_type_rcd",SqlDbType.NVarChar).Value = bookingDocumentTypeRcd;
        ...
        // parameters:
        //  bookingDocumentTypeRcd: primary key of table booking_document_type_ref
        public static CrudeBookingDocumentTypeRefData GetByBookingDocumentTypeRcd(string bookingDocumentTypeRcd) {
            // create query against booking_document_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingDocumentTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_document_type_ref
        ...
        public static List<CrudeBookingDocumentTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingDocumentTypeRefData>();
            ...
            string sql = @" select booking_document_type_rcd, booking_document_type_name, user_id, date_time
                            from [booking_document_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_document_type_ref
        ...
        public void FetchByBookingDocumentTypeName(string bookingDocumentTypeName) {
            // create query against booking_document_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 booking_document_type_rcd, booking_document_type_name, user_id, date_time
                            from [booking_document_type_ref]
                            where booking_document_type_name like '%' + @bookingDocumentTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@bookingDocumentTypeName",SqlDbType.NVarChar).Value = bookingDocumentTypeName;
        ...
        public static List<CrudeBookingDocumentTypeRefData> FetchAll() {
            var dataList = new List<CrudeBookingDocumentTypeRefData>();
        ...
        public static List<CrudeBookingDocumentTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingDocumentTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_document_type_rcd, booking_document_type_name, user_id, date_time
                            from [booking_document_type_ref]
                            order by booking_document_type_name";
        ...
        public static List<CrudeBookingDocumentTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingDocumentTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_document_type_ref]";
        ...
        public static List<CrudeBookingDocumentTypeRefData> FetchWithFilter(string bookingDocumentTypeRcd, string bookingDocumentTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingDocumentTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(bookingDocumentTypeName)) {
                        sql += "  and booking_document_type_name like '%' + @booking_document_type_name + '%'";
                        command.Parameters.Add("@booking_document_type_name", SqlDbType.NVarChar).Value = bookingDocumentTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by booking_document_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["booking_document_type_name"] != System.DBNull.Value) BookingDocumentTypeName = (System.String) reader["booking_document_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking_document_type_ref] (booking_document_type_rcd, booking_document_type_name, user_id, date_time)";
            sql += "            values (@booking_document_type_rcd, @booking_document_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_document_type_name",SqlDbType.NVarChar).Value = (System.String)BookingDocumentTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_document_type_ref] set
                 booking_document_type_rcd = @booking_document_type_rcd
                ,booking_document_type_name = @booking_document_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where booking_document_type_rcd = @booking_document_type_rcd";
        ...
        public static void Delete(string bookingDocumentTypeRcd) {
            // create query against booking_document_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_document_type_ref] 
                where booking_document_type_rcd = @booking_document_type_rcd";
