...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of nationality_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    [Serializable()]
    public partial class CrudeNationalityRefData {
        ...
        public void FetchByNationalityRcd(string nationalityRcd) {
            // create query against nationality_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 nationality_rcd, nationality_name, user_id, date_time
                            from [nationality_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@nationality_rcd",SqlDbType.NVarChar).Value = nationalityRcd;
        ...
        // parameters:
        //  nationalityRcd: primary key of table nationality_ref
        public static CrudeNationalityRefData GetByNationalityRcd(string nationalityRcd) {
            // create query against nationality_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeNationalityRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against nationality_ref
        ...
        public static List<CrudeNationalityRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeNationalityRefData>();
            ...
            string sql = @" select nationality_rcd, nationality_name, user_id, date_time
                            from [nationality_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of nationality_ref
        ...
        public void FetchByNationalityName(string nationalityName) {
            // create query against nationality_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 nationality_rcd, nationality_name, user_id, date_time
                            from [nationality_ref]
                            where nationality_name like '%' + @nationalityName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@nationalityName",SqlDbType.NVarChar).Value = nationalityName;
        ...
        public static List<CrudeNationalityRefData> FetchAll() {
            var dataList = new List<CrudeNationalityRefData>();
        ...
        public static List<CrudeNationalityRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeNationalityRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" nationality_rcd, nationality_name, user_id, date_time
                            from [nationality_ref]
                            order by nationality_name";
        ...
        public static List<CrudeNationalityRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeNationalityRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [nationality_ref]";
        ...
        public static List<CrudeNationalityRefData> FetchWithFilter(string nationalityRcd, string nationalityName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeNationalityRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(nationalityName)) {
                        sql += "  and nationality_name like '%' + @nationality_name + '%'";
                        command.Parameters.Add("@nationality_name", SqlDbType.NVarChar).Value = nationalityName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["nationality_name"] != System.DBNull.Value) NationalityName = (System.String) reader["nationality_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [nationality_ref] (nationality_rcd, nationality_name, user_id, date_time)";
            sql += "            values (@nationality_rcd, @nationality_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@nationality_rcd",SqlDbType.NVarChar).Value = (System.String)NationalityRcd;
                    command.Parameters.Add("@nationality_name",SqlDbType.NVarChar).Value = (System.String)NationalityName;
        ...
        public void Update() {
            ...
            string sql = @" update [nationality_ref] set
        ...
        public static void Delete(string nationalityRcd) {
            // create query against nationality_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [nationality_ref] 
                where nationality_rcd = @nationality_rcd";
