...
namespace SolutionNorSolutionPort.DataAccessLayer {
    ...
    // this class start with an identical representation of date_time_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeDateTimeTypeRefData {
        ...
        public void FetchByDateTimeTypeRcd(string dateTimeTypeRcd) {
            // create query against date_time_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 date_time_type_rcd, date_time_type_name, user_id, date_time
                            from [date_time_type_ref]
                            where date_time_type_rcd = @date_time_type_rcd
                            order by date_time_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@date_time_type_rcd",SqlDbType.NVarChar).Value = dateTimeTypeRcd;
        ...
        // parameters:
        //  dateTimeTypeRcd: primary key of table date_time_type_ref
        public static CrudeDateTimeTypeRefData GetByDateTimeTypeRcd(string dateTimeTypeRcd) {
            // create query against date_time_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeDateTimeTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against date_time_type_ref
        ...
        public static List<CrudeDateTimeTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeDateTimeTypeRefData>();
            ...
            string sql = @" select date_time_type_rcd, date_time_type_name, user_id, date_time
                            from [date_time_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of date_time_type_ref
        ...
        public void FetchByDateTimeTypeName(string dateTimeTypeName) {
            // create query against date_time_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 date_time_type_rcd, date_time_type_name, user_id, date_time
                            from [date_time_type_ref]
                            where date_time_type_name like '%' + @dateTimeTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@dateTimeTypeName",SqlDbType.NVarChar).Value = dateTimeTypeName;
        ...
        public static List<CrudeDateTimeTypeRefData> FetchAll() {
            var dataList = new List<CrudeDateTimeTypeRefData>();
        ...
        public static List<CrudeDateTimeTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeDateTimeTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" date_time_type_rcd, date_time_type_name, user_id, date_time
                            from [date_time_type_ref]
                            order by date_time_type_name";
        ...
        public static List<CrudeDateTimeTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeDateTimeTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [date_time_type_ref]";
        ...
        public static List<CrudeDateTimeTypeRefData> FetchWithFilter(string dateTimeTypeRcd, string dateTimeTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeDateTimeTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(dateTimeTypeName)) {
                        sql += "  and date_time_type_name like '%' + @date_time_type_name + '%'";
                        command.Parameters.Add("@date_time_type_name", SqlDbType.NVarChar).Value = dateTimeTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by date_time_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["date_time_type_name"] != System.DBNull.Value) DateTimeTypeName = (System.String) reader["date_time_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [date_time_type_ref] (date_time_type_rcd, date_time_type_name, user_id, date_time)";
            sql += "            values (@date_time_type_rcd, @date_time_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@date_time_type_name",SqlDbType.NVarChar).Value = (System.String)DateTimeTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [date_time_type_ref] set
                 date_time_type_rcd = @date_time_type_rcd
                ,date_time_type_name = @date_time_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where date_time_type_rcd = @date_time_type_rcd";
        ...
        public static void Delete(string dateTimeTypeRcd) {
            // create query against date_time_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [date_time_type_ref] 
                where date_time_type_rcd = @date_time_type_rcd";
