...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of language_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeLanguageRefData {
        ...
        public void FetchByLanguageRcd(string languageRcd) {
            // create query against language_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 language_rcd, language_name, user_id, date_time
                            from [language_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@language_rcd",SqlDbType.NVarChar).Value = languageRcd;
        ...
        // parameters:
        //  languageRcd: primary key of table language_ref
        public static CrudeLanguageRefData GetByLanguageRcd(string languageRcd) {
            // create query against language_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeLanguageRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against language_ref
        ...
        public static List<CrudeLanguageRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeLanguageRefData>();
            ...
            string sql = @" select language_rcd, language_name, user_id, date_time
                            from [language_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of language_ref
        ...
        public void FetchByLanguageName(string languageName) {
            // create query against language_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@languageName",SqlDbType.NVarChar).Value = languageName;
        ...
        public static List<CrudeLanguageRefData> FetchAll() {
            var dataList = new List<CrudeLanguageRefData>();
        ...
        public static List<CrudeLanguageRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeLanguageRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" language_rcd, language_name, user_id, date_time
                            from [language_ref]
                            order by language_name";
        ...
        public static List<CrudeLanguageRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeLanguageRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [language_ref]";
        ...
        public static List<CrudeLanguageRefData> FetchWithFilter(string languageRcd, string languageName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeLanguageRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(languageName)) {
                        sql += "  and language_name like '%' + @language_name + '%'";
                        command.Parameters.Add("@language_name", SqlDbType.NVarChar).Value = languageName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["language_name"] != System.DBNull.Value) LanguageName = (System.String) reader["language_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [language_ref] (language_rcd, language_name, user_id, date_time)";
            sql += "            values (@language_rcd, @language_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@language_name",SqlDbType.NVarChar).Value = (System.String)LanguageName;
        ...
        public void Update() {
            ...
            string sql = @" update [language_ref] set
        ...
        public static void Delete(string languageRcd) {
            // create query against language_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [language_ref] 
                where language_rcd = @language_rcd";
