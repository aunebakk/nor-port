/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:31:17 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of reporting_roundup_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeReportingRoundupTypeRefData {
        
        public string ReportingRoundupTypeRcd { get; set; }
        
        public string ReportingRoundupTypeName { get; set; }
        ...
        public void FetchByReportingRoundupTypeRcd(string reportingRoundupTypeRcd) {
            // create query against reporting_roundup_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 reporting_roundup_type_rcd, reporting_roundup_type_name, user_id, date_time
                            from [reporting_roundup_type_ref]
                            where reporting_roundup_type_rcd = @reporting_roundup_type_rcd
                            order by reporting_roundup_type_name";
        ...
        // parameters:
        //  reportingRoundupTypeRcd: primary key of table reporting_roundup_type_ref
        public static CrudeReportingRoundupTypeRefData GetByReportingRoundupTypeRcd(string reportingRoundupTypeRcd) {
            // create query against reporting_roundup_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeReportingRoundupTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against reporting_roundup_type_ref
        ...
        public static List<CrudeReportingRoundupTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeReportingRoundupTypeRefData>();
            ...
            string sql = @" select reporting_roundup_type_rcd, reporting_roundup_type_name, user_id, date_time
                            from [reporting_roundup_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of reporting_roundup_type_ref
        ...
        public void FetchByReportingRoundupTypeName(string reportingRoundupTypeName) {
            // create query against reporting_roundup_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 reporting_roundup_type_rcd, reporting_roundup_type_name, user_id, date_time
                            from [reporting_roundup_type_ref]
                            where reporting_roundup_type_name like '%' + @reportingRoundupTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@reportingRoundupTypeName",SqlDbType.NVarChar).Value = reportingRoundupTypeName;
        ...
        public static List<CrudeReportingRoundupTypeRefData> FetchAll() {
            var dataList = new List<CrudeReportingRoundupTypeRefData>();
        ...
        public static List<CrudeReportingRoundupTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeReportingRoundupTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" reporting_roundup_type_rcd, reporting_roundup_type_name, user_id, date_time
                            from [reporting_roundup_type_ref]
                            order by reporting_roundup_type_name";
        ...
        public static List<CrudeReportingRoundupTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeReportingRoundupTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [reporting_roundup_type_ref]";
        ...
        public static List<CrudeReportingRoundupTypeRefData> FetchWithFilter(string reportingRoundupTypeRcd, string reportingRoundupTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeReportingRoundupTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(reportingRoundupTypeName)) {
                        sql += "  and reporting_roundup_type_name like '%' + @reporting_roundup_type_name + '%'";
                        command.Parameters.Add("@reporting_roundup_type_name", SqlDbType.NVarChar).Value = reportingRoundupTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by reporting_roundup_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["reporting_roundup_type_name"] != System.DBNull.Value) ReportingRoundupTypeName = (System.String) reader["reporting_roundup_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [reporting_roundup_type_ref] (reporting_roundup_type_rcd, reporting_roundup_type_name, user_id, date_time)";
            sql += "            values (@reporting_roundup_type_rcd, @reporting_roundup_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@reporting_roundup_type_name",SqlDbType.NVarChar).Value = (System.String)ReportingRoundupTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [reporting_roundup_type_ref] set
                 reporting_roundup_type_rcd = @reporting_roundup_type_rcd
                ,reporting_roundup_type_name = @reporting_roundup_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where reporting_roundup_type_rcd = @reporting_roundup_type_rcd";
        ...
        public static void Delete(string reportingRoundupTypeRcd) {
            // create query against reporting_roundup_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [reporting_roundup_type_ref] 
                where reporting_roundup_type_rcd = @reporting_roundup_type_rcd";
