/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:31:03 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial class CrudeProductData {
        ...
        public void FetchByProductId(System.Guid productId) {
            ...
            string sql = @" select top 1 product_id, product_name, state_rcd, user_id, date_time, product_became_id
                            from [product]
        ...
        public static List<CrudeProductData> FetchByUserId(System.Guid userId) {
            ...
            string sql = @" select product_id, product_name, state_rcd, user_id, date_time, product_became_id
                            from [product]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of product
        ...
        public static List<CrudeProductData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" product_id, product_name, state_rcd, user_id, date_time, product_became_id
                            from [product]
                            order by product_name";
        ...
        public static List<CrudeProductData> FetchWithFilter(System.Guid productId, string productName, string stateRcd, System.Guid userId, System.DateTime dateTime, System.Guid productBecameId) {
            var dataList = new List<CrudeProductData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [product] (product_id, product_name, state_rcd, user_id, date_time, product_became_id)";
            sql += "            values (@product_id, @product_name, @state_rcd, @user_id, @date_time, @product_became_id)";
