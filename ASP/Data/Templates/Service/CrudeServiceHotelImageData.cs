/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:50:52 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of service_hotel_image's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeServiceHotelImageData {
        ...
        public void FetchByServiceHotelImageId(System.Guid serviceHotelImageId) {
            // create query against service_hotel_image
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_hotel_image_id, service_hotel_id, service_image_type_rcd, image_file_name, image, user_id, date_time
                            from [service_hotel_image]
                            where service_hotel_image_id = @service_hotel_image_id
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@service_hotel_image_id",SqlDbType.UniqueIdentifier).Value = serviceHotelImageId;
        ...
        // parameters:
        //  serviceHotelImageId: primary key of table service_hotel_image
        public static CrudeServiceHotelImageData GetByServiceHotelImageId(System.Guid serviceHotelImageId) {
            // create query against service_hotel_image
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceHotelImageData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_hotel_image
        ...
        public static List<CrudeServiceHotelImageData> FetchByServiceHotelId(System.Guid serviceHotelId) {
            var dataList = new List<CrudeServiceHotelImageData>();
            ...
            string sql = @" select service_hotel_image_id, service_hotel_id, service_image_type_rcd, image_file_name, image, user_id, date_time
                            from [service_hotel_image]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_hotel_image
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceHotelImageData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceHotelImageData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServiceHotelImageData> FetchByServiceImageTypeRcd(string serviceImageTypeRcd) {
            var dataList = new List<CrudeServiceHotelImageData>();
            ...
            string sql = @" select service_hotel_image_id, service_hotel_id, service_image_type_rcd, image_file_name, image, user_id, date_time
                            from [service_hotel_image]
                            where service_image_type_rcd = @service_image_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@service_image_type_rcd", SqlDbType.NVarChar).Value = serviceImageTypeRcd.Replace("'","''");
        ...
        public static List<CrudeServiceHotelImageData> FetchAll() {
            var dataList = new List<CrudeServiceHotelImageData>();
        ...
        public static List<CrudeServiceHotelImageData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceHotelImageData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_hotel_image_id, service_hotel_id, service_image_type_rcd, image_file_name, image, user_id, date_time
                            from [service_hotel_image]
                            order by image_file_name";
        ...
        public static List<CrudeServiceHotelImageData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceHotelImageData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_hotel_image]";
        ...
        public static List<CrudeServiceHotelImageData> FetchWithFilter(System.Guid serviceHotelImageId, System.Guid serviceHotelId, string serviceImageTypeRcd, string imageFileName, byte[] image, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceHotelImageData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (serviceHotelImageId != Guid.Empty) {
                        sql += "  and service_hotel_image_id = @service_hotel_image_id";
                        command.Parameters.Add("@service_hotel_image_id", SqlDbType.UniqueIdentifier).Value = serviceHotelImageId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(serviceImageTypeRcd)) {
                        sql += "  and service_image_type_rcd like '%' + @service_image_type_rcd + '%'";
                        command.Parameters.Add("@service_image_type_rcd", SqlDbType.NVarChar).Value = serviceImageTypeRcd.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["service_hotel_image_id"] != System.DBNull.Value) ServiceHotelImageId = (System.Guid) reader["service_hotel_image_id"];
            if (reader["service_hotel_id"] != System.DBNull.Value) ServiceHotelId = (System.Guid) reader["service_hotel_id"];
            if (reader["service_image_type_rcd"] != System.DBNull.Value) ServiceImageTypeRcd = (System.String) reader["service_image_type_rcd"];
        ...
        public void Insert() {
            ...
            if (ServiceHotelImageId == Guid.Empty)
                ServiceHotelImageId = Guid.NewGuid();
            ...
            string sql = "insert into [service_hotel_image] (service_hotel_image_id, service_hotel_id, service_image_type_rcd, image_file_name, image, user_id, date_time)";
            sql += "            values (@service_hotel_image_id, @service_hotel_id, @service_image_type_rcd, @image_file_name, @image, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_hotel_image_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServiceHotelImageId;
                    command.Parameters.Add("@service_hotel_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServiceHotelId;
                    command.Parameters.Add("@service_image_type_rcd",SqlDbType.NVarChar).Value = (System.String)ServiceImageTypeRcd;
        ...
        public void Update() {
            ...
            string sql = @" update [service_hotel_image] set
                 service_hotel_image_id = @service_hotel_image_id
                ,service_hotel_id = @service_hotel_id
                ,service_image_type_rcd = @service_image_type_rcd
        ...
        public static void Delete(System.Guid serviceHotelImageId) {
            // create query against service_hotel_image
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_hotel_image] 
                where service_hotel_image_id = @service_hotel_image_id";
