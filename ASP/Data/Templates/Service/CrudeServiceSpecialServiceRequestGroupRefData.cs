/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:26:05 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of service_special_service_request_group_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeServiceSpecialServiceRequestGroupRefData {
        ...
        public void FetchByServiceSpecialServiceRequestGroupRcd(string serviceSpecialServiceRequestGroupRcd) {
            // create query against service_special_service_request_group_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_special_service_request_group_rcd, service_special_service_request_group_name, user_id, date_time
                            from [service_special_service_request_group_ref]
                            where service_special_service_request_group_rcd = @service_special_service_request_group_rcd
                            order by service_special_service_request_group_name";
        ...
        // parameters:
        //  serviceSpecialServiceRequestGroupRcd: primary key of table service_special_service_request_group_ref
        public static CrudeServiceSpecialServiceRequestGroupRefData GetByServiceSpecialServiceRequestGroupRcd(string serviceSpecialServiceRequestGroupRcd) {
            // create query against service_special_service_request_group_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceSpecialServiceRequestGroupRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_special_service_request_group_ref
        ...
        public static List<CrudeServiceSpecialServiceRequestGroupRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceSpecialServiceRequestGroupRefData>();
            ...
            string sql = @" select service_special_service_request_group_rcd, service_special_service_request_group_name, user_id, date_time
                            from [service_special_service_request_group_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_special_service_request_group_ref
        ...
        public void FetchByServiceSpecialServiceRequestGroupName(string serviceSpecialServiceRequestGroupName) {
            // create query against service_special_service_request_group_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 service_special_service_request_group_rcd, service_special_service_request_group_name, user_id, date_time
                            from [service_special_service_request_group_ref]
                            where service_special_service_request_group_name like '%' + @serviceSpecialServiceRequestGroupName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@serviceSpecialServiceRequestGroupName",SqlDbType.NVarChar).Value = serviceSpecialServiceRequestGroupName;
        ...
        public static List<CrudeServiceSpecialServiceRequestGroupRefData> FetchAll() {
            var dataList = new List<CrudeServiceSpecialServiceRequestGroupRefData>();
        ...
        public static List<CrudeServiceSpecialServiceRequestGroupRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceSpecialServiceRequestGroupRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_special_service_request_group_rcd, service_special_service_request_group_name, user_id, date_time
                            from [service_special_service_request_group_ref]
                            order by service_special_service_request_group_name";
        ...
        public static List<CrudeServiceSpecialServiceRequestGroupRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceSpecialServiceRequestGroupRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_special_service_request_group_ref]";
        ...
        public static List<CrudeServiceSpecialServiceRequestGroupRefData> FetchWithFilter(string serviceSpecialServiceRequestGroupRcd, string serviceSpecialServiceRequestGroupName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceSpecialServiceRequestGroupRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(serviceSpecialServiceRequestGroupName)) {
                        sql += "  and service_special_service_request_group_name like '%' + @service_special_service_request_group_name + '%'";
                        command.Parameters.Add("@service_special_service_request_group_name", SqlDbType.NVarChar).Value = serviceSpecialServiceRequestGroupName.Replace("'","''");
                    }
                    ...
                    sql += " order by service_special_service_request_group_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["service_special_service_request_group_name"] != System.DBNull.Value) ServiceSpecialServiceRequestGroupName = (System.String) reader["service_special_service_request_group_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [service_special_service_request_group_ref] (service_special_service_request_group_rcd, service_special_service_request_group_name, user_id, date_time)";
            sql += "            values (@service_special_service_request_group_rcd, @service_special_service_request_group_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_special_service_request_group_name",SqlDbType.NVarChar).Value = (System.String)ServiceSpecialServiceRequestGroupName;
        ...
        public void Update() {
            ...
            string sql = @" update [service_special_service_request_group_ref] set
                 service_special_service_request_group_rcd = @service_special_service_request_group_rcd
                ,service_special_service_request_group_name = @service_special_service_request_group_name
                ,user_id = @user_id
                ,date_time = @date_time
            where service_special_service_request_group_rcd = @service_special_service_request_group_rcd";
        ...
        public static void Delete(string serviceSpecialServiceRequestGroupRcd) {
            // create query against service_special_service_request_group_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_special_service_request_group_ref] 
                where service_special_service_request_group_rcd = @service_special_service_request_group_rcd";
