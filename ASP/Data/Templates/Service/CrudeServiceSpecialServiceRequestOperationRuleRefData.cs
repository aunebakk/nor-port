/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:32:49 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of service_special_service_request_operation_rule_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeServiceSpecialServiceRequestOperationRuleRefData {
        ...
        public void FetchByServiceSpecialServiceRequestOperationRuleRcd(string serviceSpecialServiceRequestOperationRuleRcd) {
            // create query against service_special_service_request_operation_rule_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_special_service_request_operation_rule_rcd, service_special_service_request_operation_rule_name, user_id, date_time
                            from [service_special_service_request_operation_rule_ref]
                            where service_special_service_request_operation_rule_rcd = @service_special_service_request_operation_rule_rcd
                            order by service_special_service_request_operation_rule_name";
        ...
        // parameters:
        //  serviceSpecialServiceRequestOperationRuleRcd: primary key of table service_special_service_request_operation_rule_ref
        public static CrudeServiceSpecialServiceRequestOperationRuleRefData GetByServiceSpecialServiceRequestOperationRuleRcd(string serviceSpecialServiceRequestOperationRuleRcd) {
            // create query against service_special_service_request_operation_rule_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceSpecialServiceRequestOperationRuleRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_special_service_request_operation_rule_ref
        ...
        public static List<CrudeServiceSpecialServiceRequestOperationRuleRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceSpecialServiceRequestOperationRuleRefData>();
            ...
            string sql = @" select service_special_service_request_operation_rule_rcd, service_special_service_request_operation_rule_name, user_id, date_time
                            from [service_special_service_request_operation_rule_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_special_service_request_operation_rule_ref
        ...
        public void FetchByServiceSpecialServiceRequestOperationRuleName(string serviceSpecialServiceRequestOperationRuleName) {
            // create query against service_special_service_request_operation_rule_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 service_special_service_request_operation_rule_rcd, service_special_service_request_operation_rule_name, user_id, date_time
                            from [service_special_service_request_operation_rule_ref]
                            where service_special_service_request_operation_rule_name like '%' + @serviceSpecialServiceRequestOperationRuleName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@serviceSpecialServiceRequestOperationRuleName",SqlDbType.NVarChar).Value = serviceSpecialServiceRequestOperationRuleName;
        ...
        public static List<CrudeServiceSpecialServiceRequestOperationRuleRefData> FetchAll() {
            var dataList = new List<CrudeServiceSpecialServiceRequestOperationRuleRefData>();
        ...
        public static List<CrudeServiceSpecialServiceRequestOperationRuleRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceSpecialServiceRequestOperationRuleRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_special_service_request_operation_rule_rcd, service_special_service_request_operation_rule_name, user_id, date_time
                            from [service_special_service_request_operation_rule_ref]
                            order by service_special_service_request_operation_rule_name";
        ...
        public static List<CrudeServiceSpecialServiceRequestOperationRuleRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceSpecialServiceRequestOperationRuleRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_special_service_request_operation_rule_ref]";
        ...
        public static List<CrudeServiceSpecialServiceRequestOperationRuleRefData> FetchWithFilter(string serviceSpecialServiceRequestOperationRuleRcd, string serviceSpecialServiceRequestOperationRuleName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceSpecialServiceRequestOperationRuleRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(serviceSpecialServiceRequestOperationRuleName)) {
                        sql += "  and service_special_service_request_operation_rule_name like '%' + @service_special_service_request_operation_rule_name + '%'";
                        command.Parameters.Add("@service_special_service_request_operation_rule_name", SqlDbType.NVarChar).Value = serviceSpecialServiceRequestOperationRuleName.Replace("'","''");
                    }
                    ...
                    sql += " order by service_special_service_request_operation_rule_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["service_special_service_request_operation_rule_name"] != System.DBNull.Value) ServiceSpecialServiceRequestOperationRuleName = (System.String) reader["service_special_service_request_operation_rule_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [service_special_service_request_operation_rule_ref] (service_special_service_request_operation_rule_rcd, service_special_service_request_operation_rule_name, user_id, date_time)";
            sql += "            values (@service_special_service_request_operation_rule_rcd, @service_special_service_request_operation_rule_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_special_service_request_operation_rule_name",SqlDbType.NVarChar).Value = (System.String)ServiceSpecialServiceRequestOperationRuleName;
        ...
        public void Update() {
            ...
            string sql = @" update [service_special_service_request_operation_rule_ref] set
                 service_special_service_request_operation_rule_rcd = @service_special_service_request_operation_rule_rcd
                ,service_special_service_request_operation_rule_name = @service_special_service_request_operation_rule_name
                ,user_id = @user_id
                ,date_time = @date_time
            where service_special_service_request_operation_rule_rcd = @service_special_service_request_operation_rule_rcd";
        ...
        public static void Delete(string serviceSpecialServiceRequestOperationRuleRcd) {
            // create query against service_special_service_request_operation_rule_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_special_service_request_operation_rule_ref] 
                where service_special_service_request_operation_rule_rcd = @service_special_service_request_operation_rule_rcd";
