/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:51:03 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of service_image_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeServiceImageTypeRefData {
        
        public string ServiceImageTypeRcd { get; set; }
        
        public string ServiceImageTypeName { get; set; }
        ...
        public void FetchByServiceImageTypeRcd(string serviceImageTypeRcd) {
            // create query against service_image_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_image_type_rcd, service_image_type_name, user_id, date_time
                            from [service_image_type_ref]
                            where service_image_type_rcd = @service_image_type_rcd
                            order by service_image_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@service_image_type_rcd",SqlDbType.NVarChar).Value = serviceImageTypeRcd;
        ...
        // parameters:
        //  serviceImageTypeRcd: primary key of table service_image_type_ref
        public static CrudeServiceImageTypeRefData GetByServiceImageTypeRcd(string serviceImageTypeRcd) {
            // create query against service_image_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServiceImageTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_image_type_ref
        ...
        public static List<CrudeServiceImageTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServiceImageTypeRefData>();
            ...
            string sql = @" select service_image_type_rcd, service_image_type_name, user_id, date_time
                            from [service_image_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_image_type_ref
        ...
        public void FetchByServiceImageTypeName(string serviceImageTypeName) {
            // create query against service_image_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 service_image_type_rcd, service_image_type_name, user_id, date_time
                            from [service_image_type_ref]
                            where service_image_type_name like '%' + @serviceImageTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@serviceImageTypeName",SqlDbType.NVarChar).Value = serviceImageTypeName;
        ...
        public static List<CrudeServiceImageTypeRefData> FetchAll() {
            var dataList = new List<CrudeServiceImageTypeRefData>();
        ...
        public static List<CrudeServiceImageTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServiceImageTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_image_type_rcd, service_image_type_name, user_id, date_time
                            from [service_image_type_ref]
                            order by service_image_type_name";
        ...
        public static List<CrudeServiceImageTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServiceImageTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_image_type_ref]";
        ...
        public static List<CrudeServiceImageTypeRefData> FetchWithFilter(string serviceImageTypeRcd, string serviceImageTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeServiceImageTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(serviceImageTypeName)) {
                        sql += "  and service_image_type_name like '%' + @service_image_type_name + '%'";
                        command.Parameters.Add("@service_image_type_name", SqlDbType.NVarChar).Value = serviceImageTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by service_image_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["service_image_type_name"] != System.DBNull.Value) ServiceImageTypeName = (System.String) reader["service_image_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [service_image_type_ref] (service_image_type_rcd, service_image_type_name, user_id, date_time)";
            sql += "            values (@service_image_type_rcd, @service_image_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_image_type_name",SqlDbType.NVarChar).Value = (System.String)ServiceImageTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [service_image_type_ref] set
                 service_image_type_rcd = @service_image_type_rcd
                ,service_image_type_name = @service_image_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where service_image_type_rcd = @service_image_type_rcd";
        ...
        public static void Delete(string serviceImageTypeRcd) {
            // create query against service_image_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_image_type_ref] 
                where service_image_type_rcd = @service_image_type_rcd";
