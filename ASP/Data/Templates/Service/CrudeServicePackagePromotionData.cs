/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:32:21 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of service_package_promotion's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeServicePackagePromotionData {
        ...
        public void FetchByServicePackagePromotionId(System.Guid servicePackagePromotionId) {
            // create query against service_package_promotion
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 service_package_promotion_id, service_package_id, promotion_price_amount, financial_currency_id, user_id, date_time, booking_id, client_id
                            from [service_package_promotion]
                            where service_package_promotion_id = @service_package_promotion_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@service_package_promotion_id",SqlDbType.UniqueIdentifier).Value = servicePackagePromotionId;
        ...
        // parameters:
        //  servicePackagePromotionId: primary key of table service_package_promotion
        public static CrudeServicePackagePromotionData GetByServicePackagePromotionId(System.Guid servicePackagePromotionId) {
            // create query against service_package_promotion
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeServicePackagePromotionData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against service_package_promotion
        ...
        public static List<CrudeServicePackagePromotionData> FetchByServicePackageId(System.Guid servicePackageId) {
            var dataList = new List<CrudeServicePackagePromotionData>();
            ...
            string sql = @" select service_package_promotion_id, service_package_id, promotion_price_amount, financial_currency_id, user_id, date_time, booking_id, client_id
                            from [service_package_promotion]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of service_package_promotion
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackagePromotionData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeServicePackagePromotionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackagePromotionData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeServicePackagePromotionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackagePromotionData> FetchByBookingId(System.Guid bookingId) {
            var dataList = new List<CrudeServicePackagePromotionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeServicePackagePromotionData> FetchByClientId(System.Guid clientId) {
            var dataList = new List<CrudeServicePackagePromotionData>();
        ...
        public static List<CrudeServicePackagePromotionData> FetchAll() {
            var dataList = new List<CrudeServicePackagePromotionData>();
        ...
        public static List<CrudeServicePackagePromotionData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeServicePackagePromotionData>();
            ...
            string sql = @" select top " + limit.ToString() + @" service_package_promotion_id, service_package_id, promotion_price_amount, financial_currency_id, user_id, date_time, booking_id, client_id
                            from [service_package_promotion]";
        ...
        public static List<CrudeServicePackagePromotionData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeServicePackagePromotionData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [service_package_promotion]";
        ...
        public static List<CrudeServicePackagePromotionData> FetchWithFilter(System.Guid servicePackagePromotionId, System.Guid servicePackageId, decimal promotionPriceAmount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime, System.Guid bookingId, System.Guid clientId) {
            var dataList = new List<CrudeServicePackagePromotionData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (servicePackagePromotionId != Guid.Empty) {
                        sql += "  and service_package_promotion_id = @service_package_promotion_id";
                        command.Parameters.Add("@service_package_promotion_id", SqlDbType.UniqueIdentifier).Value = servicePackagePromotionId;
                    }
                    ...
                    if (promotionPriceAmount != 0) {
                        sql += "  and promotion_price_amount = @promotion_price_amount";
                        command.Parameters.Add("@promotion_price_amount", SqlDbType.Decimal).Value = promotionPriceAmount;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["service_package_promotion_id"] != System.DBNull.Value) ServicePackagePromotionId = (System.Guid) reader["service_package_promotion_id"];
            if (reader["service_package_id"] != System.DBNull.Value) ServicePackageId = (System.Guid) reader["service_package_id"];
            if (reader["promotion_price_amount"] != System.DBNull.Value) PromotionPriceAmount = (System.Decimal) reader["promotion_price_amount"];
        ...
        public void Insert() {
            ...
            if (ServicePackagePromotionId == Guid.Empty)
                ServicePackagePromotionId = Guid.NewGuid();
            ...
            string sql = "insert into [service_package_promotion] (service_package_promotion_id, service_package_id, promotion_price_amount, financial_currency_id, user_id, date_time, booking_id, client_id)";
            sql += "            values (@service_package_promotion_id, @service_package_id, @promotion_price_amount, @financial_currency_id, @user_id, @date_time, @booking_id, @client_id)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@service_package_promotion_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServicePackagePromotionId;
                    command.Parameters.Add("@service_package_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServicePackageId;
                    command.Parameters.Add("@promotion_price_amount",SqlDbType.Decimal).Value = (PromotionPriceAmount == 0 ? (object)DBNull.Value : (System.Decimal)PromotionPriceAmount);
                    ...
                    command.Parameters.Add("@booking_id",SqlDbType.UniqueIdentifier).Value = (BookingId == Guid.Empty ? (object)DBNull.Value : (System.Guid)BookingId);
        ...
        public void Update() {
            ...
            string sql = @" update [service_package_promotion] set
                 service_package_promotion_id = @service_package_promotion_id
        ...
        public static void Delete(System.Guid servicePackagePromotionId) {
            // create query against service_package_promotion
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [service_package_promotion] 
                where service_package_promotion_id = @service_package_promotion_id";
