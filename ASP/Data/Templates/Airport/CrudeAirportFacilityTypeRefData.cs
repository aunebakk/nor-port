/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:41:02 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of airport_facility_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAirportFacilityTypeRefData {
        
        public string AirportFacilityTypeRcd { get; set; }
        
        public string AirportFacilityTypeName { get; set; }
        ...
        public void FetchByAirportFacilityTypeRcd(string airportFacilityTypeRcd) {
            // create query against airport_facility_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_facility_type_rcd, airport_facility_type_name, user_id, date_time
                            from [airport_facility_type_ref]
                            where airport_facility_type_rcd = @airport_facility_type_rcd
                            order by airport_facility_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_facility_type_rcd",SqlDbType.NVarChar).Value = airportFacilityTypeRcd;
        ...
        // parameters:
        //  airportFacilityTypeRcd: primary key of table airport_facility_type_ref
        public static CrudeAirportFacilityTypeRefData GetByAirportFacilityTypeRcd(string airportFacilityTypeRcd) {
            // create query against airport_facility_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportFacilityTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_facility_type_ref
        ...
        public static List<CrudeAirportFacilityTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportFacilityTypeRefData>();
            ...
            string sql = @" select airport_facility_type_rcd, airport_facility_type_name, user_id, date_time
                            from [airport_facility_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_facility_type_ref
        ...
        public void FetchByAirportFacilityTypeName(string airportFacilityTypeName) {
            // create query against airport_facility_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airport_facility_type_rcd, airport_facility_type_name, user_id, date_time
                            from [airport_facility_type_ref]
                            where airport_facility_type_name like '%' + @airportFacilityTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airportFacilityTypeName",SqlDbType.NVarChar).Value = airportFacilityTypeName;
        ...
        public static List<CrudeAirportFacilityTypeRefData> FetchAll() {
            var dataList = new List<CrudeAirportFacilityTypeRefData>();
        ...
        public static List<CrudeAirportFacilityTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportFacilityTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_facility_type_rcd, airport_facility_type_name, user_id, date_time
                            from [airport_facility_type_ref]
                            order by airport_facility_type_name";
        ...
        public static List<CrudeAirportFacilityTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportFacilityTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_facility_type_ref]";
        ...
        public static List<CrudeAirportFacilityTypeRefData> FetchWithFilter(string airportFacilityTypeRcd, string airportFacilityTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportFacilityTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(airportFacilityTypeName)) {
                        sql += "  and airport_facility_type_name like '%' + @airport_facility_type_name + '%'";
                        command.Parameters.Add("@airport_facility_type_name", SqlDbType.NVarChar).Value = airportFacilityTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by airport_facility_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["airport_facility_type_name"] != System.DBNull.Value) AirportFacilityTypeName = (System.String) reader["airport_facility_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airport_facility_type_ref] (airport_facility_type_rcd, airport_facility_type_name, user_id, date_time)";
            sql += "            values (@airport_facility_type_rcd, @airport_facility_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_facility_type_name",SqlDbType.NVarChar).Value = (System.String)AirportFacilityTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_facility_type_ref] set
                 airport_facility_type_rcd = @airport_facility_type_rcd
                ,airport_facility_type_name = @airport_facility_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where airport_facility_type_rcd = @airport_facility_type_rcd";
        ...
        public static void Delete(string airportFacilityTypeRcd) {
            // create query against airport_facility_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_facility_type_ref] 
                where airport_facility_type_rcd = @airport_facility_type_rcd";
