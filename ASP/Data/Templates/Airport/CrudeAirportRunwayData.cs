/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:15:46 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of airport_runway's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAirportRunwayData {
        ...
        public void FetchByAirportRunwayId(System.Guid airportRunwayId) {
            // create query against airport_runway
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_runway_id, airport_id, direction, dimensions, surface, instrument_landing_system_type, user_id, date_time
                            from [airport_runway]
                            where airport_runway_id = @airport_runway_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_runway_id",SqlDbType.UniqueIdentifier).Value = airportRunwayId;
        ...
        // parameters:
        //  airportRunwayId: primary key of table airport_runway
        public static CrudeAirportRunwayData GetByAirportRunwayId(System.Guid airportRunwayId) {
            // create query against airport_runway
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportRunwayData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_runway
        ...
        public static List<CrudeAirportRunwayData> FetchByAirportId(System.Guid airportId) {
            var dataList = new List<CrudeAirportRunwayData>();
            ...
            string sql = @" select airport_runway_id, airport_id, direction, dimensions, surface, instrument_landing_system_type, user_id, date_time
                            from [airport_runway]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_runway
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportRunwayData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportRunwayData>();
        ...
        public static List<CrudeAirportRunwayData> FetchAll() {
            var dataList = new List<CrudeAirportRunwayData>();
        ...
        public static List<CrudeAirportRunwayData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportRunwayData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_runway_id, airport_id, direction, dimensions, surface, instrument_landing_system_type, user_id, date_time
                            from [airport_runway]";
        ...
        public static List<CrudeAirportRunwayData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportRunwayData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_runway]";
        ...
        public static List<CrudeAirportRunwayData> FetchWithFilter(System.Guid airportRunwayId, System.Guid airportId, string direction, string dimensions, string surface, string instrumentLandingSystemType, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportRunwayData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airportRunwayId != Guid.Empty) {
                        sql += "  and airport_runway_id = @airport_runway_id";
                        command.Parameters.Add("@airport_runway_id", SqlDbType.UniqueIdentifier).Value = airportRunwayId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(direction)) {
                        sql += "  and direction like '%' + @direction + '%'";
                        command.Parameters.Add("@direction", SqlDbType.NVarChar).Value = direction.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(dimensions)) {
                        sql += "  and dimensions like '%' + @dimensions + '%'";
                        command.Parameters.Add("@dimensions", SqlDbType.NVarChar).Value = dimensions.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(surface)) {
                        sql += "  and surface like '%' + @surface + '%'";
                        command.Parameters.Add("@surface", SqlDbType.NVarChar).Value = surface.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(instrumentLandingSystemType)) {
                        sql += "  and instrument_landing_system_type like '%' + @instrument_landing_system_type + '%'";
                        command.Parameters.Add("@instrument_landing_system_type", SqlDbType.NVarChar).Value = instrumentLandingSystemType.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_runway_id"] != System.DBNull.Value) AirportRunwayId = (System.Guid) reader["airport_runway_id"];
            if (reader["airport_id"] != System.DBNull.Value) AirportId = (System.Guid) reader["airport_id"];
            if (reader["direction"] != System.DBNull.Value) Direction = (System.String) reader["direction"];
            if (reader["dimensions"] != System.DBNull.Value) Dimensions = (System.String) reader["dimensions"];
            if (reader["surface"] != System.DBNull.Value) Surface = (System.String) reader["surface"];
            if (reader["instrument_landing_system_type"] != System.DBNull.Value) InstrumentLandingSystemType = (System.String) reader["instrument_landing_system_type"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airport_runway] (airport_runway_id, airport_id, direction, dimensions, surface, instrument_landing_system_type, user_id, date_time)";
            sql += "            values (@airport_runway_id, @airport_id, @direction, @dimensions, @surface, @instrument_landing_system_type, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_runway_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportRunwayId;
                    command.Parameters.Add("@airport_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportId;
                    command.Parameters.Add("@direction",SqlDbType.NVarChar).Value = (System.String)Direction;
                    command.Parameters.Add("@dimensions",SqlDbType.NVarChar).Value = (System.String)Dimensions;
                    command.Parameters.Add("@surface",SqlDbType.NVarChar).Value = (System.String)Surface;
                    command.Parameters.Add("@instrument_landing_system_type",SqlDbType.NVarChar).Value = (System.String)InstrumentLandingSystemType;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_runway] set
                 airport_runway_id = @airport_runway_id
                ,airport_id = @airport_id
                ,direction = @direction
                ,dimensions = @dimensions
                ,surface = @surface
                ,instrument_landing_system_type = @instrument_landing_system_type
                ,user_id = @user_id
                ,date_time = @date_time
            where airport_runway_id = @airport_runway_id";
        ...
        public static void Delete(System.Guid airportRunwayId) {
            // create query against airport_runway
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_runway] 
                where airport_runway_id = @airport_runway_id";
