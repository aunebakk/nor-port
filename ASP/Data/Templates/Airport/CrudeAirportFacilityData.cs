/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:21:20 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of airport_facility's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAirportFacilityData {
        ...
        public void FetchByAirportFacilityId(System.Guid airportFacilityId) {
            // create query against airport_facility
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_facility_id, airport_facility_type_rcd, airport_id, airport_facility_name, user_id, date_time
                            from [airport_facility]
                            where airport_facility_id = @airport_facility_id
                            order by airport_facility_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airport_facility_id",SqlDbType.UniqueIdentifier).Value = airportFacilityId;
        ...
        // parameters:
        //  airportFacilityId: primary key of table airport_facility
        public static CrudeAirportFacilityData GetByAirportFacilityId(System.Guid airportFacilityId) {
            // create query against airport_facility
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportFacilityData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_facility
        ...
        public static List<CrudeAirportFacilityData> FetchByAirportId(System.Guid airportId) {
            var dataList = new List<CrudeAirportFacilityData>();
            ...
            string sql = @" select airport_facility_id, airport_facility_type_rcd, airport_id, airport_facility_name, user_id, date_time
                            from [airport_facility]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_facility
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportFacilityData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportFacilityData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportFacilityData> FetchByAirportFacilityTypeRcd(string airportFacilityTypeRcd) {
            var dataList = new List<CrudeAirportFacilityData>();
            ...
            string sql = @" select airport_facility_id, airport_facility_type_rcd, airport_id, airport_facility_name, user_id, date_time
                            from [airport_facility]
                            where airport_facility_type_rcd = @airport_facility_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@airport_facility_type_rcd", SqlDbType.NVarChar).Value = airportFacilityTypeRcd.Replace("'","''");
        ...
        public void FetchByAirportFacilityName(string airportFacilityName) {
            // create query against airport_facility
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airport_facility_id, airport_facility_type_rcd, airport_id, airport_facility_name, user_id, date_time
                            from [airport_facility]
                            where airport_facility_name like '%' + @airportFacilityName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airportFacilityName",SqlDbType.NVarChar).Value = airportFacilityName;
        ...
        public static List<CrudeAirportFacilityData> FetchAll() {
            var dataList = new List<CrudeAirportFacilityData>();
        ...
        public static List<CrudeAirportFacilityData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportFacilityData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_facility_id, airport_facility_type_rcd, airport_id, airport_facility_name, user_id, date_time
                            from [airport_facility]
                            order by airport_facility_name";
        ...
        public static List<CrudeAirportFacilityData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportFacilityData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_facility]";
        ...
        public static List<CrudeAirportFacilityData> FetchWithFilter(System.Guid airportFacilityId, string airportFacilityTypeRcd, System.Guid airportId, string airportFacilityName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportFacilityData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airportFacilityId != Guid.Empty) {
                        sql += "  and airport_facility_id = @airport_facility_id";
                        command.Parameters.Add("@airport_facility_id", SqlDbType.UniqueIdentifier).Value = airportFacilityId;
                    }
                    if (!string.IsNullOrEmpty(airportFacilityTypeRcd)) {
                        sql += "  and airport_facility_type_rcd like '%' + @airport_facility_type_rcd + '%'";
                        command.Parameters.Add("@airport_facility_type_rcd", SqlDbType.NVarChar).Value = airportFacilityTypeRcd.Replace("'","''");
                    }
                    ...
                    if (!string.IsNullOrEmpty(airportFacilityName)) {
                        sql += "  and airport_facility_name like '%' + @airport_facility_name + '%'";
                        command.Parameters.Add("@airport_facility_name", SqlDbType.NVarChar).Value = airportFacilityName.Replace("'","''");
                    }
                    ...
                    sql += " order by airport_facility_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["airport_facility_id"] != System.DBNull.Value) AirportFacilityId = (System.Guid) reader["airport_facility_id"];
            if (reader["airport_facility_type_rcd"] != System.DBNull.Value) AirportFacilityTypeRcd = (System.String) reader["airport_facility_type_rcd"];
            if (reader["airport_id"] != System.DBNull.Value) AirportId = (System.Guid) reader["airport_id"];
            if (reader["airport_facility_name"] != System.DBNull.Value) AirportFacilityName = (System.String) reader["airport_facility_name"];
        ...
        public void Insert() {
            ...
            if (AirportFacilityId == Guid.Empty)
                AirportFacilityId = Guid.NewGuid();
            ...
            string sql = "insert into [airport_facility] (airport_facility_id, airport_facility_type_rcd, airport_id, airport_facility_name, user_id, date_time)";
            sql += "            values (@airport_facility_id, @airport_facility_type_rcd, @airport_id, @airport_facility_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_facility_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportFacilityId;
                    command.Parameters.Add("@airport_facility_type_rcd",SqlDbType.NVarChar).Value = (System.String)AirportFacilityTypeRcd;
                    command.Parameters.Add("@airport_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirportId;
                    command.Parameters.Add("@airport_facility_name",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(AirportFacilityName)) ? (object)DBNull.Value : (System.String)AirportFacilityName;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_facility] set
                 airport_facility_id = @airport_facility_id
                ,airport_facility_type_rcd = @airport_facility_type_rcd
                ,airport_id = @airport_id
                ,airport_facility_name = @airport_facility_name
                ,user_id = @user_id
                ,date_time = @date_time
            where airport_facility_id = @airport_facility_id";
        ...
        public static void Delete(System.Guid airportFacilityId) {
            // create query against airport_facility
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_facility] 
                where airport_facility_id = @airport_facility_id";
