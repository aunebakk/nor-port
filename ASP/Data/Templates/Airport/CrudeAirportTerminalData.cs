/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:21:48 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of airport_terminal's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAirportTerminalData {
        ...
        public void FetchByAirportTerminalId(System.Guid airportTerminalId) {
            // create query against airport_terminal
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airport_terminal_id, airport_id, airport_terminal_name, user_id, date_time
                            from [airport_terminal]
                            where airport_terminal_id = @airport_terminal_id
                            order by airport_terminal_name";
        ...
        // parameters:
        //  airportTerminalId: primary key of table airport_terminal
        public static CrudeAirportTerminalData GetByAirportTerminalId(System.Guid airportTerminalId) {
            // create query against airport_terminal
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirportTerminalData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airport_terminal
        ...
        public static List<CrudeAirportTerminalData> FetchByAirportId(System.Guid airportId) {
            var dataList = new List<CrudeAirportTerminalData>();
            ...
            string sql = @" select airport_terminal_id, airport_id, airport_terminal_name, user_id, date_time
                            from [airport_terminal]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airport_terminal
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirportTerminalData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirportTerminalData>();
        ...
        public void FetchByAirportTerminalName(string airportTerminalName) {
            // create query against airport_terminal
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airport_terminal_id, airport_id, airport_terminal_name, user_id, date_time
                            from [airport_terminal]
                            where airport_terminal_name like '%' + @airportTerminalName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airportTerminalName",SqlDbType.NVarChar).Value = airportTerminalName;
        ...
        public static List<CrudeAirportTerminalData> FetchAll() {
            var dataList = new List<CrudeAirportTerminalData>();
        ...
        public static List<CrudeAirportTerminalData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirportTerminalData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airport_terminal_id, airport_id, airport_terminal_name, user_id, date_time
                            from [airport_terminal]
                            order by airport_terminal_name";
        ...
        public static List<CrudeAirportTerminalData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirportTerminalData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airport_terminal]";
        ...
        public static List<CrudeAirportTerminalData> FetchWithFilter(System.Guid airportTerminalId, System.Guid airportId, string airportTerminalName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirportTerminalData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(airportTerminalName)) {
                        sql += "  and airport_terminal_name like '%' + @airport_terminal_name + '%'";
                        command.Parameters.Add("@airport_terminal_name", SqlDbType.NVarChar).Value = airportTerminalName.Replace("'","''");
                    }
                    ...
                    sql += " order by airport_terminal_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["airport_terminal_name"] != System.DBNull.Value) AirportTerminalName = (System.String) reader["airport_terminal_name"];
        ...
        public void Insert() {
            ...
            if (AirportTerminalId == Guid.Empty)
                AirportTerminalId = Guid.NewGuid();
            ...
            string sql = "insert into [airport_terminal] (airport_terminal_id, airport_id, airport_terminal_name, user_id, date_time)";
            sql += "            values (@airport_terminal_id, @airport_id, @airport_terminal_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airport_terminal_name",SqlDbType.NVarChar).Value = (System.String)AirportTerminalName;
        ...
        public void Update() {
            ...
            string sql = @" update [airport_terminal] set
                 airport_terminal_id = @airport_terminal_id
                ,airport_id = @airport_id
                ,airport_terminal_name = @airport_terminal_name
                ,user_id = @user_id
                ,date_time = @date_time
            where airport_terminal_id = @airport_terminal_id";
        ...
        public static void Delete(System.Guid airportTerminalId) {
            // create query against airport_terminal
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airport_terminal] 
                where airport_terminal_id = @airport_terminal_id";
