/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:15:03 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of airline_language's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAirlineLanguageData {
        ...
        public void FetchByAirlineLanguageId(System.Guid airlineLanguageId) {
            // create query against airline_language
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airline_language_id, airline_id, language_rcd, airline_language_name, user_id, date_time
                            from [airline_language]
                            where airline_language_id = @airline_language_id
                            order by airline_language_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airline_language_id",SqlDbType.UniqueIdentifier).Value = airlineLanguageId;
        ...
        // parameters:
        //  airlineLanguageId: primary key of table airline_language
        public static CrudeAirlineLanguageData GetByAirlineLanguageId(System.Guid airlineLanguageId) {
            // create query against airline_language
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirlineLanguageData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airline_language
        ...
        public static List<CrudeAirlineLanguageData> FetchByAirlineId(System.Guid airlineId) {
            var dataList = new List<CrudeAirlineLanguageData>();
            ...
            string sql = @" select airline_language_id, airline_id, language_rcd, airline_language_name, user_id, date_time
                            from [airline_language]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airline_language
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineLanguageData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirlineLanguageData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineLanguageData> FetchByLanguageRcd(string languageRcd) {
            var dataList = new List<CrudeAirlineLanguageData>();
            ...
            string sql = @" select airline_language_id, airline_id, language_rcd, airline_language_name, user_id, date_time
                            from [airline_language]
                            where language_rcd = @language_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@language_rcd", SqlDbType.NVarChar).Value = languageRcd.Replace("'","''");
        ...
        public void FetchByAirlineLanguageName(string airlineLanguageName) {
            // create query against airline_language
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airline_language_id, airline_id, language_rcd, airline_language_name, user_id, date_time
                            from [airline_language]
                            where airline_language_name like '%' + @airlineLanguageName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airlineLanguageName",SqlDbType.NVarChar).Value = airlineLanguageName;
        ...
        public static List<CrudeAirlineLanguageData> FetchAll() {
            var dataList = new List<CrudeAirlineLanguageData>();
        ...
        public static List<CrudeAirlineLanguageData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirlineLanguageData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airline_language_id, airline_id, language_rcd, airline_language_name, user_id, date_time
                            from [airline_language]
                            order by airline_language_name";
        ...
        public static List<CrudeAirlineLanguageData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirlineLanguageData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airline_language]";
        ...
        public static List<CrudeAirlineLanguageData> FetchWithFilter(System.Guid airlineLanguageId, System.Guid airlineId, string languageRcd, string airlineLanguageName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirlineLanguageData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airlineLanguageId != Guid.Empty) {
                        sql += "  and airline_language_id = @airline_language_id";
                        command.Parameters.Add("@airline_language_id", SqlDbType.UniqueIdentifier).Value = airlineLanguageId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(languageRcd)) {
                        sql += "  and language_rcd like '%' + @language_rcd + '%'";
                        command.Parameters.Add("@language_rcd", SqlDbType.NVarChar).Value = languageRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(airlineLanguageName)) {
                        sql += "  and airline_language_name like '%' + @airline_language_name + '%'";
                        command.Parameters.Add("@airline_language_name", SqlDbType.NVarChar).Value = airlineLanguageName.Replace("'","''");
                    }
                    ...
                    sql += " order by airline_language_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["airline_language_id"] != System.DBNull.Value) AirlineLanguageId = (System.Guid) reader["airline_language_id"];
            if (reader["airline_id"] != System.DBNull.Value) AirlineId = (System.Guid) reader["airline_id"];
            if (reader["language_rcd"] != System.DBNull.Value) LanguageRcd = (System.String) reader["language_rcd"];
            if (reader["airline_language_name"] != System.DBNull.Value) AirlineLanguageName = (System.String) reader["airline_language_name"];
        ...
        public void Insert() {
            ...
            if (AirlineLanguageId == Guid.Empty)
                AirlineLanguageId = Guid.NewGuid();
            ...
            string sql = "insert into [airline_language] (airline_language_id, airline_id, language_rcd, airline_language_name, user_id, date_time)";
            sql += "            values (@airline_language_id, @airline_id, @language_rcd, @airline_language_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airline_language_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineLanguageId;
                    command.Parameters.Add("@airline_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineId;
                    command.Parameters.Add("@language_rcd",SqlDbType.NVarChar).Value = (System.String)LanguageRcd;
                    command.Parameters.Add("@airline_language_name",SqlDbType.NVarChar).Value = (System.String)AirlineLanguageName;
        ...
        public void Update() {
            ...
            string sql = @" update [airline_language] set
                 airline_language_id = @airline_language_id
                ,airline_id = @airline_id
                ,language_rcd = @language_rcd
                ,airline_language_name = @airline_language_name
                ,user_id = @user_id
                ,date_time = @date_time
            where airline_language_id = @airline_language_id";
        ...
        public static void Delete(System.Guid airlineLanguageId) {
            // create query against airline_language
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airline_language] 
                where airline_language_id = @airline_language_id";
