/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:21:13 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of airline_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAirlineTypeRefData {
        ...
        public void FetchByAirlineTypeRcd(string airlineTypeRcd) {
            // create query against airline_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airline_type_rcd, airline_type_name, user_id, date_time
                            from [airline_type_ref]
                            where airline_type_rcd = @airline_type_rcd
                            order by airline_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airline_type_rcd",SqlDbType.NVarChar).Value = airlineTypeRcd;
        ...
        // parameters:
        //  airlineTypeRcd: primary key of table airline_type_ref
        public static CrudeAirlineTypeRefData GetByAirlineTypeRcd(string airlineTypeRcd) {
            // create query against airline_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirlineTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airline_type_ref
        ...
        public static List<CrudeAirlineTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirlineTypeRefData>();
            ...
            string sql = @" select airline_type_rcd, airline_type_name, user_id, date_time
                            from [airline_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airline_type_ref
        ...
        public void FetchByAirlineTypeName(string airlineTypeName) {
            // create query against airline_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airline_type_rcd, airline_type_name, user_id, date_time
                            from [airline_type_ref]
                            where airline_type_name like '%' + @airlineTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airlineTypeName",SqlDbType.NVarChar).Value = airlineTypeName;
        ...
        public static List<CrudeAirlineTypeRefData> FetchAll() {
            var dataList = new List<CrudeAirlineTypeRefData>();
        ...
        public static List<CrudeAirlineTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirlineTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airline_type_rcd, airline_type_name, user_id, date_time
                            from [airline_type_ref]
                            order by airline_type_name";
        ...
        public static List<CrudeAirlineTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirlineTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airline_type_ref]";
        ...
        public static List<CrudeAirlineTypeRefData> FetchWithFilter(string airlineTypeRcd, string airlineTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirlineTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(airlineTypeName)) {
                        sql += "  and airline_type_name like '%' + @airline_type_name + '%'";
                        command.Parameters.Add("@airline_type_name", SqlDbType.NVarChar).Value = airlineTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by airline_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["airline_type_name"] != System.DBNull.Value) AirlineTypeName = (System.String) reader["airline_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airline_type_ref] (airline_type_rcd, airline_type_name, user_id, date_time)";
            sql += "            values (@airline_type_rcd, @airline_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airline_type_name",SqlDbType.NVarChar).Value = (System.String)AirlineTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [airline_type_ref] set
                 airline_type_rcd = @airline_type_rcd
                ,airline_type_name = @airline_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where airline_type_rcd = @airline_type_rcd";
        ...
        public static void Delete(string airlineTypeRcd) {
            // create query against airline_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airline_type_ref] 
                where airline_type_rcd = @airline_type_rcd";
