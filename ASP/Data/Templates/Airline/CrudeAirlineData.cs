/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:20:50 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of airline's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAirlineData {
        ...
        public void FetchByAirlineId(System.Guid airlineId) {
            // create query against airline
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airline_id, airline_name, airline_type_rcd, legal_name, address_id, product_id, stock_market_symbol, aircraft_count, user_id, date_time
                            from [airline]
        ...
        // parameters:
        //  airlineId: primary key of table airline
        public static CrudeAirlineData GetByAirlineId(System.Guid airlineId) {
            // create query against airline
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeAirlineData> FetchByAddressId(System.Guid addressId) {
            var dataList = new List<CrudeAirlineData>();
            ...
            string sql = @" select airline_id, airline_name, airline_type_rcd, legal_name, address_id, product_id, stock_market_symbol, aircraft_count, user_id, date_time
                            from [airline]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@address_id", SqlDbType.UniqueIdentifier).Value = addressId;
                    ...
                    // read all rows returned from the query of airline
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineData> FetchByProductId(System.Guid productId) {
            var dataList = new List<CrudeAirlineData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirlineData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineData> FetchByAirlineTypeRcd(string airlineTypeRcd) {
            var dataList = new List<CrudeAirlineData>();
            ...
            string sql = @" select airline_id, airline_name, airline_type_rcd, legal_name, address_id, product_id, stock_market_symbol, aircraft_count, user_id, date_time
                            from [airline]
                            where airline_type_rcd = @airline_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@airline_type_rcd", SqlDbType.NVarChar).Value = airlineTypeRcd.Replace("'","''");
        ...
        public void FetchByAirlineName(string airlineName) {
            // create query against airline
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 airline_id, airline_name, airline_type_rcd, legal_name, address_id, product_id, stock_market_symbol, aircraft_count, user_id, date_time
                            from [airline]
                            where airline_name like '%' + @airlineName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@airlineName",SqlDbType.NVarChar).Value = airlineName;
        ...
        public static List<CrudeAirlineData> FetchAll() {
            var dataList = new List<CrudeAirlineData>();
        ...
        public static List<CrudeAirlineData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirlineData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airline_id, airline_name, airline_type_rcd, legal_name, address_id, product_id, stock_market_symbol, aircraft_count, user_id, date_time
                            from [airline]
                            order by airline_name";
        ...
        public static List<CrudeAirlineData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirlineData>();
        ...
        public static List<CrudeAirlineData> FetchWithFilter(System.Guid airlineId, string airlineName, string airlineTypeRcd, string legalName, System.Guid addressId, System.Guid productId, string stockMarketSymbol, int aircraftCount, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirlineData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(airlineName)) {
                        sql += "  and airline_name like '%' + @airline_name + '%'";
                        command.Parameters.Add("@airline_name", SqlDbType.NVarChar).Value = airlineName.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(airlineTypeRcd)) {
                        sql += "  and airline_type_rcd like '%' + @airline_type_rcd + '%'";
                        command.Parameters.Add("@airline_type_rcd", SqlDbType.NVarChar).Value = airlineTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(legalName)) {
                        sql += "  and legal_name like '%' + @legal_name + '%'";
                        command.Parameters.Add("@legal_name", SqlDbType.NVarChar).Value = legalName.Replace("'","''");
                    }
                    ...
                    if (!string.IsNullOrEmpty(stockMarketSymbol)) {
                        sql += "  and stock_market_symbol like '%' + @stock_market_symbol + '%'";
                        command.Parameters.Add("@stock_market_symbol", SqlDbType.NVarChar).Value = stockMarketSymbol.Replace("'","''");
                    }
                    if (aircraftCount != 0) {
                        sql += "  and aircraft_count = @aircraft_count";
                        command.Parameters.Add("@aircraft_count", SqlDbType.Int).Value = aircraftCount;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["airline_name"] != System.DBNull.Value) AirlineName = (System.String) reader["airline_name"];
            if (reader["airline_type_rcd"] != System.DBNull.Value) AirlineTypeRcd = (System.String) reader["airline_type_rcd"];
            if (reader["legal_name"] != System.DBNull.Value) LegalName = (System.String) reader["legal_name"];
            if (reader["address_id"] != System.DBNull.Value) AddressId = (System.Guid) reader["address_id"];
            if (reader["product_id"] != System.DBNull.Value) ProductId = (System.Guid) reader["product_id"];
            if (reader["stock_market_symbol"] != System.DBNull.Value) StockMarketSymbol = (System.String) reader["stock_market_symbol"];
            if (reader["aircraft_count"] != System.DBNull.Value) AircraftCount = (System.Int32) reader["aircraft_count"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airline] (airline_id, airline_name, airline_type_rcd, legal_name, address_id, product_id, stock_market_symbol, aircraft_count, user_id, date_time)";
            sql += "            values (@airline_id, @airline_name, @airline_type_rcd, @legal_name, @address_id, @product_id, @stock_market_symbol, @aircraft_count, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airline_name",SqlDbType.NVarChar).Value = (System.String)AirlineName;
                    command.Parameters.Add("@airline_type_rcd",SqlDbType.NVarChar).Value = (System.String)AirlineTypeRcd;
                    command.Parameters.Add("@legal_name",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(LegalName)) ? (object)DBNull.Value : (System.String)LegalName;
                    command.Parameters.Add("@address_id",SqlDbType.UniqueIdentifier).Value = (AddressId == Guid.Empty ? (object)DBNull.Value : (System.Guid)AddressId);
                    ...
                    command.Parameters.Add("@stock_market_symbol",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(StockMarketSymbol)) ? (object)DBNull.Value : (System.String)StockMarketSymbol;
                    command.Parameters.Add("@aircraft_count",SqlDbType.Int).Value = (AircraftCount == 0 ? (object)DBNull.Value : (System.Int32)AircraftCount);
        ...
        public void Update() {
            ...
            string sql = @" update [airline] set
                ...
                ,airline_type_rcd = @airline_type_rcd
                ,legal_name = @legal_name
                ,address_id = @address_id
                ,product_id = @product_id
                ,stock_market_symbol = @stock_market_symbol
        ...
        public static void Delete(System.Guid airlineId) {
            // create query against airline
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
