/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:21:10 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of airline_link's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAirlineLinkData {
        ...
        public void FetchByAirlineLinkId(System.Guid airlineLinkId) {
            // create query against airline_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 airline_link_id, airline_id, link_type_rcd, link_name, link, user_id, date_time
                            from [airline_link]
                            where airline_link_id = @airline_link_id
                            order by link_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@airline_link_id",SqlDbType.UniqueIdentifier).Value = airlineLinkId;
        ...
        // parameters:
        //  airlineLinkId: primary key of table airline_link
        public static CrudeAirlineLinkData GetByAirlineLinkId(System.Guid airlineLinkId) {
            // create query against airline_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAirlineLinkData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against airline_link
        ...
        public static List<CrudeAirlineLinkData> FetchByAirlineId(System.Guid airlineId) {
            var dataList = new List<CrudeAirlineLinkData>();
            ...
            string sql = @" select airline_link_id, airline_id, link_type_rcd, link_name, link, user_id, date_time
                            from [airline_link]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of airline_link
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineLinkData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAirlineLinkData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAirlineLinkData> FetchByLinkTypeRcd(string linkTypeRcd) {
            var dataList = new List<CrudeAirlineLinkData>();
        ...
        public static List<CrudeAirlineLinkData> FetchAll() {
            var dataList = new List<CrudeAirlineLinkData>();
        ...
        public static List<CrudeAirlineLinkData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAirlineLinkData>();
            ...
            string sql = @" select top " + limit.ToString() + @" airline_link_id, airline_id, link_type_rcd, link_name, link, user_id, date_time
                            from [airline_link]
                            order by link_name";
        ...
        public static List<CrudeAirlineLinkData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAirlineLinkData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [airline_link]";
        ...
        public static List<CrudeAirlineLinkData> FetchWithFilter(System.Guid airlineLinkId, System.Guid airlineId, string linkTypeRcd, string linkName, string link, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAirlineLinkData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (airlineLinkId != Guid.Empty) {
                        sql += "  and airline_link_id = @airline_link_id";
                        command.Parameters.Add("@airline_link_id", SqlDbType.UniqueIdentifier).Value = airlineLinkId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["airline_link_id"] != System.DBNull.Value) AirlineLinkId = (System.Guid) reader["airline_link_id"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [airline_link] (airline_link_id, airline_id, link_type_rcd, link_name, link, user_id, date_time)";
            sql += "            values (@airline_link_id, @airline_id, @link_type_rcd, @link_name, @link, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@airline_link_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineLinkId;
                    ...
                    command.Parameters.Add("@link_name",SqlDbType.NVarChar).Value = (System.String)LinkName;
        ...
        public void Update() {
            ...
            string sql = @" update [airline_link] set
                 airline_link_id = @airline_link_id
        ...
        public static void Delete(System.Guid airlineLinkId) {
            // create query against airline_link
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [airline_link] 
                where airline_link_id = @airline_link_id";
