/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:24:01 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of gender_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeGenderRefData {
        ...
        public void FetchByGenderRcd(string genderRcd) {
            // create query against gender_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 gender_rcd, gender_name, user_id, date_time
                            from [gender_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@gender_rcd",SqlDbType.NVarChar).Value = genderRcd;
        ...
        // parameters:
        //  genderRcd: primary key of table gender_ref
        public static CrudeGenderRefData GetByGenderRcd(string genderRcd) {
            // create query against gender_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeGenderRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against gender_ref
        ...
        public static List<CrudeGenderRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeGenderRefData>();
            ...
            string sql = @" select gender_rcd, gender_name, user_id, date_time
                            from [gender_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of gender_ref
        ...
        public void FetchByGenderName(string genderName) {
            // create query against gender_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 gender_rcd, gender_name, user_id, date_time
                            from [gender_ref]
                            where gender_name like '%' + @genderName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@genderName",SqlDbType.NVarChar).Value = genderName;
        ...
        public static List<CrudeGenderRefData> FetchAll() {
            var dataList = new List<CrudeGenderRefData>();
        ...
        public static List<CrudeGenderRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeGenderRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" gender_rcd, gender_name, user_id, date_time
                            from [gender_ref]
                            order by gender_name";
        ...
        public static List<CrudeGenderRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeGenderRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [gender_ref]";
        ...
        public static List<CrudeGenderRefData> FetchWithFilter(string genderRcd, string genderName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeGenderRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(genderName)) {
                        sql += "  and gender_name like '%' + @gender_name + '%'";
                        command.Parameters.Add("@gender_name", SqlDbType.NVarChar).Value = genderName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["gender_name"] != System.DBNull.Value) GenderName = (System.String) reader["gender_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [gender_ref] (gender_rcd, gender_name, user_id, date_time)";
            sql += "            values (@gender_rcd, @gender_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@gender_rcd",SqlDbType.NVarChar).Value = (System.String)GenderRcd;
                    command.Parameters.Add("@gender_name",SqlDbType.NVarChar).Value = (System.String)GenderName;
        ...
        public void Update() {
            ...
            string sql = @" update [gender_ref] set
        ...
        public static void Delete(string genderRcd) {
            // create query against gender_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
