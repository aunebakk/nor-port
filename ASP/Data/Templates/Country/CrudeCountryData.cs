/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:43:19 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of country's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeCountryData {
        ...
        public void FetchByCountryId(System.Guid countryId) {
            // create query against country
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 country_id, country_code, country_name, product_id, user_id, date_time
                            from [country]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@country_id",SqlDbType.UniqueIdentifier).Value = countryId;
        ...
        // parameters:
        //  countryId: primary key of table country
        public static CrudeCountryData GetByCountryId(System.Guid countryId) {
            // create query against country
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeCountryData> FetchByProductId(System.Guid productId) {
            var dataList = new List<CrudeCountryData>();
            ...
            string sql = @" select country_id, country_code, country_name, product_id, user_id, date_time
                            from [country]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of country
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeCountryData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeCountryData>();
        ...
        public void FetchByCountryCode(string countryCode) {
            // create query against country
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeCountryData> FetchAll() {
            var dataList = new List<CrudeCountryData>();
        ...
        public static List<CrudeCountryData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeCountryData>();
            ...
            string sql = @" select top " + limit.ToString() + @" country_id, country_code, country_name, product_id, user_id, date_time
                            from [country]
                            order by country_name";
        ...
        public static List<CrudeCountryData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeCountryData>();
        ...
        public static List<CrudeCountryData> FetchWithFilter(System.Guid countryId, string countryCode, string countryName, System.Guid productId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeCountryData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(countryCode)) {
                        ...
                        command.Parameters.Add("@country_code", SqlDbType.NVarChar).Value = countryCode.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(countryName)) {
                        sql += "  and country_name like '%' + @country_name + '%'";
                        command.Parameters.Add("@country_name", SqlDbType.NVarChar).Value = countryName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["country_id"] != System.DBNull.Value) CountryId = (System.Guid) reader["country_id"];
            if (reader["country_code"] != System.DBNull.Value) CountryCode = (System.String) reader["country_code"];
            if (reader["country_name"] != System.DBNull.Value) CountryName = (System.String) reader["country_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [country] (country_id, country_code, country_name, product_id, user_id, date_time)";
            sql += "            values (@country_id, @country_code, @country_name, @product_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@country_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)CountryId;
                    command.Parameters.Add("@country_code",SqlDbType.NVarChar).Value = (System.String)CountryCode;
                    command.Parameters.Add("@country_name",SqlDbType.NVarChar).Value = (System.String)CountryName;
        ...
        public static void Delete(System.Guid countryId) {
            // create query against country
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
