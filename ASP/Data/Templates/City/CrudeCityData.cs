/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:42:49 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of city's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeCityData {
        ...
        public void FetchByCityId(System.Guid cityId) {
            // create query against city
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 city_id, country_id, city_code, city_name, product_id, user_id, date_time
                            from [city]
        ...
        // parameters:
        //  cityId: primary key of table city
        public static CrudeCityData GetByCityId(System.Guid cityId) {
            // create query against city
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeCityData> FetchByCountryId(System.Guid countryId) {
            var dataList = new List<CrudeCityData>();
            ...
            string sql = @" select city_id, country_id, city_code, city_name, product_id, user_id, date_time
                            from [city]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of city
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeCityData> FetchByProductId(System.Guid productId) {
            var dataList = new List<CrudeCityData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeCityData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeCityData>();
        ...
        public void FetchByCityCode(string cityCode) {
            // create query against city
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@cityCode",SqlDbType.NVarChar).Value = cityCode;
        ...
        public static List<CrudeCityData> FetchAll() {
            var dataList = new List<CrudeCityData>();
        ...
        public static List<CrudeCityData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeCityData>();
            ...
            string sql = @" select top " + limit.ToString() + @" city_id, country_id, city_code, city_name, product_id, user_id, date_time
                            from [city]
                            order by city_name";
        ...
        public static List<CrudeCityData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeCityData>();
        ...
        public static List<CrudeCityData> FetchWithFilter(System.Guid cityId, System.Guid countryId, string cityCode, string cityName, System.Guid productId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeCityData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(cityCode)) {
                        sql += "  and city_code like '%' + @city_code + '%'";
                        command.Parameters.Add("@city_code", SqlDbType.NVarChar).Value = cityCode.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["city_code"] != System.DBNull.Value) CityCode = (System.String) reader["city_code"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [city] (city_id, country_id, city_code, city_name, product_id, user_id, date_time)";
            sql += "            values (@city_id, @country_id, @city_code, @city_name, @product_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@city_code",SqlDbType.NVarChar).Value = (System.String)CityCode;
        ...
        public static void Delete(System.Guid cityId) {
            // create query against city
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
