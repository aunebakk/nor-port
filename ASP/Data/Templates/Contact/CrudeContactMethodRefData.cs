/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:43:15 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of contact_method_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeContactMethodRefData {
        ...
        public void FetchByContactMethodRcd(string contactMethodRcd) {
            // create query against contact_method_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 contact_method_rcd, contact_method_name, user_id, date_time
                            from [contact_method_ref]
                            where contact_method_rcd = @contact_method_rcd
                            order by contact_method_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@contact_method_rcd",SqlDbType.NVarChar).Value = contactMethodRcd;
        ...
        // parameters:
        //  contactMethodRcd: primary key of table contact_method_ref
        public static CrudeContactMethodRefData GetByContactMethodRcd(string contactMethodRcd) {
            // create query against contact_method_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeContactMethodRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against contact_method_ref
        ...
        public static List<CrudeContactMethodRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeContactMethodRefData>();
            ...
            string sql = @" select contact_method_rcd, contact_method_name, user_id, date_time
                            from [contact_method_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of contact_method_ref
        ...
        public void FetchByContactMethodName(string contactMethodName) {
            // create query against contact_method_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 contact_method_rcd, contact_method_name, user_id, date_time
                            from [contact_method_ref]
                            where contact_method_name like '%' + @contactMethodName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@contactMethodName",SqlDbType.NVarChar).Value = contactMethodName;
        ...
        public static List<CrudeContactMethodRefData> FetchAll() {
            var dataList = new List<CrudeContactMethodRefData>();
        ...
        public static List<CrudeContactMethodRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeContactMethodRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" contact_method_rcd, contact_method_name, user_id, date_time
                            from [contact_method_ref]
                            order by contact_method_name";
        ...
        public static List<CrudeContactMethodRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeContactMethodRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [contact_method_ref]";
        ...
        public static List<CrudeContactMethodRefData> FetchWithFilter(string contactMethodRcd, string contactMethodName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeContactMethodRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(contactMethodName)) {
                        sql += "  and contact_method_name like '%' + @contact_method_name + '%'";
                        command.Parameters.Add("@contact_method_name", SqlDbType.NVarChar).Value = contactMethodName.Replace("'","''");
                    }
                    ...
                    sql += " order by contact_method_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["contact_method_name"] != System.DBNull.Value) ContactMethodName = (System.String) reader["contact_method_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [contact_method_ref] (contact_method_rcd, contact_method_name, user_id, date_time)";
            sql += "            values (@contact_method_rcd, @contact_method_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@contact_method_name",SqlDbType.NVarChar).Value = (System.String)ContactMethodName;
        ...
        public void Update() {
            ...
            string sql = @" update [contact_method_ref] set
        ...
        public static void Delete(string contactMethodRcd) {
            // create query against contact_method_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [contact_method_ref] 
                where contact_method_rcd = @contact_method_rcd";
