/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:49:08 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of flight_schedule_segment_rule's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeFlightScheduleSegmentRuleData {
        
        public System.Guid FlightScheduleSegmentRuleId { get; set; }
        
        public System.Guid FlightScheduleSegmentId { get; set; }
        
        public string FlightScheduleSegmentRuleRcd { get; set; }
        ...
        public void FetchByFlightScheduleSegmentRuleId(System.Guid flightScheduleSegmentRuleId) {
            // create query against flight_schedule_segment_rule
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_schedule_segment_rule_id, flight_schedule_segment_id, flight_schedule_segment_rule_rcd, user_id, date_time
                            from [flight_schedule_segment_rule]
                            where flight_schedule_segment_rule_id = @flight_schedule_segment_rule_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@flight_schedule_segment_rule_id",SqlDbType.UniqueIdentifier).Value = flightScheduleSegmentRuleId;
        ...
        // parameters:
        //  flightScheduleSegmentRuleId: primary key of table flight_schedule_segment_rule
        public static CrudeFlightScheduleSegmentRuleData GetByFlightScheduleSegmentRuleId(System.Guid flightScheduleSegmentRuleId) {
            // create query against flight_schedule_segment_rule
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightScheduleSegmentRuleData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_schedule_segment_rule
        ...
        public static List<CrudeFlightScheduleSegmentRuleData> FetchByFlightScheduleSegmentId(System.Guid flightScheduleSegmentId) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleData>();
            ...
            string sql = @" select flight_schedule_segment_rule_id, flight_schedule_segment_id, flight_schedule_segment_rule_rcd, user_id, date_time
                            from [flight_schedule_segment_rule]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of flight_schedule_segment_rule
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleSegmentRuleData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleSegmentRuleData> FetchByFlightScheduleSegmentRuleRcd(string flightScheduleSegmentRuleRcd) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleData>();
            ...
            string sql = @" select flight_schedule_segment_rule_id, flight_schedule_segment_id, flight_schedule_segment_rule_rcd, user_id, date_time
                            from [flight_schedule_segment_rule]
                            where flight_schedule_segment_rule_rcd = @flight_schedule_segment_rule_rcd
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@flight_schedule_segment_rule_rcd", SqlDbType.NVarChar).Value = flightScheduleSegmentRuleRcd.Replace("'","''");
        ...
        public static List<CrudeFlightScheduleSegmentRuleData> FetchAll() {
            var dataList = new List<CrudeFlightScheduleSegmentRuleData>();
        ...
        public static List<CrudeFlightScheduleSegmentRuleData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_schedule_segment_rule_id, flight_schedule_segment_id, flight_schedule_segment_rule_rcd, user_id, date_time
                            from [flight_schedule_segment_rule]";
        ...
        public static List<CrudeFlightScheduleSegmentRuleData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_schedule_segment_rule]";
        ...
        public static List<CrudeFlightScheduleSegmentRuleData> FetchWithFilter(System.Guid flightScheduleSegmentRuleId, System.Guid flightScheduleSegmentId, string flightScheduleSegmentRuleRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightScheduleSegmentRuleData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (flightScheduleSegmentRuleId != Guid.Empty) {
                        sql += "  and flight_schedule_segment_rule_id = @flight_schedule_segment_rule_id";
                        command.Parameters.Add("@flight_schedule_segment_rule_id", SqlDbType.UniqueIdentifier).Value = flightScheduleSegmentRuleId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(flightScheduleSegmentRuleRcd)) {
                        sql += "  and flight_schedule_segment_rule_rcd like '%' + @flight_schedule_segment_rule_rcd + '%'";
                        command.Parameters.Add("@flight_schedule_segment_rule_rcd", SqlDbType.NVarChar).Value = flightScheduleSegmentRuleRcd.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["flight_schedule_segment_rule_id"] != System.DBNull.Value) FlightScheduleSegmentRuleId = (System.Guid) reader["flight_schedule_segment_rule_id"];
            ...
            if (reader["flight_schedule_segment_rule_rcd"] != System.DBNull.Value) FlightScheduleSegmentRuleRcd = (System.String) reader["flight_schedule_segment_rule_rcd"];
        ...
        public void Insert() {
            ...
            if (FlightScheduleSegmentRuleId == Guid.Empty)
                FlightScheduleSegmentRuleId = Guid.NewGuid();
            ...
            string sql = "insert into [flight_schedule_segment_rule] (flight_schedule_segment_rule_id, flight_schedule_segment_id, flight_schedule_segment_rule_rcd, user_id, date_time)";
            sql += "            values (@flight_schedule_segment_rule_id, @flight_schedule_segment_id, @flight_schedule_segment_rule_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_schedule_segment_rule_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightScheduleSegmentRuleId;
                    command.Parameters.Add("@flight_schedule_segment_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightScheduleSegmentId;
                    command.Parameters.Add("@flight_schedule_segment_rule_rcd",SqlDbType.NVarChar).Value = (System.String)FlightScheduleSegmentRuleRcd;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_schedule_segment_rule] set
                 flight_schedule_segment_rule_id = @flight_schedule_segment_rule_id
                ,flight_schedule_segment_id = @flight_schedule_segment_id
                ,flight_schedule_segment_rule_rcd = @flight_schedule_segment_rule_rcd
                ,user_id = @user_id
                ,date_time = @date_time
            where flight_schedule_segment_rule_id = @flight_schedule_segment_rule_id";
        ...
        public static void Delete(System.Guid flightScheduleSegmentRuleId) {
            // create query against flight_schedule_segment_rule
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_schedule_segment_rule] 
                where flight_schedule_segment_rule_id = @flight_schedule_segment_rule_id";
