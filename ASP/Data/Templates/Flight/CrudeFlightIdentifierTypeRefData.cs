/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:48:45 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of flight_identifier_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeFlightIdentifierTypeRefData {
        ...
        public void FetchByFlightIdentifierTypeRcd(string flightIdentifierTypeRcd) {
            // create query against flight_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_identifier_type_rcd, flight_identifier_type_name, user_id, date_time
                            from [flight_identifier_type_ref]
                            where flight_identifier_type_rcd = @flight_identifier_type_rcd
                            order by flight_identifier_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@flight_identifier_type_rcd",SqlDbType.NVarChar).Value = flightIdentifierTypeRcd;
        ...
        // parameters:
        //  flightIdentifierTypeRcd: primary key of table flight_identifier_type_ref
        public static CrudeFlightIdentifierTypeRefData GetByFlightIdentifierTypeRcd(string flightIdentifierTypeRcd) {
            // create query against flight_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightIdentifierTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_identifier_type_ref
        ...
        public static List<CrudeFlightIdentifierTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightIdentifierTypeRefData>();
            ...
            string sql = @" select flight_identifier_type_rcd, flight_identifier_type_name, user_id, date_time
                            from [flight_identifier_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of flight_identifier_type_ref
        ...
        public void FetchByFlightIdentifierTypeName(string flightIdentifierTypeName) {
            // create query against flight_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 flight_identifier_type_rcd, flight_identifier_type_name, user_id, date_time
                            from [flight_identifier_type_ref]
                            where flight_identifier_type_name like '%' + @flightIdentifierTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@flightIdentifierTypeName",SqlDbType.NVarChar).Value = flightIdentifierTypeName;
        ...
        public static List<CrudeFlightIdentifierTypeRefData> FetchAll() {
            var dataList = new List<CrudeFlightIdentifierTypeRefData>();
        ...
        public static List<CrudeFlightIdentifierTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightIdentifierTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_identifier_type_rcd, flight_identifier_type_name, user_id, date_time
                            from [flight_identifier_type_ref]
                            order by flight_identifier_type_name";
        ...
        public static List<CrudeFlightIdentifierTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightIdentifierTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_identifier_type_ref]";
        ...
        public static List<CrudeFlightIdentifierTypeRefData> FetchWithFilter(string flightIdentifierTypeRcd, string flightIdentifierTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightIdentifierTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(flightIdentifierTypeName)) {
                        sql += "  and flight_identifier_type_name like '%' + @flight_identifier_type_name + '%'";
                        command.Parameters.Add("@flight_identifier_type_name", SqlDbType.NVarChar).Value = flightIdentifierTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by flight_identifier_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["flight_identifier_type_name"] != System.DBNull.Value) FlightIdentifierTypeName = (System.String) reader["flight_identifier_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [flight_identifier_type_ref] (flight_identifier_type_rcd, flight_identifier_type_name, user_id, date_time)";
            sql += "            values (@flight_identifier_type_rcd, @flight_identifier_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_identifier_type_name",SqlDbType.NVarChar).Value = (System.String)FlightIdentifierTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_identifier_type_ref] set
                 flight_identifier_type_rcd = @flight_identifier_type_rcd
                ,flight_identifier_type_name = @flight_identifier_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where flight_identifier_type_rcd = @flight_identifier_type_rcd";
        ...
        public static void Delete(string flightIdentifierTypeRcd) {
            // create query against flight_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_identifier_type_ref] 
                where flight_identifier_type_rcd = @flight_identifier_type_rcd";
