/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:48:30 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of flight's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeFlightData {
        ...
        public void FetchByFlightId(System.Guid flightId) {
            // create query against flight
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_id, became_flight_id, binding_flight_id, airline_id, aircraft_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, from_date_time, until_date_time, comment, user_id, date_time
                            from [flight]
        ...
        // parameters:
        //  flightId: primary key of table flight
        public static CrudeFlightData GetByFlightId(System.Guid flightId) {
            // create query against flight
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeFlightData> FetchByBecameFlightId(System.Guid becameFlightId) {
            var dataList = new List<CrudeFlightData>();
            ...
            string sql = @" select flight_id, became_flight_id, binding_flight_id, airline_id, aircraft_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, from_date_time, until_date_time, comment, user_id, date_time
                            from [flight]
                            where became_flight_id = @became_flight_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@became_flight_id", SqlDbType.UniqueIdentifier).Value = becameFlightId;
                    ...
                    // read all rows returned from the query of flight
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightData> FetchByBindingFlightId(System.Guid bindingFlightId) {
            var dataList = new List<CrudeFlightData>();
            ...
            string sql = @" select flight_id, became_flight_id, binding_flight_id, airline_id, aircraft_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, from_date_time, until_date_time, comment, user_id, date_time
                            from [flight]
                            where binding_flight_id = @binding_flight_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@binding_flight_id", SqlDbType.UniqueIdentifier).Value = bindingFlightId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightData> FetchByAirlineId(System.Guid airlineId) {
            var dataList = new List<CrudeFlightData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightData> FetchByAircraftId(System.Guid aircraftId) {
            var dataList = new List<CrudeFlightData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightData> FetchByDepartureAirportId(System.Guid departureAirportId) {
            var dataList = new List<CrudeFlightData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightData> FetchByArrivalAirportId(System.Guid arrivalAirportId) {
            var dataList = new List<CrudeFlightData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightData> FetchByAircraftTypeRcd(string aircraftTypeRcd) {
            var dataList = new List<CrudeFlightData>();
        ...
        public static List<CrudeFlightData> FetchAll() {
            var dataList = new List<CrudeFlightData>();
        ...
        public static List<CrudeFlightData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_id, became_flight_id, binding_flight_id, airline_id, aircraft_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, from_date_time, until_date_time, comment, user_id, date_time
                            from [flight]";
        ...
        public static List<CrudeFlightData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight]";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (becameFlightId != Guid.Empty) {
                        sql += "  and became_flight_id = @became_flight_id";
                        command.Parameters.Add("@became_flight_id", SqlDbType.UniqueIdentifier).Value = becameFlightId;
                    }
                    if (bindingFlightId != Guid.Empty) {
                        sql += "  and binding_flight_id = @binding_flight_id";
                        command.Parameters.Add("@binding_flight_id", SqlDbType.UniqueIdentifier).Value = bindingFlightId;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["became_flight_id"] != System.DBNull.Value) BecameFlightId = (System.Guid) reader["became_flight_id"];
            if (reader["binding_flight_id"] != System.DBNull.Value) BindingFlightId = (System.Guid) reader["binding_flight_id"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [flight] (flight_id, became_flight_id, binding_flight_id, airline_id, aircraft_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, from_date_time, until_date_time, comment, user_id, date_time)";
            sql += "            values (@flight_id, @became_flight_id, @binding_flight_id, @airline_id, @aircraft_id, @aircraft_type_rcd, @departure_airport_id, @arrival_airport_id, @from_date_time, @until_date_time, @comment, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@became_flight_id",SqlDbType.UniqueIdentifier).Value = (BecameFlightId == Guid.Empty ? (object)DBNull.Value : (System.Guid)BecameFlightId);
                    command.Parameters.Add("@binding_flight_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BindingFlightId;
                    ...
                    command.Parameters.Add("@from_date_time",SqlDbType.DateTime).Value = (FromDateTime == DateTime.MinValue ? (object)DBNull.Value : (System.DateTime)FromDateTime);
                    command.Parameters.Add("@until_date_time",SqlDbType.DateTime).Value = (UntilDateTime == DateTime.MinValue ? (object)DBNull.Value : (System.DateTime)UntilDateTime);
        ...
        public void Update() {
            ...
            string sql = @" update [flight] set
                 flight_id = @flight_id
                ,became_flight_id = @became_flight_id
                ,binding_flight_id = @binding_flight_id
        ...
        public static void Delete(System.Guid flightId) {
            // create query against flight
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
