/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:29:23 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of flight_event's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeFlightEventData {
        ...
        // parameters:
        //  flightEventId: primary key of table flight_event
        public void FetchByFlightEventId(System.Guid flightEventId) {
            // create query against flight_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_event_id, flight_id, flight_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time
                            from [flight_event]
                            where flight_event_id = @flight_event_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@flight_event_id",SqlDbType.UniqueIdentifier).Value = flightEventId;
        ...
        // parameters:
        //  flightEventId: primary key of table flight_event
        public static CrudeFlightEventData GetByFlightEventId(System.Guid flightEventId) {
            // create query against flight_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightEventData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_event
        ...
        public static List<CrudeFlightEventData> FetchByFlightId(System.Guid flightId) {
            var dataList = new List<CrudeFlightEventData>();
            ...
            string sql = @" select flight_event_id, flight_id, flight_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time
                            from [flight_event]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of flight_event
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightEventData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightEventData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightEventData> FetchByDateTimeTypeRcd(string dateTimeTypeRcd) {
            var dataList = new List<CrudeFlightEventData>();
        ...
        public static List<CrudeFlightEventData> FetchAll() {
            var dataList = new List<CrudeFlightEventData>();
        ...
        public static List<CrudeFlightEventData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightEventData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_event_id, flight_id, flight_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time
                            from [flight_event]";
        ...
        public static List<CrudeFlightEventData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightEventData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_event]";
        ...
        public static List<CrudeFlightEventData> FetchWithFilter(System.Guid flightEventId, System.Guid flightId, int flightEventNumber, string dateTimeTypeRcd, System.DateTime newDateTime, string remarks, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightEventData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (flightEventId != Guid.Empty) {
                        sql += "  and flight_event_id = @flight_event_id";
                        command.Parameters.Add("@flight_event_id", SqlDbType.UniqueIdentifier).Value = flightEventId;
                    }
                    ...
                    if (flightEventNumber != 0) {
                        sql += "  and flight_event_number = @flight_event_number";
                        command.Parameters.Add("@flight_event_number", SqlDbType.Int).Value = flightEventNumber;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["flight_event_id"] != System.DBNull.Value) FlightEventId = (System.Guid) reader["flight_event_id"];
            if (reader["flight_id"] != System.DBNull.Value) FlightId = (System.Guid) reader["flight_id"];
            if (reader["flight_event_number"] != System.DBNull.Value) FlightEventNumber = (System.Int32) reader["flight_event_number"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [flight_event] (flight_event_id, flight_id, flight_event_number, date_time_type_rcd, new_date_time, remarks, user_id, date_time)";
            sql += "            values (@flight_event_id, @flight_id, @flight_event_number, @date_time_type_rcd, @new_date_time, @remarks, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@flight_event_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightEventId;
                    command.Parameters.Add("@flight_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FlightId;
                    command.Parameters.Add("@flight_event_number",SqlDbType.Int).Value = (System.Int32)FlightEventNumber;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_event] set
                 flight_event_id = @flight_event_id
                ,flight_id = @flight_id
                ,flight_event_number = @flight_event_number
        ...
        public static void Delete(System.Guid flightEventId) {
            // create query against flight_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_event] 
                where flight_event_id = @flight_event_id";
