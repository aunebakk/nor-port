/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:48:50 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of flight_schedule's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeFlightScheduleData {
        ...
        public void FetchByFlightScheduleId(System.Guid flightScheduleId) {
            // create query against flight_schedule
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 flight_schedule_id, became_flight_schedule_id, binding_flight_schedule_id, airline_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, comment, from_date_time, until_date_time, user_id, date_time
        ...
        // parameters:
        //  flightScheduleId: primary key of table flight_schedule
        public static CrudeFlightScheduleData GetByFlightScheduleId(System.Guid flightScheduleId) {
            // create query against flight_schedule
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFlightScheduleData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against flight_schedule
        ...
        public static List<CrudeFlightScheduleData> FetchByBecameFlightScheduleId(System.Guid becameFlightScheduleId) {
            var dataList = new List<CrudeFlightScheduleData>();
            ...
            string sql = @" select flight_schedule_id, became_flight_schedule_id, binding_flight_schedule_id, airline_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, comment, from_date_time, until_date_time, user_id, date_time
                            from [flight_schedule]
                            where became_flight_schedule_id = @became_flight_schedule_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@became_flight_schedule_id", SqlDbType.UniqueIdentifier).Value = becameFlightScheduleId;
                    ...
                    // read all rows returned from the query of flight_schedule
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleData> FetchByBindingFlightScheduleId(System.Guid bindingFlightScheduleId) {
            var dataList = new List<CrudeFlightScheduleData>();
            ...
            string sql = @" select flight_schedule_id, became_flight_schedule_id, binding_flight_schedule_id, airline_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, comment, from_date_time, until_date_time, user_id, date_time
                            from [flight_schedule]
                            where binding_flight_schedule_id = @binding_flight_schedule_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@binding_flight_schedule_id", SqlDbType.UniqueIdentifier).Value = bindingFlightScheduleId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleData> FetchByAirlineId(System.Guid airlineId) {
            var dataList = new List<CrudeFlightScheduleData>();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@airline_id", SqlDbType.UniqueIdentifier).Value = airlineId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleData> FetchByDepartureAirportId(System.Guid departureAirportId) {
            var dataList = new List<CrudeFlightScheduleData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleData> FetchByArrivalAirportId(System.Guid arrivalAirportId) {
            var dataList = new List<CrudeFlightScheduleData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFlightScheduleData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFlightScheduleData> FetchByAircraftTypeRcd(string aircraftTypeRcd) {
            var dataList = new List<CrudeFlightScheduleData>();
        ...
        public static List<CrudeFlightScheduleData> FetchAll() {
            var dataList = new List<CrudeFlightScheduleData>();
        ...
        public static List<CrudeFlightScheduleData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFlightScheduleData>();
            ...
            string sql = @" select top " + limit.ToString() + @" flight_schedule_id, became_flight_schedule_id, binding_flight_schedule_id, airline_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, comment, from_date_time, until_date_time, user_id, date_time
                            from [flight_schedule]";
        ...
        public static List<CrudeFlightScheduleData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFlightScheduleData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [flight_schedule]";
        ...
        public static List<CrudeFlightScheduleData> FetchWithFilter(System.Guid flightScheduleId, System.Guid becameFlightScheduleId, System.Guid bindingFlightScheduleId, System.Guid airlineId, string aircraftTypeRcd, System.Guid departureAirportId, System.Guid arrivalAirportId, string comment, System.DateTime fromDateTime, System.DateTime untilDateTime, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFlightScheduleData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (becameFlightScheduleId != Guid.Empty) {
                        sql += "  and became_flight_schedule_id = @became_flight_schedule_id";
                        command.Parameters.Add("@became_flight_schedule_id", SqlDbType.UniqueIdentifier).Value = becameFlightScheduleId;
                    }
                    if (bindingFlightScheduleId != Guid.Empty) {
                        sql += "  and binding_flight_schedule_id = @binding_flight_schedule_id";
                        command.Parameters.Add("@binding_flight_schedule_id", SqlDbType.UniqueIdentifier).Value = bindingFlightScheduleId;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["became_flight_schedule_id"] != System.DBNull.Value) BecameFlightScheduleId = (System.Guid) reader["became_flight_schedule_id"];
            if (reader["binding_flight_schedule_id"] != System.DBNull.Value) BindingFlightScheduleId = (System.Guid) reader["binding_flight_schedule_id"];
            if (reader["airline_id"] != System.DBNull.Value) AirlineId = (System.Guid) reader["airline_id"];
            ...
            if (reader["from_date_time"] != System.DBNull.Value) FromDateTime = (System.DateTime) reader["from_date_time"];
            if (reader["until_date_time"] != System.DBNull.Value) UntilDateTime = (System.DateTime) reader["until_date_time"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [flight_schedule] (flight_schedule_id, became_flight_schedule_id, binding_flight_schedule_id, airline_id, aircraft_type_rcd, departure_airport_id, arrival_airport_id, comment, from_date_time, until_date_time, user_id, date_time)";
            sql += "            values (@flight_schedule_id, @became_flight_schedule_id, @binding_flight_schedule_id, @airline_id, @aircraft_type_rcd, @departure_airport_id, @arrival_airport_id, @comment, @from_date_time, @until_date_time, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@became_flight_schedule_id",SqlDbType.UniqueIdentifier).Value = (BecameFlightScheduleId == Guid.Empty ? (object)DBNull.Value : (System.Guid)BecameFlightScheduleId);
                    command.Parameters.Add("@binding_flight_schedule_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BindingFlightScheduleId;
                    command.Parameters.Add("@airline_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AirlineId;
                    ...
                    command.Parameters.Add("@from_date_time",SqlDbType.DateTime).Value = (System.DateTime)FromDateTime;
                    command.Parameters.Add("@until_date_time",SqlDbType.DateTime).Value = (System.DateTime)UntilDateTime;
        ...
        public void Update() {
            ...
            string sql = @" update [flight_schedule] set
                 flight_schedule_id = @flight_schedule_id
                ,became_flight_schedule_id = @became_flight_schedule_id
                ,binding_flight_schedule_id = @binding_flight_schedule_id
        ...
        public static void Delete(System.Guid flightScheduleId) {
            // create query against flight_schedule
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [flight_schedule] 
                where flight_schedule_id = @flight_schedule_id";
