/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:19:52 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of ferry_identifier's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeFerryIdentifierData {
        ...
        // parameters:
        //  ferryIdentifierId: primary key of table ferry_identifier
        public void FetchByFerryIdentifierId(System.Guid ferryIdentifierId) {
            // create query against ferry_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 ferry_identifier_id, ferry_id, ferry_identifier_type_rcd, ferry_identifier_code, state_rcd, user_id, date_time
                            from [ferry_identifier]
                            where ferry_identifier_id = @ferry_identifier_id
                            order by ferry_identifier_code";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@ferry_identifier_id",SqlDbType.UniqueIdentifier).Value = ferryIdentifierId;
        ...
        // parameters:
        //  ferryIdentifierId: primary key of table ferry_identifier
        public static CrudeFerryIdentifierData GetByFerryIdentifierId(System.Guid ferryIdentifierId) {
            // create query against ferry_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFerryIdentifierData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against ferry_identifier
        ...
        public static List<CrudeFerryIdentifierData> FetchByFerryId(System.Guid ferryId) {
            var dataList = new List<CrudeFerryIdentifierData>();
            ...
            string sql = @" select ferry_identifier_id, ferry_id, ferry_identifier_type_rcd, ferry_identifier_code, state_rcd, user_id, date_time
                            from [ferry_identifier]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of ferry_identifier
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFerryIdentifierData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFerryIdentifierData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFerryIdentifierData> FetchByFerryIdentifierTypeRcd(string ferryIdentifierTypeRcd) {
            var dataList = new List<CrudeFerryIdentifierData>();
            ...
            string sql = @" select ferry_identifier_id, ferry_id, ferry_identifier_type_rcd, ferry_identifier_code, state_rcd, user_id, date_time
                            from [ferry_identifier]
                            where ferry_identifier_type_rcd = @ferry_identifier_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@ferry_identifier_type_rcd", SqlDbType.NVarChar).Value = ferryIdentifierTypeRcd.Replace("'","''");
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFerryIdentifierData> FetchByStateRcd(string stateRcd) {
            var dataList = new List<CrudeFerryIdentifierData>();
        ...
        public static List<CrudeFerryIdentifierData> FetchAll() {
            var dataList = new List<CrudeFerryIdentifierData>();
        ...
        public static List<CrudeFerryIdentifierData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFerryIdentifierData>();
            ...
            string sql = @" select top " + limit.ToString() + @" ferry_identifier_id, ferry_id, ferry_identifier_type_rcd, ferry_identifier_code, state_rcd, user_id, date_time
                            from [ferry_identifier]
                            order by ferry_identifier_code";
        ...
        public static List<CrudeFerryIdentifierData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFerryIdentifierData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [ferry_identifier]";
        ...
        public static List<CrudeFerryIdentifierData> FetchWithFilter(System.Guid ferryIdentifierId, System.Guid ferryId, string ferryIdentifierTypeRcd, string ferryIdentifierCode, string stateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFerryIdentifierData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (ferryIdentifierId != Guid.Empty) {
                        sql += "  and ferry_identifier_id = @ferry_identifier_id";
                        command.Parameters.Add("@ferry_identifier_id", SqlDbType.UniqueIdentifier).Value = ferryIdentifierId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(ferryIdentifierTypeRcd)) {
                        sql += "  and ferry_identifier_type_rcd like '%' + @ferry_identifier_type_rcd + '%'";
                        command.Parameters.Add("@ferry_identifier_type_rcd", SqlDbType.NVarChar).Value = ferryIdentifierTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(ferryIdentifierCode)) {
                        sql += "  and ferry_identifier_code like '%' + @ferry_identifier_code + '%'";
                        command.Parameters.Add("@ferry_identifier_code", SqlDbType.NVarChar).Value = ferryIdentifierCode.Replace("'","''");
                    }
                    ...
                    sql += " order by ferry_identifier_code";
        ...
        public void Populate(IDataReader reader) {
            if (reader["ferry_identifier_id"] != System.DBNull.Value) FerryIdentifierId = (System.Guid) reader["ferry_identifier_id"];
            if (reader["ferry_id"] != System.DBNull.Value) FerryId = (System.Guid) reader["ferry_id"];
            if (reader["ferry_identifier_type_rcd"] != System.DBNull.Value) FerryIdentifierTypeRcd = (System.String) reader["ferry_identifier_type_rcd"];
            if (reader["ferry_identifier_code"] != System.DBNull.Value) FerryIdentifierCode = (System.String) reader["ferry_identifier_code"];
        ...
        public void Insert() {
            ...
            if (FerryIdentifierId == Guid.Empty)
                FerryIdentifierId = Guid.NewGuid();
            ...
            string sql = "insert into [ferry_identifier] (ferry_identifier_id, ferry_id, ferry_identifier_type_rcd, ferry_identifier_code, state_rcd, user_id, date_time)";
            sql += "            values (@ferry_identifier_id, @ferry_id, @ferry_identifier_type_rcd, @ferry_identifier_code, @state_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@ferry_identifier_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FerryIdentifierId;
                    command.Parameters.Add("@ferry_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FerryId;
                    command.Parameters.Add("@ferry_identifier_type_rcd",SqlDbType.NVarChar).Value = (System.String)FerryIdentifierTypeRcd;
                    command.Parameters.Add("@ferry_identifier_code",SqlDbType.NVarChar).Value = (System.String)FerryIdentifierCode;
        ...
        public void Update() {
            ...
            string sql = @" update [ferry_identifier] set
                 ferry_identifier_id = @ferry_identifier_id
                ,ferry_id = @ferry_id
                ,ferry_identifier_type_rcd = @ferry_identifier_type_rcd
                ,ferry_identifier_code = @ferry_identifier_code
                ,state_rcd = @state_rcd
                ,user_id = @user_id
                ,date_time = @date_time
            where ferry_identifier_id = @ferry_identifier_id";
        ...
        public static void Delete(System.Guid ferryIdentifierId) {
            // create query against ferry_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [ferry_identifier] 
                where ferry_identifier_id = @ferry_identifier_id";
