/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:20:01 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of ferry_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeFerryTypeRefData {
        ...
        public void FetchByFerryTypeRcd(string ferryTypeRcd) {
            // create query against ferry_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 ferry_type_rcd, ferry_type_name, state_rcd, user_id, date_time
                            from [ferry_type_ref]
                            where ferry_type_rcd = @ferry_type_rcd
                            order by ferry_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@ferry_type_rcd",SqlDbType.NVarChar).Value = ferryTypeRcd;
        ...
        // parameters:
        //  ferryTypeRcd: primary key of table ferry_type_ref
        public static CrudeFerryTypeRefData GetByFerryTypeRcd(string ferryTypeRcd) {
            // create query against ferry_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFerryTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against ferry_type_ref
        ...
        public static List<CrudeFerryTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFerryTypeRefData>();
            ...
            string sql = @" select ferry_type_rcd, ferry_type_name, state_rcd, user_id, date_time
                            from [ferry_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of ferry_type_ref
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFerryTypeRefData> FetchByStateRcd(string stateRcd) {
            var dataList = new List<CrudeFerryTypeRefData>();
        ...
        public void FetchByFerryTypeName(string ferryTypeName) {
            // create query against ferry_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 ferry_type_rcd, ferry_type_name, state_rcd, user_id, date_time
                            from [ferry_type_ref]
                            where ferry_type_name like '%' + @ferryTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@ferryTypeName",SqlDbType.NVarChar).Value = ferryTypeName;
        ...
        public static List<CrudeFerryTypeRefData> FetchAll() {
            var dataList = new List<CrudeFerryTypeRefData>();
        ...
        public static List<CrudeFerryTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFerryTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" ferry_type_rcd, ferry_type_name, state_rcd, user_id, date_time
                            from [ferry_type_ref]
                            order by ferry_type_name";
        ...
        public static List<CrudeFerryTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFerryTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [ferry_type_ref]";
        ...
        public static List<CrudeFerryTypeRefData> FetchWithFilter(string ferryTypeRcd, string ferryTypeName, string stateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFerryTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(ferryTypeName)) {
                        sql += "  and ferry_type_name like '%' + @ferry_type_name + '%'";
                        command.Parameters.Add("@ferry_type_name", SqlDbType.NVarChar).Value = ferryTypeName.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["ferry_type_name"] != System.DBNull.Value) FerryTypeName = (System.String) reader["ferry_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [ferry_type_ref] (ferry_type_rcd, ferry_type_name, state_rcd, user_id, date_time)";
            sql += "            values (@ferry_type_rcd, @ferry_type_name, @state_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@ferry_type_name",SqlDbType.NVarChar).Value = (System.String)FerryTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [ferry_type_ref] set
                 ferry_type_rcd = @ferry_type_rcd
                ,ferry_type_name = @ferry_type_name
                ,state_rcd = @state_rcd
                ,user_id = @user_id
                ,date_time = @date_time
            where ferry_type_rcd = @ferry_type_rcd";
        ...
        public static void Delete(string ferryTypeRcd) {
            // create query against ferry_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [ferry_type_ref] 
                where ferry_type_rcd = @ferry_type_rcd";
