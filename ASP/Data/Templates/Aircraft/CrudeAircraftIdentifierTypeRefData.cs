/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:40:24 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of aircraft_identifier_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAircraftIdentifierTypeRefData {
        ...
        public void FetchByAircraftIdentifierTypeRcd(string aircraftIdentifierTypeRcd) {
            // create query against aircraft_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_identifier_type_rcd, aircraft_identifier_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_identifier_type_ref]
                            where aircraft_identifier_type_rcd = @aircraft_identifier_type_rcd
                            order by aircraft_identifier_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_identifier_type_rcd",SqlDbType.NVarChar).Value = aircraftIdentifierTypeRcd;
        ...
        // parameters:
        //  aircraftIdentifierTypeRcd: primary key of table aircraft_identifier_type_ref
        public static CrudeAircraftIdentifierTypeRefData GetByAircraftIdentifierTypeRcd(string aircraftIdentifierTypeRcd) {
            // create query against aircraft_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftIdentifierTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_identifier_type_ref
        ...
        public static List<CrudeAircraftIdentifierTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftIdentifierTypeRefData>();
            ...
            string sql = @" select aircraft_identifier_type_rcd, aircraft_identifier_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_identifier_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_identifier_type_ref
        ...
        public void FetchByAircraftIdentifierTypeName(string aircraftIdentifierTypeName) {
            // create query against aircraft_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 aircraft_identifier_type_rcd, aircraft_identifier_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_identifier_type_ref]
                            where aircraft_identifier_type_name like '%' + @aircraftIdentifierTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@aircraftIdentifierTypeName",SqlDbType.NVarChar).Value = aircraftIdentifierTypeName;
        ...
        public static List<CrudeAircraftIdentifierTypeRefData> FetchAll() {
            var dataList = new List<CrudeAircraftIdentifierTypeRefData>();
        ...
        public static List<CrudeAircraftIdentifierTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftIdentifierTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_identifier_type_rcd, aircraft_identifier_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_identifier_type_ref]
                            order by aircraft_identifier_type_name";
        ...
        public static List<CrudeAircraftIdentifierTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftIdentifierTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_identifier_type_ref]";
        ...
        public static List<CrudeAircraftIdentifierTypeRefData> FetchWithFilter(string aircraftIdentifierTypeRcd, string aircraftIdentifierTypeName, bool activeFlag, int sortOrder, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftIdentifierTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(aircraftIdentifierTypeName)) {
                        sql += "  and aircraft_identifier_type_name like '%' + @aircraft_identifier_type_name + '%'";
                        command.Parameters.Add("@aircraft_identifier_type_name", SqlDbType.NVarChar).Value = aircraftIdentifierTypeName.Replace("'","''");
                    }
                    if (activeFlag != false) {
                    ...
                    sql += " order by aircraft_identifier_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["aircraft_identifier_type_name"] != System.DBNull.Value) AircraftIdentifierTypeName = (System.String) reader["aircraft_identifier_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [aircraft_identifier_type_ref] (aircraft_identifier_type_rcd, aircraft_identifier_type_name, active_flag, sort_order, user_id, date_time)";
            sql += "            values (@aircraft_identifier_type_rcd, @aircraft_identifier_type_name, @active_flag, @sort_order, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_identifier_type_name",SqlDbType.NVarChar).Value = (System.String)AircraftIdentifierTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_identifier_type_ref] set
                 aircraft_identifier_type_rcd = @aircraft_identifier_type_rcd
                ,aircraft_identifier_type_name = @aircraft_identifier_type_name
        ...
        public static void Delete(string aircraftIdentifierTypeRcd) {
            // create query against aircraft_identifier_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_identifier_type_ref] 
                where aircraft_identifier_type_rcd = @aircraft_identifier_type_rcd";
