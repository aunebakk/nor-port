/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:20:25 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of aircraft_compartment_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAircraftCompartmentTypeRefData {
        ...
        public void FetchByAircraftCompartmentTypeRcd(string aircraftCompartmentTypeRcd) {
            // create query against aircraft_compartment_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_compartment_type_rcd, aircraft_compartment_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_compartment_type_ref]
                            where aircraft_compartment_type_rcd = @aircraft_compartment_type_rcd
                            order by aircraft_compartment_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_compartment_type_rcd",SqlDbType.NVarChar).Value = aircraftCompartmentTypeRcd;
        ...
        // parameters:
        //  aircraftCompartmentTypeRcd: primary key of table aircraft_compartment_type_ref
        public static CrudeAircraftCompartmentTypeRefData GetByAircraftCompartmentTypeRcd(string aircraftCompartmentTypeRcd) {
            // create query against aircraft_compartment_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftCompartmentTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_compartment_type_ref
        ...
        public static List<CrudeAircraftCompartmentTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftCompartmentTypeRefData>();
            ...
            string sql = @" select aircraft_compartment_type_rcd, aircraft_compartment_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_compartment_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_compartment_type_ref
        ...
        public void FetchByAircraftCompartmentTypeName(string aircraftCompartmentTypeName) {
            // create query against aircraft_compartment_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 aircraft_compartment_type_rcd, aircraft_compartment_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_compartment_type_ref]
                            where aircraft_compartment_type_name like '%' + @aircraftCompartmentTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@aircraftCompartmentTypeName",SqlDbType.NVarChar).Value = aircraftCompartmentTypeName;
        ...
        public static List<CrudeAircraftCompartmentTypeRefData> FetchAll() {
            var dataList = new List<CrudeAircraftCompartmentTypeRefData>();
        ...
        public static List<CrudeAircraftCompartmentTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftCompartmentTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_compartment_type_rcd, aircraft_compartment_type_name, active_flag, sort_order, user_id, date_time
                            from [aircraft_compartment_type_ref]
                            order by aircraft_compartment_type_name";
        ...
        public static List<CrudeAircraftCompartmentTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftCompartmentTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_compartment_type_ref]";
        ...
        public static List<CrudeAircraftCompartmentTypeRefData> FetchWithFilter(string aircraftCompartmentTypeRcd, string aircraftCompartmentTypeName, bool activeFlag, int sortOrder, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftCompartmentTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(aircraftCompartmentTypeName)) {
                        sql += "  and aircraft_compartment_type_name like '%' + @aircraft_compartment_type_name + '%'";
                        command.Parameters.Add("@aircraft_compartment_type_name", SqlDbType.NVarChar).Value = aircraftCompartmentTypeName.Replace("'","''");
                    }
                    if (activeFlag != false) {
                    ...
                    sql += " order by aircraft_compartment_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["aircraft_compartment_type_name"] != System.DBNull.Value) AircraftCompartmentTypeName = (System.String) reader["aircraft_compartment_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [aircraft_compartment_type_ref] (aircraft_compartment_type_rcd, aircraft_compartment_type_name, active_flag, sort_order, user_id, date_time)";
            sql += "            values (@aircraft_compartment_type_rcd, @aircraft_compartment_type_name, @active_flag, @sort_order, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_compartment_type_name",SqlDbType.NVarChar).Value = (System.String)AircraftCompartmentTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_compartment_type_ref] set
                 aircraft_compartment_type_rcd = @aircraft_compartment_type_rcd
                ,aircraft_compartment_type_name = @aircraft_compartment_type_name
        ...
        public static void Delete(string aircraftCompartmentTypeRcd) {
            // create query against aircraft_compartment_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_compartment_type_ref] 
                where aircraft_compartment_type_rcd = @aircraft_compartment_type_rcd";
