/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:40:05 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of aircraft_compartment's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAircraftCompartmentData {
        ...
        public void FetchByAircraftCompartmentId(System.Guid aircraftCompartmentId) {
            // create query against aircraft_compartment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_compartment_id, aircraft_id, aircraft_compartment_measurement_id, aircraft_compartment_type_rcd, aircraft_compartment_name, user_id, date_time
                            from [aircraft_compartment]
                            where aircraft_compartment_id = @aircraft_compartment_id
                            order by aircraft_compartment_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_compartment_id",SqlDbType.UniqueIdentifier).Value = aircraftCompartmentId;
        ...
        // parameters:
        //  aircraftCompartmentId: primary key of table aircraft_compartment
        public static CrudeAircraftCompartmentData GetByAircraftCompartmentId(System.Guid aircraftCompartmentId) {
            // create query against aircraft_compartment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftCompartmentData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_compartment
        ...
        public static List<CrudeAircraftCompartmentData> FetchByAircraftId(System.Guid aircraftId) {
            var dataList = new List<CrudeAircraftCompartmentData>();
            ...
            string sql = @" select aircraft_compartment_id, aircraft_id, aircraft_compartment_measurement_id, aircraft_compartment_type_rcd, aircraft_compartment_name, user_id, date_time
                            from [aircraft_compartment]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_compartment
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAircraftCompartmentData> FetchByAircraftCompartmentMeasurementId(System.Guid aircraftCompartmentMeasurementId) {
            var dataList = new List<CrudeAircraftCompartmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAircraftCompartmentData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftCompartmentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAircraftCompartmentData> FetchByAircraftCompartmentTypeRcd(string aircraftCompartmentTypeRcd) {
            var dataList = new List<CrudeAircraftCompartmentData>();
            ...
            string sql = @" select aircraft_compartment_id, aircraft_id, aircraft_compartment_measurement_id, aircraft_compartment_type_rcd, aircraft_compartment_name, user_id, date_time
                            from [aircraft_compartment]
                            where aircraft_compartment_type_rcd = @aircraft_compartment_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@aircraft_compartment_type_rcd", SqlDbType.NVarChar).Value = aircraftCompartmentTypeRcd.Replace("'","''");
        ...
        public void FetchByAircraftCompartmentName(string aircraftCompartmentName) {
            // create query against aircraft_compartment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 aircraft_compartment_id, aircraft_id, aircraft_compartment_measurement_id, aircraft_compartment_type_rcd, aircraft_compartment_name, user_id, date_time
                            from [aircraft_compartment]
                            where aircraft_compartment_name like '%' + @aircraftCompartmentName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@aircraftCompartmentName",SqlDbType.NVarChar).Value = aircraftCompartmentName;
        ...
        public static List<CrudeAircraftCompartmentData> FetchAll() {
            var dataList = new List<CrudeAircraftCompartmentData>();
        ...
        public static List<CrudeAircraftCompartmentData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftCompartmentData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_compartment_id, aircraft_id, aircraft_compartment_measurement_id, aircraft_compartment_type_rcd, aircraft_compartment_name, user_id, date_time
                            from [aircraft_compartment]
                            order by aircraft_compartment_name";
        ...
        public static List<CrudeAircraftCompartmentData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftCompartmentData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_compartment]";
        ...
        public static List<CrudeAircraftCompartmentData> FetchWithFilter(System.Guid aircraftCompartmentId, System.Guid aircraftId, System.Guid aircraftCompartmentMeasurementId, string aircraftCompartmentTypeRcd, string aircraftCompartmentName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftCompartmentData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (aircraftCompartmentId != Guid.Empty) {
                        sql += "  and aircraft_compartment_id = @aircraft_compartment_id";
                        command.Parameters.Add("@aircraft_compartment_id", SqlDbType.UniqueIdentifier).Value = aircraftCompartmentId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(aircraftCompartmentTypeRcd)) {
                        sql += "  and aircraft_compartment_type_rcd like '%' + @aircraft_compartment_type_rcd + '%'";
                        command.Parameters.Add("@aircraft_compartment_type_rcd", SqlDbType.NVarChar).Value = aircraftCompartmentTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(aircraftCompartmentName)) {
                        sql += "  and aircraft_compartment_name like '%' + @aircraft_compartment_name + '%'";
                        command.Parameters.Add("@aircraft_compartment_name", SqlDbType.NVarChar).Value = aircraftCompartmentName.Replace("'","''");
                    }
                    ...
                    sql += " order by aircraft_compartment_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["aircraft_compartment_id"] != System.DBNull.Value) AircraftCompartmentId = (System.Guid) reader["aircraft_compartment_id"];
            ...
            if (reader["aircraft_compartment_type_rcd"] != System.DBNull.Value) AircraftCompartmentTypeRcd = (System.String) reader["aircraft_compartment_type_rcd"];
            if (reader["aircraft_compartment_name"] != System.DBNull.Value) AircraftCompartmentName = (System.String) reader["aircraft_compartment_name"];
        ...
        public void Insert() {
            ...
            if (AircraftCompartmentId == Guid.Empty)
                AircraftCompartmentId = Guid.NewGuid();
            ...
            string sql = "insert into [aircraft_compartment] (aircraft_compartment_id, aircraft_id, aircraft_compartment_measurement_id, aircraft_compartment_type_rcd, aircraft_compartment_name, user_id, date_time)";
            sql += "            values (@aircraft_compartment_id, @aircraft_id, @aircraft_compartment_measurement_id, @aircraft_compartment_type_rcd, @aircraft_compartment_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_compartment_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AircraftCompartmentId;
                    command.Parameters.Add("@aircraft_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AircraftId;
                    command.Parameters.Add("@aircraft_compartment_measurement_id",SqlDbType.UniqueIdentifier).Value = (AircraftCompartmentMeasurementId == Guid.Empty ? (object)DBNull.Value : (System.Guid)AircraftCompartmentMeasurementId);
                    command.Parameters.Add("@aircraft_compartment_type_rcd",SqlDbType.NVarChar).Value = (System.String)AircraftCompartmentTypeRcd;
                    command.Parameters.Add("@aircraft_compartment_name",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(AircraftCompartmentName)) ? (object)DBNull.Value : (System.String)AircraftCompartmentName;
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_compartment] set
                 aircraft_compartment_id = @aircraft_compartment_id
                ,aircraft_id = @aircraft_id
                ,aircraft_compartment_measurement_id = @aircraft_compartment_measurement_id
                ,aircraft_compartment_type_rcd = @aircraft_compartment_type_rcd
                ,aircraft_compartment_name = @aircraft_compartment_name
                ,user_id = @user_id
                ,date_time = @date_time
            where aircraft_compartment_id = @aircraft_compartment_id";
        ...
        public static void Delete(System.Guid aircraftCompartmentId) {
            // create query against aircraft_compartment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_compartment] 
                where aircraft_compartment_id = @aircraft_compartment_id";
