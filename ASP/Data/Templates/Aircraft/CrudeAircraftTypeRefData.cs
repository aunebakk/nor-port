/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:14:46 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of aircraft_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAircraftTypeRefData {
        ...
        public void FetchByAircraftTypeRcd(string aircraftTypeRcd) {
            // create query against aircraft_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_type_rcd, aircraft_type_name, description, aircraft_family_image, active_flag, sort_order, user_id, date_time
                            from [aircraft_type_ref]
                            where aircraft_type_rcd = @aircraft_type_rcd
                            order by aircraft_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_type_rcd",SqlDbType.NVarChar).Value = aircraftTypeRcd;
        ...
        // parameters:
        //  aircraftTypeRcd: primary key of table aircraft_type_ref
        public static CrudeAircraftTypeRefData GetByAircraftTypeRcd(string aircraftTypeRcd) {
            // create query against aircraft_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_type_ref
        ...
        public static List<CrudeAircraftTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftTypeRefData>();
            ...
            string sql = @" select aircraft_type_rcd, aircraft_type_name, description, aircraft_family_image, active_flag, sort_order, user_id, date_time
                            from [aircraft_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_type_ref
        ...
        public void FetchByAircraftTypeName(string aircraftTypeName) {
            // create query against aircraft_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 aircraft_type_rcd, aircraft_type_name, description, aircraft_family_image, active_flag, sort_order, user_id, date_time
                            from [aircraft_type_ref]
                            where aircraft_type_name like '%' + @aircraftTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@aircraftTypeName",SqlDbType.NVarChar).Value = aircraftTypeName;
        ...
        public static List<CrudeAircraftTypeRefData> FetchAll() {
            var dataList = new List<CrudeAircraftTypeRefData>();
        ...
        public static List<CrudeAircraftTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_type_rcd, aircraft_type_name, description, aircraft_family_image, active_flag, sort_order, user_id, date_time
                            from [aircraft_type_ref]
                            order by aircraft_type_name";
        ...
        public static List<CrudeAircraftTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_type_ref]";
        ...
        public static List<CrudeAircraftTypeRefData> FetchWithFilter(string aircraftTypeRcd, string aircraftTypeName, string description, byte[] aircraftFamilyImage, bool activeFlag, int sortOrder, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(aircraftTypeName)) {
                        sql += "  and aircraft_type_name like '%' + @aircraft_type_name + '%'";
                        command.Parameters.Add("@aircraft_type_name", SqlDbType.NVarChar).Value = aircraftTypeName.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(description)) {
                        sql += "  and description like '%' + @description + '%'";
                        command.Parameters.Add("@description", SqlDbType.NVarChar).Value = description.Replace("'","''");
                    }
                    if (aircraftFamilyImage != null) {
                        sql += "  and aircraft_family_image = @aircraft_family_image";
                        command.Parameters.Add("@aircraft_family_image", SqlDbType.VarBinary).Value = aircraftFamilyImage;
                    }
                    if (activeFlag != false) {
                    ...
                    sql += " order by aircraft_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["aircraft_type_name"] != System.DBNull.Value) AircraftTypeName = (System.String) reader["aircraft_type_name"];
            if (reader["description"] != System.DBNull.Value) Description = (System.String) reader["description"];
            if (reader["aircraft_family_image"] != System.DBNull.Value) AircraftFamilyImage = (System.Byte[]) reader["aircraft_family_image"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [aircraft_type_ref] (aircraft_type_rcd, aircraft_type_name, description, aircraft_family_image, active_flag, sort_order, user_id, date_time)";
            sql += "            values (@aircraft_type_rcd, @aircraft_type_name, @description, @aircraft_family_image, @active_flag, @sort_order, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_type_name",SqlDbType.NVarChar).Value = (System.String)AircraftTypeName;
                    ...
                    command.Parameters.Add("@aircraft_family_image",SqlDbType.VarBinary).Value = (AircraftFamilyImage == null ? (object)DBNull.Value : (System.Byte[])AircraftFamilyImage);
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_type_ref] set
                 aircraft_type_rcd = @aircraft_type_rcd
                ,aircraft_type_name = @aircraft_type_name
                ,description = @description
                ,aircraft_family_image = @aircraft_family_image
        ...
        public static void Delete(string aircraftTypeRcd) {
            // create query against aircraft_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_type_ref] 
                where aircraft_type_rcd = @aircraft_type_rcd";
