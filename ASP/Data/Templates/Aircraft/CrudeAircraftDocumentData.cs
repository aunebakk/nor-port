/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:40:15 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of aircraft_document's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAircraftDocumentData {
        ...
        public void FetchByAircraftDocumentId(System.Guid aircraftDocumentId) {
            // create query against aircraft_document
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_document_id, aircraft_id, aircraft_document_type_rcd, document_name, document_date_time, expiry_date_time, user_id, date_time
                            from [aircraft_document]
                            where aircraft_document_id = @aircraft_document_id
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_document_id",SqlDbType.UniqueIdentifier).Value = aircraftDocumentId;
        ...
        // parameters:
        //  aircraftDocumentId: primary key of table aircraft_document
        public static CrudeAircraftDocumentData GetByAircraftDocumentId(System.Guid aircraftDocumentId) {
            // create query against aircraft_document
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftDocumentData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_document
        ...
        public static List<CrudeAircraftDocumentData> FetchByAircraftId(System.Guid aircraftId) {
            var dataList = new List<CrudeAircraftDocumentData>();
            ...
            string sql = @" select aircraft_document_id, aircraft_id, aircraft_document_type_rcd, document_name, document_date_time, expiry_date_time, user_id, date_time
                            from [aircraft_document]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_document
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAircraftDocumentData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftDocumentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAircraftDocumentData> FetchByAircraftDocumentTypeRcd(string aircraftDocumentTypeRcd) {
            var dataList = new List<CrudeAircraftDocumentData>();
        ...
        public static List<CrudeAircraftDocumentData> FetchAll() {
            var dataList = new List<CrudeAircraftDocumentData>();
        ...
        public static List<CrudeAircraftDocumentData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftDocumentData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_document_id, aircraft_id, aircraft_document_type_rcd, document_name, document_date_time, expiry_date_time, user_id, date_time
                            from [aircraft_document]
                            order by document_name";
        ...
        public static List<CrudeAircraftDocumentData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftDocumentData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_document]";
        ...
        public static List<CrudeAircraftDocumentData> FetchWithFilter(System.Guid aircraftDocumentId, System.Guid aircraftId, string aircraftDocumentTypeRcd, string documentName, System.DateTime documentDateTime, System.DateTime expiryDateTime, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftDocumentData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (aircraftDocumentId != Guid.Empty) {
                        sql += "  and aircraft_document_id = @aircraft_document_id";
                        command.Parameters.Add("@aircraft_document_id", SqlDbType.UniqueIdentifier).Value = aircraftDocumentId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["aircraft_document_id"] != System.DBNull.Value) AircraftDocumentId = (System.Guid) reader["aircraft_document_id"];
        ...
        public void Insert() {
            ...
            if (AircraftDocumentId == Guid.Empty)
                AircraftDocumentId = Guid.NewGuid();
            ...
            string sql = "insert into [aircraft_document] (aircraft_document_id, aircraft_id, aircraft_document_type_rcd, document_name, document_date_time, expiry_date_time, user_id, date_time)";
            sql += "            values (@aircraft_document_id, @aircraft_id, @aircraft_document_type_rcd, @document_name, @document_date_time, @expiry_date_time, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_document_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AircraftDocumentId;
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_document] set
                 aircraft_document_id = @aircraft_document_id
        ...
        public static void Delete(System.Guid aircraftDocumentId) {
            // create query against aircraft_document
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_document] 
                where aircraft_document_id = @aircraft_document_id";
