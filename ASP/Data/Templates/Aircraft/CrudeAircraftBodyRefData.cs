/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:14:19 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of aircraft_body_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAircraftBodyRefData {
        ...
        public void FetchByAircraftBodyRcd(string aircraftBodyRcd) {
            // create query against aircraft_body_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_body_rcd, aircraft_body_name, description, active_flag, sort_order, user_id, date_time
                            from [aircraft_body_ref]
                            where aircraft_body_rcd = @aircraft_body_rcd
                            order by aircraft_body_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_body_rcd",SqlDbType.NVarChar).Value = aircraftBodyRcd;
        ...
        // parameters:
        //  aircraftBodyRcd: primary key of table aircraft_body_ref
        public static CrudeAircraftBodyRefData GetByAircraftBodyRcd(string aircraftBodyRcd) {
            // create query against aircraft_body_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftBodyRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_body_ref
        ...
        public static List<CrudeAircraftBodyRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftBodyRefData>();
            ...
            string sql = @" select aircraft_body_rcd, aircraft_body_name, description, active_flag, sort_order, user_id, date_time
                            from [aircraft_body_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_body_ref
        ...
        public void FetchByAircraftBodyName(string aircraftBodyName) {
            // create query against aircraft_body_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 aircraft_body_rcd, aircraft_body_name, description, active_flag, sort_order, user_id, date_time
                            from [aircraft_body_ref]
                            where aircraft_body_name like '%' + @aircraftBodyName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@aircraftBodyName",SqlDbType.NVarChar).Value = aircraftBodyName;
        ...
        public static List<CrudeAircraftBodyRefData> FetchAll() {
            var dataList = new List<CrudeAircraftBodyRefData>();
        ...
        public static List<CrudeAircraftBodyRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftBodyRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_body_rcd, aircraft_body_name, description, active_flag, sort_order, user_id, date_time
                            from [aircraft_body_ref]
                            order by aircraft_body_name";
        ...
        public static List<CrudeAircraftBodyRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftBodyRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_body_ref]";
        ...
        public static List<CrudeAircraftBodyRefData> FetchWithFilter(string aircraftBodyRcd, string aircraftBodyName, string description, bool activeFlag, int sortOrder, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftBodyRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(aircraftBodyName)) {
                        sql += "  and aircraft_body_name like '%' + @aircraft_body_name + '%'";
                        command.Parameters.Add("@aircraft_body_name", SqlDbType.NVarChar).Value = aircraftBodyName.Replace("'","''");
                    }
                    ...
                    sql += " order by aircraft_body_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["aircraft_body_name"] != System.DBNull.Value) AircraftBodyName = (System.String) reader["aircraft_body_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [aircraft_body_ref] (aircraft_body_rcd, aircraft_body_name, description, active_flag, sort_order, user_id, date_time)";
            sql += "            values (@aircraft_body_rcd, @aircraft_body_name, @description, @active_flag, @sort_order, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_body_name",SqlDbType.NVarChar).Value = (System.String)AircraftBodyName;
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_body_ref] set
                 aircraft_body_rcd = @aircraft_body_rcd
                ,aircraft_body_name = @aircraft_body_name
        ...
        public static void Delete(string aircraftBodyRcd) {
            // create query against aircraft_body_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_body_ref] 
                where aircraft_body_rcd = @aircraft_body_rcd";
