/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:14:38 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of aircraft_identifier's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeAircraftIdentifierData {
        ...
        public void FetchByAircraftIdentifierId(System.Guid aircraftIdentifierId) {
            // create query against aircraft_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_identifier_id, aircraft_id, aircraft_identifier_type_rcd, aircraft_identifier_code, user_id, date_time
                            from [aircraft_identifier]
                            where aircraft_identifier_id = @aircraft_identifier_id
                            order by aircraft_identifier_code";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@aircraft_identifier_id",SqlDbType.UniqueIdentifier).Value = aircraftIdentifierId;
        ...
        // parameters:
        //  aircraftIdentifierId: primary key of table aircraft_identifier
        public static CrudeAircraftIdentifierData GetByAircraftIdentifierId(System.Guid aircraftIdentifierId) {
            // create query against aircraft_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftIdentifierData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_identifier
        ...
        public static List<CrudeAircraftIdentifierData> FetchByAircraftId(System.Guid aircraftId) {
            var dataList = new List<CrudeAircraftIdentifierData>();
            ...
            string sql = @" select aircraft_identifier_id, aircraft_id, aircraft_identifier_type_rcd, aircraft_identifier_code, user_id, date_time
                            from [aircraft_identifier]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_identifier
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAircraftIdentifierData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftIdentifierData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeAircraftIdentifierData> FetchByAircraftIdentifierTypeRcd(string aircraftIdentifierTypeRcd) {
            var dataList = new List<CrudeAircraftIdentifierData>();
            ...
            string sql = @" select aircraft_identifier_id, aircraft_id, aircraft_identifier_type_rcd, aircraft_identifier_code, user_id, date_time
                            from [aircraft_identifier]
                            where aircraft_identifier_type_rcd = @aircraft_identifier_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@aircraft_identifier_type_rcd", SqlDbType.NVarChar).Value = aircraftIdentifierTypeRcd.Replace("'","''");
        ...
        public static List<CrudeAircraftIdentifierData> FetchAll() {
            var dataList = new List<CrudeAircraftIdentifierData>();
        ...
        public static List<CrudeAircraftIdentifierData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftIdentifierData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_identifier_id, aircraft_id, aircraft_identifier_type_rcd, aircraft_identifier_code, user_id, date_time
                            from [aircraft_identifier]
                            order by aircraft_identifier_code";
        ...
        public static List<CrudeAircraftIdentifierData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftIdentifierData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_identifier]";
        ...
        public static List<CrudeAircraftIdentifierData> FetchWithFilter(System.Guid aircraftIdentifierId, System.Guid aircraftId, string aircraftIdentifierTypeRcd, string aircraftIdentifierCode, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftIdentifierData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (aircraftIdentifierId != Guid.Empty) {
                        sql += "  and aircraft_identifier_id = @aircraft_identifier_id";
                        command.Parameters.Add("@aircraft_identifier_id", SqlDbType.UniqueIdentifier).Value = aircraftIdentifierId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(aircraftIdentifierTypeRcd)) {
                        sql += "  and aircraft_identifier_type_rcd like '%' + @aircraft_identifier_type_rcd + '%'";
                        command.Parameters.Add("@aircraft_identifier_type_rcd", SqlDbType.NVarChar).Value = aircraftIdentifierTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(aircraftIdentifierCode)) {
                        sql += "  and aircraft_identifier_code like '%' + @aircraft_identifier_code + '%'";
                        command.Parameters.Add("@aircraft_identifier_code", SqlDbType.NVarChar).Value = aircraftIdentifierCode.Replace("'","''");
                    }
                    ...
                    sql += " order by aircraft_identifier_code";
        ...
        public void Populate(IDataReader reader) {
            if (reader["aircraft_identifier_id"] != System.DBNull.Value) AircraftIdentifierId = (System.Guid) reader["aircraft_identifier_id"];
            if (reader["aircraft_id"] != System.DBNull.Value) AircraftId = (System.Guid) reader["aircraft_id"];
            if (reader["aircraft_identifier_type_rcd"] != System.DBNull.Value) AircraftIdentifierTypeRcd = (System.String) reader["aircraft_identifier_type_rcd"];
            if (reader["aircraft_identifier_code"] != System.DBNull.Value) AircraftIdentifierCode = (System.String) reader["aircraft_identifier_code"];
        ...
        public void Insert() {
            ...
            if (AircraftIdentifierId == Guid.Empty)
                AircraftIdentifierId = Guid.NewGuid();
            ...
            string sql = "insert into [aircraft_identifier] (aircraft_identifier_id, aircraft_id, aircraft_identifier_type_rcd, aircraft_identifier_code, user_id, date_time)";
            sql += "            values (@aircraft_identifier_id, @aircraft_id, @aircraft_identifier_type_rcd, @aircraft_identifier_code, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_identifier_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AircraftIdentifierId;
                    command.Parameters.Add("@aircraft_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AircraftId;
                    command.Parameters.Add("@aircraft_identifier_type_rcd",SqlDbType.NVarChar).Value = (System.String)AircraftIdentifierTypeRcd;
                    command.Parameters.Add("@aircraft_identifier_code",SqlDbType.NVarChar).Value = (System.String)AircraftIdentifierCode;
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_identifier] set
                 aircraft_identifier_id = @aircraft_identifier_id
                ,aircraft_id = @aircraft_id
                ,aircraft_identifier_type_rcd = @aircraft_identifier_type_rcd
                ,aircraft_identifier_code = @aircraft_identifier_code
                ,user_id = @user_id
                ,date_time = @date_time
            where aircraft_identifier_id = @aircraft_identifier_id";
        ...
        public static void Delete(System.Guid aircraftIdentifierId) {
            // create query against aircraft_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_identifier] 
                where aircraft_identifier_id = @aircraft_identifier_id";
