/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:40:26 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of aircraft_measurement's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeAircraftMeasurementData {
        ...
        public void FetchByAircraftMeasurementId(System.Guid aircraftMeasurementId) {
            // create query against aircraft_measurement
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 aircraft_measurement_id, length, height, weight, wingspan, width, payload, takeoff_weight_in_kilo, speed, user_id, date_time
                            from [aircraft_measurement]
        ...
        // parameters:
        //  aircraftMeasurementId: primary key of table aircraft_measurement
        public static CrudeAircraftMeasurementData GetByAircraftMeasurementId(System.Guid aircraftMeasurementId) {
            // create query against aircraft_measurement
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeAircraftMeasurementData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against aircraft_measurement
        ...
        public static List<CrudeAircraftMeasurementData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeAircraftMeasurementData>();
            ...
            string sql = @" select aircraft_measurement_id, length, height, weight, wingspan, width, payload, takeoff_weight_in_kilo, speed, user_id, date_time
                            from [aircraft_measurement]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of aircraft_measurement
        ...
        public static List<CrudeAircraftMeasurementData> FetchAll() {
            var dataList = new List<CrudeAircraftMeasurementData>();
        ...
        public static List<CrudeAircraftMeasurementData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeAircraftMeasurementData>();
            ...
            string sql = @" select top " + limit.ToString() + @" aircraft_measurement_id, length, height, weight, wingspan, width, payload, takeoff_weight_in_kilo, speed, user_id, date_time
                            from [aircraft_measurement]";
        ...
        public static List<CrudeAircraftMeasurementData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeAircraftMeasurementData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [aircraft_measurement]";
        ...
        public static List<CrudeAircraftMeasurementData> FetchWithFilter(System.Guid aircraftMeasurementId, decimal length, decimal height, decimal weight, decimal wingspan, decimal width, decimal payload, decimal takeoffWeightInKilo, decimal speed, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeAircraftMeasurementData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (wingspan != 0) {
                        ...
                        command.Parameters.Add("@wingspan", SqlDbType.Decimal).Value = wingspan;
                    }
                    if (width != 0) {
                        sql += "  and width = @width";
                    ...
                    if (payload != 0) {
                        ...
                        command.Parameters.Add("@payload", SqlDbType.Decimal).Value = payload;
                    }
                    if (takeoffWeightInKilo != 0) {
                        sql += "  and takeoff_weight_in_kilo = @takeoff_weight_in_kilo";
                        command.Parameters.Add("@takeoff_weight_in_kilo", SqlDbType.Decimal).Value = takeoffWeightInKilo;
                    }
                    if (speed != 0) {
                        sql += "  and speed = @speed";
                        command.Parameters.Add("@speed", SqlDbType.Decimal).Value = speed;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["weight"] != System.DBNull.Value) Weight = (System.Decimal) reader["weight"];
            if (reader["wingspan"] != System.DBNull.Value) Wingspan = (System.Decimal) reader["wingspan"];
            if (reader["width"] != System.DBNull.Value) Width = (System.Decimal) reader["width"];
            if (reader["payload"] != System.DBNull.Value) Payload = (System.Decimal) reader["payload"];
            if (reader["takeoff_weight_in_kilo"] != System.DBNull.Value) TakeoffWeightInKilo = (System.Decimal) reader["takeoff_weight_in_kilo"];
            if (reader["speed"] != System.DBNull.Value) Speed = (System.Decimal) reader["speed"];
        ...
        public void Insert() {
            ...
            if (AircraftMeasurementId == Guid.Empty)
                AircraftMeasurementId = Guid.NewGuid();
            ...
            string sql = "insert into [aircraft_measurement] (aircraft_measurement_id, length, height, weight, wingspan, width, payload, takeoff_weight_in_kilo, speed, user_id, date_time)";
            sql += "            values (@aircraft_measurement_id, @length, @height, @weight, @wingspan, @width, @payload, @takeoff_weight_in_kilo, @speed, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@aircraft_measurement_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)AircraftMeasurementId;
                    ...
                    command.Parameters.Add("@weight",SqlDbType.Decimal).Value = (Weight == 0 ? (object)DBNull.Value : (System.Decimal)Weight);
                    command.Parameters.Add("@wingspan",SqlDbType.Decimal).Value = (Wingspan == 0 ? (object)DBNull.Value : (System.Decimal)Wingspan);
                    command.Parameters.Add("@width",SqlDbType.Decimal).Value = (Width == 0 ? (object)DBNull.Value : (System.Decimal)Width);
                    command.Parameters.Add("@payload",SqlDbType.Decimal).Value = (Payload == 0 ? (object)DBNull.Value : (System.Decimal)Payload);
                    command.Parameters.Add("@takeoff_weight_in_kilo",SqlDbType.Decimal).Value = (TakeoffWeightInKilo == 0 ? (object)DBNull.Value : (System.Decimal)TakeoffWeightInKilo);
                    command.Parameters.Add("@speed",SqlDbType.Decimal).Value = (Speed == 0 ? (object)DBNull.Value : (System.Decimal)Speed);
        ...
        public void Update() {
            ...
            string sql = @" update [aircraft_measurement] set
                ...
                ,width = @width
                ,payload = @payload
                ,takeoff_weight_in_kilo = @takeoff_weight_in_kilo
                ,speed = @speed
                ,user_id = @user_id
                ,date_time = @date_time
            where aircraft_measurement_id = @aircraft_measurement_id";
        ...
        public static void Delete(System.Guid aircraftMeasurementId) {
            // create query against aircraft_measurement
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [aircraft_measurement] 
                where aircraft_measurement_id = @aircraft_measurement_id";
