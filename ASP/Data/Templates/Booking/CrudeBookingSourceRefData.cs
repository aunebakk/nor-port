/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:22:56 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking_source_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeBookingSourceRefData {
        ...
        public void FetchByBookingSourceRcd(string bookingSourceRcd) {
            // create query against booking_source_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_source_rcd, booking_source_name, user_id, date_time
                            from [booking_source_ref]
                            where booking_source_rcd = @booking_source_rcd
                            order by booking_source_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@booking_source_rcd",SqlDbType.NVarChar).Value = bookingSourceRcd;
        ...
        // parameters:
        //  bookingSourceRcd: primary key of table booking_source_ref
        public static CrudeBookingSourceRefData GetByBookingSourceRcd(string bookingSourceRcd) {
            // create query against booking_source_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingSourceRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_source_ref
        ...
        public static List<CrudeBookingSourceRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingSourceRefData>();
            ...
            string sql = @" select booking_source_rcd, booking_source_name, user_id, date_time
                            from [booking_source_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_source_ref
        ...
        public void FetchByBookingSourceName(string bookingSourceName) {
            // create query against booking_source_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 booking_source_rcd, booking_source_name, user_id, date_time
                            from [booking_source_ref]
                            where booking_source_name like '%' + @bookingSourceName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@bookingSourceName",SqlDbType.NVarChar).Value = bookingSourceName;
        ...
        public static List<CrudeBookingSourceRefData> FetchAll() {
            var dataList = new List<CrudeBookingSourceRefData>();
        ...
        public static List<CrudeBookingSourceRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingSourceRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_source_rcd, booking_source_name, user_id, date_time
                            from [booking_source_ref]
                            order by booking_source_name";
        ...
        public static List<CrudeBookingSourceRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingSourceRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_source_ref]";
        ...
        public static List<CrudeBookingSourceRefData> FetchWithFilter(string bookingSourceRcd, string bookingSourceName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingSourceRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(bookingSourceName)) {
                        sql += "  and booking_source_name like '%' + @booking_source_name + '%'";
                        command.Parameters.Add("@booking_source_name", SqlDbType.NVarChar).Value = bookingSourceName.Replace("'","''");
                    }
                    ...
                    sql += " order by booking_source_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["booking_source_name"] != System.DBNull.Value) BookingSourceName = (System.String) reader["booking_source_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking_source_ref] (booking_source_rcd, booking_source_name, user_id, date_time)";
            sql += "            values (@booking_source_rcd, @booking_source_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_source_rcd",SqlDbType.NVarChar).Value = (System.String)BookingSourceRcd;
                    command.Parameters.Add("@booking_source_name",SqlDbType.NVarChar).Value = (System.String)BookingSourceName;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_source_ref] set
        ...
        public static void Delete(string bookingSourceRcd) {
            // create query against booking_source_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_source_ref] 
                where booking_source_rcd = @booking_source_rcd";
