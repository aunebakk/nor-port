...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking_passenger_event_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeBookingPassengerEventTypeRefData {
        
        public string BookingPassengerEventTypeRcd { get; set; }
        
        public string BookingPassengerEventTypeName { get; set; }
        ...
        public void FetchByBookingPassengerEventTypeRcd(string bookingPassengerEventTypeRcd) {
        ...
        public void FetchByBookingPassengerEventTypeName(string bookingPassengerEventTypeName) {
            // create query against booking_passenger_event_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 booking_passenger_event_type_rcd, booking_passenger_event_type_name, user_id, date_time
                            from [booking_passenger_event_type_ref]
                            where booking_passenger_event_type_name like '%' + @bookingPassengerEventTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@bookingPassengerEventTypeName",SqlDbType.NVarChar).Value = bookingPassengerEventTypeName;
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_passenger_event_type_ref]";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["booking_passenger_event_type_name"] != System.DBNull.Value) BookingPassengerEventTypeName = (System.String) reader["booking_passenger_event_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking_passenger_event_type_ref] (booking_passenger_event_type_rcd, booking_passenger_event_type_name, user_id, date_time)";
            sql += "            values (@booking_passenger_event_type_rcd, @booking_passenger_event_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_passenger_event_type_name",SqlDbType.NVarChar).Value = (System.String)BookingPassengerEventTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_passenger_event_type_ref] set
                 booking_passenger_event_type_rcd = @booking_passenger_event_type_rcd
                ,booking_passenger_event_type_name = @booking_passenger_event_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where booking_passenger_event_type_rcd = @booking_passenger_event_type_rcd";
        ...
        public static void Delete(string bookingPassengerEventTypeRcd) {
            // create query against booking_passenger_event_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_passenger_event_type_ref] 
                where booking_passenger_event_type_rcd = @booking_passenger_event_type_rcd";
