/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:17:01 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    //[Serializable()]
    public partial class CrudeBookingServiceRequestData {
        ...
        public void FetchByBookingServiceRequestId(System.Guid bookingServiceRequestId) {
            // create query against booking_service_request
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_service_request_id, booking_id, service_type_rcd, service_special_service_request_id, service_request_status_rcd, service_hotel_id, service_car_rental_id, user_id, date_time, service_ferry_id
                            from [booking_service_request]
        ...
        // parameters:
        //  bookingServiceRequestId: primary key of table booking_service_request
        public static CrudeBookingServiceRequestData GetByBookingServiceRequestId(System.Guid bookingServiceRequestId) {
            // create query against booking_service_request
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingServiceRequestData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_service_request
        ...
        public static List<CrudeBookingServiceRequestData> FetchByBookingId(System.Guid bookingId) {
            var dataList = new List<CrudeBookingServiceRequestData>();
            ...
            string sql = @" select booking_service_request_id, booking_id, service_type_rcd, service_special_service_request_id, service_request_status_rcd, service_hotel_id, service_car_rental_id, user_id, date_time, service_ferry_id
                            from [booking_service_request]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_service_request
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingServiceRequestData> FetchByServiceHotelId(System.Guid serviceHotelId) {
            var dataList = new List<CrudeBookingServiceRequestData>();
            ...
            string sql = @" select booking_service_request_id, booking_id, service_type_rcd, service_special_service_request_id, service_request_status_rcd, service_hotel_id, service_car_rental_id, user_id, date_time, service_ferry_id
                            from [booking_service_request]
                            where service_hotel_id = @service_hotel_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@service_hotel_id", SqlDbType.UniqueIdentifier).Value = serviceHotelId;
        ...
        public static List<CrudeBookingServiceRequestData> FetchByServiceCarRentalId(System.Guid serviceCarRentalId) {
            ...
            string sql = @" select booking_service_request_id, booking_id, service_type_rcd, service_special_service_request_id, service_request_status_rcd, service_hotel_id, service_car_rental_id, user_id, date_time, service_ferry_id
                            from [booking_service_request]
                            where service_car_rental_id = @service_car_rental_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@service_car_rental_id", SqlDbType.UniqueIdentifier).Value = serviceCarRentalId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingServiceRequestData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingServiceRequestData>();
        ...
        public static List<CrudeBookingServiceRequestData> FetchByServiceFerryId(System.Guid serviceFerryId) {
            ...
            string sql = @" select booking_service_request_id, booking_id, service_type_rcd, service_special_service_request_id, service_request_status_rcd, service_hotel_id, service_car_rental_id, user_id, date_time, service_ferry_id
                            from [booking_service_request]
                            where service_ferry_id = @service_ferry_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@service_ferry_id", SqlDbType.UniqueIdentifier).Value = serviceFerryId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingServiceRequestData> FetchByServiceTypeRcd(string serviceTypeRcd) {
            var dataList = new List<CrudeBookingServiceRequestData>();
        ...
        public static List<CrudeBookingServiceRequestData> FetchByServiceRequestStatusRcd(string serviceRequestStatusRcd) {
            ...
            string sql = @" select booking_service_request_id, booking_id, service_type_rcd, service_special_service_request_id, service_request_status_rcd, service_hotel_id, service_car_rental_id, user_id, date_time, service_ferry_id
                            from [booking_service_request]
                            where service_request_status_rcd = @service_request_status_rcd
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@service_request_status_rcd", SqlDbType.NVarChar).Value = serviceRequestStatusRcd.Replace("'","''");
        ...
        public static List<CrudeBookingServiceRequestData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" booking_service_request_id, booking_id, service_type_rcd, service_special_service_request_id, service_request_status_rcd, service_hotel_id, service_car_rental_id, user_id, date_time, service_ferry_id
                            from [booking_service_request]";
        ...
        public static List<CrudeBookingServiceRequestData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingServiceRequestData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_service_request]";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(serviceRequestStatusRcd)) {
                        sql += "  and service_request_status_rcd like '%' + @service_request_status_rcd + '%'";
                        command.Parameters.Add("@service_request_status_rcd", SqlDbType.NVarChar).Value = serviceRequestStatusRcd.Replace("'","''");
                    }
                    if (serviceHotelId != Guid.Empty) {
                        sql += "  and service_hotel_id = @service_hotel_id";
                        command.Parameters.Add("@service_hotel_id", SqlDbType.UniqueIdentifier).Value = serviceHotelId;
                    }
                    if (serviceCarRentalId != Guid.Empty) {
                        sql += "  and service_car_rental_id = @service_car_rental_id";
                        command.Parameters.Add("@service_car_rental_id", SqlDbType.UniqueIdentifier).Value = serviceCarRentalId;
                    }
                    ...
                    if (serviceFerryId != Guid.Empty) {
                        sql += "  and service_ferry_id = @service_ferry_id";
                        command.Parameters.Add("@service_ferry_id", SqlDbType.UniqueIdentifier).Value = serviceFerryId;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["booking_id"] != System.DBNull.Value) BookingId = (System.Guid) reader["booking_id"];
            ...
            if (reader["service_request_status_rcd"] != System.DBNull.Value) ServiceRequestStatusRcd = (System.String) reader["service_request_status_rcd"];
            if (reader["service_hotel_id"] != System.DBNull.Value) ServiceHotelId = (System.Guid) reader["service_hotel_id"];
            if (reader["service_car_rental_id"] != System.DBNull.Value) ServiceCarRentalId = (System.Guid) reader["service_car_rental_id"];
        ...
        public void Insert() {
            ...
            if (BookingServiceRequestId == Guid.Empty)
                BookingServiceRequestId = Guid.NewGuid();
            ...
            string sql = "insert into [booking_service_request] (booking_service_request_id, booking_id, service_type_rcd, service_special_service_request_id, service_request_status_rcd, service_hotel_id, service_car_rental_id, user_id, date_time, service_ferry_id)";
            sql += "            values (@booking_service_request_id, @booking_id, @service_type_rcd, @service_special_service_request_id, @service_request_status_rcd, @service_hotel_id, @service_car_rental_id, @user_id, @date_time, @service_ferry_id)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingId;
                    command.Parameters.Add("@service_type_rcd",SqlDbType.NVarChar).Value = (System.String)ServiceTypeRcd;
                    command.Parameters.Add("@service_special_service_request_id",SqlDbType.UniqueIdentifier).Value = (ServiceSpecialServiceRequestId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ServiceSpecialServiceRequestId);
                    command.Parameters.Add("@service_request_status_rcd",SqlDbType.NVarChar).Value = (System.String)ServiceRequestStatusRcd;
                    command.Parameters.Add("@service_hotel_id",SqlDbType.UniqueIdentifier).Value = (ServiceHotelId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ServiceHotelId);
                    command.Parameters.Add("@service_car_rental_id",SqlDbType.UniqueIdentifier).Value = (ServiceCarRentalId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ServiceCarRentalId);
                    command.Parameters.Add("@user_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)UserId;
                    command.Parameters.Add("@date_time",SqlDbType.DateTime).Value = (System.DateTime)DateTime;
                    command.Parameters.Add("@service_ferry_id",SqlDbType.UniqueIdentifier).Value = (ServiceFerryId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ServiceFerryId);
                    // execute query against booking_service_request
        ...
        public void Update() {
            ...
            string sql = @" update [booking_service_request] set
                ...
                ,service_request_status_rcd = @service_request_status_rcd
                ,service_hotel_id = @service_hotel_id
                ,service_car_rental_id = @service_car_rental_id
                ,user_id = @user_id
                ,date_time = @date_time
                ,service_ferry_id = @service_ferry_id
            where booking_service_request_id = @booking_service_request_id";
        ...
        public static void Delete(System.Guid bookingServiceRequestId) {
            // create query against booking_service_request
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_service_request] 
                where booking_service_request_id = @booking_service_request_id";
