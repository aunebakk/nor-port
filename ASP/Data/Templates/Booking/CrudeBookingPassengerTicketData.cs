...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking_passenger_ticket's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeBookingPassengerTicketData {
        ...
        public void FetchByBookingPassengerTicketId(System.Guid bookingPassengerTicketId) {
            // create query against booking_passenger_ticket
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_passenger_ticket_id, ticket_number, ticket_description, user_id, date_time
                            from [booking_passenger_ticket]
        ...
        // parameters:
        //  bookingPassengerTicketId: primary key of table booking_passenger_ticket
        public static CrudeBookingPassengerTicketData GetByBookingPassengerTicketId(System.Guid bookingPassengerTicketId) {
            // create query against booking_passenger_ticket
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingPassengerTicketData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_passenger_ticket
        ...
        public static List<CrudeBookingPassengerTicketData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingPassengerTicketData>();
            ...
            string sql = @" select booking_passenger_ticket_id, ticket_number, ticket_description, user_id, date_time
                            from [booking_passenger_ticket]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_passenger_ticket
        ...
        public static List<CrudeBookingPassengerTicketData> FetchAll() {
            var dataList = new List<CrudeBookingPassengerTicketData>();
        ...
        public static List<CrudeBookingPassengerTicketData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingPassengerTicketData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_passenger_ticket_id, ticket_number, ticket_description, user_id, date_time
                            from [booking_passenger_ticket]";
        ...
        public static List<CrudeBookingPassengerTicketData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingPassengerTicketData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_passenger_ticket]";
        ...
        public static List<CrudeBookingPassengerTicketData> FetchWithFilter(System.Guid bookingPassengerTicketId, string ticketNumber, string ticketDescription, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingPassengerTicketData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(ticketNumber)) {
                        ...
                        command.Parameters.Add("@ticket_number", SqlDbType.NVarChar).Value = ticketNumber.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(ticketDescription)) {
                        sql += "  and ticket_description like '%' + @ticket_description + '%'";
                        command.Parameters.Add("@ticket_description", SqlDbType.NVarChar).Value = ticketDescription.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["ticket_number"] != System.DBNull.Value) TicketNumber = (System.String) reader["ticket_number"];
            if (reader["ticket_description"] != System.DBNull.Value) TicketDescription = (System.String) reader["ticket_description"];
        ...
        public void Insert() {
            ...
            if (BookingPassengerTicketId == Guid.Empty)
                BookingPassengerTicketId = Guid.NewGuid();
            ...
            string sql = "insert into [booking_passenger_ticket] (booking_passenger_ticket_id, ticket_number, ticket_description, user_id, date_time)";
            sql += "            values (@booking_passenger_ticket_id, @ticket_number, @ticket_description, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_passenger_ticket_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingPassengerTicketId;
                    command.Parameters.Add("@ticket_number",SqlDbType.NVarChar).Value = (System.String)TicketNumber;
                    command.Parameters.Add("@ticket_description",SqlDbType.NVarChar).Value = (System.String)TicketDescription;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_passenger_ticket] set
        ...
        public static void Delete(System.Guid bookingPassengerTicketId) {
            // create query against booking_passenger_ticket
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_passenger_ticket] 
                where booking_passenger_ticket_id = @booking_passenger_ticket_id";
