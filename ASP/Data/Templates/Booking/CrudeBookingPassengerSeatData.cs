...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking_passenger_seat's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeBookingPassengerSeatData {
        ...
        public void FetchByBookingPassengerSeatId(System.Guid bookingPassengerSeatId) {
            // create query against booking_passenger_seat
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_passenger_seat_id, seat_number, user_id, date_time
        ...
        // parameters:
        //  bookingPassengerSeatId: primary key of table booking_passenger_seat
        public static CrudeBookingPassengerSeatData GetByBookingPassengerSeatId(System.Guid bookingPassengerSeatId) {
            // create query against booking_passenger_seat
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingPassengerSeatData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_passenger_seat
        ...
        public static List<CrudeBookingPassengerSeatData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingPassengerSeatData>();
            ...
            string sql = @" select booking_passenger_seat_id, seat_number, user_id, date_time
                            from [booking_passenger_seat]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_passenger_seat
        ...
        public static List<CrudeBookingPassengerSeatData> FetchAll() {
            var dataList = new List<CrudeBookingPassengerSeatData>();
        ...
        public static List<CrudeBookingPassengerSeatData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingPassengerSeatData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_passenger_seat_id, seat_number, user_id, date_time
                            from [booking_passenger_seat]";
        ...
        public static List<CrudeBookingPassengerSeatData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingPassengerSeatData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_passenger_seat]";
        ...
        public static List<CrudeBookingPassengerSeatData> FetchWithFilter(System.Guid bookingPassengerSeatId, string seatNumber, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingPassengerSeatData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(seatNumber)) {
                        sql += "  and seat_number like '%' + @seat_number + '%'";
                        command.Parameters.Add("@seat_number", SqlDbType.NVarChar).Value = seatNumber.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["seat_number"] != System.DBNull.Value) SeatNumber = (System.String) reader["seat_number"];
        ...
        public void Insert() {
            ...
            if (BookingPassengerSeatId == Guid.Empty)
                BookingPassengerSeatId = Guid.NewGuid();
            ...
            string sql = "insert into [booking_passenger_seat] (booking_passenger_seat_id, seat_number, user_id, date_time)";
            sql += "            values (@booking_passenger_seat_id, @seat_number, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_passenger_seat_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingPassengerSeatId;
                    command.Parameters.Add("@seat_number",SqlDbType.NVarChar).Value = (System.String)SeatNumber;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_passenger_seat] set
        ...
        public static void Delete(System.Guid bookingPassengerSeatId) {
            // create query against booking_passenger_seat
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_passenger_seat] 
                where booking_passenger_seat_id = @booking_passenger_seat_id";
