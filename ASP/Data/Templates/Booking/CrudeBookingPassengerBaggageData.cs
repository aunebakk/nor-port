/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:22:34 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking_passenger_baggage's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeBookingPassengerBaggageData {
        ...
        public void FetchByBookingPassengerBaggageId(System.Guid bookingPassengerBaggageId) {
            // create query against booking_passenger_baggage
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_passenger_baggage_id, item_count, weight, user_id, date_time, remarks
                            from [booking_passenger_baggage]
        ...
        // parameters:
        //  bookingPassengerBaggageId: primary key of table booking_passenger_baggage
        public static CrudeBookingPassengerBaggageData GetByBookingPassengerBaggageId(System.Guid bookingPassengerBaggageId) {
            // create query against booking_passenger_baggage
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingPassengerBaggageData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_passenger_baggage
        ...
        public static List<CrudeBookingPassengerBaggageData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingPassengerBaggageData>();
            ...
            string sql = @" select booking_passenger_baggage_id, item_count, weight, user_id, date_time, remarks
                            from [booking_passenger_baggage]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_passenger_baggage
        ...
        public static List<CrudeBookingPassengerBaggageData> FetchAll() {
            var dataList = new List<CrudeBookingPassengerBaggageData>();
        ...
        public static List<CrudeBookingPassengerBaggageData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingPassengerBaggageData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_passenger_baggage_id, item_count, weight, user_id, date_time, remarks
                            from [booking_passenger_baggage]";
        ...
        public static List<CrudeBookingPassengerBaggageData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingPassengerBaggageData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_passenger_baggage]";
        ...
        public static List<CrudeBookingPassengerBaggageData> FetchWithFilter(System.Guid bookingPassengerBaggageId, int itemCount, decimal weight, System.Guid userId, System.DateTime dateTime, string remarks) {
            var dataList = new List<CrudeBookingPassengerBaggageData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (itemCount != 0) {
                        sql += "  and item_count = @item_count";
                        command.Parameters.Add("@item_count", SqlDbType.Int).Value = itemCount;
                    }
                    if (weight != 0) {
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["item_count"] != System.DBNull.Value) ItemCount = (System.Int32) reader["item_count"];
        ...
        public void Insert() {
            ...
            if (BookingPassengerBaggageId == Guid.Empty)
                BookingPassengerBaggageId = Guid.NewGuid();
            ...
            string sql = "insert into [booking_passenger_baggage] (booking_passenger_baggage_id, item_count, weight, user_id, date_time, remarks)";
            sql += "            values (@booking_passenger_baggage_id, @item_count, @weight, @user_id, @date_time, @remarks)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_passenger_baggage_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingPassengerBaggageId;
                    command.Parameters.Add("@item_count",SqlDbType.Int).Value = (System.Int32)ItemCount;
                    command.Parameters.Add("@weight",SqlDbType.Decimal).Value = (System.Decimal)Weight;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_passenger_baggage] set
        ...
        public static void Delete(System.Guid bookingPassengerBaggageId) {
            // create query against booking_passenger_baggage
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_passenger_baggage] 
                where booking_passenger_baggage_id = @booking_passenger_baggage_id";
