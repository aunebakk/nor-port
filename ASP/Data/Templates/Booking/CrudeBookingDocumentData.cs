/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:22:05 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking_document's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeBookingDocumentData {
        ...
        public void FetchByBookingDocumentId(System.Guid bookingDocumentId) {
            // create query against booking_document
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_document_id, booking_id, booking_document_type_rcd, booking_document_name, booking_document_filename, booking_document, comment, user_id, date_time
                            from [booking_document]
                            where booking_document_id = @booking_document_id
                            order by booking_document_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@booking_document_id",SqlDbType.UniqueIdentifier).Value = bookingDocumentId;
        ...
        // parameters:
        //  bookingDocumentId: primary key of table booking_document
        public static CrudeBookingDocumentData GetByBookingDocumentId(System.Guid bookingDocumentId) {
            // create query against booking_document
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingDocumentData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_document
        ...
        public static List<CrudeBookingDocumentData> FetchByBookingId(System.Guid bookingId) {
            var dataList = new List<CrudeBookingDocumentData>();
            ...
            string sql = @" select booking_document_id, booking_id, booking_document_type_rcd, booking_document_name, booking_document_filename, booking_document, comment, user_id, date_time
                            from [booking_document]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_document
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingDocumentData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingDocumentData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingDocumentData> FetchByBookingDocumentTypeRcd(string bookingDocumentTypeRcd) {
            var dataList = new List<CrudeBookingDocumentData>();
            ...
            string sql = @" select booking_document_id, booking_id, booking_document_type_rcd, booking_document_name, booking_document_filename, booking_document, comment, user_id, date_time
                            from [booking_document]
                            where booking_document_type_rcd = @booking_document_type_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@booking_document_type_rcd", SqlDbType.NVarChar).Value = bookingDocumentTypeRcd.Replace("'","''");
        ...
        public void FetchByBookingDocumentName(string bookingDocumentName) {
            // create query against booking_document
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 booking_document_id, booking_id, booking_document_type_rcd, booking_document_name, booking_document_filename, booking_document, comment, user_id, date_time
                            from [booking_document]
                            where booking_document_name like '%' + @bookingDocumentName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@bookingDocumentName",SqlDbType.NVarChar).Value = bookingDocumentName;
        ...
        public static List<CrudeBookingDocumentData> FetchAll() {
            var dataList = new List<CrudeBookingDocumentData>();
        ...
        public static List<CrudeBookingDocumentData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingDocumentData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_document_id, booking_id, booking_document_type_rcd, booking_document_name, booking_document_filename, booking_document, comment, user_id, date_time
                            from [booking_document]
                            order by booking_document_name";
        ...
        public static List<CrudeBookingDocumentData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingDocumentData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_document]";
        ...
        public static List<CrudeBookingDocumentData> FetchWithFilter(System.Guid bookingDocumentId, System.Guid bookingId, string bookingDocumentTypeRcd, string bookingDocumentName, string bookingDocumentFilename, string bookingDocument, string comment, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingDocumentData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (bookingDocumentId != Guid.Empty) {
                        sql += "  and booking_document_id = @booking_document_id";
                        command.Parameters.Add("@booking_document_id", SqlDbType.UniqueIdentifier).Value = bookingDocumentId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(bookingDocumentTypeRcd)) {
                        sql += "  and booking_document_type_rcd like '%' + @booking_document_type_rcd + '%'";
                        command.Parameters.Add("@booking_document_type_rcd", SqlDbType.NVarChar).Value = bookingDocumentTypeRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(bookingDocumentName)) {
                        sql += "  and booking_document_name like '%' + @booking_document_name + '%'";
                        command.Parameters.Add("@booking_document_name", SqlDbType.NVarChar).Value = bookingDocumentName.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(bookingDocumentFilename)) {
                        sql += "  and booking_document_filename like '%' + @booking_document_filename + '%'";
                        command.Parameters.Add("@booking_document_filename", SqlDbType.NVarChar).Value = bookingDocumentFilename.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(bookingDocument)) {
                        sql += "  and booking_document like '%' + @booking_document + '%'";
                        command.Parameters.Add("@booking_document", SqlDbType.NVarChar).Value = bookingDocument.Replace("'","''");
                    }
                    ...
                    sql += " order by booking_document_name";
        ...
        public void Populate(IDataReader reader) {
            if (reader["booking_document_id"] != System.DBNull.Value) BookingDocumentId = (System.Guid) reader["booking_document_id"];
            if (reader["booking_id"] != System.DBNull.Value) BookingId = (System.Guid) reader["booking_id"];
            if (reader["booking_document_type_rcd"] != System.DBNull.Value) BookingDocumentTypeRcd = (System.String) reader["booking_document_type_rcd"];
            if (reader["booking_document_name"] != System.DBNull.Value) BookingDocumentName = (System.String) reader["booking_document_name"];
            if (reader["booking_document_filename"] != System.DBNull.Value) BookingDocumentFilename = (System.String) reader["booking_document_filename"];
            if (reader["booking_document"] != System.DBNull.Value) BookingDocument = (System.String) reader["booking_document"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking_document] (booking_document_id, booking_id, booking_document_type_rcd, booking_document_name, booking_document_filename, booking_document, comment, user_id, date_time)";
            sql += "            values (@booking_document_id, @booking_id, @booking_document_type_rcd, @booking_document_name, @booking_document_filename, @booking_document, @comment, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_document_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingDocumentId;
                    command.Parameters.Add("@booking_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingId;
                    command.Parameters.Add("@booking_document_type_rcd",SqlDbType.NVarChar).Value = (System.String)BookingDocumentTypeRcd;
                    command.Parameters.Add("@booking_document_name",SqlDbType.NVarChar).Value = (System.String)BookingDocumentName;
                    command.Parameters.Add("@booking_document_filename",SqlDbType.NVarChar).Value = (System.String)BookingDocumentFilename;
                    command.Parameters.Add("@booking_document",SqlDbType.NVarChar).Value = (System.String)BookingDocument;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_document] set
                 booking_document_id = @booking_document_id
                ,booking_id = @booking_id
                ,booking_document_type_rcd = @booking_document_type_rcd
                ,booking_document_name = @booking_document_name
                ,booking_document_filename = @booking_document_filename
        ...
        public static void Delete(System.Guid bookingDocumentId) {
            // create query against booking_document
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_document] 
                where booking_document_id = @booking_document_id";
