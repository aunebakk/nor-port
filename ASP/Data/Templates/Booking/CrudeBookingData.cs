/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:16:11 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking's columns
    ...
    public partial class CrudeBookingData {
        ...
        public void FetchByBookingId(System.Guid bookingId) {
            // create query against booking
        ...
        // parameters:
        //  bookingId: primary key of table booking
        public static CrudeBookingData GetByBookingId(System.Guid bookingId) {
            // create query against booking
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
        ...
        public static List<CrudeBookingData> FetchByAddressId(System.Guid addressId) {
            var dataList = new List<CrudeBookingData>();
            ...
            string sql = @" select booking_id, received_from, address_id, booking_source_rcd, external_system_id, agency_id, financial_currency_id, financial_costcentre_id, comment, user_id, date_time
                            from [booking]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingData> FetchByExternalSystemId(System.Guid externalSystemId) {
            var dataList = new List<CrudeBookingData>();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@external_system_id", SqlDbType.UniqueIdentifier).Value = externalSystemId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingData> FetchByAgencyId(System.Guid agencyId) {
            var dataList = new List<CrudeBookingData>();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@agency_id", SqlDbType.UniqueIdentifier).Value = agencyId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeBookingData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingData> FetchByFinancialCostcentreId(System.Guid financialCostcentreId) {
            var dataList = new List<CrudeBookingData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingData> FetchByBookingSourceRcd(string bookingSourceRcd) {
            var dataList = new List<CrudeBookingData>();
            ...
            string sql = @" select booking_id, received_from, address_id, booking_source_rcd, external_system_id, agency_id, financial_currency_id, financial_costcentre_id, comment, user_id, date_time
                            from [booking]
                            where booking_source_rcd = @booking_source_rcd
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@booking_source_rcd", SqlDbType.NVarChar).Value = bookingSourceRcd.Replace("'","''");
        ...
        public static List<CrudeBookingData> FetchAll() {
            var dataList = new List<CrudeBookingData>();
        ...
        public static List<CrudeBookingData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_id, received_from, address_id, booking_source_rcd, external_system_id, agency_id, financial_currency_id, financial_costcentre_id, comment, user_id, date_time
                            from [booking]";
        ...
        public static List<CrudeBookingData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(receivedFrom)) {
                        sql += "  and received_from like '%' + @received_from + '%'";
                        command.Parameters.Add("@received_from", SqlDbType.NVarChar).Value = receivedFrom.Replace("'","''");
                    }
                    if (addressId != Guid.Empty) {
                        sql += "  and address_id = @address_id";
                        command.Parameters.Add("@address_id", SqlDbType.UniqueIdentifier).Value = addressId;
                    }
                    if (!string.IsNullOrEmpty(bookingSourceRcd)) {
                        sql += "  and booking_source_rcd like '%' + @booking_source_rcd + '%'";
                        command.Parameters.Add("@booking_source_rcd", SqlDbType.NVarChar).Value = bookingSourceRcd.Replace("'","''");
                    }
                    if (externalSystemId != Guid.Empty) {
                        sql += "  and external_system_id = @external_system_id";
                        command.Parameters.Add("@external_system_id", SqlDbType.UniqueIdentifier).Value = externalSystemId;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["received_from"] != System.DBNull.Value) ReceivedFrom = (System.String) reader["received_from"];
            if (reader["address_id"] != System.DBNull.Value) AddressId = (System.Guid) reader["address_id"];
            if (reader["booking_source_rcd"] != System.DBNull.Value) BookingSourceRcd = (System.String) reader["booking_source_rcd"];
            if (reader["external_system_id"] != System.DBNull.Value) ExternalSystemId = (System.Guid) reader["external_system_id"];
            if (reader["agency_id"] != System.DBNull.Value) AgencyId = (System.Guid) reader["agency_id"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking] (booking_id, received_from, address_id, booking_source_rcd, external_system_id, agency_id, financial_currency_id, financial_costcentre_id, comment, user_id, date_time)";
            sql += "            values (@booking_id, @received_from, @address_id, @booking_source_rcd, @external_system_id, @agency_id, @financial_currency_id, @financial_costcentre_id, @comment, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@received_from",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(ReceivedFrom)) ? (object)DBNull.Value : (System.String)ReceivedFrom;
                    ...
                    command.Parameters.Add("@booking_source_rcd",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(BookingSourceRcd)) ? (object)DBNull.Value : (System.String)BookingSourceRcd;
                    command.Parameters.Add("@external_system_id",SqlDbType.UniqueIdentifier).Value = (ExternalSystemId == Guid.Empty ? (object)DBNull.Value : (System.Guid)ExternalSystemId);
                    command.Parameters.Add("@agency_id",SqlDbType.UniqueIdentifier).Value = (AgencyId == Guid.Empty ? (object)DBNull.Value : (System.Guid)AgencyId);
        ...
        public void Update() {
            ...
            string sql = @" update [booking] set
                ...
                ,booking_source_rcd = @booking_source_rcd
        ...
        public static void Delete(System.Guid bookingId) {
            // create query against booking
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
