/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:16:41 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking_passenger's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeBookingPassengerData {
        ...
        public void FetchByBookingPassengerId(System.Guid bookingPassengerId) {
            // create query against booking_passenger
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_passenger_id, became_booking_passenger_id, binding_booking_passenger_id, booking_id, passenger_id, default_state_rcd, user_id, date_time
        ...
        // parameters:
        //  bookingPassengerId: primary key of table booking_passenger
        public static CrudeBookingPassengerData GetByBookingPassengerId(System.Guid bookingPassengerId) {
            // create query against booking_passenger
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingPassengerData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_passenger
        ...
        public static List<CrudeBookingPassengerData> FetchByBecameBookingPassengerId(System.Guid becameBookingPassengerId) {
            var dataList = new List<CrudeBookingPassengerData>();
            ...
            string sql = @" select booking_passenger_id, became_booking_passenger_id, binding_booking_passenger_id, booking_id, passenger_id, default_state_rcd, user_id, date_time
                            from [booking_passenger]
                            where became_booking_passenger_id = @became_booking_passenger_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@became_booking_passenger_id", SqlDbType.UniqueIdentifier).Value = becameBookingPassengerId;
                    ...
                    // read all rows returned from the query of booking_passenger
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingPassengerData> FetchByBindingBookingPassengerId(System.Guid bindingBookingPassengerId) {
            var dataList = new List<CrudeBookingPassengerData>();
            ...
            string sql = @" select booking_passenger_id, became_booking_passenger_id, binding_booking_passenger_id, booking_id, passenger_id, default_state_rcd, user_id, date_time
                            from [booking_passenger]
                            where binding_booking_passenger_id = @binding_booking_passenger_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@binding_booking_passenger_id", SqlDbType.UniqueIdentifier).Value = bindingBookingPassengerId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingPassengerData> FetchByBookingId(System.Guid bookingId) {
            var dataList = new List<CrudeBookingPassengerData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingPassengerData> FetchByPassengerId(System.Guid passengerId) {
            var dataList = new List<CrudeBookingPassengerData>();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@passenger_id", SqlDbType.UniqueIdentifier).Value = passengerId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingPassengerData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingPassengerData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingPassengerData> FetchByDefaultStateRcd(string defaultStateRcd) {
            var dataList = new List<CrudeBookingPassengerData>();
        ...
        public static List<CrudeBookingPassengerData> FetchAll() {
            var dataList = new List<CrudeBookingPassengerData>();
        ...
        public static List<CrudeBookingPassengerData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingPassengerData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_passenger_id, became_booking_passenger_id, binding_booking_passenger_id, booking_id, passenger_id, default_state_rcd, user_id, date_time
                            from [booking_passenger]";
        ...
        public static List<CrudeBookingPassengerData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingPassengerData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_passenger]";
        ...
        public static List<CrudeBookingPassengerData> FetchWithFilter(System.Guid bookingPassengerId, System.Guid becameBookingPassengerId, System.Guid bindingBookingPassengerId, System.Guid bookingId, System.Guid passengerId, string defaultStateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingPassengerData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (becameBookingPassengerId != Guid.Empty) {
                        sql += "  and became_booking_passenger_id = @became_booking_passenger_id";
                        command.Parameters.Add("@became_booking_passenger_id", SqlDbType.UniqueIdentifier).Value = becameBookingPassengerId;
                    }
                    if (bindingBookingPassengerId != Guid.Empty) {
                        sql += "  and binding_booking_passenger_id = @binding_booking_passenger_id";
                        command.Parameters.Add("@binding_booking_passenger_id", SqlDbType.UniqueIdentifier).Value = bindingBookingPassengerId;
                    }
                    ...
                    if (passengerId != Guid.Empty) {
                        sql += "  and passenger_id = @passenger_id";
                        command.Parameters.Add("@passenger_id", SqlDbType.UniqueIdentifier).Value = passengerId;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["became_booking_passenger_id"] != System.DBNull.Value) BecameBookingPassengerId = (System.Guid) reader["became_booking_passenger_id"];
            if (reader["binding_booking_passenger_id"] != System.DBNull.Value) BindingBookingPassengerId = (System.Guid) reader["binding_booking_passenger_id"];
            if (reader["booking_id"] != System.DBNull.Value) BookingId = (System.Guid) reader["booking_id"];
            if (reader["passenger_id"] != System.DBNull.Value) PassengerId = (System.Guid) reader["passenger_id"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking_passenger] (booking_passenger_id, became_booking_passenger_id, binding_booking_passenger_id, booking_id, passenger_id, default_state_rcd, user_id, date_time)";
            sql += "            values (@booking_passenger_id, @became_booking_passenger_id, @binding_booking_passenger_id, @booking_id, @passenger_id, @default_state_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@became_booking_passenger_id",SqlDbType.UniqueIdentifier).Value = (BecameBookingPassengerId == Guid.Empty ? (object)DBNull.Value : (System.Guid)BecameBookingPassengerId);
                    command.Parameters.Add("@binding_booking_passenger_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BindingBookingPassengerId;
                    command.Parameters.Add("@booking_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingId;
                    command.Parameters.Add("@passenger_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)PassengerId;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_passenger] set
                 booking_passenger_id = @booking_passenger_id
                ,became_booking_passenger_id = @became_booking_passenger_id
                ,binding_booking_passenger_id = @binding_booking_passenger_id
        ...
        public static void Delete(System.Guid bookingPassengerId) {
            // create query against booking_passenger
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_passenger] 
                where booking_passenger_id = @booking_passenger_id";
