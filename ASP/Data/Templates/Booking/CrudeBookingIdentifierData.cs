/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:16:34 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial class CrudeBookingIdentifierData {
        ...
        public void FetchByBookingIdentifierId(System.Guid bookingIdentifierId) {
            // create query against booking_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_identifier_id, booking_id, booking_identifier_type_rcd, booking_identifier_value, comment, user_id, date_time
                            from [booking_identifier]
                            where booking_identifier_id = @booking_identifier_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@booking_identifier_id",SqlDbType.UniqueIdentifier).Value = bookingIdentifierId;
        ...
        // parameters:
        //  bookingIdentifierId: primary key of table booking_identifier
        public static CrudeBookingIdentifierData GetByBookingIdentifierId(System.Guid bookingIdentifierId) {
            // create query against booking_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingIdentifierData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_identifier
        ...
        public static List<CrudeBookingIdentifierData> FetchByBookingId(System.Guid bookingId) {
            var dataList = new List<CrudeBookingIdentifierData>();
            ...
            string sql = @" select booking_identifier_id, booking_id, booking_identifier_type_rcd, booking_identifier_value, comment, user_id, date_time
                            from [booking_identifier]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_identifier
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingIdentifierData> FetchByBookingIdentifierTypeRcd(string bookingIdentifierTypeRcd) {
            var dataList = new List<CrudeBookingIdentifierData>();
        ...
        public static List<CrudeBookingIdentifierData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" booking_identifier_id, booking_id, booking_identifier_type_rcd, booking_identifier_value, comment, user_id, date_time
                            from [booking_identifier]";
        ...
        public static List<CrudeBookingIdentifierData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingIdentifierData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_identifier]";
        ...
        public static List<CrudeBookingIdentifierData> FetchWithFilter(System.Guid bookingIdentifierId, System.Guid bookingId, string bookingIdentifierTypeRcd, string bookingIdentifierValue, string comment, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingIdentifierData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (bookingIdentifierId != Guid.Empty) {
                        sql += "  and booking_identifier_id = @booking_identifier_id";
                        command.Parameters.Add("@booking_identifier_id", SqlDbType.UniqueIdentifier).Value = bookingIdentifierId;
                    }
                    ...
                    if (!string.IsNullOrEmpty(bookingIdentifierValue)) {
                        sql += "  and booking_identifier_value like '%' + @booking_identifier_value + '%'";
                        command.Parameters.Add("@booking_identifier_value", SqlDbType.NVarChar).Value = bookingIdentifierValue.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["booking_identifier_id"] != System.DBNull.Value) BookingIdentifierId = (System.Guid) reader["booking_identifier_id"];
            ...
            if (reader["booking_identifier_value"] != System.DBNull.Value) BookingIdentifierValue = (System.String) reader["booking_identifier_value"];
        ...
        public void Insert() {
            ...
            if (BookingIdentifierId == Guid.Empty)
                BookingIdentifierId = Guid.NewGuid();
            ...
            string sql = "insert into [booking_identifier] (booking_identifier_id, booking_id, booking_identifier_type_rcd, booking_identifier_value, comment, user_id, date_time)";
            sql += "            values (@booking_identifier_id, @booking_id, @booking_identifier_type_rcd, @booking_identifier_value, @comment, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_identifier_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingIdentifierId;
                    ...
                    command.Parameters.Add("@booking_identifier_value",SqlDbType.NVarChar).Value = (System.String)BookingIdentifierValue;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_identifier] set
                 booking_identifier_id = @booking_identifier_id
                ,booking_id = @booking_id
                ,booking_identifier_type_rcd = @booking_identifier_type_rcd
                ,booking_identifier_value = @booking_identifier_value
                ,comment = @comment
                ,user_id = @user_id
                ,date_time = @date_time
            where booking_identifier_id = @booking_identifier_id";
        ...
        public static void Delete(System.Guid bookingIdentifierId) {
            // create query against booking_identifier
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_identifier] 
                where booking_identifier_id = @booking_identifier_id";
