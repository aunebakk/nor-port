/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:22:12 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of booking_event's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeBookingEventData {
        ...
        public void FetchByBookingEventId(System.Guid bookingEventId) {
            // create query against booking_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 booking_event_id, booking_id, booking_event_type_rcd, comment, user_id, date_time
                            from [booking_event]
                            where booking_event_id = @booking_event_id";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@booking_event_id",SqlDbType.UniqueIdentifier).Value = bookingEventId;
        ...
        // parameters:
        //  bookingEventId: primary key of table booking_event
        public static CrudeBookingEventData GetByBookingEventId(System.Guid bookingEventId) {
            // create query against booking_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeBookingEventData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against booking_event
        ...
        public static List<CrudeBookingEventData> FetchByBookingId(System.Guid bookingId) {
            var dataList = new List<CrudeBookingEventData>();
            ...
            string sql = @" select booking_event_id, booking_id, booking_event_type_rcd, comment, user_id, date_time
                            from [booking_event]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of booking_event
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingEventData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeBookingEventData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeBookingEventData> FetchByBookingEventTypeRcd(string bookingEventTypeRcd) {
            var dataList = new List<CrudeBookingEventData>();
        ...
        public static List<CrudeBookingEventData> FetchAll() {
            var dataList = new List<CrudeBookingEventData>();
        ...
        public static List<CrudeBookingEventData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeBookingEventData>();
            ...
            string sql = @" select top " + limit.ToString() + @" booking_event_id, booking_id, booking_event_type_rcd, comment, user_id, date_time
                            from [booking_event]";
        ...
        public static List<CrudeBookingEventData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeBookingEventData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [booking_event]";
        ...
        public static List<CrudeBookingEventData> FetchWithFilter(System.Guid bookingEventId, System.Guid bookingId, string bookingEventTypeRcd, string comment, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeBookingEventData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (bookingEventId != Guid.Empty) {
                        sql += "  and booking_event_id = @booking_event_id";
                        command.Parameters.Add("@booking_event_id", SqlDbType.UniqueIdentifier).Value = bookingEventId;
                    }
        ...
        public void Populate(IDataReader reader) {
            if (reader["booking_event_id"] != System.DBNull.Value) BookingEventId = (System.Guid) reader["booking_event_id"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [booking_event] (booking_event_id, booking_id, booking_event_type_rcd, comment, user_id, date_time)";
            sql += "            values (@booking_event_id, @booking_id, @booking_event_type_rcd, @comment, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@booking_event_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)BookingEventId;
        ...
        public void Update() {
            ...
            string sql = @" update [booking_event] set
        ...
        public static void Delete(System.Guid bookingEventId) {
            // create query against booking_event
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [booking_event] 
                where booking_event_id = @booking_event_id";
