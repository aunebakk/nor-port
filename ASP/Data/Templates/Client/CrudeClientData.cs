/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:17:23 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial class CrudeClientData {
        ...
        public void FetchByClientId(System.Guid clientId) {
            ...
            string sql = @" select top 1 client_id, first_name, middle_name, last_name, address_id, default_user_id, passenger_type_rcd, nationality_rcd, gender_rcd, title_rcd, client_type_rcd, user_id, date_time
                            from [client]
        ...
        public static List<CrudeClientData> FetchByAddressId(System.Guid addressId) {
            ...
            string sql = @" select client_id, first_name, middle_name, last_name, address_id, default_user_id, passenger_type_rcd, nationality_rcd, gender_rcd, title_rcd, client_type_rcd, user_id, date_time
                            from [client]
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeClientData> FetchByDefaultUserId(System.Guid defaultUserId) {
            var dataList = new List<CrudeClientData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeClientData> FetchByPassengerTypeRcd(string passengerTypeRcd) {
            var dataList = new List<CrudeClientData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeClientData> FetchByNationalityRcd(string nationalityRcd) {
            var dataList = new List<CrudeClientData>();
            ...
            string sql = @" select client_id, first_name, middle_name, last_name, address_id, default_user_id, passenger_type_rcd, nationality_rcd, gender_rcd, title_rcd, client_type_rcd, user_id, date_time
                            from [client]
                            where nationality_rcd = @nationality_rcd
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@nationality_rcd", SqlDbType.NVarChar).Value = nationalityRcd.Replace("'","''");
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeClientData> FetchByGenderRcd(string genderRcd) {
            var dataList = new List<CrudeClientData>();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@gender_rcd", SqlDbType.NVarChar).Value = genderRcd.Replace("'","''");
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeClientData> FetchByTitleRcd(string titleRcd) {
            var dataList = new List<CrudeClientData>();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@title_rcd", SqlDbType.NVarChar).Value = titleRcd.Replace("'","''");
        ...
        public static List<CrudeClientData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" client_id, first_name, middle_name, last_name, address_id, default_user_id, passenger_type_rcd, nationality_rcd, gender_rcd, title_rcd, client_type_rcd, user_id, date_time
                            from [client]
                            order by first_name";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(nationalityRcd)) {
                        sql += "  and nationality_rcd like '%' + @nationality_rcd + '%'";
                        command.Parameters.Add("@nationality_rcd", SqlDbType.NVarChar).Value = nationalityRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(genderRcd)) {
                        sql += "  and gender_rcd like '%' + @gender_rcd + '%'";
                        command.Parameters.Add("@gender_rcd", SqlDbType.NVarChar).Value = genderRcd.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(titleRcd)) {
                        sql += "  and title_rcd like '%' + @title_rcd + '%'";
                        command.Parameters.Add("@title_rcd", SqlDbType.NVarChar).Value = titleRcd.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["nationality_rcd"] != System.DBNull.Value) NationalityRcd = (System.String) reader["nationality_rcd"];
            if (reader["gender_rcd"] != System.DBNull.Value) GenderRcd = (System.String) reader["gender_rcd"];
            if (reader["title_rcd"] != System.DBNull.Value) TitleRcd = (System.String) reader["title_rcd"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [client] (client_id, first_name, middle_name, last_name, address_id, default_user_id, passenger_type_rcd, nationality_rcd, gender_rcd, title_rcd, client_type_rcd, user_id, date_time)";
            sql += "            values (@client_id, @first_name, @middle_name, @last_name, @address_id, @default_user_id, @passenger_type_rcd, @nationality_rcd, @gender_rcd, @title_rcd, @client_type_rcd, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@passenger_type_rcd",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(PassengerTypeRcd)) ? (object)DBNull.Value : (System.String)PassengerTypeRcd;
                    command.Parameters.Add("@nationality_rcd",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(NationalityRcd)) ? (object)DBNull.Value : (System.String)NationalityRcd;
                    command.Parameters.Add("@gender_rcd",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(GenderRcd)) ? (object)DBNull.Value : (System.String)GenderRcd;
                    command.Parameters.Add("@title_rcd",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(TitleRcd)) ? (object)DBNull.Value : (System.String)TitleRcd;
                    command.Parameters.Add("@client_type_rcd",SqlDbType.NVarChar).Value = (String.IsNullOrEmpty(ClientTypeRcd)) ? (object)DBNull.Value : (System.String)ClientTypeRcd;
        ...
        public void Update() {
            ...
            string sql = @" update [client] set
                ...
                ,nationality_rcd = @nationality_rcd
                ,gender_rcd = @gender_rcd
                ,title_rcd = @title_rcd
