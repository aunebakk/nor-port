/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:33:10 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of timezone's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeTimezoneData {
        ...
        public void FetchByTimezoneId(System.Guid timezoneId) {
            // create query against timezone
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 timezone_id, timezone_name, utc_offset, user_id, date_time
                            from [timezone]
        ...
        // parameters:
        //  timezoneId: primary key of table timezone
        public static CrudeTimezoneData GetByTimezoneId(System.Guid timezoneId) {
            // create query against timezone
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against timezone
        ...
        public static List<CrudeTimezoneData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeTimezoneData>();
            ...
            string sql = @" select timezone_id, timezone_name, utc_offset, user_id, date_time
                            from [timezone]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of timezone
        ...
        public void FetchByTimezoneName(string timezoneName) {
            // create query against timezone
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 timezone_id, timezone_name, utc_offset, user_id, date_time
                            from [timezone]
                            where timezone_name like '%' + @timezoneName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@timezoneName",SqlDbType.NVarChar).Value = timezoneName;
        ...
        public static List<CrudeTimezoneData> FetchAll() {
            var dataList = new List<CrudeTimezoneData>();
        ...
        public static List<CrudeTimezoneData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeTimezoneData>();
            ...
            string sql = @" select top " + limit.ToString() + @" timezone_id, timezone_name, utc_offset, user_id, date_time
                            from [timezone]
                            order by timezone_name";
        ...
        public static List<CrudeTimezoneData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeTimezoneData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [timezone]";
        ...
        public static List<CrudeTimezoneData> FetchWithFilter(System.Guid timezoneId, string timezoneName, string utcOffset, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeTimezoneData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(timezoneName)) {
                        sql += "  and timezone_name like '%' + @timezone_name + '%'";
                        command.Parameters.Add("@timezone_name", SqlDbType.NVarChar).Value = timezoneName.Replace("'","''");
                    }
                    if (!string.IsNullOrEmpty(utcOffset)) {
                        sql += "  and utc_offset like '%' + @utc_offset + '%'";
                        command.Parameters.Add("@utc_offset", SqlDbType.NVarChar).Value = utcOffset.Replace("'","''");
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["timezone_name"] != System.DBNull.Value) TimezoneName = (System.String) reader["timezone_name"];
            if (reader["utc_offset"] != System.DBNull.Value) UtcOffset = (System.String) reader["utc_offset"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [timezone] (timezone_id, timezone_name, utc_offset, user_id, date_time)";
            sql += "            values (@timezone_id, @timezone_name, @utc_offset, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@timezone_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)TimezoneId;
                    command.Parameters.Add("@timezone_name",SqlDbType.NVarChar).Value = (System.String)TimezoneName;
                    command.Parameters.Add("@utc_offset",SqlDbType.NVarChar).Value = (System.String)UtcOffset;
        ...
        public void Update() {
            ...
            string sql = @" update [timezone] set
        ...
        public static void Delete(System.Guid timezoneId) {
            // create query against timezone
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
