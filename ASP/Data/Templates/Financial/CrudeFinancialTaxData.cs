...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_tax's columns
    ...
    public partial class CrudeFinancialTaxData {
        ...
        public void FetchByFinancialTaxId(System.Guid financialTaxId) {
            // create query against financial_tax
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_tax_id, financial_tax_type_rcd, amount, financial_currency_id, user_id, date_time
                            from [financial_tax]
        ...
        public static CrudeFinancialTaxData GetByFinancialTaxId(System.Guid financialTaxId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_tax
        ...
        public static List<CrudeFinancialTaxData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_tax_id, financial_tax_type_rcd, amount, financial_currency_id, user_id, date_time
                            from [financial_tax]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_tax
        ...
        public static List<CrudeFinancialTaxData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_tax_id, financial_tax_type_rcd, amount, financial_currency_id, user_id, date_time
                            from [financial_tax]";
        ...
        public static List<CrudeFinancialTaxData> FetchWithFilter(System.Guid financialTaxId, string financialTaxTypeRcd, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialTaxData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_tax] (financial_tax_id, financial_tax_type_rcd, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_tax_id, @financial_tax_type_rcd, @amount, @financial_currency_id, @user_id, @date_time)";
