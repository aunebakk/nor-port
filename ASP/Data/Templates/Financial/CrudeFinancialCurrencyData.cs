/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:20:57 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial class CrudeFinancialCurrencyData {
        ...
        public void FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select top 1 financial_currency_id, financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, financial_currency_against_financial_currency_type_rcd, valid_from_date_time, valid_until_date_time, amount, equals_amount, decimal_count, user_id, date_time
        ...
        public static List<CrudeFinancialCurrencyData> FetchByUserId(System.Guid userId) {
            ...
            string sql = @" select financial_currency_id, financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, financial_currency_against_financial_currency_type_rcd, valid_from_date_time, valid_until_date_time, amount, equals_amount, decimal_count, user_id, date_time
                            from [financial_currency]
        ...
        public void FetchByFinancialCurrencyTypeCode(string financialCurrencyTypeCode) {
            // create query against financial_currency
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 financial_currency_id, financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, financial_currency_against_financial_currency_type_rcd, valid_from_date_time, valid_until_date_time, amount, equals_amount, decimal_count, user_id, date_time
                            from [financial_currency]
                            where financial_currency_type_code like '%' + @financialCurrencyTypeCode + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@financialCurrencyTypeCode",SqlDbType.NVarChar).Value = financialCurrencyTypeCode;
        ...
        public static List<CrudeFinancialCurrencyData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_currency_id, financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, financial_currency_against_financial_currency_type_rcd, valid_from_date_time, valid_until_date_time, amount, equals_amount, decimal_count, user_id, date_time
                            from [financial_currency]
                            order by financial_currency_type_name";
        ...
        public static List<CrudeFinancialCurrencyData> FetchWithFilter(System.Guid financialCurrencyId, string financialCurrencyTypeRcd, string financialCurrencyTypeCode, string financialCurrencyTypeName, string financialCurrencyAgainstFinancialCurrencyTypeRcd, System.DateTime validFromDateTime, System.DateTime validUntilDateTime, decimal amount, decimal equalsAmount, int decimalCount, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialCurrencyData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_currency] (financial_currency_id, financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, financial_currency_against_financial_currency_type_rcd, valid_from_date_time, valid_until_date_time, amount, equals_amount, decimal_count, user_id, date_time)";
            sql += "            values (@financial_currency_id, @financial_currency_type_rcd, @financial_currency_type_code, @financial_currency_type_name, @financial_currency_against_financial_currency_type_rcd, @valid_from_date_time, @valid_until_date_time, @amount, @equals_amount, @decimal_count, @user_id, @date_time)";
