/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:27:13 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_currency_type_ref's columns
    ...
    public partial class CrudeFinancialCurrencyTypeRefData {
        ...
        public void FetchByFinancialCurrencyTypeRcd(string financialCurrencyTypeRcd) {
            // create query against financial_currency_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, decimal_count, user_id, date_time
        ...
        public static CrudeFinancialCurrencyTypeRefData GetByFinancialCurrencyTypeRcd(string financialCurrencyTypeRcd) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_currency_type_ref
        ...
        public static List<CrudeFinancialCurrencyTypeRefData> FetchByUserId(System.Guid userId) {
            ...
            string sql = @" select financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, decimal_count, user_id, date_time
                            from [financial_currency_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_currency_type_ref
        ...
        public static List<CrudeFinancialCurrencyTypeRefData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, decimal_count, user_id, date_time
                            from [financial_currency_type_ref]
                            order by financial_currency_type_name";
        ...
        public static List<CrudeFinancialCurrencyTypeRefData> FetchWithFilter(string financialCurrencyTypeRcd, string financialCurrencyTypeCode, string financialCurrencyTypeName, int decimalCount, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialCurrencyTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_currency_type_ref] (financial_currency_type_rcd, financial_currency_type_code, financial_currency_type_name, decimal_count, user_id, date_time)";
            sql += "            values (@financial_currency_type_rcd, @financial_currency_type_code, @financial_currency_type_name, @decimal_count, @user_id, @date_time)";
