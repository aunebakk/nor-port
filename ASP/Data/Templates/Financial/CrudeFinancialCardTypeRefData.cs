/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:20:35 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_card_type_ref's columns
    ...
    public partial class CrudeFinancialCardTypeRefData {
        ...
        public void FetchByFinancialCardTypeRcd(string financialCardTypeRcd) {
            // create query against financial_card_type_ref
        ...
        public static CrudeFinancialCardTypeRefData GetByFinancialCardTypeRcd(string financialCardTypeRcd) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_card_type_ref
        ...
        public static List<CrudeFinancialCardTypeRefData> FetchByUserId(System.Guid userId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_card_type_ref
