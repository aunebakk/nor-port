/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:26:10 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_adjustment's columns
    ...
    public partial class CrudeFinancialAdjustmentData {
        ...
        public void FetchByFinancialAdjustmentId(System.Guid financialAdjustmentId) {
            // create query against financial_adjustment
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_adjustment_id, financial_adjustment_type_rcd, amount, financial_currency_id, user_id, date_time
        ...
        public static CrudeFinancialAdjustmentData GetByFinancialAdjustmentId(System.Guid financialAdjustmentId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_adjustment
        ...
        public static List<CrudeFinancialAdjustmentData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_adjustment_id, financial_adjustment_type_rcd, amount, financial_currency_id, user_id, date_time
                            from [financial_adjustment]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_adjustment
        ...
        public static List<CrudeFinancialAdjustmentData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_adjustment_id, financial_adjustment_type_rcd, amount, financial_currency_id, user_id, date_time
                            from [financial_adjustment]";
        ...
        public static List<CrudeFinancialAdjustmentData> FetchWithFilter(System.Guid financialAdjustmentId, string financialAdjustmentTypeRcd, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialAdjustmentData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_adjustment] (financial_adjustment_id, financial_adjustment_type_rcd, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_adjustment_id, @financial_adjustment_type_rcd, @amount, @financial_currency_id, @user_id, @date_time)";
