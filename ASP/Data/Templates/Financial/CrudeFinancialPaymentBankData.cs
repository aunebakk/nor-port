/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:28:06 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_payment_bank's columns
    ...
    public partial class CrudeFinancialPaymentBankData {
        ...
        public void FetchByFinancialPaymentBankId(System.Guid financialPaymentBankId) {
            // create query against financial_payment_bank
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_payment_bank_id, financial_bank_account_number_type_rcd, bank_name, bank_account, bank_number, amount, financial_currency_id, user_id, date_time
        ...
        public static CrudeFinancialPaymentBankData GetByFinancialPaymentBankId(System.Guid financialPaymentBankId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_payment_bank
        ...
        public static List<CrudeFinancialPaymentBankData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_payment_bank_id, financial_bank_account_number_type_rcd, bank_name, bank_account, bank_number, amount, financial_currency_id, user_id, date_time
                            from [financial_payment_bank]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_payment_bank
        ...
        public static List<CrudeFinancialPaymentBankData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_payment_bank_id, financial_bank_account_number_type_rcd, bank_name, bank_account, bank_number, amount, financial_currency_id, user_id, date_time
                            from [financial_payment_bank]
                            order by bank_name";
        ...
        public static List<CrudeFinancialPaymentBankData> FetchWithFilter(System.Guid financialPaymentBankId, string financialBankAccountNumberTypeRcd, string bankName, string bankAccount, string bankNumber, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialPaymentBankData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_payment_bank] (financial_payment_bank_id, financial_bank_account_number_type_rcd, bank_name, bank_account, bank_number, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_payment_bank_id, @financial_bank_account_number_type_rcd, @bank_name, @bank_account, @bank_number, @amount, @financial_currency_id, @user_id, @date_time)";
