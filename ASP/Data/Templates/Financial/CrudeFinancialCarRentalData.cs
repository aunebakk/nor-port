/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:20:30 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_car_rental's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeFinancialCarRentalData {
        ...
        public void FetchByFinancialCarRentalId(System.Guid financialCarRentalId) {
            // create query against financial_car_rental
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_car_rental_id, service_car_rental_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_car_rental]
        ...
        // parameters:
        //  financialCarRentalId: primary key of table financial_car_rental
        public static CrudeFinancialCarRentalData GetByFinancialCarRentalId(System.Guid financialCarRentalId) {
            // create query against financial_car_rental
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFinancialCarRentalData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_car_rental
        ...
        public static List<CrudeFinancialCarRentalData> FetchByServiceCarRentalId(System.Guid serviceCarRentalId) {
            var dataList = new List<CrudeFinancialCarRentalData>();
            ...
            string sql = @" select financial_car_rental_id, service_car_rental_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_car_rental]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_car_rental
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialCarRentalData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeFinancialCarRentalData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialCarRentalData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFinancialCarRentalData>();
        ...
        public static List<CrudeFinancialCarRentalData> FetchAll() {
            var dataList = new List<CrudeFinancialCarRentalData>();
        ...
        public static List<CrudeFinancialCarRentalData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFinancialCarRentalData>();
            ...
            string sql = @" select top " + limit.ToString() + @" financial_car_rental_id, service_car_rental_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_car_rental]";
        ...
        public static List<CrudeFinancialCarRentalData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFinancialCarRentalData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [financial_car_rental]";
        ...
        public static List<CrudeFinancialCarRentalData> FetchWithFilter(System.Guid financialCarRentalId, System.Guid serviceCarRentalId, System.DateTime fromDateTime, System.DateTime untilDateTime, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialCarRentalData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            if (FinancialCarRentalId == Guid.Empty)
                FinancialCarRentalId = Guid.NewGuid();
            ...
            string sql = "insert into [financial_car_rental] (financial_car_rental_id, service_car_rental_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_car_rental_id, @service_car_rental_id, @from_date_time, @until_date_time, @amount, @financial_currency_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_car_rental_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FinancialCarRentalId;
                    command.Parameters.Add("@service_car_rental_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServiceCarRentalId;
        ...
        public void Update() {
            ...
            string sql = @" update [financial_car_rental] set
        ...
        public static void Delete(System.Guid financialCarRentalId) {
            // create query against financial_car_rental
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [financial_car_rental] 
                where financial_car_rental_id = @financial_car_rental_id";
