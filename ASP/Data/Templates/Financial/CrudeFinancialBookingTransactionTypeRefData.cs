/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:26:30 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_booking_transaction_type_ref's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeFinancialBookingTransactionTypeRefData {
        
        public string FinancialBookingTransactionTypeRcd { get; set; }
        
        public string FinancialBookingTransactionTypeName { get; set; }
        ...
        public void FetchByFinancialBookingTransactionTypeRcd(string financialBookingTransactionTypeRcd) {
            // create query against financial_booking_transaction_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_booking_transaction_type_rcd, financial_booking_transaction_type_name, user_id, date_time
                            from [financial_booking_transaction_type_ref]
                            where financial_booking_transaction_type_rcd = @financial_booking_transaction_type_rcd
                            order by financial_booking_transaction_type_name";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    command.Parameters.Add("@financial_booking_transaction_type_rcd",SqlDbType.NVarChar).Value = financialBookingTransactionTypeRcd;
        ...
        // parameters:
        //  financialBookingTransactionTypeRcd: primary key of table financial_booking_transaction_type_ref
        public static CrudeFinancialBookingTransactionTypeRefData GetByFinancialBookingTransactionTypeRcd(string financialBookingTransactionTypeRcd) {
            // create query against financial_booking_transaction_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFinancialBookingTransactionTypeRefData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_booking_transaction_type_ref
        ...
        public static List<CrudeFinancialBookingTransactionTypeRefData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFinancialBookingTransactionTypeRefData>();
            ...
            string sql = @" select financial_booking_transaction_type_rcd, financial_booking_transaction_type_name, user_id, date_time
                            from [financial_booking_transaction_type_ref]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_booking_transaction_type_ref
        ...
        public void FetchByFinancialBookingTransactionTypeName(string financialBookingTransactionTypeName) {
            // create query against financial_booking_transaction_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 financial_booking_transaction_type_rcd, financial_booking_transaction_type_name, user_id, date_time
                            from [financial_booking_transaction_type_ref]
                            where financial_booking_transaction_type_name like '%' + @financialBookingTransactionTypeName + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@financialBookingTransactionTypeName",SqlDbType.NVarChar).Value = financialBookingTransactionTypeName;
        ...
        public static List<CrudeFinancialBookingTransactionTypeRefData> FetchAll() {
            var dataList = new List<CrudeFinancialBookingTransactionTypeRefData>();
        ...
        public static List<CrudeFinancialBookingTransactionTypeRefData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFinancialBookingTransactionTypeRefData>();
            ...
            string sql = @" select top " + limit.ToString() + @" financial_booking_transaction_type_rcd, financial_booking_transaction_type_name, user_id, date_time
                            from [financial_booking_transaction_type_ref]
                            order by financial_booking_transaction_type_name";
        ...
        public static List<CrudeFinancialBookingTransactionTypeRefData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFinancialBookingTransactionTypeRefData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [financial_booking_transaction_type_ref]";
        ...
        public static List<CrudeFinancialBookingTransactionTypeRefData> FetchWithFilter(string financialBookingTransactionTypeRcd, string financialBookingTransactionTypeName, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialBookingTransactionTypeRefData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(financialBookingTransactionTypeName)) {
                        sql += "  and financial_booking_transaction_type_name like '%' + @financial_booking_transaction_type_name + '%'";
                        command.Parameters.Add("@financial_booking_transaction_type_name", SqlDbType.NVarChar).Value = financialBookingTransactionTypeName.Replace("'","''");
                    }
                    ...
                    sql += " order by financial_booking_transaction_type_name";
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["financial_booking_transaction_type_name"] != System.DBNull.Value) FinancialBookingTransactionTypeName = (System.String) reader["financial_booking_transaction_type_name"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_booking_transaction_type_ref] (financial_booking_transaction_type_rcd, financial_booking_transaction_type_name, user_id, date_time)";
            sql += "            values (@financial_booking_transaction_type_rcd, @financial_booking_transaction_type_name, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_booking_transaction_type_name",SqlDbType.NVarChar).Value = (System.String)FinancialBookingTransactionTypeName;
        ...
        public void Update() {
            ...
            string sql = @" update [financial_booking_transaction_type_ref] set
                 financial_booking_transaction_type_rcd = @financial_booking_transaction_type_rcd
                ,financial_booking_transaction_type_name = @financial_booking_transaction_type_name
                ,user_id = @user_id
                ,date_time = @date_time
            where financial_booking_transaction_type_rcd = @financial_booking_transaction_type_rcd";
        ...
        public static void Delete(string financialBookingTransactionTypeRcd) {
            // create query against financial_booking_transaction_type_ref
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [financial_booking_transaction_type_ref] 
                where financial_booking_transaction_type_rcd = @financial_booking_transaction_type_rcd";
