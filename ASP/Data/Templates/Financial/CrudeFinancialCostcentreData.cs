/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:26:51 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_costcentre's columns
    ...
    public partial class CrudeFinancialCostcentreData {
        ...
        public void FetchByFinancialCostcentreId(System.Guid financialCostcentreId) {
            // create query against financial_costcentre
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_costcentre_id, financial_costcentre_code, financial_costcentre_name, financial_company_id, user_id, date_time
        ...
        public static CrudeFinancialCostcentreData GetByFinancialCostcentreId(System.Guid financialCostcentreId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_costcentre
        ...
        public static List<CrudeFinancialCostcentreData> FetchByFinancialCompanyId(System.Guid financialCompanyId) {
            ...
            string sql = @" select financial_costcentre_id, financial_costcentre_code, financial_costcentre_name, financial_company_id, user_id, date_time
                            from [financial_costcentre]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_costcentre
        ...
        public void FetchByFinancialCostcentreCode(string financialCostcentreCode) {
            // create query against financial_costcentre
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" select top 1 financial_costcentre_id, financial_costcentre_code, financial_costcentre_name, financial_company_id, user_id, date_time
                            from [financial_costcentre]
                            where financial_costcentre_code like '%' + @financialCostcentreCode + '%'
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                command.Parameters.Add("@financialCostcentreCode",SqlDbType.NVarChar).Value = financialCostcentreCode;
        ...
        public static List<CrudeFinancialCostcentreData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_costcentre_id, financial_costcentre_code, financial_costcentre_name, financial_company_id, user_id, date_time
                            from [financial_costcentre]
                            order by financial_costcentre_name";
        ...
        public static List<CrudeFinancialCostcentreData> FetchWithFilter(System.Guid financialCostcentreId, string financialCostcentreCode, string financialCostcentreName, System.Guid financialCompanyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialCostcentreData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_costcentre] (financial_costcentre_id, financial_costcentre_code, financial_costcentre_name, financial_company_id, user_id, date_time)";
            sql += "            values (@financial_costcentre_id, @financial_costcentre_code, @financial_costcentre_name, @financial_company_id, @user_id, @date_time)";
