/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:28:18 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_payment_cash's columns
    ...
    public partial class CrudeFinancialPaymentCashData {
        ...
        public void FetchByFinancialPaymentCashId(System.Guid financialPaymentCashId) {
            // create query against financial_payment_cash
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_payment_cash_id, amount, financial_currency_id, user_id, date_time
        ...
        public static CrudeFinancialPaymentCashData GetByFinancialPaymentCashId(System.Guid financialPaymentCashId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_payment_cash
        ...
        public static List<CrudeFinancialPaymentCashData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_payment_cash_id, amount, financial_currency_id, user_id, date_time
                            from [financial_payment_cash]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_payment_cash
        ...
        public static List<CrudeFinancialPaymentCashData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_payment_cash_id, amount, financial_currency_id, user_id, date_time
                            from [financial_payment_cash]";
        ...
        public static List<CrudeFinancialPaymentCashData> FetchWithFilter(System.Guid financialPaymentCashId, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialPaymentCashData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_payment_cash] (financial_payment_cash_id, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_payment_cash_id, @amount, @financial_currency_id, @user_id, @date_time)";
