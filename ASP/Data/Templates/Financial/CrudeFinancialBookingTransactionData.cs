/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:26:25 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_booking_transaction's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  serialization: https://docs.microsoft.com/en-us/dotnet/csharp/programming-guide/concepts/serialization/
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    //[Serializable()]
    public partial class CrudeFinancialBookingTransactionData {
        ...
        public void FetchByFinancialBookingTransactionId(System.Guid financialBookingTransactionId) {
            // create query against financial_booking_transaction
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_booking_transaction_id, booking_id, transaction_number, financial_booking_transaction_type_rcd, amount, financial_fee_id, financial_tax_id, financial_fare_id, financial_payment_id, financial_currency_id, financial_costcentre_id, financial_adjustment_id, financial_service_id, user_id, date_time
                            from [financial_booking_transaction]
        ...
        // parameters:
        //  financialBookingTransactionId: primary key of table financial_booking_transaction
        public static CrudeFinancialBookingTransactionData GetByFinancialBookingTransactionId(System.Guid financialBookingTransactionId) {
            // create query against financial_booking_transaction
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFinancialBookingTransactionData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_booking_transaction
        ...
        public static List<CrudeFinancialBookingTransactionData> FetchByBookingId(System.Guid bookingId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
            ...
            string sql = @" select financial_booking_transaction_id, booking_id, transaction_number, financial_booking_transaction_type_rcd, amount, financial_fee_id, financial_tax_id, financial_fare_id, financial_payment_id, financial_currency_id, financial_costcentre_id, financial_adjustment_id, financial_service_id, user_id, date_time
                            from [financial_booking_transaction]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_booking_transaction
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialFeeId(System.Guid financialFeeId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialTaxId(System.Guid financialTaxId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialFareId(System.Guid financialFareId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
            ...
            string sql = @" select financial_booking_transaction_id, booking_id, transaction_number, financial_booking_transaction_type_rcd, amount, financial_fee_id, financial_tax_id, financial_fare_id, financial_payment_id, financial_currency_id, financial_costcentre_id, financial_adjustment_id, financial_service_id, user_id, date_time
                            from [financial_booking_transaction]
                            where financial_fare_id = @financial_fare_id
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@financial_fare_id", SqlDbType.UniqueIdentifier).Value = financialFareId;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialPaymentId(System.Guid financialPaymentId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialCostcentreId(System.Guid financialCostcentreId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialAdjustmentId(System.Guid financialAdjustmentId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialServiceId(System.Guid financialServiceId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialBookingTransactionData> FetchByFinancialBookingTransactionTypeRcd(string financialBookingTransactionTypeRcd) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
            ...
            string sql = @" select financial_booking_transaction_id, booking_id, transaction_number, financial_booking_transaction_type_rcd, amount, financial_fee_id, financial_tax_id, financial_fare_id, financial_payment_id, financial_currency_id, financial_costcentre_id, financial_adjustment_id, financial_service_id, user_id, date_time
                            from [financial_booking_transaction]
                            where financial_booking_transaction_type_rcd = @financial_booking_transaction_type_rcd
                              ";
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // links:
                    // docLink: http://sql2x.org/documentationLink/8aec2e5c-4732-4662-badb-83b89d1c34a9
                    command.Parameters.Add("@financial_booking_transaction_type_rcd", SqlDbType.NVarChar).Value = financialBookingTransactionTypeRcd.Replace("'","''");
        ...
        public static List<CrudeFinancialBookingTransactionData> FetchAll() {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        public static List<CrudeFinancialBookingTransactionData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
            ...
            string sql = @" select top " + limit.ToString() + @" financial_booking_transaction_id, booking_id, transaction_number, financial_booking_transaction_type_rcd, amount, financial_fee_id, financial_tax_id, financial_fare_id, financial_payment_id, financial_currency_id, financial_costcentre_id, financial_adjustment_id, financial_service_id, user_id, date_time
                            from [financial_booking_transaction]";
        ...
        public static List<CrudeFinancialBookingTransactionData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFinancialBookingTransactionData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [financial_booking_transaction]";
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    if (!string.IsNullOrEmpty(financialBookingTransactionTypeRcd)) {
                        sql += "  and financial_booking_transaction_type_rcd like '%' + @financial_booking_transaction_type_rcd + '%'";
                        command.Parameters.Add("@financial_booking_transaction_type_rcd", SqlDbType.NVarChar).Value = financialBookingTransactionTypeRcd.Replace("'","''");
                    }
                    if (amount != 0) {
                    ...
                    if (financialFareId != Guid.Empty) {
                        sql += "  and financial_fare_id = @financial_fare_id";
                        command.Parameters.Add("@financial_fare_id", SqlDbType.UniqueIdentifier).Value = financialFareId;
                    }
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["financial_booking_transaction_type_rcd"] != System.DBNull.Value) FinancialBookingTransactionTypeRcd = (System.String) reader["financial_booking_transaction_type_rcd"];
            ...
            if (reader["financial_fare_id"] != System.DBNull.Value) FinancialFareId = (System.Guid) reader["financial_fare_id"];
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_booking_transaction] (financial_booking_transaction_id, booking_id, transaction_number, financial_booking_transaction_type_rcd, amount, financial_fee_id, financial_tax_id, financial_fare_id, financial_payment_id, financial_currency_id, financial_costcentre_id, financial_adjustment_id, financial_service_id, user_id, date_time)";
            sql += "            values (@financial_booking_transaction_id, @booking_id, @transaction_number, @financial_booking_transaction_type_rcd, @amount, @financial_fee_id, @financial_tax_id, @financial_fare_id, @financial_payment_id, @financial_currency_id, @financial_costcentre_id, @financial_adjustment_id, @financial_service_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_booking_transaction_type_rcd",SqlDbType.NVarChar).Value = (System.String)FinancialBookingTransactionTypeRcd;
                    ...
                    command.Parameters.Add("@financial_fare_id",SqlDbType.UniqueIdentifier).Value = (FinancialFareId == Guid.Empty ? (object)DBNull.Value : (System.Guid)FinancialFareId);
                    ...
                    command.Parameters.Add("@financial_service_id",SqlDbType.UniqueIdentifier).Value = (FinancialServiceId == Guid.Empty ? (object)DBNull.Value : (System.Guid)FinancialServiceId);
        ...
        public void Update() {
            ...
            string sql = @" update [financial_booking_transaction] set
                 financial_booking_transaction_id = @financial_booking_transaction_id
                ,booking_id = @booking_id
                ,transaction_number = @transaction_number
                ,financial_booking_transaction_type_rcd = @financial_booking_transaction_type_rcd
                ,amount = @amount
                ,financial_fee_id = @financial_fee_id
                ,financial_tax_id = @financial_tax_id
                ,financial_fare_id = @financial_fare_id
        ...
        public static void Delete(System.Guid financialBookingTransactionId) {
            ...
            string sql = @" delete [financial_booking_transaction] 
                where financial_booking_transaction_id = @financial_booking_transaction_id";
