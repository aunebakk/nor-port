/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:47:10 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_hotel_booking's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeFinancialHotelBookingData {
        ...
        public void FetchByFinancialHotelBookingId(System.Guid financialHotelBookingId) {
            // create query against financial_hotel_booking
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_hotel_booking_id, service_hotel_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_hotel_booking]
        ...
        // parameters:
        //  financialHotelBookingId: primary key of table financial_hotel_booking
        public static CrudeFinancialHotelBookingData GetByFinancialHotelBookingId(System.Guid financialHotelBookingId) {
            // create query against financial_hotel_booking
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFinancialHotelBookingData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_hotel_booking
        ...
        public static List<CrudeFinancialHotelBookingData> FetchByServiceHotelId(System.Guid serviceHotelId) {
            var dataList = new List<CrudeFinancialHotelBookingData>();
            ...
            string sql = @" select financial_hotel_booking_id, service_hotel_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_hotel_booking]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_hotel_booking
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialHotelBookingData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeFinancialHotelBookingData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialHotelBookingData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFinancialHotelBookingData>();
        ...
        public static List<CrudeFinancialHotelBookingData> FetchAll() {
            var dataList = new List<CrudeFinancialHotelBookingData>();
        ...
        public static List<CrudeFinancialHotelBookingData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFinancialHotelBookingData>();
            ...
            string sql = @" select top " + limit.ToString() + @" financial_hotel_booking_id, service_hotel_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time
                            from [financial_hotel_booking]";
        ...
        public static List<CrudeFinancialHotelBookingData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFinancialHotelBookingData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [financial_hotel_booking]";
        ...
        public static List<CrudeFinancialHotelBookingData> FetchWithFilter(System.Guid financialHotelBookingId, System.Guid serviceHotelId, System.DateTime fromDateTime, System.DateTime untilDateTime, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialHotelBookingData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            if (FinancialHotelBookingId == Guid.Empty)
                FinancialHotelBookingId = Guid.NewGuid();
            ...
            string sql = "insert into [financial_hotel_booking] (financial_hotel_booking_id, service_hotel_id, from_date_time, until_date_time, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_hotel_booking_id, @service_hotel_id, @from_date_time, @until_date_time, @amount, @financial_currency_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_hotel_booking_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FinancialHotelBookingId;
                    command.Parameters.Add("@service_hotel_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)ServiceHotelId;
        ...
        public void Update() {
            ...
            string sql = @" update [financial_hotel_booking] set
        ...
        public static void Delete(System.Guid financialHotelBookingId) {
            // create query against financial_hotel_booking
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [financial_hotel_booking] 
                where financial_hotel_booking_id = @financial_hotel_booking_id";
