/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:26:56 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_coupon's columns
    ...
    public partial class CrudeFinancialCouponData {
        ...
        public void FetchByFinancialCouponId(System.Guid financialCouponId) {
            // create query against financial_coupon
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_coupon_id, financial_coupon_type_rcd, coupon_number, value_amount, financial_currency_id, valid_from_date_time, valid_until_date_time, coupon_description, user_id, date_time
        ...
        public static CrudeFinancialCouponData GetByFinancialCouponId(System.Guid financialCouponId) {
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_coupon
        ...
        public static List<CrudeFinancialCouponData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            ...
            string sql = @" select financial_coupon_id, financial_coupon_type_rcd, coupon_number, value_amount, financial_currency_id, valid_from_date_time, valid_until_date_time, coupon_description, user_id, date_time
                            from [financial_coupon]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_coupon
        ...
        public static List<CrudeFinancialCouponData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" financial_coupon_id, financial_coupon_type_rcd, coupon_number, value_amount, financial_currency_id, valid_from_date_time, valid_until_date_time, coupon_description, user_id, date_time
                            from [financial_coupon]";
        ...
        public static List<CrudeFinancialCouponData> FetchWithFilter(System.Guid financialCouponId, string financialCouponTypeRcd, int couponNumber, decimal valueAmount, System.Guid financialCurrencyId, System.DateTime validFromDateTime, System.DateTime validUntilDateTime, string couponDescription, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialCouponData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [financial_coupon] (financial_coupon_id, financial_coupon_type_rcd, coupon_number, value_amount, financial_currency_id, valid_from_date_time, valid_until_date_time, coupon_description, user_id, date_time)";
            sql += "            values (@financial_coupon_id, @financial_coupon_type_rcd, @coupon_number, @value_amount, @financial_currency_id, @valid_from_date_time, @valid_until_date_time, @coupon_description, @user_id, @date_time)";
