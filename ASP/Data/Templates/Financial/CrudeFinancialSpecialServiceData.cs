/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:48:02 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of financial_special_service's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  docLink: http://sql2x.org/documentationLink/e32ed6d4-57c7-43b1-8f2e-918c702e730a
    public partial class CrudeFinancialSpecialServiceData {
        ...
        public void FetchByFinancialSpecialServiceId(System.Guid financialSpecialServiceId) {
            // create query against financial_special_service
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            // links:
            // docLink: http://sql2x.org/documentationLink/34fb7e37-dc72-4674-b0b8-075b6f06e158
            string sql = @" select top 1 financial_special_service_id, service_special_service_request_id, quantity, amount, financial_currency_id, user_id, date_time
                            from [financial_special_service]
        ...
        // parameters:
        //  financialSpecialServiceId: primary key of table financial_special_service
        public static CrudeFinancialSpecialServiceData GetByFinancialSpecialServiceId(System.Guid financialSpecialServiceId) {
            // create query against financial_special_service
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            var ret = new CrudeFinancialSpecialServiceData();
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // execute query against financial_special_service
        ...
        public static List<CrudeFinancialSpecialServiceData> FetchByServiceSpecialServiceRequestId(System.Guid serviceSpecialServiceRequestId) {
            var dataList = new List<CrudeFinancialSpecialServiceData>();
            ...
            string sql = @" select financial_special_service_id, service_special_service_request_id, quantity, amount, financial_currency_id, user_id, date_time
                            from [financial_special_service]
            ...
            using (var conn = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, conn)) {
                    ...
                    // read all rows returned from the query of financial_special_service
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialSpecialServiceData> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
            var dataList = new List<CrudeFinancialSpecialServiceData>();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/13095cd7-f136-4532-8969-c50c62cc05ef
        public static List<CrudeFinancialSpecialServiceData> FetchByUserId(System.Guid userId) {
            var dataList = new List<CrudeFinancialSpecialServiceData>();
        ...
        public static List<CrudeFinancialSpecialServiceData> FetchAll() {
            var dataList = new List<CrudeFinancialSpecialServiceData>();
        ...
        public static List<CrudeFinancialSpecialServiceData> FetchAllWithLimit(int limit) {
            var dataList = new List<CrudeFinancialSpecialServiceData>();
            ...
            string sql = @" select top " + limit.ToString() + @" financial_special_service_id, service_special_service_request_id, quantity, amount, financial_currency_id, user_id, date_time
                            from [financial_special_service]";
        ...
        public static List<CrudeFinancialSpecialServiceData> FetchAllWithLimitAndOffset(int limit, int offset) {
            var dataList = new List<CrudeFinancialSpecialServiceData>();
        ...
        public static int FetchAllCount() {
            ...
            string sql = @" select count(*) as count from [financial_special_service]";
        ...
        public static List<CrudeFinancialSpecialServiceData> FetchWithFilter(System.Guid financialSpecialServiceId, System.Guid serviceSpecialServiceRequestId, int quantity, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeFinancialSpecialServiceData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Populate(IDataReader reader) {
            ...
            if (reader["quantity"] != System.DBNull.Value) Quantity = (System.Int32) reader["quantity"];
        ...
        public void Insert() {
            ...
            if (FinancialSpecialServiceId == Guid.Empty)
                FinancialSpecialServiceId = Guid.NewGuid();
            ...
            string sql = "insert into [financial_special_service] (financial_special_service_id, service_special_service_request_id, quantity, amount, financial_currency_id, user_id, date_time)";
            sql += "            values (@financial_special_service_id, @service_special_service_request_id, @quantity, @amount, @financial_currency_id, @user_id, @date_time)";
            ...
            using (var connection = new SqlConnection(Conn.ConnectionString)) {
                ...
                using (var command = new SqlCommand(sql, connection)) {
                    ...
                    command.Parameters.Add("@financial_special_service_id",SqlDbType.UniqueIdentifier).Value = (System.Guid)FinancialSpecialServiceId;
                    ...
                    command.Parameters.Add("@quantity",SqlDbType.Int).Value = (System.Int32)Quantity;
        ...
        public void Update() {
            ...
            string sql = @" update [financial_special_service] set
        ...
        public static void Delete(System.Guid financialSpecialServiceId) {
            // create query against financial_special_service
            // this will be ansi sql and parameterized
            // parameterized queries are a good way of preventing sql injection
            //   and to make sure the query plan is pre-compiled
            ...
            string sql = @" delete [financial_special_service] 
                where financial_special_service_id = @financial_special_service_id";
