/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:17:08 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of cart_product's columns
    ...
    public partial class CrudeCartProductData {
        ...
        public void FetchByCartProductId(System.Guid cartProductId) {
            ...
            string sql = @" select top 1 cart_product_id, product_id, amount, financial_currency_id, state_rcd, user_id, date_time
                            from [cart_product]
        ...
        public static List<CrudeCartProductData> FetchByProductId(System.Guid productId) {
            ...
            string sql = @" select cart_product_id, product_id, amount, financial_currency_id, state_rcd, user_id, date_time
                            from [cart_product]
        ...
        public static List<CrudeCartProductData> FetchAllWithLimit(int limit) {
            ...
            string sql = @" select top " + limit.ToString() + @" cart_product_id, product_id, amount, financial_currency_id, state_rcd, user_id, date_time
                            from [cart_product]";
        ...
        public static List<CrudeCartProductData> FetchWithFilter(System.Guid cartProductId, System.Guid productId, decimal amount, System.Guid financialCurrencyId, string stateRcd, System.Guid userId, System.DateTime dateTime) {
            var dataList = new List<CrudeCartProductData>();
...
// docLink: http://sql2x.org/documentationLink/6ec2495f-3a49-4a94-ad59-0ce064fc8654
        ...
        public void Insert() {
            ...
            string sql = "insert into [cart_product] (cart_product_id, product_id, amount, financial_currency_id, state_rcd, user_id, date_time)";
            sql += "            values (@cart_product_id, @product_id, @amount, @financial_currency_id, @state_rcd, @user_id, @date_time)";
