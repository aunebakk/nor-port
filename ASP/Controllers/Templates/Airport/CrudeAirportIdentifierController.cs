...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirportIdentifierController : Controller {
        ...
        // create AirportIdentifier POST page for controller
        // links:
        ...
        public string CrudeAirportIdentifierCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:37:47 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeAirportIdentifier/CrudeAirportIdentifierCreate/", content).Result;
        ...
        // Update AirportIdentifier POST page for controller
        // links:
        ...
        public string CrudeAirportIdentifierUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeAirportIdentifier/CrudeAirportIdentifierUpdate/", content).Result;
        ...
        public string CrudeAirportIdentifierDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeAirportIdentifier/CrudeAirportIdentifierDelete/00000000-0000-0000-0000-000000000001" ).Result;
