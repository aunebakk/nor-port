...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirportFacilityController : Controller {
        ...
        // parameters:
        //  airportfacilityid: filter by primary key
        ...
        // parameters:
        //  airportfacilitytypercd: filter by this foreign this key, use the following for no filter: ''
        ...
        // create AirportFacility POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeAirportFacilityModel: contract to add
        ...
        public string CrudeAirportFacilityCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:40:59 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportFacility/CrudeAirportFacilityCreate/", content).Result;
        ...
        // Update AirportFacility POST page for controller
        // links:
        ...
        public string CrudeAirportFacilityUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportFacility/CrudeAirportFacilityUpdate/", content).Result;
        ...
        public string CrudeAirportFacilityDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportFacility/CrudeAirportFacilityDelete/00000000-0000-0000-0000-000000000001" ).Result;
