...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirportTypeRefController : Controller {
        ...
        // create AirportTypeRef POST API for controller
        // links:
        ...
        public string CrudeAirportTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/4/2021 10:05:08 PM" ) );
        ...
        // ppdate AirportTypeRef POST API for controller
        // links:
