...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirportTypeRefController : Controller {
        ...
        // parameters:
        //  airporttypercd: filter by primary key
        ...
        // create AirportTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeAirportTypeRefModel: contract to add
        ...
        public string CrudeAirportTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:41:34 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportTypeRef/CrudeAirportTypeRefCreate/", content).Result;
        ...
        // Update AirportTypeRef POST page for controller
        // links:
        ...
        public string CrudeAirportTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportTypeRef/CrudeAirportTypeRefUpdate/", content).Result;
        ...
        public string CrudeAirportTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportTypeRef/CrudeAirportTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
