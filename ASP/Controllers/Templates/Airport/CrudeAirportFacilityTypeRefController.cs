...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirportFacilityTypeRefController : Controller {
        ...
        // parameters:
        //  airportfacilitytypercd: filter by primary key
        ...
        // create AirportFacilityTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeAirportFacilityTypeRefModel: contract to add
        ...
        public string CrudeAirportFacilityTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:41:02 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportFacilityTypeRef/CrudeAirportFacilityTypeRefCreate/", content).Result;
        ...
        // Update AirportFacilityTypeRef POST page for controller
        // links:
        ...
        public string CrudeAirportFacilityTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportFacilityTypeRef/CrudeAirportFacilityTypeRefUpdate/", content).Result;
        ...
        public string CrudeAirportFacilityTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirportFacilityTypeRef/CrudeAirportFacilityTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
