...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirportFacilityTypeRefController : Controller {
        ...
        // create AirportFacilityTypeRef POST API for controller
        // links:
        ...
        public string CrudeAirportFacilityTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/5/2021 12:53:18 PM" ) );
        ...
        // ppdate AirportFacilityTypeRef POST API for controller
        // links:
