/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/29/2020 2:37:36 AM
    ...
    public class CrudeAirportController : Controller {
        ...
        public string CrudeAirportCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ActivationDateTime" , "12/29/2020 2:37:36 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:37:36 AM" ) );
