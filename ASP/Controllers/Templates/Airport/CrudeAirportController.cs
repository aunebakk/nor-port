/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/3/2021 2:05:22 PM
    ...
    public class CrudeAirportController : Controller {
        ...
        public string CrudeAirportCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ActivationDateTime" , "1/3/2021 2:05:22 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/3/2021 2:05:22 PM" ) );
