/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/30/2020 5:27:38 AM
    ...
    public class CrudeAirportController : Controller {
        ...
        public string CrudeAirportCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ActivationDateTime" , "12/30/2020 5:27:38 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/30/2020 5:27:38 AM" ) );
