/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/30/2020 1:29:12 PM
    ...
    public class CrudeAirportController : Controller {
        ...
        public string CrudeAirportCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ActivationDateTime" , "12/30/2020 1:29:12 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/30/2020 1:29:12 PM" ) );
