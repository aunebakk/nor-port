    ...
    public class CrudeAirportController : Controller {
        ...
        public string CrudeAirportCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ActivationDateTime" , "12/28/2020 5:02:00 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/28/2020 5:02:00 PM" ) );
