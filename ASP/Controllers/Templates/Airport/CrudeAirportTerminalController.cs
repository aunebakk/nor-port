    ...
    public class CrudeAirportTerminalController : Controller {
        ...
        public string CrudeAirportTerminalCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/28/2020 12:16:00 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeAirportTerminal/CrudeAirportTerminalCreate/", content).Result;
        ...
        public string CrudeAirportTerminalUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeAirportTerminal/CrudeAirportTerminalUpdate/", content).Result;
        ...
        public string CrudeAirportTerminalDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeAirportTerminal/CrudeAirportTerminalDelete/00000000-0000-0000-0000-000000000001" ).Result;
