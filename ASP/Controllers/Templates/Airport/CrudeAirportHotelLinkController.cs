...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirportHotelLinkController : Controller {
        ...
        // create AirportHotelLink POST page for controller
        // links:
        ...
        public string CrudeAirportHotelLinkCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:41:05 AM" ) );
        ...
        // Update AirportHotelLink POST page for controller
        // links:
