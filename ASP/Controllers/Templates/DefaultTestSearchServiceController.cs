/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/23/2021 6:10:16 PM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    [Route("api/1/DefaultTestSearchService")]
    ...
    public class DefaultTestSearchServiceController : Controller {
        ...
        public IActionResult Help(
            ...
            return View(@"Views\Templates\DefaultTestSearchService\DefaultTestSearchServiceHelp.cshtml");
        }

        [HttpGet("DefaultTestSearchWithFilterHelp")]
        public IActionResult DefaultTestSearchWithFilterHelp(
            ) {

            return View(@"Views\Templates\DefaultTestSearchService\DefaultTestSearchWithFilterHelp.cshtml");
        }
