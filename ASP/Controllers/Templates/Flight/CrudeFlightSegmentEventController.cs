...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFlightSegmentEventController : Controller {
        ...
        // parameters:
        //  flightsegmenteventid: filter by primary key
        ...
        // parameters:
        //  flightsegmentid: filter by this foreign this key, use the following for no filter: '00000000-0000-0000-0000-000000000000'
        ...
        // create FlightSegmentEvent POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFlightSegmentEventModel: contract to add
        ...
        public string CrudeFlightSegmentEventCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "NewDateTime" , "12/31/2020 10:49:25 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "Remarks" , "create" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:49:25 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightSegmentEvent/CrudeFlightSegmentEventCreate/", content).Result;
        ...
        // Update FlightSegmentEvent POST page for controller
        // links:
        ...
        public string CrudeFlightSegmentEventUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightSegmentEvent/CrudeFlightSegmentEventUpdate/", content).Result;
        ...
        public string CrudeFlightSegmentEventDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightSegmentEvent/CrudeFlightSegmentEventDelete/00000000-0000-0000-0000-000000000001" ).Result;
