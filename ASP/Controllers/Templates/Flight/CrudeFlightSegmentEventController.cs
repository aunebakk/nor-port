...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFlightSegmentEventController : Controller {
        ...
        // create FlightSegmentEvent POST API for controller
        // links:
        ...
        public string CrudeFlightSegmentEventCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "NewDateTime" , "1/4/2021 10:13:09 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "Remarks" , "create" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/4/2021 10:13:09 PM" ) );
        ...
        // ppdate FlightSegmentEvent POST API for controller
        // links:
