...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFlightScheduleSegmentController : Controller {
        ...
        // create FlightScheduleSegment POST API for controller
        // links:
        ...
        public string CrudeFlightScheduleSegmentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/4/2021 10:12:44 PM" ) );
        ...
        // ppdate FlightScheduleSegment POST API for controller
        // links:
