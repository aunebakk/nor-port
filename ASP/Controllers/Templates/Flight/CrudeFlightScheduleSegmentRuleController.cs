...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFlightScheduleSegmentRuleController : Controller {
        ...
        // create FlightScheduleSegmentRule POST API for controller
        // links:
        ...
        public string CrudeFlightScheduleSegmentRuleCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/23/2021 5:15:27 PM" ) );
        ...
        // ppdate FlightScheduleSegmentRule POST API for controller
        // links:
