...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFlightScheduleSegmentRuleController : Controller {
        ...
        // parameters:
        //  flightschedulesegmentruleid: filter by primary key
        ...
        // parameters:
        //  flightschedulesegmentid: filter by this foreign this key, use the following for no filter: '00000000-0000-0000-0000-000000000000'
        ...
        //  docLink: http://sql2x.org/documentationLink/eab9ad20-fad5-4bde-8f34-a84e2b1e2a18
        // parameters:
        //  flightschedulesegmentrulercd: filter by this foreign this key, use the following for no filter: ''
        ...
        // create FlightScheduleSegmentRule POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFlightScheduleSegmentRuleModel: contract to add
        ...
        public string CrudeFlightScheduleSegmentRuleCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:49:08 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightScheduleSegmentRule/CrudeFlightScheduleSegmentRuleCreate/", content).Result;
        ...
        // Update FlightScheduleSegmentRule POST page for controller
        // links:
        ...
        public string CrudeFlightScheduleSegmentRuleUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightScheduleSegmentRule/CrudeFlightScheduleSegmentRuleUpdate/", content).Result;
        ...
        public string CrudeFlightScheduleSegmentRuleDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightScheduleSegmentRule/CrudeFlightScheduleSegmentRuleDelete/00000000-0000-0000-0000-000000000001" ).Result;
