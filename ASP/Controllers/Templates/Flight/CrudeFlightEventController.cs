...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFlightEventController : Controller {
        ...
        // create FlightEvent POST page for controller
        // links:
        ...
        public string CrudeFlightEventCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "NewDateTime" , "12/31/2020 10:48:35 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "Remarks" , "create" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:48:35 AM" ) );
        ...
        // Update FlightEvent POST page for controller
        // links:
