...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFlightController : Controller {
        ...
        // create Flight POST page for controller
        // links:
        ...
        public string CrudeFlightCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "12/31/2020 10:48:30 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "12/31/2020 10:48:30 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "Comment" , "create" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:48:30 AM" ) );
        ...
        // Update Flight POST page for controller
        // links:
