/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 1/4/2021 1:32:42 PM
    ...
    public class CrudeFlightController : Controller {
        ...
        public string CrudeFlightCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "1/4/2021 1:32:42 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "1/4/2021 1:32:42 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "Comment" , "create" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/4/2021 1:32:42 PM" ) );
