...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFlightScheduleController : Controller {
        ...
        // parameters:
        //  flightscheduleid: filter by primary key
        ...
        // create FlightSchedule POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFlightScheduleModel: contract to add
        ...
        public string CrudeFlightScheduleCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "12/31/2020 10:48:50 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "12/31/2020 10:48:50 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:48:50 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightSchedule/CrudeFlightScheduleCreate/", content).Result;
        ...
        // Update FlightSchedule POST page for controller
        // links:
        ...
        public string CrudeFlightScheduleUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightSchedule/CrudeFlightScheduleUpdate/", content).Result;
        ...
        public string CrudeFlightScheduleDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFlightSchedule/CrudeFlightScheduleDelete/00000000-0000-0000-0000-000000000001" ).Result;
