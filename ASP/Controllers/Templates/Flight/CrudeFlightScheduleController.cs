    ...
    public class CrudeFlightScheduleController : Controller {
        ...
        public string CrudeFlightScheduleCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "12/29/2020 2:47:17 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "12/29/2020 2:47:17 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:47:17 AM" ) );
