/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:43:11 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeClientTypeRefController : Controller {
        ...
        // parameters:
        //  clienttypercd: filter by primary key
        ...
        // create ClientTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeClientTypeRefModel: contract to add
        ...
        public string CrudeClientTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:43:11 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeClientTypeRef/CrudeClientTypeRefCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeClientTypeRef/CrudeClientTypeRefCreate/", content).Result;
        ...
        // Update ClientTypeRef POST page for controller
        // links:
        ...
        public string CrudeClientTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeClientTypeRef/CrudeClientTypeRefUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeClientTypeRef/CrudeClientTypeRefUpdate/", content).Result;
        ...
        public string CrudeClientTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeClientTypeRef/CrudeClientTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
