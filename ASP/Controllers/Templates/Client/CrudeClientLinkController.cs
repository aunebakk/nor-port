...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeClientLinkController : Controller {
        ...
        // parameters:
        //  clientlinkid: filter by primary key
        ...
        // create ClientLink POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeClientLinkModel: contract to add
        ...
        public string CrudeClientLinkCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:43:07 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeClientLink/CrudeClientLinkCreate/", content).Result;
        ...
        // Update ClientLink POST page for controller
        // links:
        ...
        public string CrudeClientLinkUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeClientLink/CrudeClientLinkUpdate/", content).Result;
        ...
        public string CrudeClientLinkDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeClientLink/CrudeClientLinkDelete/00000000-0000-0000-0000-000000000001" ).Result;
