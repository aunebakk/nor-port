...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeClientEventTypeRefController : Controller {
        ...
        // create ClientEventTypeRef POST page for controller
        // links:
        ...
        public string CrudeClientEventTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:43:04 AM" ) );
        ...
        // Update ClientEventTypeRef POST page for controller
        // links:
