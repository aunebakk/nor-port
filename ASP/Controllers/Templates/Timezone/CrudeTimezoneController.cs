...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeTimezoneController : Controller {
        ...
        // create Timezone POST page for controller
        // links:
        ...
        public string CrudeTimezoneCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:51:44 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeTimezone/CrudeTimezoneCreate/", content).Result;
        ...
        // Update Timezone POST page for controller
        // links:
        ...
        public string CrudeTimezoneUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeTimezone/CrudeTimezoneUpdate/", content).Result;
        ...
        public string CrudeTimezoneDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeTimezone/CrudeTimezoneDelete/00000000-0000-0000-0000-000000000001" ).Result;
