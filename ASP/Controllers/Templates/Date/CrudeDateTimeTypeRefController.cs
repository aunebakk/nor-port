...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDateTimeTypeRefController : Controller {
        ...
        // create DateTimeTypeRef POST API for controller
        // links:
        ...
        public string CrudeDateTimeTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/4/2021 10:06:54 PM" ) );
        ...
        // ppdate DateTimeTypeRef POST API for controller
        // links:
