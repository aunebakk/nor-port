...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDateTimeTypeRefController : Controller {
        ...
        // parameters:
        //  datetimetypercd: filter by primary key
        ...
        // create DateTimeTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeDateTimeTypeRefModel: contract to add
        ...
        public string CrudeDateTimeTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:43:23 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDateTimeTypeRef/CrudeDateTimeTypeRefCreate/", content).Result;
        ...
        // Update DateTimeTypeRef POST page for controller
        // links:
        ...
        public string CrudeDateTimeTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDateTimeTypeRef/CrudeDateTimeTypeRefUpdate/", content).Result;
        ...
        public string CrudeDateTimeTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDateTimeTypeRef/CrudeDateTimeTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
