...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAddressTypeRefController : Controller {
        ...
        // parameters:
        //  addresstypercd: filter by primary key
        ...
        // create AddressTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeAddressTypeRefModel: contract to add
        ...
        public string CrudeAddressTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:39:56 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAddressTypeRef/CrudeAddressTypeRefCreate/", content).Result;
        ...
        // Update AddressTypeRef POST page for controller
        // links:
        ...
        public string CrudeAddressTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAddressTypeRef/CrudeAddressTypeRefUpdate/", content).Result;
        ...
        public string CrudeAddressTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAddressTypeRef/CrudeAddressTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
