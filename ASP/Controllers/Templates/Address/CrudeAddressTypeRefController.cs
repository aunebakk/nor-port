...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAddressTypeRefController : Controller {
        ...
        // create AddressTypeRef POST API for controller
        // links:
        ...
        public string CrudeAddressTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/23/2021 5:05:31 PM" ) );
        ...
        // ppdate AddressTypeRef POST API for controller
        // links:
