...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFerryIdentifierTypeRefController : Controller {
        ...
        // create FerryIdentifierTypeRef POST page for controller
        // links:
        ...
        public string CrudeFerryIdentifierTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:45:32 AM" ) );
        ...
        // Update FerryIdentifierTypeRef POST page for controller
        // links:
