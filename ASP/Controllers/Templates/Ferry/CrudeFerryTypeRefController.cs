...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFerryTypeRefController : Controller {
        ...
        // create FerryTypeRef POST page for controller
        // links:
        ...
        public string CrudeFerryTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:43:04 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeFerryTypeRef/CrudeFerryTypeRefCreate/", content).Result;
        ...
        // Update FerryTypeRef POST page for controller
        // links:
        ...
        public string CrudeFerryTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeFerryTypeRef/CrudeFerryTypeRefUpdate/", content).Result;
        ...
        public string CrudeFerryTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeFerryTypeRef/CrudeFerryTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
