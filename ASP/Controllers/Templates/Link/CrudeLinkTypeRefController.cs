...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeLinkTypeRefController : Controller {
        ...
        // create LinkTypeRef POST API for controller
        // links:
        ...
        public string CrudeLinkTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/23/2021 5:16:05 PM" ) );
        ...
        // ppdate LinkTypeRef POST API for controller
        // links:
