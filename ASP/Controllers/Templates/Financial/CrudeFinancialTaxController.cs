/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:48:07 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialTaxController : Controller {
        ...
        // parameters:
        //  financialtaxid: filter by primary key
        ...
        // parameters:
        //  financialtaxtypercd: filter by this foreign this key, use the following for no filter: ''
        ...
        // create FinancialTax POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialTaxModel: contract to add
        ...
        public string CrudeFinancialTaxCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:48:07 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialTax/CrudeFinancialTaxCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialTax/CrudeFinancialTaxCreate/", content).Result;
        ...
        // Update FinancialTax POST page for controller
        // links:
        ...
        public string CrudeFinancialTaxUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialTax/CrudeFinancialTaxUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialTax/CrudeFinancialTaxUpdate/", content).Result;
        ...
        public string CrudeFinancialTaxDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialTax/CrudeFinancialTaxDelete/00000000-0000-0000-0000-000000000001" ).Result;
