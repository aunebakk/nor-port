...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialBookingTransactionController : Controller {
        ...
        // create FinancialBookingTransaction POST page for controller
        // links:
        ...
        public string CrudeFinancialBookingTransactionCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:43:31 AM" ) );
        ...
        // Update FinancialBookingTransaction POST page for controller
        // links:
