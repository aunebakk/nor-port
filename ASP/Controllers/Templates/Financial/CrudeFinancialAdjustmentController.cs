...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialAdjustmentController : Controller {
        ...
        // create FinancialAdjustment POST page for controller
        // links:
        ...
        public string CrudeFinancialAdjustmentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:45:41 AM" ) );
        ...
        // Update FinancialAdjustment POST page for controller
        // links:
