/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:45:51 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialBankAccountNumberTypeRefController : Controller {
        ...
        // parameters:
        //  financialbankaccountnumbertypercd: filter by primary key
        ...
        // create FinancialBankAccountNumberTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialBankAccountNumberTypeRefModel: contract to add
        ...
        public string CrudeFinancialBankAccountNumberTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:45:51 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialBankAccountNumberTypeRef/CrudeFinancialBankAccountNumberTypeRefCreate/", content).Result;
        ...
        // Update FinancialBankAccountNumberTypeRef POST page for controller
        // links:
        ...
        public string CrudeFinancialBankAccountNumberTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialBankAccountNumberTypeRef/CrudeFinancialBankAccountNumberTypeRefUpdate/", content).Result;
        ...
        public string CrudeFinancialBankAccountNumberTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialBankAccountNumberTypeRef/CrudeFinancialBankAccountNumberTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
