...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialFareController : Controller {
        ...
        // create FinancialFare POST page for controller
        // links:
        ...
        public string CrudeFinancialFareCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromFlightDateTime" , "12/31/2020 10:46:46 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilFlightDateTime" , "12/31/2020 10:46:46 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:46:46 AM" ) );
        ...
        // Update FinancialFare POST page for controller
        // links:
