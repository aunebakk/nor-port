    ...
    public class CrudeFinancialFareController : Controller {
        ...
        public string CrudeFinancialFareCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromFlightDateTime" , "12/29/2020 2:44:33 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilFlightDateTime" , "12/29/2020 2:44:33 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:44:33 AM" ) );
