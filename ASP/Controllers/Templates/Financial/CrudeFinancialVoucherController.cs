    ...
    public class CrudeFinancialVoucherController : Controller {
        ...
        public string CrudeFinancialVoucherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "1/4/2021 6:59:14 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "1/4/2021 6:59:14 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/4/2021 6:59:14 PM" ) );
