...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialTaxTypeRefController : Controller {
        ...
        // parameters:
        //  financialtaxtypercd: filter by primary key
        ...
        // create FinancialTaxTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialTaxTypeRefModel: contract to add
        ...
        public string CrudeFinancialTaxTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:48:12 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialTaxTypeRef/CrudeFinancialTaxTypeRefCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialTaxTypeRef/CrudeFinancialTaxTypeRefCreate/", content).Result;
        ...
        // Update FinancialTaxTypeRef POST page for controller
        // links:
        ...
        public string CrudeFinancialTaxTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialTaxTypeRef/CrudeFinancialTaxTypeRefUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialTaxTypeRef/CrudeFinancialTaxTypeRefUpdate/", content).Result;
        ...
        public string CrudeFinancialTaxTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialTaxTypeRef/CrudeFinancialTaxTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
