/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:47:52 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialPaymentVoucherController : Controller {
        ...
        // parameters:
        //  financialpaymentvoucherid: filter by primary key
        ...
        // parameters:
        //  financialvoucherid: filter by this foreign this key, use the following for no filter: '00000000-0000-0000-0000-000000000000'
        ...
        // create FinancialPaymentVoucher POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialPaymentVoucherModel: contract to add
        ...
        public string CrudeFinancialPaymentVoucherCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:47:52 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentVoucher/CrudeFinancialPaymentVoucherCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialPaymentVoucher/CrudeFinancialPaymentVoucherCreate/", content).Result;
        ...
        // Update FinancialPaymentVoucher POST page for controller
        // links:
        ...
        public string CrudeFinancialPaymentVoucherUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentVoucher/CrudeFinancialPaymentVoucherUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialPaymentVoucher/CrudeFinancialPaymentVoucherUpdate/", content).Result;
        ...
        public string CrudeFinancialPaymentVoucherDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentVoucher/CrudeFinancialPaymentVoucherDelete/00000000-0000-0000-0000-000000000001" ).Result;
