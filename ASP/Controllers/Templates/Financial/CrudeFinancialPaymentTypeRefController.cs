...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialPaymentTypeRefController : Controller {
        ...
        // create FinancialPaymentTypeRef POST page for controller
        // links:
        ...
        public string CrudeFinancialPaymentTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:47:47 AM" ) );
        ...
        // Update FinancialPaymentTypeRef POST page for controller
        // links:
