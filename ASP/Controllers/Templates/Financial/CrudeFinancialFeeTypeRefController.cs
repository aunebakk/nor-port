/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:47:01 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialFeeTypeRefController : Controller {
        ...
        // parameters:
        //  financialfeetypercd: filter by primary key
        ...
        // create FinancialFeeTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialFeeTypeRefModel: contract to add
        ...
        public string CrudeFinancialFeeTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:47:01 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialFeeTypeRef/CrudeFinancialFeeTypeRefCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialFeeTypeRef/CrudeFinancialFeeTypeRefCreate/", content).Result;
        ...
        // Update FinancialFeeTypeRef POST page for controller
        // links:
        ...
        public string CrudeFinancialFeeTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialFeeTypeRef/CrudeFinancialFeeTypeRefUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialFeeTypeRef/CrudeFinancialFeeTypeRefUpdate/", content).Result;
        ...
        public string CrudeFinancialFeeTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialFeeTypeRef/CrudeFinancialFeeTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
