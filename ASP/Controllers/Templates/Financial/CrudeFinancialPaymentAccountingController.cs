...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialPaymentAccountingController : Controller {
        ...
        // create FinancialPaymentAccounting POST page for controller
        // links:
        ...
        public string CrudeFinancialPaymentAccountingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:47:21 AM" ) );
        ...
        // Update FinancialPaymentAccounting POST page for controller
        // links:
