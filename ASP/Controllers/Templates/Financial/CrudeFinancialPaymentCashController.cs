/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:47:36 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialPaymentCashController : Controller {
        ...
        // parameters:
        //  financialpaymentcashid: filter by primary key
        ...
        // create FinancialPaymentCash POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialPaymentCashModel: contract to add
        ...
        public string CrudeFinancialPaymentCashCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:47:36 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentCash/CrudeFinancialPaymentCashCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialPaymentCash/CrudeFinancialPaymentCashCreate/", content).Result;
        ...
        // Update FinancialPaymentCash POST page for controller
        // links:
        ...
        public string CrudeFinancialPaymentCashUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentCash/CrudeFinancialPaymentCashUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialPaymentCash/CrudeFinancialPaymentCashUpdate/", content).Result;
        ...
        public string CrudeFinancialPaymentCashDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentCash/CrudeFinancialPaymentCashDelete/00000000-0000-0000-0000-000000000001" ).Result;
