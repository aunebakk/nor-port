...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialSpecialServiceController : Controller {
        ...
        // create FinancialSpecialService POST API for controller
        // links:
        ...
        public string CrudeFinancialSpecialServiceCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/4/2021 10:11:40 PM" ) );
        ...
        // ppdate FinancialSpecialService POST API for controller
        // links:
