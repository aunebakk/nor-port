/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:48:24 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialVoucherTypeRefController : Controller {
        ...
        // parameters:
        //  financialvouchertypercd: filter by primary key
        ...
        // create FinancialVoucherTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialVoucherTypeRefModel: contract to add
        ...
        public string CrudeFinancialVoucherTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:48:24 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialVoucherTypeRef/CrudeFinancialVoucherTypeRefCreate/", content).Result;
        ...
        // Update FinancialVoucherTypeRef POST page for controller
        // links:
        ...
        public string CrudeFinancialVoucherTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialVoucherTypeRef/CrudeFinancialVoucherTypeRefUpdate/", content).Result;
        ...
        public string CrudeFinancialVoucherTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialVoucherTypeRef/CrudeFinancialVoucherTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
