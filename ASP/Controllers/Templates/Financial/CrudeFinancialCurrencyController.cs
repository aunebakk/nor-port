...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialCurrencyController : Controller {
        ...
        // create FinancialCurrency POST page for controller
        // links:
        ...
        public string CrudeFinancialCurrencyCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "ValidFromDateTime" , "12/31/2020 10:46:36 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ValidUntilDateTime" , "12/31/2020 10:46:36 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DecimalCount" , "1" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:46:36 AM" ) );
        ...
        // Update FinancialCurrency POST page for controller
        // links:
