...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialCurrencyTypeRefController : Controller {
        ...
        // parameters:
        //  financialcurrencytypercd: filter by primary key
        ...
        // create FinancialCurrencyTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialCurrencyTypeRefModel: contract to add
        ...
        public string CrudeFinancialCurrencyTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:46:41 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialCurrencyTypeRef/CrudeFinancialCurrencyTypeRefCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialCurrencyTypeRef/CrudeFinancialCurrencyTypeRefCreate/", content).Result;
        ...
        // Update FinancialCurrencyTypeRef POST page for controller
        // links:
        ...
        public string CrudeFinancialCurrencyTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialCurrencyTypeRef/CrudeFinancialCurrencyTypeRefUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialCurrencyTypeRef/CrudeFinancialCurrencyTypeRefUpdate/", content).Result;
        ...
        public string CrudeFinancialCurrencyTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialCurrencyTypeRef/CrudeFinancialCurrencyTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
