    ...
    public class CrudeFinancialCarRentalController : Controller {
        ...
        public string CrudeFinancialCarRentalCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "12/27/2020 7:03:16 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "12/27/2020 7:03:16 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/27/2020 7:03:16 PM" ) );
