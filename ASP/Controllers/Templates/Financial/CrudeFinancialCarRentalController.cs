    ...
    public class CrudeFinancialCarRentalController : Controller {
        ...
        public string CrudeFinancialCarRentalCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "1/6/2021 1:21:09 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "1/6/2021 1:21:09 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/6/2021 1:21:09 PM" ) );
