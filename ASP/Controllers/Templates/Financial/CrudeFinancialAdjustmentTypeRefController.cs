/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:45:46 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialAdjustmentTypeRefController : Controller {
        ...
        // parameters:
        //  financialadjustmenttypercd: filter by primary key
        ...
        // create FinancialAdjustmentTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialAdjustmentTypeRefModel: contract to add
        ...
        public string CrudeFinancialAdjustmentTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:45:46 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialAdjustmentTypeRef/CrudeFinancialAdjustmentTypeRefCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialAdjustmentTypeRef/CrudeFinancialAdjustmentTypeRefCreate/", content).Result;
        ...
        // Update FinancialAdjustmentTypeRef POST page for controller
        // links:
        ...
        public string CrudeFinancialAdjustmentTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialAdjustmentTypeRef/CrudeFinancialAdjustmentTypeRefUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialAdjustmentTypeRef/CrudeFinancialAdjustmentTypeRefUpdate/", content).Result;
        ...
        public string CrudeFinancialAdjustmentTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialAdjustmentTypeRef/CrudeFinancialAdjustmentTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
