    ...
    public class CrudeFinancialHotelBookingController : Controller {
        ...
        public string CrudeFinancialHotelBookingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "1/5/2021 7:34:18 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "1/5/2021 7:34:18 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/5/2021 7:34:18 AM" ) );
