    ...
    public class CrudeFinancialHotelBookingController : Controller {
        ...
        public string CrudeFinancialHotelBookingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "1/4/2021 4:41:21 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "1/4/2021 4:41:21 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/4/2021 4:41:21 PM" ) );
