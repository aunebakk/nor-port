...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialHotelBookingController : Controller {
        ...
        // create FinancialHotelBooking POST API for controller
        // links:
        ...
        public string CrudeFinancialHotelBookingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "1/5/2021 12:59:15 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "1/5/2021 12:59:15 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/5/2021 12:59:15 PM" ) );
        ...
        // ppdate FinancialHotelBooking POST API for controller
        // links:
