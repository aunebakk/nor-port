    ...
    public class CrudeFinancialHotelBookingController : Controller {
        ...
        public string CrudeFinancialHotelBookingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "1/3/2021 3:53:42 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "1/3/2021 3:53:42 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/3/2021 3:53:42 PM" ) );
