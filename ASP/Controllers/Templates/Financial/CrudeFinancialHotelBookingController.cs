    ...
    public class CrudeFinancialHotelBookingController : Controller {
        ...
        public string CrudeFinancialHotelBookingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "1/2/2021 2:26:38 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "1/2/2021 2:26:38 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/2/2021 2:26:38 PM" ) );
