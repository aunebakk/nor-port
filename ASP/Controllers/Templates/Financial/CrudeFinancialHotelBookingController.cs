    ...
    public class CrudeFinancialHotelBookingController : Controller {
        ...
        public string CrudeFinancialHotelBookingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "FromDateTime" , "12/28/2020 8:12:21 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "UntilDateTime" , "12/28/2020 8:12:21 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/28/2020 8:12:21 AM" ) );
