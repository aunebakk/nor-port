...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialFareTypeRefController : Controller {
        ...
        // create FinancialFareTypeRef POST page for controller
        // links:
        ...
        public string CrudeFinancialFareTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:46:51 AM" ) );
        ...
        // Update FinancialFareTypeRef POST page for controller
        // links:
