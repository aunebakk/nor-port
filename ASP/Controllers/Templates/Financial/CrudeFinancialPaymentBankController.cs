...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialPaymentBankController : Controller {
        ...
        // create FinancialPaymentBank POST page for controller
        // links:
        ...
        public string CrudeFinancialPaymentBankCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:47:26 AM" ) );
        ...
        // Update FinancialPaymentBank POST page for controller
        // links:
