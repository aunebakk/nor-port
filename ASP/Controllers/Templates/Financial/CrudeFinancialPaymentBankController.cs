...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialPaymentBankController : Controller {
        ...
        // parameters:
        //  financialpaymentbankid: filter by primary key
        ...
        // parameters:
        //  financialbankaccountnumbertypercd: filter by this foreign this key, use the following for no filter: ''
        ...
        // create FinancialPaymentBank POST API for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeFinancialPaymentBankModel: contract to add
        ...
        public string CrudeFinancialPaymentBankCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/6/2021 1:22:37 PM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentBank/CrudeFinancialPaymentBankCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialPaymentBank/CrudeFinancialPaymentBankCreate/", content).Result;
        ...
        // ppdate FinancialPaymentBank POST API for controller
        // links:
        ...
        public string CrudeFinancialPaymentBankUpdateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/6/2021 1:22:38 PM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentBank/CrudeFinancialPaymentBankUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeFinancialPaymentBank/CrudeFinancialPaymentBankUpdate/", content).Result;
        ...
        public string CrudeFinancialPaymentBankDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeFinancialPaymentBank/CrudeFinancialPaymentBankDelete/00000000-0000-0000-0000-000000000001" ).Result;
