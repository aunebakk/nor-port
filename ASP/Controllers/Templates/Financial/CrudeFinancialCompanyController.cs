...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialCompanyController : Controller {
        ...
        // create FinancialCompany POST page for controller
        // links:
        ...
        public string CrudeFinancialCompanyCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:46:15 AM" ) );
        ...
        // Update FinancialCompany POST page for controller
        // links:
