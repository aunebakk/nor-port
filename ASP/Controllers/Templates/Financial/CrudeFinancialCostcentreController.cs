...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialCostcentreController : Controller {
        ...
        // create FinancialCostcentre POST page for controller
        // links:
        ...
        public string CrudeFinancialCostcentreCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:46:20 AM" ) );
        ...
        // Update FinancialCostcentre POST page for controller
        // links:
