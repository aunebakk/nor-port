...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeFinancialPaymentCardController : Controller {
        ...
        // create FinancialPaymentCard POST page for controller
        // links:
        ...
        public string CrudeFinancialPaymentCardCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:47:31 AM" ) );
        ...
        // Update FinancialPaymentCard POST page for controller
        // links:
