...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingDocumentTypeRefController : Controller {
        ...
        // create BookingDocumentTypeRef POST page for controller
        // links:
        ...
        public string CrudeBookingDocumentTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:41:47 AM" ) );
        ...
        // Update BookingDocumentTypeRef POST page for controller
        // links:
