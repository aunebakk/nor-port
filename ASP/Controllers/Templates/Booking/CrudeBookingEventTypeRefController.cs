...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingEventTypeRefController : Controller {
        ...
        // create BookingEventTypeRef POST page for controller
        // links:
        ...
        public string CrudeBookingEventTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:38:33 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeBookingEventTypeRef/CrudeBookingEventTypeRefCreate/", content).Result;
        ...
        // Update BookingEventTypeRef POST page for controller
        // links:
        ...
        public string CrudeBookingEventTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeBookingEventTypeRef/CrudeBookingEventTypeRefUpdate/", content).Result;
        ...
        public string CrudeBookingEventTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeBookingEventTypeRef/CrudeBookingEventTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
