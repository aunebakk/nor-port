    ...
    public class CrudeBookingPassengerTicketController : Controller {
        ...
        public string CrudeBookingPassengerTicketCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/28/2020 12:16:57 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeBookingPassengerTicket/CrudeBookingPassengerTicketCreate/", content).Result;
        ...
        public string CrudeBookingPassengerTicketUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeBookingPassengerTicket/CrudeBookingPassengerTicketUpdate/", content).Result;
        ...
        public string CrudeBookingPassengerTicketDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeBookingPassengerTicket/CrudeBookingPassengerTicketDelete/00000000-0000-0000-0000-000000000001" ).Result;
