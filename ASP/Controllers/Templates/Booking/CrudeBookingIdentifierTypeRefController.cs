...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingIdentifierTypeRefController : Controller {
        ...
        // create BookingIdentifierTypeRef POST API for controller
        // links:
        ...
        public string CrudeBookingIdentifierTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/5/2021 12:54:15 PM" ) );
        ...
        // ppdate BookingIdentifierTypeRef POST API for controller
        // links:
