...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingController : Controller {
        ...
        // create Booking POST page for controller
        // links:
        ...
        public string CrudeBookingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:41:38 AM" ) );
        ...
        // Update Booking POST page for controller
        // links:
