...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingContactMethodController : Controller {
        ...
        // create BookingContactMethod POST page for controller
        // links:
        ...
        public string CrudeBookingContactMethodCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:41:41 AM" ) );
        ...
        // Update BookingContactMethod POST page for controller
        // links:
