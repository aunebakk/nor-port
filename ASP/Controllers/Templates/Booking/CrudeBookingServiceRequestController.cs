...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingServiceRequestController : Controller {
        ...
        // create BookingServiceRequest POST page for controller
        // links:
        ...
        public string CrudeBookingServiceRequestCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:39:11 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeBookingServiceRequest/CrudeBookingServiceRequestCreate/", content).Result;
        ...
        // Update BookingServiceRequest POST page for controller
        // links:
        ...
        public string CrudeBookingServiceRequestUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeBookingServiceRequest/CrudeBookingServiceRequestUpdate/", content).Result;
        ...
        public string CrudeBookingServiceRequestDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeBookingServiceRequest/CrudeBookingServiceRequestDelete/00000000-0000-0000-0000-000000000001" ).Result;
