...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingIdentifierController : Controller {
        ...
        // create BookingIdentifier POST page for controller
        // links:
        ...
        public string CrudeBookingIdentifierCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:38:40 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeBookingIdentifier/CrudeBookingIdentifierCreate/", content).Result;
        ...
        // Update BookingIdentifier POST page for controller
        // links:
        ...
        public string CrudeBookingIdentifierUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeBookingIdentifier/CrudeBookingIdentifierUpdate/", content).Result;
        ...
        public string CrudeBookingIdentifierDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeBookingIdentifier/CrudeBookingIdentifierDelete/00000000-0000-0000-0000-000000000001" ).Result;
