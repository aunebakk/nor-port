...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingEventController : Controller {
        ...
        // create BookingEvent POST page for controller
        // links:
        ...
        public string CrudeBookingEventCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:38:29 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeBookingEvent/CrudeBookingEventCreate/", content).Result;
        ...
        // Update BookingEvent POST page for controller
        // links:
        ...
        public string CrudeBookingEventUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeBookingEvent/CrudeBookingEventUpdate/", content).Result;
        ...
        public string CrudeBookingEventDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeBookingEvent/CrudeBookingEventDelete/00000000-0000-0000-0000-000000000001" ).Result;
