/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:41:58 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingFlightSegmentController : Controller {
        ...
        // parameters:
        //  bookingflightsegmentid: filter by primary key
        ...
        // create BookingFlightSegment POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeBookingFlightSegmentModel: contract to add
        ...
        public string CrudeBookingFlightSegmentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:41:58 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeBookingFlightSegment/CrudeBookingFlightSegmentCreate/", content).Result;
        ...
        // Update BookingFlightSegment POST page for controller
        // links:
        ...
        public string CrudeBookingFlightSegmentUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeBookingFlightSegment/CrudeBookingFlightSegmentUpdate/", content).Result;
        ...
        public string CrudeBookingFlightSegmentDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeBookingFlightSegment/CrudeBookingFlightSegmentDelete/00000000-0000-0000-0000-000000000001" ).Result;
