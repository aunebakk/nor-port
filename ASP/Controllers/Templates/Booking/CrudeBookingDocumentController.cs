...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingDocumentController : Controller {
        ...
        // create BookingDocument POST page for controller
        // links:
        ...
        public string CrudeBookingDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:41:44 AM" ) );
        ...
        // Update BookingDocument POST page for controller
        // links:
