...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeBookingPassengerController : Controller {
        ...
        // parameters:
        //  bookingpassengerid: filter by primary key
        ...
        //  docLink: http://sql2x.org/documentationLink/eab9ad20-fad5-4bde-8f34-a84e2b1e2a18
        // parameters:
        //  passengerid: filter by this foreign this key, use the following for no filter: '00000000-0000-0000-0000-000000000000'
        ...
        // create BookingPassenger POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeBookingPassengerModel: contract to add
        ...
        public string CrudeBookingPassengerCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:42:08 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeBookingPassenger/CrudeBookingPassengerCreate/", content).Result;
        ...
        // Update BookingPassenger POST page for controller
        // links:
        ...
        public string CrudeBookingPassengerUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeBookingPassenger/CrudeBookingPassengerUpdate/", content).Result;
        ...
        public string CrudeBookingPassengerDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeBookingPassenger/CrudeBookingPassengerDelete/00000000-0000-0000-0000-000000000001" ).Result;
