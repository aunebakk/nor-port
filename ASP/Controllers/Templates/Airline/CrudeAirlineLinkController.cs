...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirlineLinkController : Controller {
        ...
        // create AirlineLink POST page for controller
        // links:
        ...
        public string CrudeAirlineLinkCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:37:30 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeAirlineLink/CrudeAirlineLinkCreate/", content).Result;
        ...
        // Update AirlineLink POST page for controller
        // links:
        ...
        public string CrudeAirlineLinkUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeAirlineLink/CrudeAirlineLinkUpdate/", content).Result;
        ...
        public string CrudeAirlineLinkDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeAirlineLink/CrudeAirlineLinkDelete/00000000-0000-0000-0000-000000000001" ).Result;
