...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirlineLanguageController : Controller {
        ...
        // create AirlineLanguage POST page for controller
        // links:
        ...
        public string CrudeAirlineLanguageCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:40:46 AM" ) );
        ...
        // Update AirlineLanguage POST page for controller
        // links:
