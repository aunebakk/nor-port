...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirlineTypeRefController : Controller {
        ...
        // create AirlineTypeRef POST page for controller
        // links:
        ...
        public string CrudeAirlineTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:37:33 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeAirlineTypeRef/CrudeAirlineTypeRefCreate/", content).Result;
        ...
        // Update AirlineTypeRef POST page for controller
        // links:
        ...
        public string CrudeAirlineTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeAirlineTypeRef/CrudeAirlineTypeRefUpdate/", content).Result;
        ...
        public string CrudeAirlineTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeAirlineTypeRef/CrudeAirlineTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
