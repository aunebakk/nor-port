...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirlineBaseAirportController : Controller {
        ...
        // create AirlineBaseAirport POST page for controller
        // links:
        ...
        public string CrudeAirlineBaseAirportCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:37:17 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeAirlineBaseAirport/CrudeAirlineBaseAirportCreate/", content).Result;
        ...
        // Update AirlineBaseAirport POST page for controller
        // links:
        ...
        public string CrudeAirlineBaseAirportUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeAirlineBaseAirport/CrudeAirlineBaseAirportUpdate/", content).Result;
        ...
        public string CrudeAirlineBaseAirportDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeAirlineBaseAirport/CrudeAirlineBaseAirportDelete/00000000-0000-0000-0000-000000000001" ).Result;
