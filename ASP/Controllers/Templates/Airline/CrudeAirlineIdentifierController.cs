...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirlineIdentifierController : Controller {
        ...
        // create AirlineIdentifier POST API for controller
        // links:
        ...
        public string CrudeAirlineIdentifierCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/5/2021 12:52:59 PM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirlineIdentifier/CrudeAirlineIdentifierCreate/", content).Result;
        ...
        // ppdate AirlineIdentifier POST API for controller
        // links:
        ...
        public string CrudeAirlineIdentifierUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirlineIdentifier/CrudeAirlineIdentifierUpdate/", content).Result;
        ...
        public string CrudeAirlineIdentifierDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAirlineIdentifier/CrudeAirlineIdentifierDelete/00000000-0000-0000-0000-000000000001" ).Result;
