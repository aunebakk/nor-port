...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAirlineController : Controller {
        ...
        // create Airline POST page for controller
        // links:
        ...
        public string CrudeAirlineCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:40:32 AM" ) );
        ...
        // Update Airline POST page for controller
        // links:
