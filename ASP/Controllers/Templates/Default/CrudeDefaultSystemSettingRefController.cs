...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultSystemSettingRefController : Controller {
        ...
        // create DefaultSystemSettingRef POST page for controller
        // links:
        ...
        public string CrudeDefaultSystemSettingRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:44:41 AM" ) );
        ...
        // Update DefaultSystemSettingRef POST page for controller
        // links:
