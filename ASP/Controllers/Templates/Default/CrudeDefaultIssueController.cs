...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultIssueController : Controller {
        ...
        // create DefaultIssue POST page for controller
        // links:
        ...
        public string CrudeDefaultIssueCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/30/2020 1:32:07 PM" ) );
        ...
        // Update DefaultIssue POST page for controller
        // links:
