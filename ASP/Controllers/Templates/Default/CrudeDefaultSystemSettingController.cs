/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:44:36 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultSystemSettingController : Controller {
        ...
        // parameters:
        //  defaultsystemsettingid: filter by primary key
        ...
        // parameters:
        //  defaultsystemsettingrcd: filter by this foreign this key, use the following for no filter: ''
        ...
        // create DefaultSystemSetting POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeDefaultSystemSettingModel: contract to add
        ...
        public string CrudeDefaultSystemSettingCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:44:36 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultSystemSetting/CrudeDefaultSystemSettingCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeDefaultSystemSetting/CrudeDefaultSystemSettingCreate/", content).Result;
        ...
        // Update DefaultSystemSetting POST page for controller
        // links:
        ...
        public string CrudeDefaultSystemSettingUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultSystemSetting/CrudeDefaultSystemSettingUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeDefaultSystemSetting/CrudeDefaultSystemSettingUpdate/", content).Result;
        ...
        public string CrudeDefaultSystemSettingDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultSystemSetting/CrudeDefaultSystemSettingDelete/00000000-0000-0000-0000-000000000001" ).Result;
