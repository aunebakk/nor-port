...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultPerformanceIssueController : Controller {
        ...
        // create DefaultPerformanceIssue POST page for controller
        // links:
        ...
        public string CrudeDefaultPerformanceIssueCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:44:02 AM" ) );
        ...
        // Update DefaultPerformanceIssue POST page for controller
        // links:
