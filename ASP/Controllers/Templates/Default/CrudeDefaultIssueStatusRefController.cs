/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:43:53 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultIssueStatusRefController : Controller {
        ...
        // parameters:
        //  defaultissuestatusrcd: filter by primary key
        ...
        // create DefaultIssueStatusRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeDefaultIssueStatusRefModel: contract to add
        ...
        public string CrudeDefaultIssueStatusRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:43:53 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultIssueStatusRef/CrudeDefaultIssueStatusRefCreate/", content).Result;
        ...
        // Update DefaultIssueStatusRef POST page for controller
        // links:
        ...
        public string CrudeDefaultIssueStatusRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultIssueStatusRef/CrudeDefaultIssueStatusRefUpdate/", content).Result;
        ...
        public string CrudeDefaultIssueStatusRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultIssueStatusRef/CrudeDefaultIssueStatusRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
