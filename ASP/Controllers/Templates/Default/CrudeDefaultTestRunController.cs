/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/30/2020 5:31:50 AM
    ...
    public class CrudeDefaultTestRunController : Controller {
        ...
        public string CrudeDefaultTestRunCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "StartDateTime" , "12/30/2020 5:31:50 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "EndDateTime" , "12/30/2020 5:31:50 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ElapsedMilliseconds" , "1" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/30/2020 5:31:50 AM" ) );
