...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultUserActivityController : Controller {
        ...
        // create DefaultUserActivity POST page for controller
        // links:
        ...
        public string CrudeDefaultUserActivityCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:45:04 AM" ) );
        ...
        // Update DefaultUserActivity POST page for controller
        // links:
