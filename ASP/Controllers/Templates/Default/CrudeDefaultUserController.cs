/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/30/2020 1:33:17 PM
    ...
    public class CrudeDefaultUserController : Controller {
        ...
        public string CrudeDefaultUserCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/30/2020 1:33:17 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "LastActivityDateTime" , "12/30/2020 1:33:17 PM" ) );
