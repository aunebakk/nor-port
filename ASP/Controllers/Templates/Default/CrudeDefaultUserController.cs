/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/30/2020 5:32:00 AM
    ...
    public class CrudeDefaultUserController : Controller {
        ...
        public string CrudeDefaultUserCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/30/2020 5:32:00 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "LastActivityDateTime" , "12/30/2020 5:32:00 AM" ) );
