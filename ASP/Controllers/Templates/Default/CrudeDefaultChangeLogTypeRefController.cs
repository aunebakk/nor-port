...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultChangeLogTypeRefController : Controller {
        ...
        // create DefaultChangeLogTypeRef POST page for controller
        // links:
        ...
        public string CrudeDefaultChangeLogTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:43:31 AM" ) );
        ...
        // Update DefaultChangeLogTypeRef POST page for controller
        // links:
