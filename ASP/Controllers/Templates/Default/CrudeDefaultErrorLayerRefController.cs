/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:43:40 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultErrorLayerRefController : Controller {
        ...
        // parameters:
        //  defaulterrorlayerrcd: filter by primary key
        ...
        // create DefaultErrorLayerRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeDefaultErrorLayerRefModel: contract to add
        ...
        public string CrudeDefaultErrorLayerRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:43:40 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultErrorLayerRef/CrudeDefaultErrorLayerRefCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeDefaultErrorLayerRef/CrudeDefaultErrorLayerRefCreate/", content).Result;
        ...
        // Update DefaultErrorLayerRef POST page for controller
        // links:
        ...
        public string CrudeDefaultErrorLayerRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultErrorLayerRef/CrudeDefaultErrorLayerRefUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeDefaultErrorLayerRef/CrudeDefaultErrorLayerRefUpdate/", content).Result;
        ...
        public string CrudeDefaultErrorLayerRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultErrorLayerRef/CrudeDefaultErrorLayerRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
