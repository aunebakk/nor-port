/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/31/2020 10:44:07 AM
...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeDefaultPerformanceTimeController : Controller {
        ...
        // parameters:
        //  defaultperformancetimeid: filter by primary key
        ...
        // create DefaultPerformanceTime POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeDefaultPerformanceTimeModel: contract to add
        ...
        public string CrudeDefaultPerformanceTimeCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:44:07 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultPerformanceTime/CrudeDefaultPerformanceTimeCreate/", content).Result;
                // todo var response = client.PostAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeDefaultPerformanceTime/CrudeDefaultPerformanceTimeCreate/", content).Result;
        ...
        // Update DefaultPerformanceTime POST page for controller
        // links:
        ...
        public string CrudeDefaultPerformanceTimeUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultPerformanceTime/CrudeDefaultPerformanceTimeUpdate/", content).Result;
                // todo var response = client.PutAsync("http://NorSolutionPortCore.azurewebsites.net/api/1/CrudeDefaultPerformanceTime/CrudeDefaultPerformanceTimeUpdate/", content).Result;
        ...
        public string CrudeDefaultPerformanceTimeDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeDefaultPerformanceTime/CrudeDefaultPerformanceTimeDelete/00000000-0000-0000-0000-000000000001" ).Result;
