    ...
    public class CrudeAircraftMeasurementController : Controller {
        ...
        public string CrudeAircraftMeasurementCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/28/2020 12:14:44 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeAircraftMeasurement/CrudeAircraftMeasurementCreate/", content).Result;
        ...
        public string CrudeAircraftMeasurementUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeAircraftMeasurement/CrudeAircraftMeasurementUpdate/", content).Result;
        ...
        public string CrudeAircraftMeasurementDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeAircraftMeasurement/CrudeAircraftMeasurementDelete/00000000-0000-0000-0000-000000000001" ).Result;
