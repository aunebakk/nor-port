...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAircraftMeasurementController : Controller {
        ...
        // create AircraftMeasurement POST API for controller
        // links:
        ...
        public string CrudeAircraftMeasurementCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/23/2021 5:06:03 PM" ) );
        ...
        // ppdate AircraftMeasurement POST API for controller
        // links:
