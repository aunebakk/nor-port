...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAircraftCompartmentTypeRefController : Controller {
        ...
        // parameters:
        //  aircraftcompartmenttypercd: filter by primary key
        ...
        // create AircraftCompartmentTypeRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeAircraftCompartmentTypeRefModel: contract to add
        ...
        public string CrudeAircraftCompartmentTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:40:10 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAircraftCompartmentTypeRef/CrudeAircraftCompartmentTypeRefCreate/", content).Result;
        ...
        // Update AircraftCompartmentTypeRef POST page for controller
        // links:
        ...
        public string CrudeAircraftCompartmentTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAircraftCompartmentTypeRef/CrudeAircraftCompartmentTypeRefUpdate/", content).Result;
        ...
        public string CrudeAircraftCompartmentTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeAircraftCompartmentTypeRef/CrudeAircraftCompartmentTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
