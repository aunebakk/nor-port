    ...
    public class CrudeAircraftController : Controller {
        ...
        public string CrudeAircraftCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "OperationalDateTime" , "1/2/2021 2:19:50 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "FirstFlightDateTime" , "1/2/2021 2:19:50 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "EngineType" , "create" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "PassengerCapacity" , "1" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/2/2021 2:19:50 PM" ) );
