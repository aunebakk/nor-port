...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAircraftDocumentController : Controller {
        ...
        // create AircraftDocument POST page for controller
        // links:
        ...
        public string CrudeAircraftDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "12/31/2020 10:40:15 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "12/31/2020 10:40:15 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:40:15 AM" ) );
        ...
        // Update AircraftDocument POST page for controller
        // links:
