    ...
    public class CrudeAircraftDocumentController : Controller {
        ...
        public string CrudeAircraftDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "1/3/2021 8:06:44 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "1/3/2021 8:06:44 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/3/2021 8:06:44 AM" ) );
