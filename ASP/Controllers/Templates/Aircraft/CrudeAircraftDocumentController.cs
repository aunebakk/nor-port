    ...
    public class CrudeAircraftDocumentController : Controller {
        ...
        public string CrudeAircraftDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "1/5/2021 9:30:21 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "1/5/2021 9:30:21 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/5/2021 9:30:21 AM" ) );
