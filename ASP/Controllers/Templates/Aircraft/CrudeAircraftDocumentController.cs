    ...
    public class CrudeAircraftDocumentController : Controller {
        ...
        public string CrudeAircraftDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "12/28/2020 12:14:33 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "12/28/2020 12:14:33 AM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/28/2020 12:14:33 AM" ) );
