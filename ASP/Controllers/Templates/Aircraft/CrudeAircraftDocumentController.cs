    ...
    public class CrudeAircraftDocumentController : Controller {
        ...
        public string CrudeAircraftDocumentCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DocumentDateTime" , "12/27/2020 6:57:20 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "ExpiryDateTime" , "12/27/2020 6:57:20 PM" ) );
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/27/2020 6:57:20 PM" ) );
