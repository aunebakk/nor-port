...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeAircraftIdentifierTypeRefController : Controller {
        ...
        // create AircraftIdentifierTypeRef POST page for controller
        // links:
        ...
        public string CrudeAircraftIdentifierTypeRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:37:07 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeAircraftIdentifierTypeRef/CrudeAircraftIdentifierTypeRefCreate/", content).Result;
        ...
        // Update AircraftIdentifierTypeRef POST page for controller
        // links:
        ...
        public string CrudeAircraftIdentifierTypeRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeAircraftIdentifierTypeRef/CrudeAircraftIdentifierTypeRefUpdate/", content).Result;
        ...
        public string CrudeAircraftIdentifierTypeRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeAircraftIdentifierTypeRef/CrudeAircraftIdentifierTypeRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
