...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceHotelLinkController : Controller {
        ...
        // create ServiceHotelLink POST page for controller
        // links:
        ...
        public string CrudeServiceHotelLinkCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:50:58 AM" ) );
        ...
        // Update ServiceHotelLink POST page for controller
        // links:
