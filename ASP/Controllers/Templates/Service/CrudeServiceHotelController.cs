...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceHotelController : Controller {
        ...
        // create ServiceHotel POST API for controller
        // links:
        ...
        public string CrudeServiceHotelCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/23/2021 5:17:14 PM" ) );
        ...
        // ppdate ServiceHotel POST API for controller
        // links:
