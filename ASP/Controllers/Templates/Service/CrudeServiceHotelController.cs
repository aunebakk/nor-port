...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceHotelController : Controller {
        ...
        // parameters:
        //  servicehotelid: filter by primary key
        ...
        // create ServiceHotel POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeServiceHotelModel: contract to add
        ...
        public string CrudeServiceHotelCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:50:47 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceHotel/CrudeServiceHotelCreate/", content).Result;
        ...
        // Update ServiceHotel POST page for controller
        // links:
        ...
        public string CrudeServiceHotelUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceHotel/CrudeServiceHotelUpdate/", content).Result;
        ...
        public string CrudeServiceHotelDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceHotel/CrudeServiceHotelDelete/00000000-0000-0000-0000-000000000001" ).Result;
