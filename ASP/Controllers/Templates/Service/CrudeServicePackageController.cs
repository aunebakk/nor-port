...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServicePackageController : Controller {
        ...
        // create ServicePackage POST API for controller
        // links:
        ...
        public string CrudeServicePackageCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "1/23/2021 5:17:43 PM" ) );
        ...
        // ppdate ServicePackage POST API for controller
        // links:
