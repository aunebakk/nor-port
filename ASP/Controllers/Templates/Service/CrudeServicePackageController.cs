    ...
    public class CrudeServicePackageController : Controller {
        ...
        public string CrudeServicePackageCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/27/2020 11:32:15 PM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeServicePackage/CrudeServicePackageCreate/", content).Result;
        ...
        public string CrudeServicePackageUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeServicePackage/CrudeServicePackageUpdate/", content).Result;
        ...
        public string CrudeServicePackageDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeServicePackage/CrudeServicePackageDelete/00000000-0000-0000-0000-000000000001" ).Result;
