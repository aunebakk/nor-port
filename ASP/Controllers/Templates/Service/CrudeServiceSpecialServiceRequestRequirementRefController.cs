...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceSpecialServiceRequestRequirementRefController : Controller {
        ...
        // create ServiceSpecialServiceRequestRequirementRef POST page for controller
        // links:
        ...
        public string CrudeServiceSpecialServiceRequestRequirementRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:51:25 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequestRequirementRef/CrudeServiceSpecialServiceRequestRequirementRefCreate/", content).Result;
        ...
        // Update ServiceSpecialServiceRequestRequirementRef POST page for controller
        // links:
        ...
        public string CrudeServiceSpecialServiceRequestRequirementRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequestRequirementRef/CrudeServiceSpecialServiceRequestRequirementRefUpdate/", content).Result;
        ...
        public string CrudeServiceSpecialServiceRequestRequirementRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequestRequirementRef/CrudeServiceSpecialServiceRequestRequirementRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
