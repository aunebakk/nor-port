...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceCarRentalController : Controller {
        ...
        // parameters:
        //  servicecarrentalid: filter by primary key
        ...
        // create ServiceCarRental POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeServiceCarRentalModel: contract to add
        ...
        public string CrudeServiceCarRentalCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:50:27 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceCarRental/CrudeServiceCarRentalCreate/", content).Result;
        ...
        // Update ServiceCarRental POST page for controller
        // links:
        ...
        public string CrudeServiceCarRentalUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceCarRental/CrudeServiceCarRentalUpdate/", content).Result;
        ...
        public string CrudeServiceCarRentalDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceCarRental/CrudeServiceCarRentalDelete/00000000-0000-0000-0000-000000000001" ).Result;
