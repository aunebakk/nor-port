    ...
    public class CrudeServiceSpecialServiceRequestController : Controller {
        ...
        public string CrudeServiceSpecialServiceRequestCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/27/2020 11:32:35 PM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequest/CrudeServiceSpecialServiceRequestCreate/", content).Result;
        ...
        public string CrudeServiceSpecialServiceRequestUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequest/CrudeServiceSpecialServiceRequestUpdate/", content).Result;
        ...
        public string CrudeServiceSpecialServiceRequestDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequest/CrudeServiceSpecialServiceRequestDelete/00000000-0000-0000-0000-000000000001" ).Result;
