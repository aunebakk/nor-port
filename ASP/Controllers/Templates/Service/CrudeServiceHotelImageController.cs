...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceHotelImageController : Controller {
        ...
        // create ServiceHotelImage POST page for controller
        // links:
        ...
        public string CrudeServiceHotelImageCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:50:02 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeServiceHotelImage/CrudeServiceHotelImageCreate/", content).Result;
        ...
        // Update ServiceHotelImage POST page for controller
        // links:
        ...
        public string CrudeServiceHotelImageUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeServiceHotelImage/CrudeServiceHotelImageUpdate/", content).Result;
        ...
        public string CrudeServiceHotelImageDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeServiceHotelImage/CrudeServiceHotelImageDelete/00000000-0000-0000-0000-000000000001" ).Result;
