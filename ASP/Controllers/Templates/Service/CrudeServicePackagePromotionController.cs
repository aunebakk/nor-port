...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServicePackagePromotionController : Controller {
        ...
        // parameters:
        //  servicepackagepromotionid: filter by primary key
        ...
        // parameters:
        //  servicepackageid: filter by this foreign this key, use the following for no filter: '00000000-0000-0000-0000-000000000000'
        ...
        // create ServicePackagePromotion POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeServicePackagePromotionModel: contract to add
        ...
        public string CrudeServicePackagePromotionCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:51:15 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServicePackagePromotion/CrudeServicePackagePromotionCreate/", content).Result;
        ...
        // Update ServicePackagePromotion POST page for controller
        // links:
        ...
        public string CrudeServicePackagePromotionUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServicePackagePromotion/CrudeServicePackagePromotionUpdate/", content).Result;
        ...
        public string CrudeServicePackagePromotionDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServicePackagePromotion/CrudeServicePackagePromotionDelete/00000000-0000-0000-0000-000000000001" ).Result;
