...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceSpecialServiceRequestOperationRuleRefController : Controller {
        ...
        // create ServiceSpecialServiceRequestOperationRuleRef POST page for controller
        // links:
        ...
        public string CrudeServiceSpecialServiceRequestOperationRuleRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/29/2020 2:51:16 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequestOperationRuleRef/CrudeServiceSpecialServiceRequestOperationRuleRefCreate/", content).Result;
        ...
        // Update ServiceSpecialServiceRequestOperationRuleRef POST page for controller
        // links:
        ...
        public string CrudeServiceSpecialServiceRequestOperationRuleRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequestOperationRuleRef/CrudeServiceSpecialServiceRequestOperationRuleRefUpdate/", content).Result;
        ...
        public string CrudeServiceSpecialServiceRequestOperationRuleRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://.azurewebsites.net//api/1/CrudeServiceSpecialServiceRequestOperationRuleRef/CrudeServiceSpecialServiceRequestOperationRuleRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
