...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceFerryController : Controller {
        ...
        // parameters:
        //  serviceferryid: filter by primary key
        ...
        // create ServiceFerry POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeServiceFerryModel: contract to add
        ...
        public string CrudeServiceFerryCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/30/2020 1:39:01 PM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceFerry/CrudeServiceFerryCreate/", content).Result;
        ...
        // Update ServiceFerry POST page for controller
        // links:
        ...
        public string CrudeServiceFerryUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceFerry/CrudeServiceFerryUpdate/", content).Result;
        ...
        public string CrudeServiceFerryDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceFerry/CrudeServiceFerryDelete/00000000-0000-0000-0000-000000000001" ).Result;
