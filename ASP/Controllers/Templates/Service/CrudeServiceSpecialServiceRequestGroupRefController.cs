...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Controllers {
    ...
    public class CrudeServiceSpecialServiceRequestGroupRefController : Controller {
        ...
        // parameters:
        //  servicespecialservicerequestgrouprcd: filter by primary key
        ...
        // create ServiceSpecialServiceRequestGroupRef POST page for controller
        // links:
        //  docLink: http://sql2x.org/documentationLink/fa6b4ff5-5a11-4563-b6de-449d1bb6a5e7
        // parameters:
        //  CrudeServiceSpecialServiceRequestGroupRefModel: contract to add
        ...
        public string CrudeServiceSpecialServiceRequestGroupRefCreateTest() {
            ...
            try {
                ...
                pairs.Add ( new KeyValuePair<string , string> ( "DateTime" , "12/31/2020 10:51:33 AM" ) );
                var content = new FormUrlEncodedContent ( pairs );

                // POST model to myself
                var client = new HttpClient ();
                var response = client.PostAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceSpecialServiceRequestGroupRef/CrudeServiceSpecialServiceRequestGroupRefCreate/", content).Result;
        ...
        // Update ServiceSpecialServiceRequestGroupRef POST page for controller
        // links:
        ...
        public string CrudeServiceSpecialServiceRequestGroupRefUpdateTest() {
            ...
            try {
                ...
                // PUT model to myself
                var client = new HttpClient ();
                var response = client.PutAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceSpecialServiceRequestGroupRef/CrudeServiceSpecialServiceRequestGroupRefUpdate/", content).Result;
        ...
        public string CrudeServiceSpecialServiceRequestGroupRefDeleteTest() {
            ...
            try {
                var client = new HttpClient ();
                var response = client.DeleteAsync("http://NorSolutionPort.AzureWebSites.net/api/1/CrudeServiceSpecialServiceRequestGroupRef/CrudeServiceSpecialServiceRequestGroupRefDelete/00000000-0000-0000-0000-000000000001" ).Result;
