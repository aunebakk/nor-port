    ...
    public partial class DatabaseManager {
        void InitSystemReferenceErrorAndIssue(
            ...
            scripts.Add(lastScript = new DatabaseScript {
                ...
                Description = "Default Issue Drop",
            ...
            scripts.Add(lastScript = new DatabaseScript {
                ...
                Description = "Default Issue Create",
                #region script ( default_issue, default_error, default_error_layer_ref, default_error_type_ref, default_issue_type_ref, default_issue_status_ref )
                DatabaseScriptBatch = new DatabaseScriptBatch {
                    Script = @"
            ...
            scripts.Add(lastScript = new DatabaseScript {
                ...
                Description = "Default Issue Test Data",
                ...
                DatabaseScriptBatch = new DatabaseScriptBatch {
                    Script = @"
                        insert into default_system_setting_ref (default_system_setting_rcd, default_system_setting_name, default_user_id, date_time) 
	                        values ('dcs', 'Dark color scheme', '{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}', getutcdate());
                            ",
                    BreakUpToBatches = true
                }
                #endregion
            ...
            scripts.Add(lastScript = new DatabaseScript {
                ...
                DatabaseScriptBatch = new DatabaseScriptBatch {
                    Script = @"
                            ...
                            go
                            insert into default_test_run_result_ref (default_test_run_result_rcd, default_test_run_result_name, user_id, date_time) 
	                            values ('OK', 'OK', '{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}', getutcdate());
                            insert into default_test_run_result_ref (default_test_run_result_rcd, default_test_run_result_name, user_id, date_time) 
	                            values ('EX', 'Exception', '{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}', getutcdate());
                            insert into default_test_run_result_ref (default_test_run_result_rcd, default_test_run_result_name, user_id, date_time) 
	                            values ('WEBEX', 'Web Exception', '{FFFFFFFF-5555-5555-5555-FFFFFFFFFFFF}', getutcdate());
                            go
