...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial class CrudeBookingPassengerEventTypeRefBusiness {
        ...
        public CrudeBookingPassengerEventTypeRefModel FetchByBookingPassengerEventTypeRcd(string bookingPassengerEventTypeRcd) {
        ...
        // parameters:
        //  UserId: key of table booking_passenger_event_type_ref
        public List<CrudeBookingPassengerEventTypeRefModel> FetchByUserId(System.Guid userId) {
            return DataListToModelList(CrudeBookingPassengerEventTypeRefData.FetchByUserId(userId));
        }
        ...
        // parameters:
        //  CrudeBookingPassengerEventTypeRefData: object instance of BookingPassengerEventTypeRef
        public static List<CrudeBookingPassengerEventTypeRefModel> DataListToModelList(List<CrudeBookingPassengerEventTypeRefData> dataList) {
            var modelList = new List<CrudeBookingPassengerEventTypeRefModel>();
        ...
        // copy all rows from a List of data objects in CrudeBookingPassengerEventTypeRefData to a List of REST Contracts
        // links:
        ...
        public List<CrudeBookingPassengerEventTypeRefModel> FetchAllWithLimit(string limit) {
            var list = new List<CrudeBookingPassengerEventTypeRefModel>();
            List<CrudeBookingPassengerEventTypeRefData> dataList = CrudeBookingPassengerEventTypeRefData.FetchAllWithLimit(int.Parse(limit));
        ...
        public List<CrudeBookingPassengerEventTypeRefModel> FetchWithFilter(string bookingPassengerEventTypeRcd, string bookingPassengerEventTypeName, System.Guid userId, System.DateTime dateTime) {
            ...
            foreach (CrudeBookingPassengerEventTypeRefData data in dataList) {
                ...
                list.Add(crudeBookingPassengerEventTypeRefBusinessModel);
            }
        ...
        public void Insert(CrudeBookingPassengerEventTypeRefModel model) {
            var data = new CrudeBookingPassengerEventTypeRefData();
            ModelToData(model, data);
            data.Insert();
        }
        ...
        public void Insert(CrudeBookingPassengerEventTypeRefModel model, SqlConnection connection, SqlTransaction transaction) {
            var data = new CrudeBookingPassengerEventTypeRefData();
            ModelToData(model, data);
