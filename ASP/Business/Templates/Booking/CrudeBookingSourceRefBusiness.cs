...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial class CrudeBookingSourceRefBusiness {
        ...
        public CrudeBookingSourceRefModel FetchByBookingSourceRcd(string bookingSourceRcd) {
        ...
        // parameters:
        //  UserId: key of table booking_source_ref
        public List<CrudeBookingSourceRefModel> FetchByUserId(System.Guid userId) {
            return DataListToModelList(CrudeBookingSourceRefData.FetchByUserId(userId));
        }
        ...
        // parameters:
        //  CrudeBookingSourceRefData: object instance of BookingSourceRef
        ...
        // parameters:
        //  CrudeBookingSourceRefData: object instance of BookingSourceRef
        public static void ModelListToDataList(List<CrudeBookingSourceRefModel> modelList, List<CrudeBookingSourceRefData> dataList) {
            foreach (CrudeBookingSourceRefModel model in modelList) {
        ...
        // copy all rows from a List of data objects in CrudeBookingSourceRefData to a List of REST Contracts
        // links:
        ...
        public List<CrudeBookingSourceRefModel> FetchAllWithLimit(string limit) {
            var list = new List<CrudeBookingSourceRefModel>();
            List<CrudeBookingSourceRefData> dataList = CrudeBookingSourceRefData.FetchAllWithLimit(int.Parse(limit));
        ...
        public void Insert(CrudeBookingSourceRefModel model, SqlConnection connection, SqlTransaction transaction) {
            var data = new CrudeBookingSourceRefData();
            ModelToData(model, data);
