...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Models {
    ...
    public partial class CrudeBookingDocumentModel {
        
        [Display(Name="Booking Document Id")]
        [Required()]
        ...
        [Display(Name="Booking Document Type")]
        [Required()]
        public string BookingDocumentTypeRcd { get; set; }
        
        [Display(Name="Booking Document Name")]
        [Required()]
        public string BookingDocumentName { get; set; }
        
        [Display(Name="Booking Document Filename")]
        [Required()]
