...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Models {
    ...
    public partial class CrudeBookingPassengerEventModel {
        
        [Display(Name="Booking Passenger Event Id")]
        [Required()]
        public System.Guid BookingPassengerEventId { get; set; }
        
        [Display(Name="Booking Passenger Event Type")]
        [Required()]
        public string BookingPassengerEventTypeRcd { get; set; }
        
        [Display(Name="Booking Passenger Event Number")]
        [Required()]
        ...
        [Display(Name="Booking Passenger Ticket Id")]
        [Required()]
        public System.Guid BookingPassengerTicketId { get; set; }
        
        [Display(Name="Booking Passenger Seat Id")]
        [Required()]
        public System.Guid BookingPassengerSeatId { get; set; }
        
        [Display(Name="Booking Passenger Baggage Id")]
        [Required()]
