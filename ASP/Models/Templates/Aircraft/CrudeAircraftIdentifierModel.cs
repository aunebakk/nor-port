...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Models {
    ...
    public partial class CrudeAircraftIdentifierModel {
        
        [Display(Name="Aircraft Identifier Id")]
        [Required()]
        ...
        [Display(Name="Aircraft Identifier Type")]
        [Required()]
        public string AircraftIdentifierTypeRcd { get; set; }
        
        [Display(Name="Aircraft Identifier Code")]
        [Required()]
