...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Models {
    ...
    public partial class CrudeFlightIdentifierModel {
        
        [Display(Name="Flight Identifier Id")]
        [Required()]
        ...
        [Display(Name="Flight Identifier Code")]
        [Required()]
        public string FlightIdentifierCode { get; set; }
        
        [Display(Name="Flight Identifier Type")]
        [Required()]
