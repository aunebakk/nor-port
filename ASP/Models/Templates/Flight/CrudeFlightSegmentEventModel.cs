...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Models {
    ...
    public partial class CrudeFlightSegmentEventModel {
        
        [Display(Name="Flight Segment Event Id")]
        [Required()]
        ...
        [Display(Name="Flight Segment Event Number")]
        [Required()]
        public int FlightSegmentEventNumber { get; set; }
        
        [Display(Name="Date Time Type")]
        [Required()]
