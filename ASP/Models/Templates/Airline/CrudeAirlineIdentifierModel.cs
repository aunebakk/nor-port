...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Models {
    ...
    public partial class CrudeAirlineIdentifierModel {
        
        [Display(Name="Airline Identifier Id")]
        [Required()]
        ...
        [Display(Name="Airline Identifier Type")]
        [Required()]
        public string AirlineIdentifierTypeRcd { get; set; }
        
        [Display(Name="Airline Identifier Code")]
        [Required()]
