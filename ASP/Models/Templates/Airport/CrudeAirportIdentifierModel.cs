...
namespace SolutionNorSolutionPort.BusinessLogicLayer.Models {
    ...
    public partial class CrudeAirportIdentifierModel {
        
        [Display(Name="Airport Identifier Id")]
        [Required()]
        ...
        [Display(Name="Airport Identifier Type")]
        [Required()]
        public string AirportIdentifierTypeRcd { get; set; }
        
        [Display(Name="Airport Identifier Code")]
        [Required()]
