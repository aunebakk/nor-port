...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeLinkTypeRefEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeLinkTypeRefContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(string linkTypeRcd, string linkTypeName, System.Guid userId) {
            try {
                _contract = new CrudeLinkTypeRefContract();
                _isNew = true;
                _contract.LinkTypeRcd = linkTypeRcd;
                textBoxLinkType.Text = _contract.LinkTypeRcd;
                _contract.LinkTypeName = linkTypeName;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeLinkTypeRefServiceClient();
            try {
                _contract.LinkTypeRcd = textBoxLinkType.Text;
                _contract.LinkTypeName = textBoxLinkTypeName.Text;
