...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class AirlineIdentifierTypeRefCombo : UserControl {
        ...
        public AirlineIdentifierTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeAirlineIdentifierTypeRefServiceClient airlineIdentifierTypeRef = null;

                try {
                    airlineIdentifierTypeRef = new CrudeAirlineIdentifierTypeRefServiceClient();
                    List<CrudeAirlineIdentifierTypeRefContract> contracts = airlineIdentifierTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "AirlineIdentifierTypeName";
                    cboRef.ValueMember = "AirlineIdentifierTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (airlineIdentifierTypeRef != null) airlineIdentifierTypeRef.Close();
                }
            }
        }
    }
