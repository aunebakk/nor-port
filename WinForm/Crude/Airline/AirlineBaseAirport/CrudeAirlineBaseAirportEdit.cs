...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAirlineBaseAirportEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeAirlineBaseAirportContract _contract;
        ...
        public CrudeAirlineBaseAirportEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeAirlineBaseAirportContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(System.Guid airlineId, System.Guid airportId, System.Guid userId) {
            try {
                _contract = new CrudeAirlineBaseAirportContract();
                _isNew = true;
                _contract.AirlineId = airlineId;
        ...
        public void ShowAsEdit(System.Guid airlineBaseAirportId) {
            var service = new CrudeAirlineBaseAirportServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByAirlineBaseAirportId(airlineBaseAirportId);
                airlinePicker.SelectedValue = _contract.AirlineId;
                airportPicker.SelectedValue = _contract.AirportId;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
