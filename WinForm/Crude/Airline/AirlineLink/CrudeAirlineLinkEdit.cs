...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAirlineLinkEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeAirlineLinkContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(System.Guid airlineId, string linkTypeRcd, string linkName, string link, System.Guid userId) {
            try {
                _contract = new CrudeAirlineLinkContract();
                _isNew = true;
                _contract.AirlineId = airlineId;
        ...
        public void ShowAsEdit(System.Guid airlineLinkId) {
            var service = new CrudeAirlineLinkServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByAirlineLinkId(airlineLinkId);
                airlinePicker.SelectedValue = _contract.AirlineId;
                linkTypeRefCombo.Text = _contract.LinkTypeRcd != null ? _contract.LinkTypeRcd : String.Empty;
                textBoxLinkName.Text = _contract.LinkName;
                textBoxLink.Text = _contract.Link;
