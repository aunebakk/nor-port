...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class ReportingRoundupTypeRefCombo : UserControl {
        ...
        public ReportingRoundupTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeReportingRoundupTypeRefServiceClient reportingRoundupTypeRef = null;

                try {
                    reportingRoundupTypeRef = new CrudeReportingRoundupTypeRefServiceClient();
                    List<CrudeReportingRoundupTypeRefContract> contracts = reportingRoundupTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "ReportingRoundupTypeName";
                    cboRef.ValueMember = "ReportingRoundupTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (reportingRoundupTypeRef != null) reportingRoundupTypeRef.Close();
                }
            }
        }
    }
