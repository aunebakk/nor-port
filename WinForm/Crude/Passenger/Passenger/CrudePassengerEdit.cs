...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudePassengerEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudePassengerContract();
                _isNew = true;
                this.Text += " - Not Savable (BindingPassenger Missing)";
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
                    { }
        ...
        public void ShowAsAddByRules(string defaultStateRcd, System.Guid userId) {
            try {
                _contract = new CrudePassengerContract();
                _isNew = true;
        ...
        public void ShowAsAddByPassengerAndUser(System.Guid userId) {
            try {
                _contract = new CrudePassengerContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
        ...
        public void ShowAsAdd(System.Guid becamePassengerId, System.Guid bindingPassengerId, string passengerTypeRcd, string passengerName, string defaultStateRcd, System.Guid userId) {
            try {
                _contract = new CrudePassengerContract();
                _isNew = true;
                _contract.BecamePassengerId = becamePassengerId;
                _contract.BindingPassengerId = bindingPassengerId;
                _contract.PassengerTypeRcd = passengerTypeRcd;
                passengerTypeRefCombo.Text = _contract.PassengerTypeRcd != null ? _contract.PassengerTypeRcd : String.Empty;
                _contract.PassengerName = passengerName;
        ...
        public void ShowAsEdit(System.Guid passengerId) {
            var service = new CrudePassengerServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByPassengerId(passengerId);
                passengerTypeRefCombo.Text = _contract.PassengerTypeRcd != null ? _contract.PassengerTypeRcd : String.Empty;
                textBoxPassengerName.Text = _contract.PassengerName;
