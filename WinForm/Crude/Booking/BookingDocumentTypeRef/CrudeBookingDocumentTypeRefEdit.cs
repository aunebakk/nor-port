...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeBookingDocumentTypeRefEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeBookingDocumentTypeRefContract _contract;
        ...
        public CrudeBookingDocumentTypeRefEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeBookingDocumentTypeRefContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(string bookingDocumentTypeRcd, string bookingDocumentTypeName, System.Guid userId) {
            try {
                _contract = new CrudeBookingDocumentTypeRefContract();
                _isNew = true;
                _contract.BookingDocumentTypeRcd = bookingDocumentTypeRcd;
                textBoxBookingDocumentType.Text = _contract.BookingDocumentTypeRcd;
                _contract.BookingDocumentTypeName = bookingDocumentTypeName;
