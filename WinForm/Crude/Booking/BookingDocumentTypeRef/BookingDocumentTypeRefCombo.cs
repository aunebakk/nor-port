...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class BookingDocumentTypeRefCombo : UserControl {
        ...
        public BookingDocumentTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                ...
                try {
                    ...
                    if (bookingDocumentTypeRef != null) bookingDocumentTypeRef.Close();
                }
            }
        }
    }
