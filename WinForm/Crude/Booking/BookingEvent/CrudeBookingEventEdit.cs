...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeBookingEventEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeBookingEventContract();
                _isNew = true;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/f21e72c1-2d57-44c1-a9c1-1b80bad6a391
        public void ShowAsAddByBookingEventType(string bookingEventTypeRcd) {
            try {
                _contract = new CrudeBookingEventContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
                ...
                bookingEventTypeRefCombo.Text = _contract.BookingEventTypeRcd != null ? _contract.BookingEventTypeRcd : String.Empty;
        ...
        public void ShowAsAdd(System.Guid bookingId, string bookingEventTypeRcd, string comment, System.Guid userId) {
            try {
                _contract = new CrudeBookingEventContract();
                _isNew = true;
                _contract.BookingId = bookingId;
        ...
        public void ShowAsEdit(System.Guid bookingEventId) {
            var service = new CrudeBookingEventServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByBookingEventId(bookingEventId);
                bookingEventTypeRefCombo.Text = _contract.BookingEventTypeRcd != null ? _contract.BookingEventTypeRcd : String.Empty;
                textBoxComment.Text = _contract.Comment;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeBookingEventServiceClient();
            try {
                _contract.BookingEventTypeRcd = bookingEventTypeRefCombo.Text;
