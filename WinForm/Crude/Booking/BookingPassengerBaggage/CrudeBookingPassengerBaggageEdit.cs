...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeBookingPassengerBaggageEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeBookingPassengerBaggageContract _contract;
        ...
        public CrudeBookingPassengerBaggageEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeBookingPassengerBaggageContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(int itemCount, decimal weight, System.Guid userId, string remarks) {
            try {
                _contract = new CrudeBookingPassengerBaggageContract();
                _isNew = true;
                _contract.ItemCount = itemCount;
                maskedTextBoxItemCount.Text = _contract.ItemCount.ToString();
        ...
        public void ShowAsEdit(System.Guid bookingPassengerBaggageId) {
            var service = new CrudeBookingPassengerBaggageServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByBookingPassengerBaggageId(bookingPassengerBaggageId);
                maskedTextBoxItemCount.Text = _contract.ItemCount.ToString();
                maskedTextBoxWeight.Text = _contract.Weight.ToString();
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeBookingPassengerBaggageServiceClient();
            try {
                _contract.ItemCount = maskedTextBoxItemCount.Text == String.Empty ? 0 : Convert.ToInt32(maskedTextBoxItemCount.Text);
