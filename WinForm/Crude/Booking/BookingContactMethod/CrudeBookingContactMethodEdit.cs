...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeBookingContactMethodEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeBookingContactMethodContract _contract;
        ...
        public CrudeBookingContactMethodEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeBookingContactMethodContract();
                _isNew = true;
        ...
        public void ShowAsAdd(System.Guid bookingId, string contactMethodRcd, string contactMethodWay, string comment, System.Guid userId) {
            try {
                _contract = new CrudeBookingContactMethodContract();
                _isNew = true;
                _contract.BookingId = bookingId;
