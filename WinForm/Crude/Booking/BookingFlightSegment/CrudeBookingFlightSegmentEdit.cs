...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeBookingFlightSegmentEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeBookingFlightSegmentContract _contract;
        ...
        public CrudeBookingFlightSegmentEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeBookingFlightSegmentContract();
                _isNew = true;
                this.Text += " - Not Savable (BindingBookingFlightSegment,Booking,FlightSegment Missing)";
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
                    { }
        ...
        public void ShowAsAdd(System.Guid becameBookingFlightSegmentId, System.Guid bindingBookingFlightSegmentId, System.Guid bookingId, System.Guid flightSegmentId, string defaultStateRcd, System.Guid userId) {
            try {
                _contract = new CrudeBookingFlightSegmentContract();
                _isNew = true;
                _contract.BecameBookingFlightSegmentId = becameBookingFlightSegmentId;
                _contract.BindingBookingFlightSegmentId = bindingBookingFlightSegmentId;
                _contract.BookingId = bookingId;
                _contract.FlightSegmentId = flightSegmentId;
                _contract.DefaultStateRcd = defaultStateRcd;
                _contract.UserId = userId;
