...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeBookingPassengerEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeBookingPassengerContract _contract;
        ...
        public CrudeBookingPassengerEdit() {
            InitializeComponent();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/f21e72c1-2d57-44c1-a9c1-1b80bad6a391
        public void ShowAsAddByPassenger(System.Guid passengerId) {
            try {
                _contract = new CrudeBookingPassengerContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeBookingPassengerServiceClient();
            try {
                _contract.PassengerId = (Guid)passengerPicker.SelectedValue;
