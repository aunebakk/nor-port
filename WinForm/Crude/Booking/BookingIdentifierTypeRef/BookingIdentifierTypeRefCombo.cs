...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class BookingIdentifierTypeRefCombo : UserControl {
        ...
        public BookingIdentifierTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeBookingIdentifierTypeRefServiceClient bookingIdentifierTypeRef = null;

                try {
                    bookingIdentifierTypeRef = new CrudeBookingIdentifierTypeRefServiceClient();
                    List<CrudeBookingIdentifierTypeRefContract> contracts = bookingIdentifierTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "BookingIdentifierTypeName";
                    cboRef.ValueMember = "BookingIdentifierTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (bookingIdentifierTypeRef != null) bookingIdentifierTypeRef.Close();
                }
            }
        }
    }
