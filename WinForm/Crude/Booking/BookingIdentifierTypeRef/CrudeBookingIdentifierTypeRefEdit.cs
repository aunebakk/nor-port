...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeBookingIdentifierTypeRefEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeBookingIdentifierTypeRefContract _contract;
        ...
        public CrudeBookingIdentifierTypeRefEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeBookingIdentifierTypeRefContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(string bookingIdentifierTypeRcd, string bookingIdentifierTypeName, System.Guid userId) {
            try {
                _contract = new CrudeBookingIdentifierTypeRefContract();
                _isNew = true;
                ...
                _contract.BookingIdentifierTypeName = bookingIdentifierTypeName;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeBookingIdentifierTypeRefServiceClient();
            try {
                _contract.BookingIdentifierTypeRcd = textBoxBookingIdentifierType.Text;
                _contract.BookingIdentifierTypeName = textBoxBookingIdentifierTypeName.Text;
