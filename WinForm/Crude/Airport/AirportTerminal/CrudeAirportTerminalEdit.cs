...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAirportTerminalEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeAirportTerminalContract _contract;
        ...
        public CrudeAirportTerminalEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeAirportTerminalContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(System.Guid airportId, string airportTerminalName, System.Guid userId) {
            try {
                _contract = new CrudeAirportTerminalContract();
                _isNew = true;
                _contract.AirportId = airportId;
                airportPicker.SelectedValue = _contract.AirportId;
                _contract.AirportTerminalName = airportTerminalName;
                textBoxAirportTerminalName.Text = _contract.AirportTerminalName;
                _contract.UserId = userId;
        ...
        public void ShowAsEdit(System.Guid airportTerminalId) {
            var service = new CrudeAirportTerminalServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByAirportTerminalId(airportTerminalId);
                airportPicker.SelectedValue = _contract.AirportId;
                textBoxAirportTerminalName.Text = _contract.AirportTerminalName;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                _contract.AirportTerminalName = textBoxAirportTerminalName.Text;
