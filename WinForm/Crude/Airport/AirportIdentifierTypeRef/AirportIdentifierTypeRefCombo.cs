...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class AirportIdentifierTypeRefCombo : UserControl {
        ...
        public AirportIdentifierTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeAirportIdentifierTypeRefServiceClient airportIdentifierTypeRef = null;

                try {
                    airportIdentifierTypeRef = new CrudeAirportIdentifierTypeRefServiceClient();
                    List<CrudeAirportIdentifierTypeRefContract> contracts = airportIdentifierTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "AirportIdentifierTypeName";
                    cboRef.ValueMember = "AirportIdentifierTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (airportIdentifierTypeRef != null) airportIdentifierTypeRef.Close();
                }
            }
        }
    }
