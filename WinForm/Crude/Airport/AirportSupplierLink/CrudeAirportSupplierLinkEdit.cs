...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAirportSupplierLinkEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeAirportSupplierLinkContract _contract;
        ...
        public CrudeAirportSupplierLinkEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeAirportSupplierLinkContract();
                _isNew = true;
                this.Text += " - Not Savable (AirportSupplier Missing)";
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
                    { }
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/f21e72c1-2d57-44c1-a9c1-1b80bad6a391
        public void ShowAsAddByAirportSupplier(System.Guid airportSupplierId) {
            try {
                _contract = new CrudeAirportSupplierLinkContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
                dateTimePickerDateTime.Text = _contract.DateTime.ToString();
                _contract.AirportSupplierId = airportSupplierId;
        ...
        public void ShowAsAdd(System.Guid airportId, System.Guid airportSupplierId, System.Guid userId) {
            try {
                _contract = new CrudeAirportSupplierLinkContract();
                _isNew = true;
                _contract.AirportId = airportId;
