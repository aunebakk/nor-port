...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAirportHotelLinkEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeAirportHotelLinkContract _contract;
        ...
        public CrudeAirportHotelLinkEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeAirportHotelLinkContract();
                _isNew = true;
        ...
        public void ShowAsAdd(System.Guid airportId, System.Guid serviceHotelId, System.Guid userId) {
            try {
                _contract = new CrudeAirportHotelLinkContract();
                _isNew = true;
                _contract.AirportId = airportId;
        ...
        public void ShowAsEdit(System.Guid airportHotelLinkId) {
            var service = new CrudeAirportHotelLinkServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByAirportHotelLinkId(airportHotelLinkId);
                airportPicker.SelectedValue = _contract.AirportId;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
                dateTimePickerDateTime.Text = _contract.DateTime.ToString();
