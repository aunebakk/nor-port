...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAirportTerminalAirlineEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeAirportTerminalAirlineContract _contract;
        ...
        public CrudeAirportTerminalAirlineEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeAirportTerminalAirlineContract();
                _isNew = true;
                this.Text += " - Not Savable (AirportTerminal Missing)";
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
                    { }
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/f21e72c1-2d57-44c1-a9c1-1b80bad6a391
        public void ShowAsAddByAirportTerminal(System.Guid airportTerminalId) {
            try {
                _contract = new CrudeAirportTerminalAirlineContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
                dateTimePickerDateTime.Text = _contract.DateTime.ToString();
                _contract.AirportTerminalId = airportTerminalId;
        ...
        public void ShowAsAdd(System.Guid airportTerminalId, System.Guid airlineId, System.Guid userId) {
            try {
                _contract = new CrudeAirportTerminalAirlineContract();
                _isNew = true;
                _contract.AirportTerminalId = airportTerminalId;
        ...
        public void ShowAsEdit(System.Guid airportTerminalAirlineId) {
            var service = new CrudeAirportTerminalAirlineServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByAirportTerminalAirlineId(airportTerminalAirlineId);
                airlinePicker.SelectedValue = _contract.AirlineId;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
                dateTimePickerDateTime.Text = _contract.DateTime.ToString();
