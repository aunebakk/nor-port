...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAirportSupplierEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeAirportSupplierContract _contract;
        ...
        public CrudeAirportSupplierEdit() {
            InitializeComponent();
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeAirportSupplierServiceClient();
            try {
                _contract.AiportSupplierName = textBoxAiportSupplierName.Text;
                _contract.AirportSupplierCode = textBoxAirportSupplierCode.Text;
