...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class AirportFacilityTypeRefCombo : UserControl {
        ...
        public AirportFacilityTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeAirportFacilityTypeRefServiceClient airportFacilityTypeRef = null;

                try {
                    airportFacilityTypeRef = new CrudeAirportFacilityTypeRefServiceClient();
                    List<CrudeAirportFacilityTypeRefContract> contracts = airportFacilityTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "AirportFacilityTypeName";
                    cboRef.ValueMember = "AirportFacilityTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (airportFacilityTypeRef != null) airportFacilityTypeRef.Close();
                }
            }
        }
    }
