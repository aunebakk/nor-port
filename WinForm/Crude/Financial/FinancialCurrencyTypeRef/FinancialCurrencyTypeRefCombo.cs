...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class FinancialCurrencyTypeRefCombo : UserControl {
        ...
        public FinancialCurrencyTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                ...
                try {
                    ...
                    if (financialCurrencyTypeRef != null) financialCurrencyTypeRef.Close();
                }
            }
        }
    }
