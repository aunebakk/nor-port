...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialPaymentAccountingEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFinancialPaymentAccountingContract _contract;
        ...
        public CrudeFinancialPaymentAccountingEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeFinancialPaymentAccountingContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(decimal amount, System.Guid financialCurrencyId, System.Guid userId) {
            try {
                _contract = new CrudeFinancialPaymentAccountingContract();
                _isNew = true;
        ...
        public void ShowAsEdit(System.Guid financialPaymentAccountingId) {
            var service = new CrudeFinancialPaymentAccountingServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByFinancialPaymentAccountingId(financialPaymentAccountingId);
                maskedTextBoxAmount.Text = _contract.Amount.ToString();
                financialCurrencyPicker.SelectedValue = _contract.FinancialCurrencyId;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
