...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialFerryBookingEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFinancialFerryBookingContract _contract;
        ...
        public CrudeFinancialFerryBookingEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeFinancialFerryBookingContract();
                _isNew = true;
                this.Text += " - Not Savable (ServiceFerry Missing)";
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
                    { }
        ...
        public void ShowAsAdd(System.Guid serviceFerryId, System.DateTime fromDateTime, System.DateTime untilDateTime, decimal amount, System.Guid financialCurrencyId, System.Guid userId) {
            try {
                _contract = new CrudeFinancialFerryBookingContract();
                _isNew = true;
                _contract.ServiceFerryId = serviceFerryId;
        ...
        public void ShowAsEdit(System.Guid financialFerryBookingId) {
            var service = new CrudeFinancialFerryBookingServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByFinancialFerryBookingId(financialFerryBookingId);
                dateTimePickerFromDateTime.Value = _contract.FromDateTime != DateTime.MinValue ? _contract.FromDateTime : dateTimePickerFromDateTime.MinDate;
                dateTimePickerFromDateTime.Checked = _contract.FromDateTime != DateTime.MinValue;
                dateTimePickerUntilDateTime.Value = _contract.UntilDateTime != DateTime.MinValue ? _contract.UntilDateTime : dateTimePickerUntilDateTime.MinDate;
                dateTimePickerUntilDateTime.Checked = _contract.UntilDateTime != DateTime.MinValue;
