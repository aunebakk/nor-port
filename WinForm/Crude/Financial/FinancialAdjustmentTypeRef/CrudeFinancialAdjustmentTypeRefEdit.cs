...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialAdjustmentTypeRefEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFinancialAdjustmentTypeRefContract _contract;
        ...
        public CrudeFinancialAdjustmentTypeRefEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd(string financialAdjustmentTypeRcd, string financialAdjustmentTypeName, System.Guid userId) {
            try {
                _contract = new CrudeFinancialAdjustmentTypeRefContract();
                _isNew = true;
                ...
                _contract.FinancialAdjustmentTypeName = financialAdjustmentTypeName;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeFinancialAdjustmentTypeRefServiceClient();
            try {
                _contract.FinancialAdjustmentTypeRcd = textBoxFinancialAdjustmentType.Text;
                _contract.FinancialAdjustmentTypeName = textBoxFinancialAdjustmentTypeName.Text;
