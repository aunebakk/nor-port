...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class FinancialAdjustmentTypeRefCombo : UserControl {
        ...
        public FinancialAdjustmentTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeFinancialAdjustmentTypeRefServiceClient financialAdjustmentTypeRef = null;

                try {
                    financialAdjustmentTypeRef = new CrudeFinancialAdjustmentTypeRefServiceClient();
                    List<CrudeFinancialAdjustmentTypeRefContract> contracts = financialAdjustmentTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "FinancialAdjustmentTypeName";
                    cboRef.ValueMember = "FinancialAdjustmentTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (financialAdjustmentTypeRef != null) financialAdjustmentTypeRef.Close();
                }
            }
        }
    }
