...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialServiceEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFinancialServiceContract _contract;
        ...
        public CrudeFinancialServiceEdit() {
            InitializeComponent();
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/f21e72c1-2d57-44c1-a9c1-1b80bad6a391
        public void ShowAsAddByFinancialSpecialService(System.Guid financialSpecialServiceId) {
            try {
                _contract = new CrudeFinancialServiceContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/f21e72c1-2d57-44c1-a9c1-1b80bad6a391
        public void ShowAsAddByFinancialHotelBooking(System.Guid financialHotelBookingId) {
            try {
                _contract = new CrudeFinancialServiceContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/f21e72c1-2d57-44c1-a9c1-1b80bad6a391
        public void ShowAsAddByFinancialCarRental(System.Guid financialCarRentalId) {
            try {
                _contract = new CrudeFinancialServiceContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/f21e72c1-2d57-44c1-a9c1-1b80bad6a391
        public void ShowAsAddByBookingServiceRequest(System.Guid bookingServiceRequestId) {
            try {
                _contract = new CrudeFinancialServiceContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
