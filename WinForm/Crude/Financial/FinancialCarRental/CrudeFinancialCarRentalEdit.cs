...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialCarRentalEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFinancialCarRentalContract _contract;
        ...
        public CrudeFinancialCarRentalEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeFinancialCarRentalContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(System.Guid serviceCarRentalId, System.DateTime fromDateTime, System.DateTime untilDateTime, decimal amount, System.Guid financialCurrencyId, System.Guid userId) {
            try {
                _contract = new CrudeFinancialCarRentalContract();
                _isNew = true;
                _contract.ServiceCarRentalId = serviceCarRentalId;
        ...
        public void ShowAsEdit(System.Guid financialCarRentalId) {
            var service = new CrudeFinancialCarRentalServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByFinancialCarRentalId(financialCarRentalId);
                serviceCarRentalPicker.SelectedValue = _contract.ServiceCarRentalId;
                dateTimePickerFromDateTime.Value = _contract.FromDateTime != DateTime.MinValue ? _contract.FromDateTime : dateTimePickerFromDateTime.MinDate;
                dateTimePickerFromDateTime.Checked = _contract.FromDateTime != DateTime.MinValue;
                dateTimePickerUntilDateTime.Value = _contract.UntilDateTime != DateTime.MinValue ? _contract.UntilDateTime : dateTimePickerUntilDateTime.MinDate;
