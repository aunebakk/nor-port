...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialSpecialServiceEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFinancialSpecialServiceContract _contract;
        ...
        public CrudeFinancialSpecialServiceEdit() {
            InitializeComponent();
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                _contract.Quantity = maskedTextBoxQuantity.Text == String.Empty ? 0 : Convert.ToInt32(maskedTextBoxQuantity.Text);
