...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialCurrencySearch : Form {
        ...
        private string _financialCurrencyTypeRcd;
        
        private string _financialCurrencyAgainstFinancialCurrencyTypeRcd;
        ...
        public void Show(string financialCurrencyTypeRcd, string financialCurrencyAgainstFinancialCurrencyTypeRcd, System.Guid userId) {
            try {
                _financialCurrencyTypeRcd = financialCurrencyTypeRcd;
                _financialCurrencyAgainstFinancialCurrencyTypeRcd = financialCurrencyAgainstFinancialCurrencyTypeRcd;
                _userId = userId;
        ...
        public void RefreshCrudeFinancialCurrency() {
            ...
            try {
                ...
                bindingSource.DataSource = financialCurrency.FetchWithFilter(
                             Guid.Empty
                            ,financialCurrencyTypeRefCombo.Text
                            ,textBoxFinancialCurrencyTypeCode.Text
                            ,textBoxFinancialCurrencyTypeName.Text
                            ,financialCurrencyAgainstFinancialCurrencyTypeRefCombo.Text
