    ...
    public partial class CrudeFinancialPaymentCouponEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                ...
                _isNew = true;
                this.Text += " - Not Savable (FinancialCoupon Missing)";
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
                    { }
        ...
        public void ShowAsAdd(decimal amount, System.Guid financialCurrencyId, System.Guid financialCouponId, System.Guid userId) {
            try {
                _contract = new CrudeFinancialPaymentCouponContract();
                _isNew = true;
