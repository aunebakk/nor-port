...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class FinancialBankAccountNumberTypeRefCombo : UserControl {
        ...
        public FinancialBankAccountNumberTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeFinancialBankAccountNumberTypeRefServiceClient financialBankAccountNumberTypeRef = null;

                try {
                    financialBankAccountNumberTypeRef = new CrudeFinancialBankAccountNumberTypeRefServiceClient();
                    List<CrudeFinancialBankAccountNumberTypeRefContract> contracts = financialBankAccountNumberTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "FinancialBankAccountNumberTypeName";
                    cboRef.ValueMember = "FinancialBankAccountNumberTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (financialBankAccountNumberTypeRef != null) financialBankAccountNumberTypeRef.Close();
                }
            }
        }
    }
