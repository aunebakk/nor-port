...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialFareEdit : Form {
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeFinancialFareServiceClient();
            try {
                _contract.FinancialFareTypeRcd = financialFareTypeRefCombo.Text;
                ...
                _contract.ValidFromFlightDateTime = dateTimePickerValidFromFlightDateTime.Checked ? Convert.ToDateTime(dateTimePickerValidFromFlightDateTime.Value): DateTime.MinValue;
                _contract.ValidUntilFlightDateTime = dateTimePickerValidUntilFlightDateTime.Checked ? Convert.ToDateTime(dateTimePickerValidUntilFlightDateTime.Value): DateTime.MinValue;
