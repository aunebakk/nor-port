...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFinancialPaymentCashEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFinancialPaymentCashContract _contract;
        ...
        public CrudeFinancialPaymentCashEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeFinancialPaymentCashContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsEdit(System.Guid financialPaymentCashId) {
            var service = new CrudeFinancialPaymentCashServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByFinancialPaymentCashId(financialPaymentCashId);
                maskedTextBoxAmount.Text = _contract.Amount.ToString();
                financialCurrencyPicker.SelectedValue = _contract.FinancialCurrencyId;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
