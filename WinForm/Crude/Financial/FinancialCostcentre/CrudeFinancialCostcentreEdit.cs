    ...
    public partial class CrudeFinancialCostcentreEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                ...
                _isNew = true;
                this.Text += " - Not Savable (FinancialCompany Missing)";
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
                    { }
        ...
        public void ShowAsAdd(string financialCostcentreCode, string financialCostcentreName, System.Guid financialCompanyId, System.Guid userId) {
            try {
                _contract = new CrudeFinancialCostcentreContract();
                _isNew = true;
