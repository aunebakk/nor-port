...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAircraftBodyRefEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeAircraftBodyRefContract _contract;
        ...
        public CrudeAircraftBodyRefEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeAircraftBodyRefContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(string aircraftBodyRcd, string aircraftBodyName, string description, bool activeFlag, int sortOrder, System.Guid userId) {
            try {
                _contract = new CrudeAircraftBodyRefContract();
                _isNew = true;
                _contract.AircraftBodyRcd = aircraftBodyRcd;
                textBoxAircraftBody.Text = _contract.AircraftBodyRcd;
                _contract.AircraftBodyName = aircraftBodyName;
