...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class AircraftIdentifierTypeRefCombo : UserControl {
        ...
        public AircraftIdentifierTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                ...
                try {
                    ...
                    if (aircraftIdentifierTypeRef != null) aircraftIdentifierTypeRef.Close();
                }
            }
        }
    }
