...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class AircraftDocumentTypeRefCombo : UserControl {
        ...
        public AircraftDocumentTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                ...
                try {
                    ...
                    if (aircraftDocumentTypeRef != null) aircraftDocumentTypeRef.Close();
                }
            }
        }
    }
