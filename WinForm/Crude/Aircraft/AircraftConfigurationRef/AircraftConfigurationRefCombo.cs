...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class AircraftConfigurationRefCombo : UserControl {
        ...
        public AircraftConfigurationRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeAircraftConfigurationRefServiceClient aircraftConfigurationRef = null;

                try {
                    aircraftConfigurationRef = new CrudeAircraftConfigurationRefServiceClient();
                    List<CrudeAircraftConfigurationRefContract> contracts = aircraftConfigurationRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "AircraftConfigurationName";
                    cboRef.ValueMember = "AircraftConfigurationRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (aircraftConfigurationRef != null) aircraftConfigurationRef.Close();
                }
            }
        }
    }
