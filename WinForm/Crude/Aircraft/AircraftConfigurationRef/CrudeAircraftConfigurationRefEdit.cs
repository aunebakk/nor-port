...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeAircraftConfigurationRefEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeAircraftConfigurationRefContract _contract;
        ...
        public CrudeAircraftConfigurationRefEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeAircraftConfigurationRefContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(string aircraftConfigurationRcd, string aircraftConfigurationName, string description, bool activeFlag, int sortOrder, System.Guid userId) {
            try {
                _contract = new CrudeAircraftConfigurationRefContract();
                _isNew = true;
                _contract.AircraftConfigurationRcd = aircraftConfigurationRcd;
                textBoxAircraftConfiguration.Text = _contract.AircraftConfigurationRcd;
                _contract.AircraftConfigurationName = aircraftConfigurationName;
                textBoxAircraftConfigurationName.Text = _contract.AircraftConfigurationName;
        ...
        public void ShowAsEdit(string aircraftConfigurationRcd, System.Guid userId) {
            var service = new CrudeAircraftConfigurationRefServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByAircraftConfigurationRcd(aircraftConfigurationRcd);
                textBoxAircraftConfiguration.Text = _contract.AircraftConfigurationRcd;
                textBoxAircraftConfigurationName.Text = _contract.AircraftConfigurationName;
                textBoxDescription.Text = _contract.Description;
                checkBoxActiveFlag.Checked = _contract.ActiveFlag;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeAircraftConfigurationRefServiceClient();
            try {
                _contract.AircraftConfigurationRcd = textBoxAircraftConfiguration.Text;
                _contract.AircraftConfigurationName = textBoxAircraftConfigurationName.Text;
