...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class AircraftCompartmentTypeRefCombo : UserControl {
        ...
        public AircraftCompartmentTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeAircraftCompartmentTypeRefServiceClient aircraftCompartmentTypeRef = null;

                try {
                    aircraftCompartmentTypeRef = new CrudeAircraftCompartmentTypeRefServiceClient();
                    List<CrudeAircraftCompartmentTypeRefContract> contracts = aircraftCompartmentTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "AircraftCompartmentTypeName";
                    cboRef.ValueMember = "AircraftCompartmentTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (aircraftCompartmentTypeRef != null) aircraftCompartmentTypeRef.Close();
                }
            }
        }
    }
