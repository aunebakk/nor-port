...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFerryIdentifierTypeRefEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFerryIdentifierTypeRefContract _contract;
        ...
        public CrudeFerryIdentifierTypeRefEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeFerryIdentifierTypeRefContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(string ferryIdentifierTypeRcd, string ferryIdentifierTypeName, string stateRcd, System.Guid userId) {
            try {
                _contract = new CrudeFerryIdentifierTypeRefContract();
                _isNew = true;
                _contract.FerryIdentifierTypeRcd = ferryIdentifierTypeRcd;
                textBoxFerryIdentifierType.Text = _contract.FerryIdentifierTypeRcd;
                _contract.FerryIdentifierTypeName = ferryIdentifierTypeName;
