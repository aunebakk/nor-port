...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class FerryIdentifierTypeRefCombo : UserControl {
        ...
        public FerryIdentifierTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                ...
                try {
                    ...
                    if (ferryIdentifierTypeRef != null) ferryIdentifierTypeRef.Close();
                }
            }
        }
    }
