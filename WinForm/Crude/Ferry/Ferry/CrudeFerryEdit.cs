...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFerryEdit : Form {
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeFerryServiceClient();
            try {
                _contract.FerryName = textBoxFerryName.Text;
                _contract.FerryTypeRcd = ferryTypeRefCombo.Text;
                _contract.FirstFloatDateTime = dateTimePickerFirstFloatDateTime.Checked ? Convert.ToDateTime(dateTimePickerFirstFloatDateTime.Value): DateTime.MinValue;
