...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class FlightScheduleSegmentRuleRefCombo : UserControl {
        ...
        public FlightScheduleSegmentRuleRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeFlightScheduleSegmentRuleRefServiceClient flightScheduleSegmentRuleRef = null;

                try {
                    flightScheduleSegmentRuleRef = new CrudeFlightScheduleSegmentRuleRefServiceClient();
                    List<CrudeFlightScheduleSegmentRuleRefContract> contracts = flightScheduleSegmentRuleRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "FlightScheduleSegmentRuleName";
                    cboRef.ValueMember = "FlightScheduleSegmentRuleRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (flightScheduleSegmentRuleRef != null) flightScheduleSegmentRuleRef.Close();
                }
            }
        }
    }
