...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFlightScheduleEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeFlightScheduleContract _contract;
        ...
        public CrudeFlightScheduleEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeFlightScheduleContract();
                _isNew = true;
                this.Text += " - Not Savable (BindingFlightSchedule Missing)";
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
                    { }
        ...
        public void ShowAsAddByFlightScheduleAndBindingFlightSchedule(System.Guid bindingFlightScheduleId) {
            try {
                _contract = new CrudeFlightScheduleContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
                dateTimePickerDateTime.Text = _contract.DateTime.ToString();
                _contract.BindingFlightScheduleId = bindingFlightScheduleId;
        ...
        public void ShowAsAdd(System.Guid becameFlightScheduleId, System.Guid bindingFlightScheduleId, System.Guid airlineId, string aircraftTypeRcd, System.Guid departureAirportId, System.Guid arrivalAirportId, string comment, System.DateTime fromDateTime, System.DateTime untilDateTime, System.Guid userId) {
            try {
                _contract = new CrudeFlightScheduleContract();
                _isNew = true;
                _contract.BecameFlightScheduleId = becameFlightScheduleId;
                _contract.BindingFlightScheduleId = bindingFlightScheduleId;
                _contract.AirlineId = airlineId;
                airlinePicker.SelectedValue = _contract.AirlineId;
                _contract.AircraftTypeRcd = aircraftTypeRcd;
        ...
        public void ShowAsEdit(System.Guid flightScheduleId) {
            var service = new CrudeFlightScheduleServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByFlightScheduleId(flightScheduleId);
                airlinePicker.SelectedValue = _contract.AirlineId;
                aircraftTypeRefCombo.Text = _contract.AircraftTypeRcd != null ? _contract.AircraftTypeRcd : String.Empty;
                departureAirportPicker.SelectedValue = _contract.DepartureAirportId;
                arrivalAirportPicker.SelectedValue = _contract.ArrivalAirportId;
