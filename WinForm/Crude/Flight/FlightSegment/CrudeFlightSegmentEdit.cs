...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFlightSegmentEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeFlightSegmentContract();
                _isNew = true;
        ...
        public void ShowAsAdd(System.Guid flightId, System.Guid departureAirportId, System.Guid arrivalAirportId, int logicalSegmentNumber, int physicalSegmentNumber, System.DateTime fromDateTime, System.DateTime untilDateTime, string departureGate, string arrivalGate, System.Guid userId) {
            try {
                _contract = new CrudeFlightSegmentContract();
                _isNew = true;
                _contract.FlightId = flightId;
        ...
        public void ShowAsEdit(System.Guid flightSegmentId) {
            var service = new CrudeFlightSegmentServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByFlightSegmentId(flightSegmentId);
                departureAirportPicker.SelectedValue = _contract.DepartureAirportId;
                arrivalAirportPicker.SelectedValue = _contract.ArrivalAirportId;
                maskedTextBoxLogicalSegmentNumber.Text = _contract.LogicalSegmentNumber.ToString();
                maskedTextBoxPhysicalSegmentNumber.Text = _contract.PhysicalSegmentNumber.ToString();
