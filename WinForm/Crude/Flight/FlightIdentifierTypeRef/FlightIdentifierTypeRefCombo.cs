...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class FlightIdentifierTypeRefCombo : UserControl {
        ...
        public FlightIdentifierTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeFlightIdentifierTypeRefServiceClient flightIdentifierTypeRef = null;

                try {
                    flightIdentifierTypeRef = new CrudeFlightIdentifierTypeRefServiceClient();
                    List<CrudeFlightIdentifierTypeRefContract> contracts = flightIdentifierTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "FlightIdentifierTypeName";
                    cboRef.ValueMember = "FlightIdentifierTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (flightIdentifierTypeRef != null) flightIdentifierTypeRef.Close();
                }
            }
        }
    }
