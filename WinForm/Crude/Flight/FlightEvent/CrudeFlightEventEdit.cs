...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeFlightEventEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeFlightEventContract();
                _isNew = true;
        ...
        public void ShowAsAdd(System.Guid flightId, int flightEventNumber, string dateTimeTypeRcd, System.DateTime newDateTime, string remarks, System.Guid userId) {
            try {
                _contract = new CrudeFlightEventContract();
                _isNew = true;
                _contract.FlightId = flightId;
                _contract.FlightEventNumber = flightEventNumber;
                maskedTextBoxFlightEventNumber.Text = _contract.FlightEventNumber.ToString();
                _contract.DateTimeTypeRcd = dateTimeTypeRcd;
                dateTimeTypeRefCombo.Text = _contract.DateTimeTypeRcd != null ? _contract.DateTimeTypeRcd : String.Empty;
        ...
        public void ShowAsEdit(System.Guid flightEventId) {
            var service = new CrudeFlightEventServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByFlightEventId(flightEventId);
                maskedTextBoxFlightEventNumber.Text = _contract.FlightEventNumber.ToString();
                dateTimeTypeRefCombo.Text = _contract.DateTimeTypeRcd != null ? _contract.DateTimeTypeRcd : String.Empty;
                dateTimePickerNewDateTime.Value = _contract.NewDateTime != DateTime.MinValue ? _contract.NewDateTime : dateTimePickerNewDateTime.MinDate;
                dateTimePickerNewDateTime.Checked = _contract.NewDateTime != DateTime.MinValue;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeFlightEventServiceClient();
            try {
                _contract.FlightEventNumber = maskedTextBoxFlightEventNumber.Text == String.Empty ? 0 : Convert.ToInt32(maskedTextBoxFlightEventNumber.Text);
                _contract.DateTimeTypeRcd = dateTimeTypeRefCombo.Text;
                _contract.NewDateTime = dateTimePickerNewDateTime.Checked ? Convert.ToDateTime(dateTimePickerNewDateTime.Value): DateTime.MinValue;
