...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeServicePackagePromotionEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeServicePackagePromotionContract _contract;
        ...
        public CrudeServicePackagePromotionEdit() {
            InitializeComponent();
        ...
        public void ShowAsAddByServicePackage(System.Guid servicePackageId) {
            try {
                _contract = new CrudeServicePackagePromotionContract();
                _isNew = true;
                _contract.DateTime = DateTime.UtcNow;
