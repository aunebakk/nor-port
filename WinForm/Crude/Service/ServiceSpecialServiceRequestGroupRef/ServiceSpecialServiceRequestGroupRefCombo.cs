...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class ServiceSpecialServiceRequestGroupRefCombo : UserControl {
        ...
        public ServiceSpecialServiceRequestGroupRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeServiceSpecialServiceRequestGroupRefServiceClient serviceSpecialServiceRequestGroupRef = null;

                try {
                    serviceSpecialServiceRequestGroupRef = new CrudeServiceSpecialServiceRequestGroupRefServiceClient();
                    List<CrudeServiceSpecialServiceRequestGroupRefContract> contracts = serviceSpecialServiceRequestGroupRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "ServiceSpecialServiceRequestGroupName";
                    cboRef.ValueMember = "ServiceSpecialServiceRequestGroupRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (serviceSpecialServiceRequestGroupRef != null) serviceSpecialServiceRequestGroupRef.Close();
                }
            }
        }
    }
