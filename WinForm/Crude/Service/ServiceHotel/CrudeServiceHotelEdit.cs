...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeServiceHotelEdit : Form {
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeServiceHotelContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(string hotelName, decimal dayPriceAmount, System.Guid financialCurrencyId, System.Guid addressId, System.Guid productId, System.Guid userId) {
            try {
                _contract = new CrudeServiceHotelContract();
                _isNew = true;
                _contract.HotelName = hotelName;
