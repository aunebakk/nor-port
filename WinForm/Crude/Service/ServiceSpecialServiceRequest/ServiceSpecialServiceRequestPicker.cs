...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class ServiceSpecialServiceRequestPicker : UserControl {
        ...
        public ServiceSpecialServiceRequestPicker() {
           InitializeComponent();
        }
        ...
        public System.Guid SelectedValue {
            get {
                return _serviceSpecialServiceRequestId;
            }
            set {
                if (!DesignMode) {
                    _serviceSpecialServiceRequestId = value;
                    var serviceSpecialServiceRequest = new CrudeServiceSpecialServiceRequestServiceClient();
                    try {
                        CrudeServiceSpecialServiceRequestContract contract = serviceSpecialServiceRequest.FetchByServiceSpecialServiceRequestId(_serviceSpecialServiceRequestId);
                        ...
                        if (serviceSpecialServiceRequest != null) serviceSpecialServiceRequest.Close();
                    }
                };
            }
        }
