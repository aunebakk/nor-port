...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class ServiceImageTypeRefCombo : UserControl {
        ...
        public ServiceImageTypeRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeServiceImageTypeRefServiceClient serviceImageTypeRef = null;

                try {
                    serviceImageTypeRef = new CrudeServiceImageTypeRefServiceClient();
                    List<CrudeServiceImageTypeRefContract> contracts = serviceImageTypeRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "ServiceImageTypeName";
                    cboRef.ValueMember = "ServiceImageTypeRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (serviceImageTypeRef != null) serviceImageTypeRef.Close();
                }
            }
        }
    }
