...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeServiceCarRentalLinkEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeServiceCarRentalLinkContract _contract;
        ...
        public CrudeServiceCarRentalLinkEdit() {
            InitializeComponent();
        ...
        public void ShowAsAdd() {
            try {
                _contract = new CrudeServiceCarRentalLinkContract();
                _isNew = true;
                Show();
            } catch ( Exception ex ) {
                if ( ex == null )
        ...
        public void ShowAsAdd(System.Guid serviceCarRentalId, string linkTypeRcd, System.Guid userId) {
            try {
                _contract = new CrudeServiceCarRentalLinkContract();
                _isNew = true;
                _contract.ServiceCarRentalId = serviceCarRentalId;
        ...
        public void ShowAsEdit(System.Guid serviceCarRentalLinkId) {
            var service = new CrudeServiceCarRentalLinkServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByServiceCarRentalLinkId(serviceCarRentalLinkId);
                serviceCarRentalPicker.SelectedValue = _contract.ServiceCarRentalId;
                linkTypeRefCombo.Text = _contract.LinkTypeRcd != null ? _contract.LinkTypeRcd : String.Empty;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            ...
            try {
                ...
                _contract.LinkTypeRcd = linkTypeRefCombo.Text;
