...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class ServiceRequestStatusRefCombo : UserControl {
        ...
        public ServiceRequestStatusRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeServiceRequestStatusRefServiceClient serviceRequestStatusRef = null;

                try {
                    serviceRequestStatusRef = new CrudeServiceRequestStatusRefServiceClient();
                    List<CrudeServiceRequestStatusRefContract> contracts = serviceRequestStatusRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "ServiceRequestStatusName";
                    cboRef.ValueMember = "ServiceRequestStatusRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (serviceRequestStatusRef != null) serviceRequestStatusRef.Close();
                }
            }
        }
    }
