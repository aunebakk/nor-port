...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class ServiceSpecialServiceRequestRequirementRefCombo : UserControl {
        ...
        public ServiceSpecialServiceRequestRequirementRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeServiceSpecialServiceRequestRequirementRefServiceClient serviceSpecialServiceRequestRequirementRef = null;

                try {
                    serviceSpecialServiceRequestRequirementRef = new CrudeServiceSpecialServiceRequestRequirementRefServiceClient();
                    List<CrudeServiceSpecialServiceRequestRequirementRefContract> contracts = serviceSpecialServiceRequestRequirementRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "ServiceSpecialServiceRequestRequirementName";
                    cboRef.ValueMember = "ServiceSpecialServiceRequestRequirementRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (serviceSpecialServiceRequestRequirementRef != null) serviceSpecialServiceRequestRequirementRef.Close();
                }
            }
        }
    }
