...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeServiceHotelImageEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeServiceHotelImageContract _contract;
        ...
        public CrudeServiceHotelImageEdit() {
            InitializeComponent();
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeServiceHotelImageServiceClient();
            try {
                _contract.ServiceImageTypeRcd = serviceImageTypeRefCombo.Text;
