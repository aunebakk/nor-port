...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeServiceFerryEdit : Form {
        ...
        public void ShowAsEdit(System.Guid serviceFerryId) {
            var service = new CrudeServiceFerryServiceClient();
            _isNew = false;
            try {
                _contract = service.FetchByServiceFerryId(serviceFerryId);
                maskedTextBoxAmount.Text = _contract.Amount.ToString();
                financialCurrencyPicker.SelectedValue = _contract.FinancialCurrencyId;
                userPicker.SelectedValue = _contract.UserId;
                _contract.DateTime = DateTime.UtcNow;
