...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class ServiceSpecialServiceRequestOperationRuleRefCombo : UserControl {
        ...
        public ServiceSpecialServiceRequestOperationRuleRefCombo() {
           InitializeComponent();
        }
        ...
        public void PopulateCombo() {
            if (!DesignMode && cboRef.DataSource == null) {
                CrudeServiceSpecialServiceRequestOperationRuleRefServiceClient serviceSpecialServiceRequestOperationRuleRef = null;

                try {
                    serviceSpecialServiceRequestOperationRuleRef = new CrudeServiceSpecialServiceRequestOperationRuleRefServiceClient();
                    List<CrudeServiceSpecialServiceRequestOperationRuleRefContract> contracts = serviceSpecialServiceRequestOperationRuleRef.FetchAll();

                    cboRef.DataSource = contracts;
                    cboRef.DisplayMember = "ServiceSpecialServiceRequestOperationRuleName";
                    cboRef.ValueMember = "ServiceSpecialServiceRequestOperationRuleRcd";
                } catch (Exception ex) {
                    if (ex != null) { }
                } finally {
                    if (serviceSpecialServiceRequestOperationRuleRef != null) serviceSpecialServiceRequestOperationRuleRef.Close();
                }
            }
        }
    }
