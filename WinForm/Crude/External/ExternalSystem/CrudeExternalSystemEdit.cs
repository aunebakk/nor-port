...
namespace SolutionNorSolutionPort.UserInterface {
    ...
    public partial class CrudeExternalSystemEdit : Form {
        
        // holds the contract, with default values if in New modus, and fetched values in Edit modus
        // links:
        //  docLink: http://sql2x.org/documentationLink/295992ed-7cde-4e32-bf12-1e9163411a56
        private CrudeExternalSystemContract _contract;
        ...
        public CrudeExternalSystemEdit() {
            InitializeComponent();
        ...
        private void buttonSave_Click(object sender, EventArgs e) {
            var service = new CrudeExternalSystemServiceClient();
            try {
                _contract.ExternalSystemCode = textBoxExternalSystemCode.Text;
                _contract.ExternalSystemName = textBoxExternalSystemName.Text;
