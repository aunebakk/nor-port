...
namespace SolutionNorSolutionPort.UserInterface
{
    partial class Login : Form
    {
        ...
        public Login(Main parent) {
            ...
            Log(message: $"Assembly Version: {Assembly.GetExecutingAssembly().GetName().Version.ToString()}");
            Log(message: $"system information local computer name: {SystemInformation.ComputerName}");
            Log(message: $"system information user domain name: {SystemInformation.UserDomainName}");
            Log(message: $"system information user name: {SystemInformation.UserName}");
            _parent = parent;
