...
module DashboardInfo {
    ...
    class ProductTiles {
        ...
        constructor(
            ...
            // init tiles
            ProductTiles.tiles = new Array<Tile>();
        }
        ...
        start() {
            ...
            let line: number = 0;
            ProductTiles.tiles.push(
                new Tile('Info', 2, line, '',
                    15, Tile.tileFontSize() + 30, 15, 2, 5));

            // remaining 
            var lastTile: Tile;
            line++;

            lastTile = new Tile('Architecture', 40, line, 'https://norsolutionsql2xcore.azurewebsites.net/api/1/dashboard/DashboardArchitectureFramework',
                15, Tile.tileFontSize() + 30, 15, 2, 7);
            ProductTiles.tiles.push(lastTile);
            line++;

            lastTile = new Tile('General Statistics', 40, line, '../DefaultStatisticsTop5/DefaultStatisticsTop5Index',
                15, Tile.tileFontSize() + 30, 15, 2, 7);
            ProductTiles.tiles.push(lastTile);
            line++;
            ...
            lastTile = new Tile('User Activity By Address', 40, line, '../' +
                ...
                '/' + 'DefaultUserActivityGroupedByAddressLiveIndex',
                15, Tile.tileFontSize() + 30, 15, 2, 7);
            ProductTiles.tiles.push(lastTile); line++;
            ...
            lastTile = new Tile('Performance Indicators', 40, line, '../' +
                ...
                '/' + 'DefaultPerformanceIndicatorsIndex',
                15, Tile.tileFontSize() + 30, 15, 2, 7);
            ProductTiles.tiles.push(lastTile); line++;
            ...
            document.onmousemove = function (e) {
                ...
                if (ProductTiles.tiles) {
                    for (let tile of ProductTiles.tiles) {
    ...
    class Tile {
        ...
        public static tileFontSize(): number {
            return 14;
        }
