/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:18:21 PM
...
namespace SolutionNorSolutionPort.AspMvc.Controllers {
    ...
    public class CrudeServiceHotelImageController : Controller {
        ...
        [HttpGet]
        public ActionResult CrudeServiceHotelImageIndex() {

            return View(
                "~/Views/Crude/Service/CrudeServiceHotelImage/CrudeServiceHotelImageIndex.cshtml",
                new CrudeServiceHotelImageServiceClient().FetchAll()
                );
        }
        ...
        [HttpGet]
        public ActionResult CrudeServiceHotelImageByServiceHotelIndex(System.Guid serviceHotelId) {
            ViewBag.ServiceHotelId = serviceHotelId;

            return View(
                "~/Views/Crude/Service/CrudeServiceHotelImage/CrudeServiceHotelImageIndex.cshtml",
                new CrudeServiceHotelImageServiceClient().FetchByServiceHotelId(serviceHotelId)
                );
        }
        ...
        [HttpGet]
        public ActionResult CrudeServiceHotelImageDetails(System.Guid serviceHotelImageId) {

            return View(
                "~/Views/Crude/Service/CrudeServiceHotelImage/CrudeServiceHotelImageDetails.cshtml",
                new CrudeServiceHotelImageServiceClient().FetchByServiceHotelImageId(serviceHotelImageId)
                );
        }
        ...
        [HttpGet]
        public ActionResult CrudeServiceHotelImageEdit(
            System.Guid serviceHotelImageId
            ) {

            CrudeServiceHotelImageContract contract = new CrudeServiceHotelImageServiceClient().FetchByServiceHotelImageId(serviceHotelImageId);
        ...
        [HttpGet]
        public ActionResult CrudeServiceHotelImageDelete(
            System.Guid serviceHotelImageId
            ) {
            new CrudeServiceHotelImageServiceClient().Delete(serviceHotelImageId);
