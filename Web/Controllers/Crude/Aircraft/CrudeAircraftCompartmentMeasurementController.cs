/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/28/2020 12:05:21 AM
...
namespace SolutionNorSolutionPort.AspMvc.Controllers {
    ...
    public class CrudeAircraftCompartmentMeasurementController : Controller {
        ...
        [HttpGet]
        public ActionResult CrudeAircraftCompartmentMeasurementIndex() {

            return View(
                "~/Views/Crude/Aircraft/CrudeAircraftCompartmentMeasurement/CrudeAircraftCompartmentMeasurementIndex.cshtml",
                new CrudeAircraftCompartmentMeasurementServiceClient().FetchAll()
                );
        }
        ...
        [HttpGet]
        public ActionResult CrudeAircraftCompartmentMeasurementDetails(System.Guid aircraftCompartmentMeasurementId) {

            return View(
                "~/Views/Crude/Aircraft/CrudeAircraftCompartmentMeasurement/CrudeAircraftCompartmentMeasurementDetails.cshtml",
                new CrudeAircraftCompartmentMeasurementServiceClient().FetchByAircraftCompartmentMeasurementId(aircraftCompartmentMeasurementId)
                );
        }
        ...
        [HttpGet]
        public ActionResult CrudeAircraftCompartmentMeasurementEdit(
        ...
        [HttpGet]
        public ActionResult CrudeAircraftCompartmentMeasurementDelete(
            System.Guid aircraftCompartmentMeasurementId
            ) {
            new CrudeAircraftCompartmentMeasurementServiceClient().Delete(aircraftCompartmentMeasurementId);
