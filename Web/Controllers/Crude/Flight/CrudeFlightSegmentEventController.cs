/*
  ...
  SQL2X Version: 1.0
  http://sql2x.org/
  Generated Date: 12/27/2020 11:18:06 PM
...
namespace SolutionNorSolutionPort.AspMvc.Controllers {
    ...
    public class CrudeFlightSegmentEventController : Controller {
        ...
        [HttpGet]
        public ActionResult CrudeFlightSegmentEventIndex() {

            return View(
                "~/Views/Crude/Flight/CrudeFlightSegmentEvent/CrudeFlightSegmentEventIndex.cshtml",
                new CrudeFlightSegmentEventServiceClient().FetchAll()
                );
        }
        ...
        [HttpGet]
        public ActionResult CrudeFlightSegmentEventDetails(System.Guid flightSegmentEventId) {

            return View(
                "~/Views/Crude/Flight/CrudeFlightSegmentEvent/CrudeFlightSegmentEventDetails.cshtml",
                new CrudeFlightSegmentEventServiceClient().FetchByFlightSegmentEventId(flightSegmentEventId)
                );
        }
        ...
        [HttpGet]
        public ActionResult CrudeFlightSegmentEventEdit(
            System.Guid flightSegmentEventId
            ) {

            CrudeFlightSegmentEventContract contract = new CrudeFlightSegmentEventServiceClient().FetchByFlightSegmentEventId(flightSegmentEventId);
        ...
        [HttpGet]
        public ActionResult CrudeFlightSegmentEventDelete(
            System.Guid flightSegmentEventId
            ) {
            new CrudeFlightSegmentEventServiceClient().Delete(flightSegmentEventId);
