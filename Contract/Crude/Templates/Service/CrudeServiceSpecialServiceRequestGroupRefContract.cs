...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    // this class start with an identical representation of CrudeServiceSpecialServiceRequestGroupRef's columns
    //  formatted to follow C# casing guidelines ( Pascal casing )
    // links:
    //  POCO ( Plain old CLR object ): https://en.wikipedia.org/wiki/Plain_old_CLR_object
    //  docLink: http://sql2x.org/documentationLink/ceb39174-f927-4fd8-8396-5ec4d04ea471
    [DataContract()]
    public partial class CrudeServiceSpecialServiceRequestGroupRefContract {
