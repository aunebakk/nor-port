...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeDefaultErrorService {
        ...
        SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract FetchByDefaultErrorId(System.Guid defaultErrorId);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchByDefaultUserId(System.Guid defaultUserId);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchByDefaultErrorLayerRcd(string defaultErrorLayerRcd);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchByDefaultErrorTypeRcd(string defaultErrorTypeRcd);
        ...
        void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract contract);
        ...
        void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract contract);
        ...
        SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract FetchByMethodName(string methodName);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchAll();
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchAllWithLimit(int limit);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchAllWithLimitAndOffset(int limit, int offset);
    ...
    public class CrudeDefaultErrorServiceClient : System.ServiceModel.ClientBase<ICrudeDefaultErrorService>, ICrudeDefaultErrorService {
        ...
        public SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract FetchByDefaultErrorId(System.Guid defaultErrorId) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchByDefaultUserId(System.Guid defaultUserId) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchByDefaultErrorLayerRcd(string defaultErrorLayerRcd) {
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/b6aae770-2299-4a5e-8ef5-0e23be13974e
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchByDefaultErrorTypeRcd(string defaultErrorTypeRcd) {
        ...
        public void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract contract) {
        ...
        public void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract contract) {
        ...
        public SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract FetchByMethodName(string methodName) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchAll() {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchAllWithLimit(int limit) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeDefaultErrorContract> FetchAllWithLimitAndOffset(int limit, int offset) {
