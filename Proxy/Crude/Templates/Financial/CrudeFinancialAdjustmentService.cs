/*
  ...
  Filename: FinancialAdjustment.json
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeFinancialAdjustmentService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialAdjustmentService/FetchByFinancialAdjustmentId", ReplyAction="http://tempuri.org/ICrudeFinancialAdjustmentService/FetchByFinancialAdjustmentIdR" +
            "esponse")]
        SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract FetchByFinancialAdjustmentId(System.Guid financialAdjustmentId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialAdjustmentService/FetchByFinancialCurrencyId", ReplyAction="http://tempuri.org/ICrudeFinancialAdjustmentService/FetchByFinancialCurrencyIdRes" +
            "ponse")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchByFinancialCurrencyId(System.Guid financialCurrencyId);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchByUserId(System.Guid userId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialAdjustmentService/FetchByFinancialAdjustmentTyp" +
            ...
            "eRcdResponse")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchByFinancialAdjustmentTypeRcd(string financialAdjustmentTypeRcd);
        ...
        void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract contract);
        ...
        void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract contract);
        ...
        // fetch all rows from table financial_adjustment into new List of class instances
        // links:
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchAll();
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchAllWithLimit(int limit);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialAdjustmentService/FetchAllWithLimitAndOffset", ReplyAction="http://tempuri.org/ICrudeFinancialAdjustmentService/FetchAllWithLimitAndOffsetRes" +
            "ponse")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchAllWithLimitAndOffset(int limit, int offset);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchWithFilter(System.Guid financialAdjustmentId, string financialAdjustmentTypeRcd, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime);
    }
    ...
    public class CrudeFinancialAdjustmentServiceClient : System.ServiceModel.ClientBase<ICrudeFinancialAdjustmentService>, ICrudeFinancialAdjustmentService {
        ...
        public SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract FetchByFinancialAdjustmentId(System.Guid financialAdjustmentId) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/7f3c31d9-2d99-4f93-b9b1-b866fa1c64dc
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchByUserId(System.Guid userId) {
            return base.Channel.FetchByUserId(userId);
        }
        
        // fetch all rows matching foreign key: FinancialAdjustmentTypeRcd
        // links:
        //  docLink: http://sql2x.org/documentationLink/b6aae770-2299-4a5e-8ef5-0e23be13974e
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchByFinancialAdjustmentTypeRcd(string financialAdjustmentTypeRcd) {
        ...
        public void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract contract) {
        ...
        public void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract contract) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchAll() {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchAllWithLimit(int limit) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchAllWithLimitAndOffset(int limit, int offset) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialAdjustmentContract> FetchWithFilter(System.Guid financialAdjustmentId, string financialAdjustmentTypeRcd, decimal amount, System.Guid financialCurrencyId, System.Guid userId, System.DateTime dateTime) {
