/*
  ...
  Filename: FinancialPaymentTypeRef.json
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeFinancialPaymentTypeRefService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialPaymentTypeRefService/FetchByFinancialPaymentTy" +
            ...
            "peRcdResponse")]
        SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract FetchByFinancialPaymentTypeRcd(string financialPaymentTypeRcd);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchByUserId(System.Guid userId);
        ...
        void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract contract);
        ...
        void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract contract);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialPaymentTypeRefService/FetchByFinancialPaymentTy" +
            ...
            "peNameResponse")]
        SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract FetchByFinancialPaymentTypeName(string financialPaymentTypeName);
        
        // fetch all rows from table financial_payment_type_ref into new List of class instances
        // links:
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchAll();
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialPaymentTypeRefService/FetchAllWithLimit", ReplyAction="http://tempuri.org/ICrudeFinancialPaymentTypeRefService/FetchAllWithLimitResponse" +
            "")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchAllWithLimit(int limit);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialPaymentTypeRefService/FetchAllWithLimitAndOffse" +
            ...
            "tResponse")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchAllWithLimitAndOffset(int limit, int offset);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchWithFilter(string financialPaymentTypeRcd, string financialPaymentTypeName, System.Guid userId, System.DateTime dateTime);
    }
    ...
    public class CrudeFinancialPaymentTypeRefServiceClient : System.ServiceModel.ClientBase<ICrudeFinancialPaymentTypeRefService>, ICrudeFinancialPaymentTypeRefService {
        ...
        public SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract FetchByFinancialPaymentTypeRcd(string financialPaymentTypeRcd) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchByUserId(System.Guid userId) {
        ...
        public void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract contract) {
        ...
        public void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract contract) {
        ...
        public SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract FetchByFinancialPaymentTypeName(string financialPaymentTypeName) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchAll() {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchAllWithLimit(int limit) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchAllWithLimitAndOffset(int limit, int offset) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialPaymentTypeRefContract> FetchWithFilter(string financialPaymentTypeRcd, string financialPaymentTypeName, System.Guid userId, System.DateTime dateTime) {
