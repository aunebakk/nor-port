/*
  ...
  Filename: FinancialVoucher.json
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeFinancialVoucherService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialVoucherService/FetchByFinancialVoucherId", ReplyAction="http://tempuri.org/ICrudeFinancialVoucherService/FetchByFinancialVoucherIdRespons" +
            "e")]
        SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract FetchByFinancialVoucherId(System.Guid financialVoucherId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialVoucherService/FetchByFinancialCurrencyId", ReplyAction="http://tempuri.org/ICrudeFinancialVoucherService/FetchByFinancialCurrencyIdRespon" +
            "se")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchByFinancialCurrencyId(System.Guid financialCurrencyId);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchByUserId(System.Guid userId);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialVoucherService/FetchByFinancialVoucherTypeRcd", ReplyAction="http://tempuri.org/ICrudeFinancialVoucherService/FetchByFinancialVoucherTypeRcdRe" +
            "sponse")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchByFinancialVoucherTypeRcd(string financialVoucherTypeRcd);
        ...
        void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract contract);
        ...
        void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract contract);
        ...
        // fetch all rows from table financial_voucher into new List of class instances
        // links:
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchAll();
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchAllWithLimit(int limit);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialVoucherService/FetchAllWithLimitAndOffset", ReplyAction="http://tempuri.org/ICrudeFinancialVoucherService/FetchAllWithLimitAndOffsetRespon" +
            "se")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchAllWithLimitAndOffset(int limit, int offset);
    ...
    public class CrudeFinancialVoucherServiceClient : System.ServiceModel.ClientBase<ICrudeFinancialVoucherService>, ICrudeFinancialVoucherService {
        ...
        public SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract FetchByFinancialVoucherId(System.Guid financialVoucherId) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchByFinancialCurrencyId(System.Guid financialCurrencyId) {
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/7f3c31d9-2d99-4f93-b9b1-b866fa1c64dc
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchByUserId(System.Guid userId) {
            return base.Channel.FetchByUserId(userId);
        }
        
        // fetch all rows matching foreign key: FinancialVoucherTypeRcd
        // links:
        //  docLink: http://sql2x.org/documentationLink/b6aae770-2299-4a5e-8ef5-0e23be13974e
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchByFinancialVoucherTypeRcd(string financialVoucherTypeRcd) {
        ...
        public void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract contract) {
        ...
        public void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract contract) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchAll() {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchAllWithLimit(int limit) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialVoucherContract> FetchAllWithLimitAndOffset(int limit, int offset) {
