/*
  ...
  Filename: FinancialCostcentre.json
...
namespace SolutionNorSolutionPort.BusinessLogicLayer {
    ...
    public partial interface ICrudeFinancialCostcentreService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialCostcentreService/FetchByFinancialCostcentreId", ReplyAction="http://tempuri.org/ICrudeFinancialCostcentreService/FetchByFinancialCostcentreIdR" +
            "esponse")]
        SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract FetchByFinancialCostcentreId(System.Guid financialCostcentreId);
        
        // fetch all rows matching foreign key: FinancialCompanyId
        // links:
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialCostcentreService/FetchByFinancialCompanyId", ReplyAction="http://tempuri.org/ICrudeFinancialCostcentreService/FetchByFinancialCompanyIdResp" +
            "onse")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchByFinancialCompanyId(System.Guid financialCompanyId);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchByUserId(System.Guid userId);
        ...
        void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract contract);
        ...
        void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract contract);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialCostcentreService/FetchByFinancialCostcentreCod" +
            "e", ReplyAction="http://tempuri.org/ICrudeFinancialCostcentreService/FetchByFinancialCostcentreCod" +
            "eResponse")]
        SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract FetchByFinancialCostcentreCode(string financialCostcentreCode);
        
        // fetch all rows from table financial_costcentre into new List of class instances
        // links:
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchAll();
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchAllWithLimit(int limit);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICrudeFinancialCostcentreService/FetchAllWithLimitAndOffset", ReplyAction="http://tempuri.org/ICrudeFinancialCostcentreService/FetchAllWithLimitAndOffsetRes" +
            "ponse")]
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchAllWithLimitAndOffset(int limit, int offset);
        ...
        List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchWithFilter(System.Guid financialCostcentreId, string financialCostcentreCode, string financialCostcentreName, System.Guid financialCompanyId, System.Guid userId, System.DateTime dateTime);
    }
    ...
    public class CrudeFinancialCostcentreServiceClient : System.ServiceModel.ClientBase<ICrudeFinancialCostcentreService>, ICrudeFinancialCostcentreService {
        ...
        public SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract FetchByFinancialCostcentreId(System.Guid financialCostcentreId) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchByFinancialCompanyId(System.Guid financialCompanyId) {
        ...
        // links:
        //  docLink: http://sql2x.org/documentationLink/7f3c31d9-2d99-4f93-b9b1-b866fa1c64dc
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchByUserId(System.Guid userId) {
        ...
        public void Insert(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract contract) {
        ...
        public void Update(SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract contract) {
        ...
        public SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract FetchByFinancialCostcentreCode(string financialCostcentreCode) {
            return base.Channel.FetchByFinancialCostcentreCode(financialCostcentreCode);
        }
        
        // fetch all rows from table financial_costcentre into new List of class instances
        // links:
        //  docLink: http://sql2x.org/documentationLink/168c348a-8e3d-463e-8e60-727047f10afc
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchAll() {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchAllWithLimit(int limit) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchAllWithLimitAndOffset(int limit, int offset) {
        ...
        public List<SolutionNorSolutionPort.BusinessLogicLayer.CrudeFinancialCostcentreContract> FetchWithFilter(System.Guid financialCostcentreId, string financialCostcentreCode, string financialCostcentreName, System.Guid financialCompanyId, System.Guid userId, System.DateTime dateTime) {
